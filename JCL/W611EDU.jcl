//W611EDU  JOB (51091925800,HC2N,01,99,0,,,,0),                                 
...
//SYSIN     DD  DUMMY                                                           
//SYSPRINT  DD  SYSOUT=*                                                        
//SYSUT2    DD  SYSOUT=(A,,F001),DEST=R3130279                                  
//*YSUT2    DD  SYSOUT=(A,,F001),DEST=R3130271                                  
//*YSUT2    DD  SYSOUT=A,DEST=RSE56444 gm2  ej skall använda (SYSUT2)           
//*YSUT2    DD  SYSOUT=A,DEST=RSE56443 tr       ----- """ -----                 
//SYSUT1    DD  *                                                               
^%ÄB ^&f1Y ^&f0X ^*c0003a1329B ^*p0141y0000X^*c0P ^*p0141y1058X^*c0P            
