//W810J002 JOB (640W8100100W810JACC,W100),'RTN W810D1',                         
//             CLASS=V                                                          
...
* ----------------                                                              
***********************************************************                     
* MATCHAR EXTRAKTFIL-CDC MED EXTRAKTFIL-NDC, HÄMTA INLEV DATUM                  
***********************************************************                     
JOB INPUT (INFIL03 KEY(IN3-IDARTNR) INFIL02 KEY(IN2-IDARTNR))                   
   IF MATCHED                                                                   
     TEMP-WNDCPART EQ IN2-WNDCPART                                              
     TEMP-INLEV-DATUM EQ IN3-TIAVIDAT-SEN                                       
     PUT TEMP01                                                                 
   END-IF                                                                       
***********************************************************                     
* MATCHAR EXTRAKTFIL MED LAGERBAND                        *                     
***********************************************************                     
JOB INPUT (INFIL01 KEY(KEMI-IDARTNR) TEMP01  KEY(TEMP-IDARTNR)) +               
   START A-INIT                                                                 
*                                                                               
   IF MATCHED                                                                   
    IF TEMP-IDDC EQ '41' '42' '43' '51' '61' '62'                               
...
//INFIL02   DD   DSN=WXTR.PARTINFO.WNDCWEEK(+0),DISP=SHR                        
...
//*                                                                             
//UTFIL01   DD DSN=&&WNDCWEEK,DISP=(NEW,PASS,DELETE),                           
...
//SORT     EXEC PGM=SORT                                                        
//SYSOUT   DD  SYSOUT=*                                                         
//SORTIN   DD  DSN=&&WNDCWEEK,DISP=(OLD,DELETE,DELETE)                          
//VBOUT    DD  DSN=WXTR.KEMIREV2.WNDCWEEK(+1),                                  
...
//EMPTY1 EXEC WEMPTST,DSIN=WXTR.KEMIREV2.WNDCWEEK(+1)                           
//    IF (EMPTY1.T.RC = 0) THEN                                                 
// EXEC WZ14DAP2,DSIN=WXTR.KEMIREV2.WNDCWEEK(+1)                                
//SYSIN           DD *                                                          
WNDCWEEK                                                                        
WNDCWEEK                                                                        
//    ENDIF                                                                     
