//W97005FI JOB (540W0000100W97005FI,W100),'RTN W970V1',                         
...
//XMIT EXEC VXFER                                                               
//SYSIN DD DATA,DLM='??'                                                        
  COPY DSN(F1SMV2.IX.IXSEQ(+0))                                                 
       TODSN(W970.W970B1.W97005(+1))                                            
       DEST(NJEV1)                                                              
       MGMTCLAS(BACKUPC)                                                        
       XFERID(W97005)                                                           
...
++SYSIN (ERROR).                                                                
//W97005ER JOB (540W0000100W97005ER,W100),'RTN W970V1',                         
//             CLASS=K                                                          
...
//*   F1XFV2.PROD.ERRLOG I V2:AN) EFTER ORSAKEN.                     *          
//*   XFERID: W97005                                                 *          
//*                                                                  *          
//********************************************************************          
//VRCABE  EXEC VRCABEND                                                         
//*                                                                             
//SOP     EXEC WSOPEND,PROCESS=W97005FI                                         
++END.                                                                          
++SYSIN (OK).                                                                   
//W97005OK JOB (540W0000100W97005OK,W100),'RTN W970V1',                         
//             CLASS=K                                                          
//PROC  JCLLIB ORDER=(W.PROD.PROCLIB)                                           
//ENV  INCLUDE MEMBER=ENVPROD                                                   
/*JOBPARM FORMS=1800,LINECT=0                                                   
