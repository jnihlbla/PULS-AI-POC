...
006000     03 IDLEVNR-NUM          PIC 9(5)            COMP-3.                  
006100*                                 LEVERANTÖRNUMMER                        
006200*                                 SUPPLIER NUMBER (VENDORNUMBER)          
006300     03 PRARTSJK             PIC S9(7)V9(2)      COMP-3.                  
006400*                                 ARTIKELNS SJÄLVKOSTNAD                  
006500*                                 COST OF SALES                           
...
009700     03 IDINK-OLD            PIC S9(3)           COMP-3.                  
...
015500     03 SLAG-IDLEVNR-NUM     PIC 9(5)            COMP-3.                  
015600*                                 LEVERANTÖRNUMMER                        
015700*                                 SUPPLIER NUMBER (VENDORNUMBER)          
015800     03 IDLEVNR              PIC X(5).                                    
015900*                                 LEVERANTÖRNUMMER                        
016000*                                 SUPPLIER NUMBER (VENDOR NUMBER)         
016100     03 SLAG-IDLEVNR         PIC X(5).                                    
016200*                                 LEVERANTÖRNUMMER                        
016300*                                 SUPPLIER NUMBER (VENDOR NUMBER)         
016400     03 IDINK                PIC X(4).                                    
016500*                                 INKÖPARNUMMER                           
016600*                                 PURCHASE IDENTIFICATION NUMBER          
016700     03 IDKAT                OCCURS 3 TIMES                               
016800                             PIC X(5).                                    
016900*                                 KATALOGBETECKNING                       
017000     03 KDRAB                PIC X(3).                                    
017100*                                 RABATTKOD                               
017200     03 PRARTBEL             PIC S9(7)V9(2)      COMP-3.                  
017300*                                 BESTÄLLNINGSPRIS   PRARTBEL-002         
017400*                                 I LEVERANTÖRS VALUTA                    
017500     03 FLLSRDEL             PIC X.                                       
017600*                                 LEVERERAS SOM RESDEL                    
017700     03 IDPROJUP             PIC X(8).                                    
017800*                                 PROJEKTUPPDRAG                          
017900*                                 PROJECT ASSIGNMENT                      
018000     03 FLGEMFMC             PIC X.                                       
018100*                                 GEMENSAM FORD/MPNR ARTIKEL              
018200*                                 COMMON FMC/MPNR PARTNO.                 
018300     03 TIURPROD             PIC S9(5)           COMP-3.                  
018400*                                 DATUM UTGÅTT UR PROD   (ÅÅVV)           
018500*                                 OUT OF PRODUCTION DATE (YYWW)           
018600*** END OF VILMAII-COPY LENGTH= 210 BYTES                                 
