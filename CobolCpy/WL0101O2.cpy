...
002000*                                                                         
002100     03 RESP-KVRADER         PIC 9(5).                                    
002200*                                 ANTAL RADER                             
...
003300        05 RESP-IDFAKT       PIC 9(7).                                    
003400*                                 FAKTURANUMMER                           
003500*                                 INVOICE NO.                             
003600        05 RESP-IDSHIPM      PIC Z(6)9.                                   
...
006200        05 RESP-KVKOLLI-FAKT PIC 9(4).                                    
006300*                                 ANTAL KOLLI                             
006400*                                 NBR OF CASES                            
006500        05 RESP-KVKOLLI-MOT  PIC 9(4).                                    
006600*                                 ANTAL KOLLI                             
006700*                                 NBR OF CASES                            
006800        05 RESP-KVRADER-FAKT PIC 9(5).                                    
006900*                                 ANTAL RADER PER FAKTURA                 
007000*                                 NUMBER OF LINES PER INVOICE             
007100        05 RESP-KVRADER-MOT  PIC 9(5).                                    
007200*                                 ANTAL MOTTAGNA  RADER                   
007300*                                 NUMBER OF LINES RECEIVED                
007400        05 RESP-KVRADER-PRIO PIC 9(5).                                    
