...
006600        05 W11615-002-GRP    OCCURS 10 TIMES.                             
006700*                                 SPRÅK-RAD                               
006800           07 BEART          PIC X(25).                                   
006900*                                 ARTIKELBENÄMNING                        
007000        05 IDLEVNR-MOTSV     PIC X(5).                                    
007100*                                 LEVERANTÖRNUMMER                        
007200        05 IDLEVNR-LOC-MOTSV PIC X(5).                                    
007300*                                 LEVERANTÖRNUMMER                        
007400        05 KDTIPPR           PIC S9              COMP-3.                  
007500*                                 TIPPAT PRIS KOD                         
007600     03 IDKAT                OCCURS 3 TIMES                               
007700                             PIC X(5).                                    
007800*                                 KATALOGBETECKNING                       
007900     03 BELEVART             PIC X(30).                                   
008000*                                 LEVERANTÖRENS ARTIKELBENÄMNING          
008100     03 FLGEMFMC             PIC X.                                       
008200*                                 GEMENSAM FORD/MPNR ARTIKEL              
008300     03 IDPROJUP             PIC X(8).                                    
008400*                                 PROJEKTUPPDRAG                          
008500     03 TIURPROD             PIC 9(4).                                    
008600*                                 DATUM UTGÅTT UR PROD   (ÅÅVV)           
008700*** END OF VILMAII-COPY LENGTH= 398 BYTES                                 
