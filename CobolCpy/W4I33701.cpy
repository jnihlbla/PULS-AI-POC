000100 01  MID-W4I33701.                                                        
000200*                                 MID-COPYTEXT FÖR W4033700               
...
002300     03 MID-IDPRODNR         PIC 9(7).                                    
002400*                                 PRODUKTIONSNUMMER                       
002500     03 MID-KDPRTVAL-FS      PIC X(2).                                    
002600*                                 PRINTER-VAL KOD                         
002700     03 MID-KDPRTVAL-AF-IN   PIC X(2).                                    
002800*                                 PRINTER-VAL KOD                         
002900     03 MID-KDPRTVAL-AF-UT   PIC X(2).                                    
003000*                                 PRINTER-VAL KOD                         
003100     03 MID-VKORDBTO         PIC X(8).                                    
003200*                                 ORDERVIKT BRUTTO (KG)                   
003300     03 MID-ADFLGEO          PIC X(3).                                    
003400*                                 GEOGRAFISKT OMRÅDE FÄRDIGLAGER          
003500     03 MID-ADFLOMR          PIC X(3).                                    
003600*                                 LASTNINGSOMR/STÄLL FÄRDIGLAGER          
003700     03 MID-ADRUTNIV         PIC X(3).                                    
003800*                                 RUTA/NIVÅ I FÄRDIGLAGRET                
003900     03 MID-ADVMODUL         PIC X(3).                                    
004000*                                 VÄNSTER-MODUL                           
004100*** END OF VILMAII-COPY LENGTH= 77 BYTES                                  
