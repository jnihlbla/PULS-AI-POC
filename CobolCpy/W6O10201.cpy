000100 01  MOD-W6O10201.                                                        
000200*                                 COPYTEXT FOR MOD W6O10201               
...
003100*                                 LINES                                   
003200        05 MOD-IDLEVNR-ATTR  PIC X(2).                                    
003300*                                 MFS ATTRIBUTFÄLT                        
003400        05 MOD-IDLEVNR       PIC X(5).                                    
003500*                                 LEVERANTÖRNUMMER                        
003600        05 MOD-IDOKOLLI-ATTR PIC X(2).                                    
003700*                                 MFS ATTRIBUTFÄLT                        
003800        05 MOD-IDOKOLLI      PIC X(9).                                    
003900*                                 ODETTE KOLLINUMMER                      
