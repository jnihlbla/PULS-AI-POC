...
005800     03 MID-IDLOPNRM-NEXT    PIC X(9).                                    
005900*                                 LÖPNUMMER MOTTAGNINGSRAPPORT            
006000*                                 (0VVDLLLLK)                             
006100     03 MID-IDRADNR-NEXT     PIC X(4).                                    
006200*                                 RADNUMMER                               
006300     03 MID-IDLOPNRM-ENTER   PIC X(9).                                    
006400*                                 LÖPNUMMER MOTTAGNINGSRAPPORT            
006500*                                 (0VVDLLLLK)                             
006600     03 MID-IDRADNR-ENTER    PIC X(4).                                    
006700*                                 RADNUMMER                               
006800     03 MID-RAD              OCCURS 12 TIMES.                             
006900        05 MID-IDARTNR       PIC X(8).                                    
007000*                                 ARTIKELNUMMER                           
007100     03 MID-ADINLOMR-TOMN    PIC X(4).                                    
007200*                                 INLEVERANSOMRÅDE                        
