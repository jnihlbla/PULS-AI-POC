000100 01  MID-W2I37201.                                                        
000200*                                 MID-COPYTEXT FÖR W2037200               
...
002200     03 MID-INPUT.                                                        
002300        05 MID-KVPB-REF      PIC X(8).                                    
002400*                                 PERIODBEHOV (PROGNOS)                   
002500        05 MID-FLREFBEO      PIC X.                                       
002600        05 MID-KVPBREOI      PIC X(8).                                    
002700*                                 PERIODBEHOV (PROGNOS)                   
002800        05 MID-FLAGGA-FCD    PIC X.                                       
002900        05 MID-COMMENT-1     PIC X(36).                                   
003000        05 MID-PURCHQTY      PIC 9(7).                                    
003100        05 MID-COMMENT-2     PIC X(36).                                   
003200*** END OF VILMAII-COPY LENGTH= 150 BYTES                                 
