000100 01  MID-W6I11301.                                                        
000200*                                 MID-COPYTEXT FÖR W60113                 
...
004900        05 MID-IDLEVNR-RAD   OCCURS 12 TIMES                              
005000                             PIC X(5).                                    
005100*                                 LEVERANTÖRNUMMER                        
005200        05 MID-KDRT-RAD      OCCURS 12 TIMES                              
005300                             PIC X(2).                                    
005400*                                 REDOVISNINGSTYP                         
005500        05 MID-IDFS-RAD      OCCURS 12 TIMES                              
005600                             PIC X(8).                                    
005700*                                 FÖLJESEDELSNUMMER ENL ODETTE            
005800        05 MID-TIAVIDAT-RAD  OCCURS 12 TIMES                              
005900                             PIC X(6).                                    
006000*                                 AVISERINGSDATUM (YYMMDD)                
006100        05 MID-IDARTNR-RAD   OCCURS 12 TIMES                              
006200                             PIC X(8).                                    
006300*                                 ARTIKELNUMMER                           
006400        05 MID-KVAVIS-RAD    OCCURS 12 TIMES                              
006500                             PIC X(6).                                    
006600*                                 AVISERAT ANTAL                          
