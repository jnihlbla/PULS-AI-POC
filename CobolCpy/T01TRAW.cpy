000100* GENERATION OF COBOL HOST STRUCTURE FROM T01TRAW-TAB                     
000200  01 T01TRAW.                                                             
000300*              T01TRAW                                                    
...
001800   03 IDAPPEND          PIC X(8).                                         
001900*              APPENDIXVÄRDE                                              
002000   03 BEVOLREF          PIC X(10).                                        
...
012500   03 IDFELKOD          PIC X(3).                                         
012600*              FELKOD                                                     
012700   03 BEFEL             PIC X(50).                                        
012800*              FELTEXT                                                    
012900   03 BEANST            PIC X(25).                                        
013000*              ANSTÄLLDS NAMN                                             
013100   03 IDUSER            PIC X(8).                                         
013200*              ANVÄNDARENS SÄKERHETS ID                                   
013300   03 BETEXT            PIC X(125).                                       
013400   03 BETEXT-CRE        PIC X(100).                                       
013500   03 IDARTNR-CNTRL     PIC X(2).                                         
013600*              KONTROLLSIFFRA FÖR ARTIKELNUMMER                           
013700   03 FLPCOO            PIC X(1).                                         
013800*              FLAGGA OM FÖRMÅNSAVTAL URS.LAND                            
013900   03 IDLEVNR-ART       PIC X(5).                                         
014000*              LEVERANTÖRNR PÅ ARTIKEL                                    
014100   03 IDTRACK-1         PIC X(25).                                        
014200*              TRACKING ID FROM CUSTOMS                                   
014300   03 IDTRACK-2         PIC X(25).                                        
014400*              TRACKING ID FROM CUSTOMS                                   
014500   03 IDTRACK-3         PIC X(25).                                        
014600*              TRACKING ID FROM CUSTOMS                                   
014700   03 IDTRACK-4         PIC X(25).                                        
014800*              TRACKING ID FROM CUSTOMS                                   
014900   03 IDTRACK-5         PIC X(25).                                        
015000*              TRACKING ID FROM CUSTOMS                                   
015100   03 KVANT-TRACK-1     PIC S9(7) COMP-3.                                 
015200*              TILLHÖR AV EN VISS ARTIKEL                                 
015300   03 KVANT-TRACK-2     PIC S9(7) COMP-3.                                 
015400*              TILLHÖR AV EN VISS ARTIKEL                                 
015500   03 KVANT-TRACK-3     PIC S9(7) COMP-3.                                 
015600*              TILLHÖR AV EN VISS ARTIKEL                                 
015700   03 KVANT-TRACK-4     PIC S9(7) COMP-3.                                 
015800*              TILLHÖR AV EN VISS ARTIKEL                                 
015900   03 KVANT-TRACK-5     PIC S9(7) COMP-3.                                 
016000*              TILLHÖR AV EN VISS ARTIKEL                                 
016100   03 KDPRMOD           PIC X(2).                                         
016200*              VILKEN PRISMODELL SOM ANVÄNDS                              
016300*                                                                         
016400*** END OF VILMAII-COPY LENGTH= 1073 OLD LENGTH=                          
