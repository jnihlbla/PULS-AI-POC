...
010800     03 MOD-TIFINLV-UT       PIC 9(5).                                    
010900*                                 PUBLICERINGSVECKA, (ÅÅVVD  D=1)         
011000     03 MOD-TISOP-UT         PIC 9(5).                                    
011100*                                 PRODUKTIONSSTART, (ÅÅVVD  D=1)          
011200     03 MOD-KDUART-ATTR      PIC X(2).                                    
011300*                                 MFS ATTRIBUTFÄLT                        
011400     03 MOD-KDUART-IN        PIC X(2).                                    
011500*                                 MFS BEHANDLING AV INPUTFÄLT             
011600     03 MOD-IDPROJK-ATTR     PIC X(2).                                    
011700*                                 MFS ATTRIBUTFÄLT                        
011800     03 MOD-IDPROJK-IN       PIC X(4).                                    
011900*                                 PROJEKTIDENTITET KONSTRUKTION           
012000     03 MOD-FLPISK-ATTR      PIC X(2).                                    
012100*                                 MFS ATTRIBUTFÄLT                        
012200     03 MOD-FLPISK-IN        PIC X(2).                                    
012300*                                 MFS BEHANDLING AV INPUTFÄLT             
012400     03 MOD-IDAO-ATTR        PIC X(2).                                    
012500*                                 MFS ATTRIBUTFÄLT                        
012600     03 MOD-IDAO-IN          PIC X(2).                                    
012700*                                 MFS BEHANDLING AV INPUTFÄLT             
012800     03 MOD-TISOP-ATTR       PIC X(2).                                    
012900*                                 MFS ATTRIBUTFÄLT                        
013000     03 MOD-TISOP-IN         PIC X(2).                                    
013100*                                 MFS BEHANDLING AV INPUTFÄLT             
013200     03 MOD-FLLSRDEL-UT      PIC X.                                       
013300*                                 LEVERERAS SOM RESDEL                    
013400     03 MOD-IDPROJUP-UT      PIC X(8).                                    
013500*                                 PROJEKTUPPDRAG                          
013600     03 MOD-BEART-UT         PIC X(25).                                   
013700*                                 ARTIKELBENÄMNING                        
013800     03 MOD-IDSKYLT-ATTR     PIC X(2).                                    
013900*                                 MFS ATTRIBUTFÄLT                        
014000     03 MOD-IDSKYLT-IN       PIC X(2).                                    
014100*                                 MFS BEHANDLING AV INPUTFÄLT             
014200     03 MOD-FLLSRDEL-ATTR    PIC X(2).                                    
014300*                                 MFS ATTRIBUTFÄLT                        
014400     03 MOD-FLLSRDEL-IN      PIC X(2).                                    
014500*                                 MFS BEHANDLING AV INPUTFÄLT             
014600     03 MOD-IDPROJUP-ATTR    PIC X(2).                                    
014700*                                 MFS ATTRIBUTFÄLT                        
014800     03 MOD-IDPROJUP-IN      PIC X(2).                                    
014900*                                 MFS BEHANDLING AV INPUTFÄLT             
015000     03 MOD-BEART-ATTR       PIC X(2).                                    
015100*                                 MFS ATTRIBUTFÄLT                        
015200     03 MOD-BEART-IN         PIC X(2).                                    
015300*                                 MFS BEHANDLING AV INPUTFÄLT             
015400     03 MOD-FLRSBEART-ATTR   PIC X(2).                                    
015500*                                 MFS ATTRIBUTFÄLT                        
015600     03 MOD-FLRSBEART-IN     PIC X(2).                                    
015700*                                 MFS BEHANDLING AV INPUTFÄLT             
015800     03 MOD-IDFKNGRP-UT      PIC Z(3)9.                                   
015900*                                 FUNKTIONSGRUPP                          
016000     03 MOD-IDLEVNR-UT       PIC X(5).                                    
016100*                                 LEVERANTÖRNUMMER                        
016200     03 MOD-BELEV-UT         PIC X(30).                                   
016300*                                 LEVERANTÖRENS ARTIKELBENÄMNING          
016400     03 MOD-KVPROG-UT        PIC Z(6)9.                                   
016500*                                 ÅRSPROGNOS                              
016600     03 MOD-IDFKNGRP-ATTR    PIC X(2).                                    
016700*                                 MFS ATTRIBUTFÄLT                        
016800     03 MOD-IDFKNGRP-IN      PIC X(2).                                    
016900*                                 MFS BEHANDLING AV INPUTFÄLT             
017000     03 MOD-IDLEVNR-ATTR     PIC X(2).                                    
017100*                                 MFS ATTRIBUTFÄLT                        
017200     03 MOD-IDLEVNR-IN       PIC X(2).                                    
017300*                                 MFS BEHANDLING AV INPUTFÄLT             
017400     03 MOD-BELEV-ATTR       PIC X(2).                                    
017500*                                 MFS ATTRIBUTFÄLT                        
017600     03 MOD-BELEV-IN         PIC X(2).                                    
017700*                                 MFS BEHANDLING AV INPUTFÄLT             
017800     03 MOD-KVPROG-ATTR      PIC X(2).                                    
017900*                                 MFS ATTRIBUTFÄLT                        
018000     03 MOD-KVPROG-IN        PIC X(2).                                    
018100*                                 MFS BEHANDLING AV INPUTFÄLT             
018200     03 MOD-TEORSAK-1-ATTR   PIC X(2).                                    
018300*                                 MFS ATTRIBUTFÄLT                        
018400     03 MOD-TEORSAK-1        PIC X(50).                                   
018500*                                 INFO OM SLAG AV ÅTGÄRD                  
018600     03 MOD-IDRITN-UT        PIC X(10).                                   
018700*                                 RITNINGSNUMMER                          
018800     03 MOD-KVARTVAGN-UT     PIC Z(3).                                    
018900*                                 ANTAL ARTIKLAR PER VAGN                 
019000     03 MOD-TEARTNOT-2-ATTR  PIC X(2).                                    
019100*                                 MFS ATTRIBUTFÄLT                        
019200     03 MOD-TEARTNOT-2       PIC X(40).                                   
019300*                                 ARTIKEL NOTERING                        
019400     03 MOD-IDRITN-ATTR      PIC X(2).                                    
019500*                                 MFS ATTRIBUTFÄLT                        
019600     03 MOD-IDRITN-IN        PIC X(2).                                    
019700*                                 MFS BEHANDLING AV INPUTFÄLT             
019800     03 MOD-KVARTVAGN-ATTR   PIC X(2).                                    
019900*                                 MFS ATTRIBUTFÄLT                        
020000     03 MOD-KVARTVAGN-IN     PIC X(2).                                    
020100*                                 MFS BEHANDLING AV INPUTFÄLT             
020200     03 MOD-TEARTNOT-7-ATTR  PIC X(2).                                    
020300*                                 MFS ATTRIBUTFÄLT                        
020400     03 MOD-TEARTNOT-7       PIC X(40).                                   
020500*                                 ARTIKEL NOTERING                        
020600     03 MOD-IDARTNR-MOTSV-UT PIC Z(9).                                    
020700*                                 MOTSVARANDE ARTIKEL                     
020800     03 MOD-FLBYTES-UT       PIC X.                                       
020900*                                 BYTESARTIKEL                            
021000     03 MOD-TEARTNOT-4-ATTR  PIC X(2).                                    
021100*                                 MFS ATTRIBUTFÄLT                        
021200     03 MOD-TEARTNOT-4       PIC X(40).                                   
021300*                                 ARTIKEL NOTERING                        
021400     03 MOD-IDARTNR-MOTSV-ATTR                                            
021500                             PIC X(2).                                    
021600*                                 MFS ATTRIBUTFÄLT                        
021700     03 MOD-IDARTNR-MOTSV-IN PIC X(2).                                    
021800*                                 MFS BEHANDLING AV INPUTFÄLT             
021900     03 MOD-FLBYTES-ATTR     PIC X(2).                                    
022000*                                 MFS ATTRIBUTFÄLT                        
022100     03 MOD-FLBYTES-IN       PIC X(2).                                    
022200*                                 MFS BEHANDLING AV INPUTFÄLT             
022300     03 MOD-FLGAMART-ATTR    PIC X(2).                                    
022400*                                 MFS ATTRIBUTFÄLT                        
022500     03 MOD-FLGAMART-IN      PIC X(2).                                    
022600*                                 MFS BEHANDLING AV INPUTFÄLT             
022700     03 MOD-TEMFSINF         PIC X(55).                                   
022800*                                 INFORMATIONSMEDDELANDE                  
022900*** END OF VILMAII-COPY LENGTH= 644 BYTES                                 
