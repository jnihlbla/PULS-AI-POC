...
006000*                                 PART NET WEIGHT (KG) W/ PACKAGE         
...
015300     03 BETEXT               PIC X(125).                                  
015400     03 IDARTNR-CNTRL        PIC X(2).                                    
015500*                                 KONTROLLSIFFRA FÖR ARTIKELNUMME         
015600*                                 R                                       
015700*                                 CHECK FIGURE FOR PART NUMBER            
015800*                                                                         
015900     03 FLPCOO               PIC X.                                       
016000*                                 FLAGGA OM FÖRMÅNSAVTAL URS.LAND         
016100*                                 FLAG PREF.AGREM. COUNTRY ORIGIN         
016200     03 IDLEVNR-ART          PIC X(5).                                    
016300*                                 LEVERANTÖRNR PÅ ARTIKEL                 
016400*                                 PART SUPPLIER NUMBER                    
016500     03 IDTRACK              OCCURS 5 TIMES                               
016600                             PIC X(25).                                   
016700*                                 TRACKING ID FROM CUSTOMS                
016800*                                 CUSTOMS TRACKING ID                     
016900     03 KVTRACK-LEV          OCCURS 5 TIMES                               
017000                             PIC 9(7).                                    
017100*                                 ARTIKELNS LEV.ANTAL FÖR TRACKID         
017200*                                 DELIVERED QUANTITY FOR TRACK-ID         
017300     03 KDPRMOD              PIC X(2).                                    
017400*                                 VILKEN PRISMODELL SOM ANVÄNDS           
017500*                                 WHAT PRICE MODEL THAT IS USED           
017600*** END OF VILMAII-COPY LENGTH= 851 BYTES                                 
