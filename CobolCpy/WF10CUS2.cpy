...
008400*                                 UPDATING DATE     (YYYYMMDD)            
008500     03 DADELDAT             PIC 9(8).                                    
008600*                                 BORTTAGSDATUM      (ÅÅÅÅMMDD)           
008700*                                 DELETION DATE     (YYYYMMDD)            
008800     03 IDUSER               PIC X(8).                                    
008900*                                 ANVÄNDARENS SÄKERHETS ID                
009000*                                 USER SECURITY-IDENTITY                  
009100     03 BEBETVIL             PIC X(30).                                   
009200*                                 BETALNINGSVILLKORSTEXT                  
009300*                                 TERMS OF PAYMENT TEXT                   
009400     03 FLRATE               PIC X.                                       
009500*                                 A RATE BETWEEN TWO LOCAL CURREN         
009600*                                 CIES                                    
009700*                                 A RATE BETWEEN TWO LOCAL CURREN         
009800*                                 CIES                                    
009900     03 FLLOCCUR             PIC X.                                       
010000*                                 ANGER ATT FAKTURAN RÄKNAS               
010100*                                 OM TILL KUNDENS VALUTA (FRÅN RA         
010200*                                 D-VALUTA)                               
010300*                                 GET INVOICE IN LOCAL CURRENCY           
010400     03 KDVALTYP             PIC X.                                       
010500*                                 KURSENS PER A=ÅR/M=MÅNAD/D=DAG          
010600*                                 CURRENCY PER YEAR/MONTH/DAY             
010700*** END OF VILMAII-COPY LENGTH= 480 BYTES                                 
