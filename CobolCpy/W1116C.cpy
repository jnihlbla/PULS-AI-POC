...
005300*                                 SEMIKOLON                               
005400*                                 SEMICOLON                               
005500     03 TIERSDAT             PIC 9(5)                                     
005600                             VALUE ZEROS.                                 
005700*                                 ERSÄTTNINGSDATUM  (ÅÅVVD)               
005800*                                 DATE OF SUPERSESSION (YYWWD)            
005900     03 FILLER               PIC X                                        
006000                             VALUE ';'.                                   
006100*                                 SEMIKOLON                               
006200*                                 SEMICOLON                               
006300     03 KDERS                PIC 9(2)                                     
006400                             VALUE ZEROS.                                 
006500*                                 ERSÄTTNINGSKOD                          
006600*                                 SUPERSESSION CODE                       
006700*** END OF VILMAII-COPY LENGTH= 77 BYTES                                  
