...
005200     03 RIO-IDBIL.                                                        
005300*                                 CAR IDENTITY                            
005400        05 RIO-IDBILTYP      PIC X(3).                                    
005500*                                 CAR TYPE                                
005600        05 RIO-TIAAAA        PIC X(4).                                    
005700*                                 YEAR  (YYYY)                            
005800        05 RIO-IDCHASSI-PIE  PIC X(6).                                    
005900*                                 CHASSI NUMBER PIE                       
006000     03 RIO-PRARTNTO-LOC     PIC 9(7)V9(2).                               
006100*                                 NET PRICE EACH LOCAL CURRENCY           
006200     03 RIO-PRARTBTO-LOC     PIC 9(7)V9(2).                               
006300*                                 LOCAL GROSS SALES PRICE                 
006400     03 RIO-RERAB            PIC 9(2)V9(1).                               
006500     03 RIO-KDRAB            PIC X(5).                                    
006600     03 RIO-KDVAT            PIC X(2).                                    
006700*                                 VAT CODE                                
006800     03 RIO-PRARTSJK         PIC 9(7)V9(2).                               
006900*                                 COST OF SALES                           
007000     03 RIO-PRARTSTD         PIC 9(7)V9(2).                               
007100*                                 STANDARD PRICE                          
007200     03 RIO-BEVOLREF         PIC X(10).                                   
007300*                                 VOLVO REFERENCE                         
007400     03 RIO-IDVIN            PIC X(17).                                   
007500*                                 VEHICLE VIN ID                          
007600     03 RIO-IDTRACK          PIC X(15).                                   
007700*                                 CUSTOMS TRACKING ID                     
007800     03 RIO-DADATUM          PIC 9(8).                                    
007900*                                 REGISTRATION DATE (YYYYMMDD)            
008000*** END OF VILMAII-COPY LENGTH= 211 BYTES                                 
