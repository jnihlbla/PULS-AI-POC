      *** EDIT ALLOWED                                                          
            ...
            COMP-5 SYNC.                                                        
                       21 dgClass                       PIC X(3).               
                       21 dgDescription-length          PIC S9999               
            COMP-5 SYNC.                                                        
                       21 dgDescription                 PIC X(225).             
                       21 dgUNCode-length               PIC S9999               
            COMP-5 SYNC.                                                        
                       21 dgUNCode                      PIC X(10).              
                       21 language2-length              PIC S9999               
            COMP-5 SYNC.                                                        
                       21 language2                     PIC X(5).               
                       21 modeOfTransport-length        PIC S9999               
            COMP-5 SYNC.                                                        
                       21 modeOfTransport               PIC X(2).               
            ...
            COMP-5 SYNC.                                                        
                       21 email2                        PIC X(60).              
                     18 name2-length                  PIC S9999 COMP-5          
            SYNC.                                                               
                     18 name2                         PIC X(40).                
