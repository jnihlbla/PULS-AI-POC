...
002300*                                 KOLLINUMMER                             
002400     03 IDORDNR7             PIC 9(7).                                    
002500*                                 ORDERNUMMER                             
002600     03 KDANMORS             PIC X(2).                                    
002700*                                 ORSAK TILL LEVERANSANMÄRKNING           
002800     03 IDDC                 PIC X(2).                                    
...
004200     03 TILEVANM             PIC S9(7)           COMP-3.                  
004300*                                 DATUM LEVERANSANMÄRKNING                
004400     03 TEANMNOT-REG         OCCURS 3 TIMES                               
004500                             PIC X(70).                                   
004600*                                 FRI TEXT FRÅN REGISTRERINGEN            
004700*** END OF VILMAII-COPY LENGTH= 275 BYTES                                 
