...
001400     03 RESP-ADLAGOMR        PIC X(2).                                    
001500*                                 LAGEROMRÅDE                             
001600     03 RESP-ADGANG          PIC X(2).                                    
001700*                                 GÅNG                                    
001800     03 RESP-ADPLATS         PIC X(5).                                    
...
008000     03 RESP-KDARTHNT        PIC 9(6).                                    
008100*                                 HANTERINGSKOD                           
008200     03 RESP-KVRESS          PIC Z(6)9.                                   
008300*                                 RESERVERAT ANTAL ARTIKLAR               
008400     03 RESP-BELEV           PIC X(35).                                   
008500*                                 LEVERANTÖRSNAMN                         
008600     03 RESP-ADLEV-RAD1      PIC X(35).                                   
008700*                                 LEVERANTÖRENS GATUADRESS                
008800     03 RESP-ADLEV-ORT       PIC X(35).                                   
008900*                                 LEVERANTÖRSADRESS ORT                   
009000     03 RESP-ADLEVLND        PIC X(20).                                   
009100*                                 LEVERANTÖRSADRESS LAND                  
009200     03 RESP-BUFF-ADR        OCCURS 1 TO 200 TIMES                        
009300                             DEPENDING ON RESP-KVRADER-MAX1.              
009400        05 RESP-PLATSTYP     PIC X.                                       
009500        05 RESP-ADBUFFOMR    PIC X(2).                                    
009600*                                 BUFFERTOMRÅDE                           
009700        05 RESP-ADBUFFGANG   PIC X(2).                                    
009800*                                 BUFFERT GÅNG                            
009900        05 RESP-ADBUFFPL     PIC X(5).                                    
010000*                                 BUFFERPLATSNUMMER                       
010100        05 RESP-KVBUFF-F     PIC -(7)9.                                   
010200*                                 FÖRÄDLAT BUFFERSALDO                    
010300        05 RESP-KVBUFF-OF    PIC -(7)9.                                   
010400*                                 BUFFERSALDO OFÖRÄDLAT GODS              
010500        05 RESP-KVKOLLI-F    PIC Z(3)9.                                   
010600*                                 ANTAL FÖRÄDLADE KOLLI I BUFFER          
010700        05 RESP-KVKOLLI-OF   PIC Z(3)9.                                   
010800*                                 ANTAL OFÖRÄDLADE KOLLI I BUFFER         
010900*** END OF VILMAII-COPY LENGTH= 7265 BYTES                                
