000100 01  W510A12.                                                             
000200*                                 TYPE A12, DISCREPANCY STOCK ADJ         
000300*                                 USTMENT RECORD                          
000400*                                                                         
...
002900     03 DAJUSTDA             PIC 9(8).                                    
003000*                                 JUSTERINGSDATUM  (ÅÅÅÅMMDD)             
003100*                                 ADJUSTMENT DATE  (YYYYMMDD)             
...
004100     03 KVJUSTKV             PIC S9(7).                                   
004200*                                 JUSTERAD KVANTITET                      
004300*                                 ADJUSTED QUANTITY                       
004400     03 PRAVCOST             PIC 9(7)V9(2).                               
004500*                                 MEDELVÄRDESKOSTNAD I UTL.VALUTA         
004600*                                 AVERAGE COST FOREIGN CURRENCY           
004700     03 KDANMORS             PIC X(2).                                    
004800*                                 ORSAK TILL LEVERANSANMÄRKNING           
004900*                                 DISCREPANCY REPORT REASON CODE          
005000*** END OF VILMAII-COPY LENGTH= 67 BYTES                                  
