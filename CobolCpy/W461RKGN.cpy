...
002900*                                 LINE NO                                 
003000     03 RKG-IDDC             PIC X(2).                                    
003100*                                 WAREHOUSE IDENTIFIER                    
003200     03 RKG-PRAVCOST-CORE    PIC 9(7)V9(2).                               
003300*                                 AVERAGE COST FOREIGN CURRENCY           
003400     03 RKG-FILLERX1         PIC X.                                       
003500*** END OF VILMAII-COPY LENGTH= 80 BYTES                                  
