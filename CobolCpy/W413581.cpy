...
000700*                                                                         
000800        05 IDPTYP            PIC X(3).                                    
000900*                                 POSTTYP                                 
001000        05 IDDISTR           PIC S9(5)           COMP-3.                  
...
001900*                                 ORDERNUMMER                             
002000        05 KDRESTR           PIC S9(3)           COMP-3.                  
002100*                                 RESTRIKTIONSKOD                         
002200        05 IDARTNR           PIC S9(9)           COMP-3.                  
002300*                                 ARTIKELNUMMER                           
002400        05 IDKORTNR          PIC S9(3)           COMP-3.                  
002500*                                 KORTNUMMER                              
002600*                                 (RADLÖPNR FÖR ERSÄTTNINGSINFO)          
002700        05 IDLOPNRE          PIC S9(3)           COMP-3.                  
002800*                                 LÖPNUMMER ERSÄTTNING                    
002900        05 IDRONR            PIC S9(5)           COMP-3.                  
003000*                                 RESTORDERNUMMER                         
003100        05 IDDIVORD          PIC S9(3)           COMP-3.                  
003200*                                 DIVERSEORDERNUMMER                      
003300        05 KDORDKL           PIC S9              COMP-3.                  
003400*                                 ORDERKLASS                              
003500        05 KDFAKTYP          PIC X.                                       
003600*                                 FAKTURATYP                              
003700        05 IDPTYP-URS        PIC X(3).                                    
003800*                                 POSTTYP                                 
003900        05 KDKVBRYT          PIC S9              COMP-3.                  
004000*                                 KOD OM KVANTFÖRP SKALL BRYTAS           
004100        05 TIAAMMDD          PIC S9(7)           COMP-3.                  
004200*                                 ÅR - MÅNAD - DAG  (ÅÅMMDD)              
004300        05 TIKLOCK           PIC S9(9)           COMP-3.                  
...
005600*** END COPY W413581CC0  LENGTH=73                                        
