000100 01  RESP-WF0290O1.                                                       
000200*                                 RESPONS-COPYTEXT F÷R PGM WF0290         
...
004200*                                 INVOICE DLAG                            
004300     03 RESP-KVMANAD         PIC Z9.                                      
004400*                                 ANTAL M≈NADER                           
004500*                                                                         
004600     03 RESP-DAREGDAT        PIC Z(8).                                    
004700*                                 REGISTRERINGSDATUM (≈≈≈≈MMDD)           
004800*                                 REGISTRATION DATE (YYYYMMDD)            
004900     03 RESP-DAUPPDAT        PIC Z(8).                                    
005000*                                 UPPDATERINGSDATUM  (≈≈≈≈MMDD)           
005100*                                                                         
005200*                                 UPDATING DATE     (YYYYMMDD)            
005300*                                                                         
005400     03 RESP-IDUSER          PIC X(8).                                    
005500*                                 ANVƒNDARENS SƒKERHETS ID                
005600*                                 USER SECURITY-IDENTITY                  
005700*** END OF VILMAII-COPY LENGTH= 125 BYTES                                 
