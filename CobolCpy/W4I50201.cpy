000100 01  MID-W4I50201.                                                        
000200*                                 MID-COPYTEXT FÖR W40502                 
...
003100     03 MID-IDORDER-ENTER    PIC 9(7).                                    
003200*                                 VOLVO PARTS ORDERNUMMER                 
003300     03 MID-IDORDER-NEXT     PIC 9(7).                                    
...
003900     03 MID-IDPURAD-ENTER    PIC 9(5).                                    
004000*                                 RADNUMMER                               
004100     03 MID-IDPURAD-NEXT     PIC 9(5).                                    
004200*                                 RADNUMMER                               
004300     03 MID-IDPRODNR-ENTER   PIC 9(7).                                    
004400*                                 PRODUKTIONSNUMMER                       
004500     03 MID-IDPRODNR-NEXT    PIC 9(7).                                    
004600*                                 PRODUKTIONSNUMMER                       
004700     03 MID-IDDC-ENTER       PIC X(2).                                    
004800*                                 IDENTIFIERARE LAGER                     
004900     03 MID-IDDC-NEXT        PIC X(2).                                    
005000*                                 IDENTIFIERARE LAGER                     
005100     03 MID-ADLAGOMR-ENTER   PIC 9(3).                                    
005200*                                 LAGEROMRÅDE                             
005300     03 MID-ADLAGOMR-NEXT    PIC 9(3).                                    
005400*                                 LAGEROMRÅDE                             
005500     03 MID-ADGANG-ENTER     PIC 9(3).                                    
005600*                                 GÅNG                                    
005700     03 MID-ADGANG-NEXT      PIC 9(3).                                    
005800*                                 GÅNG                                    
005900     03 MID-ADPLATS-ENTER    PIC 9(5).                                    
006000*                                 LAGERPLATSNUMMER                        
006100     03 MID-ADPLATS-NEXT     PIC 9(5).                                    
006200*                                 LAGERPLATSNUMMER                        
006300     03 MID-IDLOPNR-ENTER    PIC 9(3).                                    
006400*                                 LÖPNUMMER                               
006500     03 MID-IDLOPNR-NEXT     PIC 9(3).                                    
006600*                                 LÖPNUMMER                               
006700     03 MID-IDPLKLST-ENTER   PIC 9(3).                                    
006800*                                 PLOCKLISTNUMMER                         
006900     03 MID-IDPLKLST-NEXT    PIC 9(3).                                    
007000*                                 PLOCKLISTNUMMER                         
007100     03 MID-IDKOLLI-ENTER    PIC 9(5).                                    
007200*                                 KOLLINUMMER                             
007300     03 MID-IDKOLLI-NEXT     PIC 9(5).                                    
007400*                                 KOLLINUMMER                             
