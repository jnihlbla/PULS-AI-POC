...
002100     03 MID-IDLOPNR-NEXT     PIC 9(3).                                    
002200*                                 LÖPNUMMER                               
002300     03 MID-IDSEKVNR-NEXT    PIC 9(3).                                    
002400*                                 GENERELLT SEKVENSNUMMER                 
002500     03 MID-IDDC-NEXT        PIC X(2).                                    
002600*                                 IDENTIFIERARE LAGER                     
002700     03 MID-KDORDBEK-NEXT    PIC 9(2).                                    
002800*                                 ORDERBEKRÄFTELSEKOD                     
002900     03 MID-KDTRTYP          PIC X.                                       
003000*                                 IMS TRANSAKTIONSTYP                     
