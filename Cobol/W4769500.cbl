001200 ID DIVISION.                                                             
001300 PROGRAM-ID.     W4769500.                                                
001400 AUTHOR.         STINA MOGREN.                                            
001500 DATE-WRITTEN.   03/02/07.                                                
001600 DATE-COMPILED.                                                           
001700                                                                          
001800                                                                          
001900*    FUNCTION:                                                            
002000*        IT READS W47694 FILE AND DELETES IDSHIPM. FILE W47694 IS         
002100*        CREATED BY W4769400 PROGRAM FOR WDE1 WITH DISTRICT               
002110*        AND IT'S 'DAYS' ARE EXCEEDED                                     
002200*                                                                         
002310*        THE PROGRAM UPDATES   WDE1                                       
002400*                                                                         
002500                                                                          
002600     SKIP3                                                                
...
003100 FILE-CONTROL.                                                            
003201     SKIP2                                                                
003202*          --- I/P FILE FOR WDE1 FOR DELETE                               
003210     SELECT W47694                     ASSIGN TO W47695D1.                
003400     EJECT                                                                
...
004100                                                                          
004200 77  IDPGM                       PIC X(8)    VALUE 'W4769500'.            
004300 01  CHKP-VAR.                                                            
...
005701                                                                          
005702 77  W47694-EOF-SW               PIC X       VALUE 'N'.                   
005710     88  END-OF-W47694                       VALUE 'Y'.                   
006000     EJECT                                                                
...
010200                                                                          
010301 01  FILLER                  PIC X(16) VALUE 'DLI-IO-WDE101'.             
010302 01  DLI-IO-WDE101.                                                       
010310*    03  -COPY WDE101                                                     
010400                                                                          
010800     EJECT                                                                
...
011201                                                                          
011202*01  -COPY W0008   -PRE WDE1-                                             
011210     05  FILLER                  PIC X.                                   
011500     EJECT                                                                
011600                                                                          
011601 PROCEDURE DIVISION  USING MSG-PCB WDE1-PCB.                              
011602 MAIN SECTION.                                                            
011610     ENTRY 'DLITCBL' USING MSG-PCB WDE1-PCB.                              
011700                                                                          
011900     SKIP2                                                                
012000     PERFORM A-INIT                                                       
012110     PERFORM S01-READ-W47694                                              
012200     PERFORM UNTIL END-OF-W47694                                          
...
012600       PERFORM IMS-GHU-WDE101                                             
012700       IF SEGMENT-FOUND                                                   
012800         ADD 1               TO CHKP-ANT                                  
012900         PERFORM IMS-DLET-WDE101                                          
013000       END-IF                                                             
013100                                                                          
013210       PERFORM S01-READ-W47694                                            
013300     END-PERFORM                                                          
013400                                                                          
013500                                                                          
...
016900     .                                                                    
017001     EJECT                                                                
017002 S01-READ-W47694  SECTION.                                                
017003     SKIP2                                                                
017004     READ W47694 INTO IN1-AREA                                            
017005     AT END                                                               
017006        MOVE HIGH-VALUE TO IN1-AREA                                       
017007        SET END-OF-W47694 TO TRUE                                         
017008                                                                          
017009     NOT AT END                                                           
017010        MOVE 'W47694'   TO POSTSUM-FDNAMN                                 
017011        MOVE 'W47695D1' TO POSTSUM-DDNAMN2                                
...
018700                                                                          
018801     EJECT                                                                
018802 IMS-GHU-WDE101 SECTION.                                                  
018803                                                                          
018804     STRING 'WDE101  (IDSHIPM  =' W-IDSHIPM-X ')'                         
018805          DELIMITED BY SIZE INTO SSA1                                     
018806     MOVE '  GE' TO GOOD-STATUSCODES                                      
018807     CALL CBLTDLI USING GHU WDE1-PCB DLI-IO-WDE101 SSA1                   
018808     MOVE WDE1-STATUS-CODE TO STATUS-WS                                   
018809     PERFORM IMS-STATUSCHECK                                              
018810     .                                                                    
018811     SKIP3                                                                
018812 IMS-DLET-WDE101 SECTION.                                                 
018813                                                                          
018814     MOVE '  ' TO GOOD-STATUSCODES                                        
018815     CALL CBLTDLI USING DLET WDE1-PCB DLI-IO-WDE101                       
018816     MOVE WDE1-STATUS-CODE TO STATUS-WS                                   
