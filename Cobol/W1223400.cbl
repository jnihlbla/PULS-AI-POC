...
002100*        ARTIKLAR SOM RENSAS WDK6 TAS BORT OCH ARTIKLAR                   
002200*        SOM SKALAS TAS BORT FRÅN WDL8 OM 11-SEGMENT SAKNAS.              
002210*        FIL W12203 MED ARTIKLAR SOM REDAN ÄR SKALADE LÄSES.              
002220*        ARTIKEL TAS BORT EFTER KONTROLL ATT 11-SEGMENT SAKNAS            
002300*                                                                         
002410*        PROGRAMMET UPPDATERAR WDL8.                                      
002500*                                                                         
003000                                                                          
003100     SKIP3                                                                
...
003710     SELECT W12207                     ASSIGN TO W12234D1.                
003900     EJECT                                                                
003910     SKIP2                                                                
003920*          --- REDAN SKALADE ARTIKLAR WDK6                                
003930     SELECT W12203                     ASSIGN TO W12234D2.                
...
004450*01  -COPY W12203      -L.                                                
004460     EJECT                                                                
004500 WORKING-STORAGE SECTION.                                                 
004600     SKIP2                                                                
004601                                                                          
004610*    -- CHECKED BY WY2000                                                 
004700 77  IDPGM                       PIC X(8)    VALUE 'W1223400'.            
004800 01  CHKP-VAR.                                                            
...
005400 03  CHKP-MAX                    PIC S9(3)   VALUE +400.                  
005500 77  JA                          PIC X       VALUE 'J'.                   
005600 77  NEJ                         PIC X       VALUE 'N'.                   
005600 77  W-DLET-WDL801               PIC 9(7)    VALUE ZERO.                  
005700     SKIP2                                                                
005800 01  FELTEXT.                                                             
...
006500                                                                          
006600 77  W12203-EOF-SW               PIC X       VALUE 'N'.                   
006700     88  END-OF-W12203                       VALUE 'J'.                   
006800                                                                          
...
008200     EJECT                                                                
008210*01  AREA -COPY W12203     -PRE IN03-                                     
008220     EJECT                                                                
008230 01  FILLER                      PIC X(16)   VALUE 'IMS-WS'.              
008240     SKIP3                                                                
...
010610 01  FILLER         PIC X(16) VALUE 'DLI-IO-WDL801'.                      
010620 01  DLI-IO-WDL801.                                                       
010630*    03  -COPY WDL801.                                                    
010640     EJECT                                                                
010650 01  FILLER         PIC X(16) VALUE 'DLI-IO-WDL811'.                      
010660 01  DLI-IO-WDL811.                                                       
010670*    03  -COPY WDL811.                                                    
010680     EJECT                                                                
012200 LINKAGE SECTION.                                                         
012400*01  -COPY W0009  -PRE MSG-                                               
012501                                                                          
012502*01  -COPY W0008  -PRE WDL8-                                              
012510     05  FILLER                  PIC X.                                   
012800     EJECT                                                                
012901 PROCEDURE DIVISION  USING MSG-PCB WDL8-PCB.                              
012902 MAIN SECTION.                                                            
012910     ENTRY 'DLITCBL' USING MSG-PCB WDL8-PCB.                              
013000                                                                          
...
013900         PERFORM IMS-GET-WDL801                                           
014000         IF SEGMENT-FINNS                                                 
014002            IF IN-UTFIL-TYP =  'B'                                        
014004               PERFORM IMS-GET-WDL801                                     
014005               PERFORM IMS-DLET-WDL8                                      
                     ADD 1 TO W-DLET-WDL801                                     
014006               ADD +1 TO CHKP-ANT                                         
014007            ELSE                                                          
014008               IF IN-UTFIL-TYP =  'S'                                     
014010                  PERFORM IMS-GET-WDL811                                  
014020                  IF SEGMENT-SAKNAS                                       
014030                     PERFORM IMS-GET-WDL801                               
014100                     PERFORM IMS-DLET-WDL8                                
                           ADD 1 TO W-DLET-WDL801                               
...
014600     END-PERFORM                                                          
014610                                                                          
014700     PERFORM S02-LAES-W12203                                              
014710     PERFORM UNTIL END-OF-W12203                                          
014711        MOVE IN03-IDARTNR TO W-IDARTNR                                    
014712        PERFORM IMS-GET-WDL801                                            
014713        IF SEGMENT-FINNS                                                  
014714           PERFORM IMS-GET-WDL811                                         
014715           IF SEGMENT-SAKNAS                                              
014717              PERFORM IMS-GET-WDL801                                      
014718              PERFORM IMS-DLET-WDL8                                       
                    ADD 1 TO W-DLET-WDL801                                      
014719              ADD +1 TO CHKP-ANT                                          
014722           END-IF                                                         
014723        END-IF                                                            
014730        IF CHKP-ANT > CHKP-MAX                                            
014740          PERFORM X-TAG-CHECKPOINT                                        
014750        END-IF                                                            
014760        PERFORM S02-LAES-W12203                                           
014770     END-PERFORM                                                          
014800                                                                          
...
017801                                                                          
           DISPLAY 'ANTAL BORTTAGNA WDL801: ' W-DLET-WDL801                     
017810     CLOSE W12207                                                         
017820           W12203                                                         
...
018311        MOVE 'W12234D1'   TO POSTSUM-DDNAMN2                              
018312        MOVE IN-UTFIL-TYP TO POSTSUM-TRANSTYP                             
018313        CALL POSTSUM USING POSTSUM-PARM                                   
018316     END-READ                                                             
018320     .                                                                    
018600     EJECT                                                                
018610 S02-LAES-W12203 SECTION.                                                 
018620                                                                          
018630     READ W12203 INTO IN03-AREA                                           
018640     AT END                                                               
018650        SET END-OF-W12203 TO TRUE                                         
018660     NOT AT END                                                           
018670        MOVE 'W12203'   TO POSTSUM-FDNAMN                                 
018680        MOVE 'W12234D2' TO POSTSUM-DDNAMN2                                
018690        MOVE SPACE      TO POSTSUM-TRANSTYP                               
018691        CALL POSTSUM USING POSTSUM-PARM                                   
018692     END-READ                                                             
018693     .                                                                    
...
020000     SKIP3                                                                
020102 IMS-GET-WDL801 SECTION.                                                  
020104     STRING 'WDL801  (IDARTNR  =' W-IDARTNR-X ')'                         
020105          DELIMITED BY SIZE INTO SSA1                                     
020106     MOVE '  GE' TO GODK-STATUSKODER                                      
020107     CALL CBLTDLI USING GHU WDL8-PCB DLI-IO-WDL801 SSA1                   
020108     MOVE WDL8-STATUS-CODE TO STATUS-WS                                   
020109     PERFORM IMS-STATUSKONTROLL                                           
020110     .                                                                    
020120     SKIP3                                                                
020121 IMS-GET-WDL811 SECTION.                                                  
020122     MOVE 'WDL811  ' TO SSA1                                              
020123     MOVE '  GE' TO GODK-STATUSKODER                                      
020124     CALL CBLTDLI USING GNP WDL8-PCB DLI-IO-WDL811 SSA1                   
020125     MOVE WDL8-STATUS-CODE TO STATUS-WS                                   
020126     PERFORM IMS-STATUSKONTROLL                                           
020127     .                                                                    
020128     SKIP3                                                                
020129 IMS-DLET-WDL8 SECTION.                                                   
020130     MOVE '  ' TO GODK-STATUSKODER                                        
020131     CALL CBLTDLI USING DLET WDL8-PCB DLI-IO-WDL801                       
020132     MOVE WDL8-STATUS-CODE TO STATUS-WS                                   
020133     PERFORM IMS-STATUSKONTROLL                                           
020140     .                                                                    
020200     EJECT                                                                
