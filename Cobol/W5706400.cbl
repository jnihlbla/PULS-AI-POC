...
000700                                                                          
000800*    FUNKTION:                                                            
000900*        PROGRAMMET LÄSER IN UPPDATERINGS-POSTER FRÅN FIL W5706F          
...
001900 FILE-CONTROL.                                                            
002000     SKIP2                                                                
002100*          --- INFIL FRÅN PGM W5706300                                    
002200     SELECT W5706F                     ASSIGN TO W57064D1.                
002300     SKIP2                                                                
002310*          --- INFIL FRÅN PGM W5706300                                    
002320     SELECT W5706B                     ASSIGN TO W57064D2.                
002330     SKIP2                                                                
002400*          --- UTFIL FRÅN PGM W5706400                                    
002500     SELECT W5706M                     ASSIGN TO W57064D3.                
002630     SKIP2                                                                
...
003900 01  W5706M-001              PIC X(999).                                  
004050     SKIP3                                                                
004100 WORKING-STORAGE SECTION.                                                 
004200                                                                          
004300 77  IDPGM                       PIC X(8)    VALUE 'W5706400'.            
004400 01  CHKP-VAR.                                                            
...
005210 77  WS-PREV-KDTRADP             PIC X(4)    VALUE SPACES.                
005300     SKIP2                                                                
005400 01  FELTEXT.                                                             
005500     03  FILLER                  PIC X(8)    VALUE 'FELTEXT'.             
005600     03  FELTEXT-STR             PIC X(72)   VALUE SPACE.                 
005700                                                                          
005800 77  W5706F-EOF-SW               PIC X       VALUE 'N'.                   
005900     88  END-OF-W5706F                       VALUE 'J'.                   
006000                                                                          
006001 77  W5706B-EOF-SW               PIC X       VALUE 'N'.                   
006002     88  END-OF-W5706B                       VALUE 'J'.                   
006003                                                                          
006100     EJECT                                                                
006110 01  W001-DAP.                                                            
006120     03  FILLER                  PIC X(165)  VALUE SPACE.                 
006130     EJECT                                                                
...
029900                                                                          
030000     PERFORM S01-LAES-W5706F                                              
030100     PERFORM UNTIL END-OF-W5706F                                          
...
030900       PERFORM S01-LAES-W5706F                                            
031000     END-PERFORM                                                          
031100                                                                          
031110     PERFORM S01-LAES-W5706B                                              
031120     PERFORM UNTIL END-OF-W5706B                                          
...
031191       PERFORM S01-LAES-W5706B                                            
031192     END-PERFORM                                                          
031193                                                                          
...
032100                                                                          
032200     OPEN INPUT  W5706F                                                   
032201     OPEN INPUT  W5706B                                                   
032210     OPEN OUTPUT W5706M                                                   
032300                                                                          
...
033500     EJECT                                                                
033501                                                                          
033512 C-CREATE-MAIL SECTION.                                                   
033513                                                                          
033514     IF IN1-EKH-KDTRADP NOT = WS-PREV-KDTRADP                             
033515       MOVE IN1-EKH-KDTRADP           TO WS-PREV-KDTRADP                  
033516       PERFORM S10-WRITE-DAP                                              
033517       WRITE W5706M-001             FROM HEAD-LINE                        
033518     END-IF                                                               
033519                                                                          
033526     MOVE IN1-FIL-IDPGM               TO UT1-MAIL-IDPGM                   
...
033663     WRITE W5706M-001 FROM ROW-LINE                                       
033668     .                                                                    
033669     EJECT                                                                
033670                                                                          
033789 Z-FINIT SECTION.                                                         
033790                                                                          
033800     CLOSE W5706F                                                         
033801     CLOSE W5706B                                                         
033810     CLOSE W5706M                                                         
...
034200     .                                                                    
034300     EJECT                                                                
034400 S01-LAES-W5706F  SECTION.                                                
034500     SKIP2                                                                
034600     READ W5706F INTO IN1-AREA                                            
034700     AT END                                                               
034800        SET END-OF-W5706F TO TRUE                                         
034900     NOT AT END                                                           
035000        MOVE 'W5706F'   TO POSTSUM-FDNAMN                                 
035100        MOVE 'W57064D1' TO POSTSUM-DDNAMN2                                
035200        MOVE 'UPPD'     TO POSTSUM-TRANSTYP                               
035300        CALL POSTSUM USING POSTSUM-PARM                                   
035400     END-READ                                                             
035500     .                                                                    
035600     EJECT                                                                
035610 S01-LAES-W5706B  SECTION.                                                
035620     SKIP2                                                                
035630     READ W5706B INTO IN2-AREA                                            
035640     AT END                                                               
035650        SET END-OF-W5706B TO TRUE                                         
035660     NOT AT END                                                           
035670        MOVE 'W5706B'   TO POSTSUM-FDNAMN                                 
035680        MOVE 'W57064D2' TO POSTSUM-DDNAMN2                                
...
041400     END-SEARCH                                                           
041500     .                                                                    
041600 S10-WRITE-DAP SECTION.                                                   
041700                                                                          
041800     MOVE ' ¤DAPW57065-001' TO W001-DAP                                   
041900     WRITE W5706M-001 FROM W001-DAP                                       
042000                                                                          
042100     MOVE SPACES            TO W001-DAP                                   
042200                                                                          
042300     STRING ' ¤DAP' WS-PREV-KDTRADP                                       
042400            DELIMITED BY SIZE INTO W001-DAP                               
042500     WRITE W5706M-001 FROM W001-DAP                                       
042600     MOVE SPACES            TO W001-DAP                                   
042700     .                                                                    
042800     EJECT                                                                
