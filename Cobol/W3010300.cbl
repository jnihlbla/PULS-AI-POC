...
001100*        PROGRAMMET LÄSER      WLBENA (WDD3)                              
001200*                                                                         
001300*    INDATA.                                                              
001400*        TRANSAKTION: W3T103                                              
001500*        MID:         W3I10301                                            
001600*                                                                         
001700*    UTDATA.                                                              
001800*        MOD:         W3O10301                                            
...
002600                                                                          
002700 77  IDPGM                   PIC X(08)   VALUE 'W3010300'.                
...
015600                                                                          
015700     EJECT                                                                
015800 01  FILLER                  PIC X(16)   VALUE 'DLI-IO-BENA11'.           
015900                                                                          
016000 01  DLI-IO-BENA11.                                                       
016100*  03  -COPY WDD311  -PRE BENA11-                                         
016200                                                                          
016300     EJECT                                                                
...
017600                                                                          
017700     EJECT                                                                
017800 PROCEDURE DIVISION  USING MSG-PCB USEA-PCB ARTF-PCB BENA-PCB.            
017900 MAIN SECTION.                                                            
018000     ENTRY 'DLITCBL' USING MSG-PCB USEA-PCB ARTF-PCB BENA-PCB.            
018100                                                                          
...
019700       END-IF                                                             
019800       COMPUTE MSG-KVLL = LENGTH OF MOD-W3O10301 + 4                      
...
020900       MOVE MSG-INDATA-MINUS-2-TRANSKODER TO MID-W3I10301                 
021000       MOVE MSG-IDTRANS-2                 TO MFS-IDTRANS                  
021100       MOVE MSG-KDMFSFOR-2                TO MFS-KDMFSFOR                 
021200     ELSE                                                                 
021300       MOVE MSG-INDATA-MINUS-1-TRANSKOD   TO MID-W3I10301                 
...
022300     MOVE 'W3O103N1'      TO MFS-IDMOD                                    
022400     MOVE '3103'          TO MOD-IDTRANS                                  
...
024600     MOVE '3103'            TO MSGI-IDTRANS                               
024700                                                                          
024800     IF EGEN-MID                                                          
...
025800                                                                          
025900     MOVE MFS-RENSA-FAELT TO MOD-IDARTNR-IN                               
026000     IF MSGI-IDARTNR NOT NUMERIC                                          
026100       MOVE NEJ TO NYCKLAR-SW                                             
026200     END-IF                                                               
026300                                                                          
026400     MOVE MFS-RENSA-FAELT TO MOD-IDLANDX2-IN                              
026500     IF EGEN-MID                                                          
...
027500     END-IF                                                               
027600                                                                          
027700     IF EGEN-MID OR NYCKLAR-OK                                            
027800       MOVE MSGI-IDARTNR   TO MOD-IDARTNR-UT                              
027900       INSPECT MOD-IDARTNR-UT REPLACING LEADING ZERO BY SPACE             
028000       MOVE WS-IDLANDX2  TO MOD-IDLANDX2-UT                               
028100     ELSE                                                                 
028200       MOVE MFS-RENSA-FAELT TO MOD-IDARTNR-UT                             
028300                               MOD-IDLANDX2-UT                            
028400     END-IF                                                               
028500                                                                          
...
036800       IF ARTF-ART-KDAIKTYP = LOW-VALUE                                   
036900         MOVE ARTF-ART-IDKUNDNR TO MOD-TIUPPDAT                           
037000       ELSE                                                               
037100         MOVE MFS-ROER-EJ-FAELT TO MOD-TIUPPDAT                           
037200       END-IF                                                             
...
041000     END-IF                                                               
041100     MOVE W-IDLANDX2 TO MOD-IDLANDX2-UT                                   
041200     MOVE '002'     TO MSGI-KDCALL                                        
041300     MOVE '3103'    TO SPAR-IDTRANS                                       
041400     MOVE SPAR-AREA TO MSGI-SPAR-AREA                                     
041500     CALL W005INIT USING MSGI-WMSGINIT USEA-PCB                           
041600                                                                          
041700     PERFORM IMS-GET-WDD311-BSEQ                                          
041800     IF SEGMENT-FINNS                                                     
041900       MOVE BENA11-TEXT-BEART TO MOD-BEART                                
042000     ELSE                                                                 
042100       MOVE SPACE             TO MOD-BEART                                
042200     END-IF                                                               
042300     .                                                                    
042400     EJECT                                                                
042500                                                                          
...
050500                                                                          
050600     EJECT                                                                
050700 IMS-GET-WDD311-BSEQ SECTION.                                             
050800                                                                          
050900     STRING 'WLBENA01(WDD3BSEQ =' W-IDARTNR-X ')'                         
051000          DELIMITED BY SIZE INTO SSA1                                     
051100     STRING 'WLBENA11(IDSKYLT  =' W-IDSKYLT-X ')'                         
051200          DELIMITED BY SIZE INTO SSA2                                     
051300     MOVE '  GE' TO GODK-STATUSKODER                                      
051400     CALL CBLTDLI USING GU BENA-PCB DLI-IO-BENA11 SSA1 SSA2               
051500     MOVE BENA-STATUS-CODE TO STATUS-WS                                   
