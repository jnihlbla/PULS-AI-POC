001000 ID DIVISION.                                                             
001100 PROGRAM-ID.     W4283200.                                                
001200 AUTHOR.         SUSANNE OLSSON.                                          
001300 DATE-WRITTEN.   01/03/19.                                                
001400 DATE-COMPILED.                                                           
001500                                                                          
001600*    FUNKTION:                                                            
001700*        PROGRAMMET SKAPAR TVÅ FILER.                                     
001900*        1 UPPFÖLJNINGSFIL TILL LISTA SOM SKRIVS UT PÅ CDC.               
...
003300 FILE-CONTROL.                                                            
003404     SKIP2                                                                
003405*          --- UPPFÖLJNINGSFIL R32'OR NA-RETURER KOD 54/94                
003410     SELECT W42832                     ASSIGN TO W42832D1.                
003420     SKIP2                                                                
003430*          --- RENSNINGSFIL                                               
003440     SELECT W42833                     ASSIGN TO W42832D2.                
003600     EJECT                                                                
...
004011                                                                          
004020*01  POST -COPY W407R32A -PRE  UT1-  -L.                                  
004030     SKIP3                                                                
004040 FD  W42833                                                               
004050     RECORDING       F                                                    
...
004400 77  IDPGM                       PIC X(8)    VALUE 'W4283200'.            
...
007411     SKIP2                                                                
007412                                                                          
007420*01  AREA -COPY W407R32A     -PRE UT1-                                    
007430     EJECT                                                                
...
007490*    05   -COPY W407R32A   -PRE UT2- -RED UT2-FIL-WDR601-DATA             
007500     EJECT                                                                
...
010020*      05   -COPY W407R32A   -RED FIL-WDR601-DATA                         
010300     EJECT                                                                
...
012940*---SKRIVER SEDAN POSTER PÅ W42832 OCH W42833                             
012950*                                                                         
012960     MOVE DLI-IO-WDR6     TO UT2-AREA                                     
012970     MOVE UT2-FIL-WDR601-DATA TO UT1-AREA                                 
012980                                                                          
012990     PERFORM S11-SKRIV-W42832                                             
012991     PERFORM S12-SKRIV-W42833                                             
012992     .                                                                    
012993     EJECT                                                                
...
013300     .                                                                    
013501     EJECT                                                                
013502 S11-SKRIV-W42832 SECTION.                                                
013503                                                                          
013504     WRITE UT1-POST FROM UT1-AREA                                         
013505                                                                          
013506     MOVE 'UT1-'     TO POSTSUM-TRANSTYP                                  
013507     MOVE 'W42832'   TO POSTSUM-FDNAMN                                    
013508     MOVE 'W42832D1' TO POSTSUM-DDNAMN2                                   
013509     CALL POSTSUM USING POSTSUM-PARM                                      
013510     .                                                                    
013511     EJECT                                                                
013512 S12-SKRIV-W42833 SECTION.                                                
013513                                                                          
013514     WRITE UT2-POST FROM UT2-AREA                                         
013515                                                                          
013517     MOVE 'UT2-'     TO POSTSUM-TRANSTYP                                  
013518     MOVE 'W42833'   TO POSTSUM-FDNAMN                                    
013519     MOVE 'W42832D2' TO POSTSUM-DDNAMN2                                   
