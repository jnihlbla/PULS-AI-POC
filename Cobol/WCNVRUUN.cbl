...
000800*                                                                         
000900*    FUNCTION:                                                            
001000         CONVERSION FROM CYRILLIC EBCDIC CODEPAGE                         
001100         (CP1025/CS1150) TO UNICODE.                                      
...
002000 77  IDPGM                       PIC X(8)    VALUE 'WCNVRUUN'.            
...
012900                                                                          
013000*      -- CONVERT FROM CYRILLIC EBCDIC CODE (CP1025)                      
013100       MOVE TECONV-FROM (IXF:1)     TO WBYTE                              
013200       ADD  WNUM  1             GIVING IX0                                
013300       MOVE CP1025-TO-UCS-X (IX0)    TO TEMP-2BYTE-X                      
