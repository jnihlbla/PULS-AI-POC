000200 ID DIVISION.                                                             
000300 PROGRAM-ID.     W2521600.                                                
000400 AUTHOR.         STENING INGER.                                           
000500 DATE-WRITTEN.   20/04/22.                                                
000600 DATE-COMPILED.                                                           
000700                                                                          
000800*                                                                         
000900*    FUNCTION:                                                            
001000*        PS&L NEW PARTS INFORMATION - DISTRIBUTION PRINT                  
001100*                                                                         
001200*                                                                         
001300*    ABENDCODES:                                                          
001400*        U0016 -  . . . .                                                 
...
002300 FILE-CONTROL.                                                            
002401     SKIP2                                                                
002403     SELECT W2521601                   ASSIGN TO W25216D1.                
002410     SELECT W2521602                   ASSIGN TO W25216D2.                
002600     EJECT                                                                
...
003300                                                                          
003400 77  IDPGM                       PIC X(8)    VALUE 'W2521600'.            
...
003837                                                                          
003838 77  W2521601-EOF-SW             PIC X       VALUE 'N'.                   
003840     88  END-OF-W2521601                     VALUE 'J'.                   
003900     EJECT                                                                
...
006212     03 FILLER             PIC X(01) VALUE ';'.                           
006213     03 IDPROJUP-H         PIC X(09) VALUE 'SUB PROJ.'.                   
006214     03 FILLER             PIC X(01) VALUE ';'.                           
006216     03 IDARTNR-H          PIC X(08) VALUE 'PART NO.'.                    
006217     03 FILLER             PIC X(01) VALUE ';'.                           
006219     03 BEART-ENG-H        PIC X(06) VALUE 'DESCR.'.                      
006220     03 FILLER             PIC X(01) VALUE ';'.                           
006222     03 TISOP-AAVV-H       PIC X(09) VALUE 'PUBL.WEEK'.                   
006223     03 FILLER             PIC X(01) VALUE ';'.                           
006225     03 TISOP-AAMMDD-H     PIC X(09) VALUE 'PUBL.DATE'.                   
006226     03 FILLER             PIC X(01) VALUE ';'.                           
006228     03 KDPRODSL-H         PIC X(10) VALUE 'PROD GROUP'.                  
006229     03 FILLER             PIC X(01) VALUE ';'.                           
006231     03 IDFKNGRP-H         PIC X(11) VALUE 'FUNCT.GROUP'.                 
006232     03 FILLER             PIC X(01) VALUE ';'.                           
006234     03 KDUART-H           PIC X(11) VALUE 'EXCEPT PART'.                 
006235     03 FILLER             PIC X(01) VALUE ';'.                           
006237     03 KDFARLIG-H         PIC X(10) VALUE 'DANG.GOODS'.                  
006238     03 FILLER             PIC X(01) VALUE ';'.                           
006240     03 FLPISK-H           PIC X(04) VALUE 'PISK'.                        
006241     03 FILLER             PIC X(01) VALUE ';'.                           
006242     03 IDAO-H             PIC X(06) VALUE 'DCN NO'.                      
006243     03 FILLER             PIC X(01) VALUE ';'.                           
006244     03 IDUPPDKU-H         PIC X(05) VALUE 'KU NO'.                       
006245     03 FILLER             PIC X(01) VALUE ';'.                           
006246     03 IDUPPDSU-H         PIC X(06) VALUE 'SU NO.'.                      
006247     03 FILLER             PIC X(01) VALUE ';'.                           
006248     03 BEUPPDSU-H         PIC X(08) VALUE 'SU TITLE'.                    
006249     03 FILLER             PIC X(01) VALUE ';'.                           
006250     03 KDERS-H            PIC X(07) VALUE 'SS CODE'.                     
006251     03 FILLER             PIC X(01) VALUE ';'.                           
006252     03 IDARTNR-TILLK-H    PIC X(11) VALUE 'SS PART NO.'.                 
006253     03 FILLER             PIC X(01) VALUE ';'.                           
006254     03 SS-AVAIL-STOCK-DC11-H PIC X(22)                                   
006255                           VALUE 'SS AVAIL.IN STOCK DC11'.                
006256     03 FILLER             PIC X(01) VALUE ';'.                           
006257     03 SS-AVAIL-STOCK-DC41-H PIC X(22)                                   
006258                           VALUE 'SS AVAIL.IN STOCK DC41'.                
006259     03 FILLER             PIC X(01) VALUE ';'.                           
006260     03 SS-AVAIL-STOCK-DC71-H PIC X(22)                                   
006261                           VALUE 'SS AVAIL.IN STOCK DC71'.                
006262     03 FILLER             PIC X(01) VALUE ';'.                           
006263     03 SS-AVAIL-STOCK-DC72-H PIC X(22)                                   
006264                           VALUE 'SS AVAIL.IN STOCK DC72'.                
006265     03 FILLER             PIC X(01) VALUE ';'.                           
006266     03 TIREGDAT-H         PIC X(09) VALUE 'REG. DATE'.                   
006267     03 FILLER             PIC X(01) VALUE ';'.                           
006268     03 IDNAMN-FORP-H      PIC X(09) VALUE 'PACK.ENG.'.                   
006269     03 FILLER             PIC X(01) VALUE ';'.                           
006270     03 KDEMBKOD-2-H       PIC X(09) VALUE 'EMB-KOD-2'.                   
006271     03 FILLER             PIC X(01) VALUE ';'.                           
006272     03 PACK-AVAIL-DC11-H  PIC X(26)                                      
006273                           VALUE 'PACK. AVAIL. IN STOCK DC11'.            
006274     03 FILLER             PIC X(01) VALUE ';'.                           
006275     03 PACK-AVAIL-DC41-H  PIC X(26)                                      
006276                           VALUE 'PACK. AVAIL. IN STOCK DC41'.            
006277     03 FILLER             PIC X(01) VALUE ';'.                           
006278     03 PACK-AVAIL-DC71-H  PIC X(26)                                      
006279                           VALUE 'PACK. AVAIL. IN STOCK DC71'.            
006280     03 FILLER             PIC X(01) VALUE ';'.                           
006281     03 PACK-AVAIL-DC72-H  PIC X(26)                                      
006282                           VALUE 'PACK. AVAIL. IN STOCK DC72'.            
006283     03 FILLER             PIC X(01) VALUE ';'.                           
006284     03 TIUPPDAT-EMB-H     PIC X(16) VALUE 'PKG. INSTR. DATE'.            
006285     03 FILLER             PIC X(01) VALUE ';'.                           
006286     03 IDNAMN-IDANSK-H    PIC X(19) VALUE 'DC11 PURCH. PLANNER'.         
006287     03 FILLER             PIC X(01) VALUE ';'.                           
006288     03 TIMOTSI-CDC-H      PIC X(19) VALUE 'DC11 REC. AT PURCH.'.         
006289     03 FILLER             PIC X(01) VALUE ';'.                           
006290     03 IDNAMN-IDANSK-DC41-H PIC X(19)                                    
006291                           VALUE 'DC41 PURCH. PLANNER'.                   
006292     03 FILLER             PIC X(01) VALUE ';'.                           
006293     03 TIMOTSI-DC41-H     PIC X(20) VALUE 'DC41 REC. AT PURCH.'.         
006294     03 FILLER             PIC X(01) VALUE ';'.                           
006295     03 IDNAMN-IDANSK-DC71-H PIC X(19)                                    
006296                           VALUE 'DC71 PURCH. PLANNER'.                   
006297     03 FILLER             PIC X(01) VALUE ';'.                           
006298     03 TIMOTSI-DC71-H     PIC X(19) VALUE 'DC71 REC. AT PURCH.'.         
006299     03 FILLER             PIC X(01) VALUE ';'.                           
006300     03 IDNAMN-IDANSK-DC72-H PIC X(19)                                    
006301                           VALUE 'DC72 PURCH. PLANNER'.                   
006302     03 FILLER             PIC X(01) VALUE ';'.                           
006303     03 TIMOTSI-DC72-H     PIC X(19) VALUE 'DC72 REC. AT PURCH.'.         
006304     03 FILLER             PIC X(01) VALUE ';'.                           
006305     03 IDNAMN-IDINK-H     PIC X(14) VALUE 'DC11 PURCHASER'.              
006306     03 FILLER             PIC X(01) VALUE ';'.                           
006307     03 KDAVT-H            PIC X(14) VALUE 'DC11 AGREEMENT'.              
006308     03 FILLER             PIC X(01) VALUE ';'.                           
006309     03 IDLEVNR-H          PIC X(13) VALUE 'DC11 SUPPLIER'.               
006310     03 FILLER             PIC X(01) VALUE ';'.                           
006311     03 KDFPKPRI-H         PIC X(18) VALUE 'DC11 PACKING INCL.'.          
006312     03 FILLER             PIC X(01) VALUE ';'.                           
006313     03 TIAVTAL-H          PIC X(14) VALUE 'DC11 AGR. DATE'.              
006314     03 FILLER             PIC X(01) VALUE ';'.                           
006315     03 IDNAMN-IDINK-DC41-H PIC X(14) VALUE 'DC41 PURCHASER'.             
006316     03 FILLER             PIC X(01) VALUE ';'.                           
006317     03 KDAVT-DC41-H       PIC X(14) VALUE 'DC41 AGREEMENT'.              
006318     03 FILLER             PIC X(01) VALUE ';'.                           
006319     03 IDLEVNR-DC41-H     PIC X(13) VALUE 'DC41 SUPPLIER'.               
006320     03 FILLER             PIC X(01) VALUE ';'.                           
006321     03 KDMATRPR-DC41-H    PIC X(18) VALUE 'DC41 PACKING INCL.'.          
006322     03 FILLER             PIC X(01) VALUE ';'.                           
006323     03 DAPRLIST-DC41-H    PIC X(14) VALUE 'DC41 AGR. DATE'.              
006324     03 FILLER             PIC X(01) VALUE ';'.                           
006325     03 IDNAMN-IDINK-DC71-H PIC X(14) VALUE 'DC71 PURCHASER'.             
006326     03 FILLER             PIC X(01) VALUE ';'.                           
006327     03 KDAVT-DC71-H       PIC X(14) VALUE 'DC71 AGREEMENT'.              
006328     03 FILLER             PIC X(01) VALUE ';'.                           
006329     03 IDLEVNR-DC71-H     PIC X(13) VALUE 'DC71 SUPPLIER'.               
006330     03 FILLER             PIC X(01) VALUE ';'.                           
006331     03 KDMATRPR-DC71-H    PIC X(18) VALUE 'DC71 PACKING INCL.'.          
006332     03 FILLER             PIC X(01) VALUE ';'.                           
006333     03 DAPRLIST-DC71-H    PIC X(14) VALUE 'DC71 AGR. DATE'.              
006334     03 FILLER             PIC X(01) VALUE ';'.                           
006335     03 IDNAMN-IDINK-DC72-H PIC X(14) VALUE 'DC72 PURCHASER'.             
006336     03 FILLER             PIC X(01) VALUE ';'.                           
006337     03 KDAVT-DC72-H       PIC X(14) VALUE 'DC72 AGREEMENT'.              
006338     03 FILLER             PIC X(01) VALUE ';'.                           
006339     03 IDLEVNR-DC72-H     PIC X(13) VALUE 'DC72 SUPPLIER'.               
006340     03 FILLER             PIC X(01) VALUE ';'.                           
006341     03 KDMATRPR-DC72-H    PIC X(18) VALUE 'DC72 PACKING INCL.'.          
006342     03 FILLER             PIC X(01) VALUE ';'.                           
006343     03 DAPRLIST-DC72-H    PIC X(14) VALUE 'DC72 AGR. DATE'.              
006344     03 FILLER             PIC X(01) VALUE ';'.                           
006345     03 KDARTURS-SE-H      PIC X(09) VALUE 'SE ORIGIN'.                   
006346     03 FILLER             PIC X(01) VALUE ';'.                           
006347     03 KDARTURS-US-H      PIC X(09) VALUE 'US ORIGIN'.                   
006348     03 FILLER             PIC X(01) VALUE ';'.                           
006349     03 KDARTURS-CN-H      PIC X(09) VALUE 'CN ORIGIN'.                   
006350     03 FILLER             PIC X(01) VALUE ';'.                           
006351     03 FLUPG-H            PIC X(03) VALUE 'PSW'.                         
006352     03 FILLER             PIC X(01) VALUE ';'.                           
006353     03 KDTPG-H            PIC X(03) VALUE 'TPD'.                         
006354     03 FILLER             PIC X(01) VALUE ';'.                           
006355     03 TIFINLV-AAVV-H     PIC X(15) VALUE 'SE L.PUBL. WEEK'.             
006356     03 FILLER             PIC X(01) VALUE ';'.                           
006357     03 REDIRLEV-H         PIC X(09) VALUE 'DC11 DDGS'.                   
006358     03 FILLER             PIC X(01) VALUE ';'.                           
006359     03 TELEVBSK-H         PIC X(09) VALUE 'DC11 TEXT'.                   
006360     03 FILLER             PIC X(01) VALUE ';'.                           
006361     03 TILEVBSK-DISP-H    PIC X(16) VALUE 'DC11 AVAIL. DAY'.             
006362     03 FILLER             PIC X(01) VALUE ';'.                           
006363     03 DC11-AVAIL-H       PIC X(21) VALUE 'DC11 AVAIL. IN STOCK'.        
006364     03 FILLER             PIC X(01) VALUE ';'.                           
006365     03 KVVORKO-H          PIC X(08) VALUE 'DC11 VOR'.                    
006366     03 FILLER             PIC X(01) VALUE ';'.                           
006367     03 TIAVIDAT-H         PIC X(14) VALUE 'DC11 REC. DATE'.              
006368     03 FILLER             PIC X(01) VALUE ';'.                           
006369     03 DAPUBL-US-H        PIC X(15) VALUE 'US L.PUBL. WEEK'.             
006370     03 FILLER             PIC X(01) VALUE ';'.                           
006371     03 TELEVBSK-DC41-H    PIC X(09) VALUE 'DC41 TEXT'.                   
006372     03 FILLER             PIC X(01) VALUE ';'.                           
006373     03 TILEVBSK-DISP-DC41-H PIC X(16) VALUE 'DC41 AVAIL. DAY'.           
006374     03 FILLER             PIC X(01) VALUE ';'.                           
006375     03 AVAIL-DC41-H       PIC X(21) VALUE 'DC41 AVAIL. IN STOCK'.        
006376     03 FILLER             PIC X(01) VALUE ';'.                           
006377     03 TIINLMOT-DC41-H    PIC X(14) VALUE 'DC41 REC. DATE'.              
006378     03 FILLER             PIC X(01) VALUE ';'.                           
006380     03 DAPUBL-CN-H        PIC X(15) VALUE 'CN L.PUBL. WEEK'.             
006381     03 FILLER             PIC X(01) VALUE ';'.                           
006382     03 TELEVBSK-DC71-H    PIC X(09) VALUE 'DC71 TEXT'.                   
006383     03 FILLER             PIC X(01) VALUE ';'.                           
006384     03 TILEVBSK-DISP-DC71-H PIC X(16) VALUE 'DC71 AVAIL. DAY'.           
006385     03 FILLER             PIC X(01) VALUE ';'.                           
006386     03 AVAIL-DC71-H       PIC X(21) VALUE 'DC71 AVAIL. IN STOCK'.        
006387     03 FILLER             PIC X(01) VALUE ';'.                           
006388     03 TIINLMOT-DC71-H    PIC X(14) VALUE 'DC71 REC. DATE'.              
006389     03 FILLER             PIC X(01) VALUE ';'.                           
006390     03 TELEVBSK-DC72-H    PIC X(09) VALUE 'DC72 TEXT'.                   
006391     03 FILLER             PIC X(01) VALUE ';'.                           
006392     03 TILEVBSK-DISP-DC72-H PIC X(16) VALUE 'DC72 AVAIL. DAY'.           
006393     03 FILLER             PIC X(01) VALUE ';'.                           
006394     03 AVAIL-DC72-H       PIC X(21) VALUE 'DC72 AVAIL. IN STOCK'.        
006395     03 FILLER             PIC X(01) VALUE ';'.                           
006396     03 TIINLMOT-DC72-H    PIC X(14) VALUE 'DC72 REC. DATE'.              
006397     03 FILLER             PIC X(01) VALUE ';'.                           
006398     03 TIBERANK-DC61-H    PIC X(12) VALUE 'DC61 GIT ETA'.                
006399     03 FILLER             PIC X(01) VALUE ';'.                           
006400     03 AVAIL-DC61-H       PIC X(21) VALUE 'DC61 AVAIL. IN STOCK'.        
006401     03 FILLER             PIC X(01) VALUE ';'.                           
006402     03 TIBERANK-DC62-H    PIC X(12) VALUE 'DC62 GIT ETA'.                
006403     03 FILLER             PIC X(01) VALUE ';'.                           
006404     03 AVAIL-DC62-H       PIC X(21) VALUE 'DC62 AVAIL. IN STOCK'.        
006405     03 FILLER             PIC X(01) VALUE ';'.                           
006406     03 TIBERANK-DC67-H    PIC X(12) VALUE 'DC67 GIT ETA'.                
006407     03 FILLER             PIC X(01) VALUE ';'.                           
006408     03 AVAIL-DC67-H       PIC X(21) VALUE 'DC67 AVAIL. IN STOCK'.        
006409     03 FILLER             PIC X(01) VALUE ';'.                           
006410     03 KVRADER-H          PIC X(12) VALUE 'AGR. CHANGES'.                
006411     03 FILLER             PIC X(01) VALUE ';'.                           
006412     03 TIUPPDAT-BTO-H     PIC X(10) VALUE 'PRICE DATE'.                  
006413     03 FILLER             PIC X(01) VALUE ';'.                           
006414     03 FLPRTSTD-H         PIC X(10) VALUE 'STD.PRICE'.                   
006415     03 FILLER             PIC X(01) VALUE ';'.                           
006416     03 DADATUM-H          PIC X(10) VALUE 'ACT.DATE'.                    
006417     03 FILLER             PIC X(01) VALUE ';'.                           
006420     EJECT                                                                
006455 01  OUT-AREA-START        PIC X(24) VALUE 'OUT-AREA-START  '.            
006456 01  OUT-AREA.                                                            
006457     03 OUT-IDPROJ         PIC X(4).                                      
006458     03 FILLER             PIC X(01) VALUE ';'.                           
006459     03 OUT-IDPROJUP       PIC X(8).                                      
006460     03 FILLER             PIC X(01) VALUE ';'.                           
006461     03 OUT-IDARTNR        PIC 9(9).                                      
006462     03 FILLER             PIC X(01) VALUE ';'.                           
006463     03 OUT-BEART-ENG      PIC X(25).                                     
006464     03 FILLER             PIC X(01) VALUE ';'.                           
006468     03 OUT-TISOP-AAVV     PIC 9(4).                                      
006469     03 FILLER             PIC X(01) VALUE ';'.                           
006470     03 OUT-TISOP-AAMMDD   PIC 9(6).                                      
006471     03 FILLER             PIC X(01) VALUE ';'.                           
006472     03 OUT-KDPRODSL       PIC 9(3).                                      
006473     03 FILLER             PIC X(01) VALUE ';'.                           
006474     03 OUT-IDFKNGRP       PIC 9(5).                                      
006475     03 FILLER             PIC X(01) VALUE ';'.                           
006476     03 OUT-KDUART         PIC X.                                         
006477     03 FILLER             PIC X(01) VALUE ';'.                           
006478     03 OUT-KDFARLIG       PIC 9.                                         
006479     03 FILLER             PIC X(01) VALUE ';'.                           
006480     03 OUT-FLPISK         PIC X.                                         
006481     03 FILLER             PIC X(01) VALUE ';'.                           
006483     03 OUT-IDAO           PIC X(10).                                     
006484     03 FILLER             PIC X(01) VALUE ';'.                           
006485     03 OUT-IDUPPDKU       PIC -(06)9.                                    
006486     03 FILLER             PIC X(01) VALUE ';'.                           
006487     03 OUT-IDUPPDSU       PIC X(08).                                     
006488     03 FILLER             PIC X(01) VALUE ';'.                           
006489     03 OUT-BEUPPDSU       PIC X(35).                                     
006490     03 FILLER             PIC X(01) VALUE ';'.                           
006491     03 OUT-KDERS          PIC 9(3).                                      
006492     03 FILLER             PIC X(01) VALUE ';'.                           
006493     03 OUT-IDARTNR-TILLK  PIC X(9).                                      
006494     03 FILLER             PIC X(01) VALUE ';'.                           
006495     03 OUT-SS-AVAIL-STOCK-DC11 PIC -(08)9.                               
006496     03 FILLER             PIC X(01) VALUE ';'.                           
006497     03 OUT-SS-AVAIL-STOCK-DC41 PIC -(08)9.                               
006498     03 FILLER             PIC X(01) VALUE ';'.                           
006499     03 OUT-SS-AVAIL-STOCK-DC71 PIC -(08)9.                               
006500     03 FILLER             PIC X(01) VALUE ';'.                           
006501     03 OUT-SS-AVAIL-STOCK-DC72 PIC -(08)9.                               
006502     03 FILLER             PIC X(01) VALUE ';'.                           
006503     03 OUT-TIREGDAT       PIC 9(7).                                      
006504     03 FILLER             PIC X(01) VALUE ';'.                           
006505     03 OUT-IDNAMN-FORP    PIC X(40).                                     
006506     03 FILLER             PIC X(01) VALUE ';'.                           
006507     03 OUT-KDEMBKOD-2     PIC 9(3).                                      
006508     03 FILLER             PIC X(01) VALUE ';'.                           
006509     03 OUT-PACK-AVAIL-DC11 PIC -(8)9.                                    
006510     03 FILLER             PIC X(01) VALUE ';'.                           
006511     03 OUT-PACK-AVAIL-DC41 PIC -(8)9.                                    
006512     03 FILLER             PIC X(01) VALUE ';'.                           
006513     03 OUT-PACK-AVAIL-DC71 PIC -(8)9.                                    
006514     03 FILLER             PIC X(01) VALUE ';'.                           
006515     03 OUT-PACK-AVAIL-DC72 PIC -(8)9.                                    
006516     03 FILLER             PIC X(01) VALUE ';'.                           
006517     03 OUT-TIUPPDAT-EMB   PIC 9(7).                                      
006518     03 FILLER             PIC X(01) VALUE ';'.                           
006519     03 OUT-IDNAMN-IDANSK  PIC X(40).                                     
006520     03 FILLER             PIC X(01) VALUE ';'.                           
006521     03 OUT-TIMOTSI        PIC 9(6).                                      
006522     03 FILLER             PIC X(01) VALUE ';'.                           
006523     03 OUT-IDNAMN-IDANSK-DC41 PIC X(40).                                 
006524     03 FILLER             PIC X(01) VALUE ';'.                           
006525     03 OUT-TIMOTSI-DC41   PIC 9(6).                                      
006526     03 FILLER             PIC X(01) VALUE ';'.                           
006527     03 OUT-IDNAMN-IDANSK-DC71 PIC X(40).                                 
006528     03 FILLER             PIC X(01) VALUE ';'.                           
006529     03 OUT-TIMOTSI-DC71   PIC 9(6).                                      
006530     03 FILLER             PIC X(01) VALUE ';'.                           
006531     03 OUT-IDNAMN-IDANSK-DC72 PIC X(40).                                 
006532     03 FILLER             PIC X(01) VALUE ';'.                           
006533     03 OUT-TIMOTSI-DC72   PIC 9(6).                                      
006534     03 FILLER             PIC X(01) VALUE ';'.                           
006535     03 OUT-IDNAMN-IDINK   PIC X(40).                                     
006536     03 FILLER             PIC X(01) VALUE ';'.                           
006537     03 OUT-KDAVT          PIC 9.                                         
006538     03 FILLER             PIC X(01) VALUE ';'.                           
006539     03 OUT-IDLEVNR        PIC X(5).                                      
006540     03 FILLER             PIC X(01) VALUE ';'.                           
006541     03 OUT-KDFPKPRI       PIC X.                                         
006542     03 FILLER             PIC X(01) VALUE ';'.                           
006543     03 OUT-TIAVTAL        PIC 9(7).                                      
006544     03 FILLER             PIC X(01) VALUE ';'.                           
006545     03 OUT-IDNAMN-IDINK-DC41 PIC X(40).                                  
006546     03 FILLER             PIC X(01) VALUE ';'.                           
006547     03 OUT-KDAVT-DC41     PIC 9.                                         
006548     03 FILLER             PIC X(01) VALUE ';'.                           
006549     03 OUT-IDLEVNR-DC41   PIC X(5).                                      
006550     03 FILLER             PIC X(01) VALUE ';'.                           
006551     03 OUT-KDMATRPR-DC41  PIC X.                                         
006552     03 FILLER             PIC X(01) VALUE ';'.                           
006553     03 OUT-DAPRLIST-DC41  PIC 9(7).                                      
006554     03 FILLER             PIC X(01) VALUE ';'.                           
006555     03 OUT-IDNAMN-IDINK-DC71 PIC X(40).                                  
006556     03 FILLER             PIC X(01) VALUE ';'.                           
006557     03 OUT-KDAVT-DC71     PIC 9.                                         
006558     03 FILLER             PIC X(01) VALUE ';'.                           
006559     03 OUT-IDLEVNR-DC71   PIC X(5).                                      
006560     03 FILLER             PIC X(01) VALUE ';'.                           
006561     03 OUT-KDMATRPR-DC71  PIC X.                                         
006562     03 FILLER             PIC X(01) VALUE ';'.                           
006563     03 OUT-DAPRLIST-DC71  PIC 9(7).                                      
006564     03 FILLER             PIC X(01) VALUE ';'.                           
006565     03 OUT-IDNAMN-IDINK-DC72 PIC X(40).                                  
006566     03 FILLER             PIC X(01) VALUE ';'.                           
006567     03 OUT-KDAVT-DC72     PIC 9.                                         
006568     03 FILLER             PIC X(01) VALUE ';'.                           
006569     03 OUT-IDLEVNR-DC72   PIC X(5).                                      
006570     03 FILLER             PIC X(01) VALUE ';'.                           
006571     03 OUT-KDMATRPR-DC72  PIC X.                                         
006572     03 FILLER             PIC X(01) VALUE ';'.                           
006573     03 OUT-DAPRLIST-DC72  PIC 9(7).                                      
006574     03 FILLER             PIC X(01) VALUE ';'.                           
006575     03 OUT-KDARTURS-SE    PIC X(2).                                      
006576     03 FILLER             PIC X(01) VALUE ';'.                           
006577     03 OUT-KDARTURS-US    PIC X(2).                                      
006578     03 FILLER             PIC X(01) VALUE ';'.                           
006579     03 OUT-KDARTURS-CN    PIC X(2).                                      
006580     03 FILLER             PIC X(01) VALUE ';'.                           
006581     03 OUT-FLUPG          PIC X(1).                                      
006582     03 FILLER             PIC X(01) VALUE ';'.                           
006583     03 OUT-KDTPD          PIC X(1).                                      
006584     03 FILLER             PIC X(01) VALUE ';'.                           
006585     03 OUT-TIFINLV-AAVV   PIC 9(4).                                      
006586     03 FILLER             PIC X(01) VALUE ';'.                           
006587     03 OUT-REDIRLEV       PIC 9.9(2).                                    
006588     03 FILLER             PIC X(01) VALUE ';'.                           
006589     03 OUT-TELEVBSK-TEXT.                                                
006590       05 FILLER           PIC X(01) VALUE '"'.                           
006591       05 OUT-TELEVBSK     PIC X(80).                                     
006592       05 FILLER           PIC X(01) VALUE '"'.                           
006593     03 FILLER             PIC X(01) VALUE ';'.                           
006594     03 OUT-TILEVBSK-DISP  PIC 9(7).                                      
006596     03 FILLER             PIC X(01) VALUE ';'.                           
006597     03 OUT-AVAIL-STOCK-DC11 PIC -(8)9.                                   
006598     03 FILLER             PIC X(01) VALUE ';'.                           
006599     03 OUT-KVVORKO        PIC -(7)9.                                     
006600     03 FILLER             PIC X(01) VALUE ';'.                           
006601     03 OUT-TIAVIDAT       PIC 9(7).                                      
006602     03 FILLER             PIC X(01) VALUE ';'.                           
006603     03 OUT-DAPUBL-US      PIC 9(4).                                      
006604     03 FILLER             PIC X(01) VALUE ';'.                           
...
006609     03 FILLER             PIC X(01) VALUE ';'.                           
006610     03 OUT-TILEVBSK-DISP-DC41 PIC 9(8).                                  
006611     03 FILLER             PIC X(01) VALUE ';'.                           
006612     03 OUT-AVAIL-STOCK-DC41 PIC -(8)9.                                   
006613     03 FILLER             PIC X(01) VALUE ';'.                           
006614     03 OUT-TIINLMOT-DC41  PIC 9(9).                                      
006615     03 FILLER             PIC X(01) VALUE ';'.                           
006616     03 OUT-DAPUBL-CN      PIC 9(4).                                      
006617     03 FILLER             PIC X(01) VALUE ';'.                           
...
006622     03 FILLER             PIC X(01) VALUE ';'.                           
006623     03 OUT-TILEVBSK-DISP-DC71 PIC 9(9).                                  
006624     03 FILLER             PIC X(01) VALUE ';'.                           
006625     03 OUT-AVAIL-STOCK-DC71 PIC -(8)9.                                   
006626     03 FILLER             PIC X(01) VALUE ';'.                           
006627     03 OUT-TIINLMOT-DC71  PIC 9(9).                                      
006628     03 FILLER             PIC X(01) VALUE ';'.                           
...
007010     PERFORM S01-READ-W2521601                                            
007020     PERFORM UNTIL END-OF-W2521601                                        
007200                                                                          
007300       PERFORM S11-WRITE-W2521602                                         
007700                                                                          
007810       PERFORM S01-READ-W2521601                                          
007900     END-PERFORM                                                          
008100                                                                          
...
008901                                                                          
008910     OPEN INPUT  W2521601                                                 
009001                                                                          
009010     OPEN OUTPUT W2521602                                                 
009100     SKIP2                                                                
...
009900     .                                                                    
010001     EJECT                                                                
010002 S01-READ-W2521601 SECTION.                                               
010003     READ W2521601 INTO IN-AREA                                           
010004     AT END                                                               
010005        MOVE HIGH-VALUE TO IN-AREA                                        
010006        SET END-OF-W2521601 TO TRUE                                       
010007                                                                          
010008     NOT AT END                                                           
010009        MOVE 'W2521601' TO POSTSUM-FDNAMN                                 
010010        MOVE 'W25216D1' TO POSTSUM-DDNAMN2                                
...
010020     .                                                                    
010101     EJECT                                                                
010102 S11-WRITE-W2521602 SECTION.                                              
010103                                                                          
...
010115     MOVE 'W2521602'       TO POSTSUM-FDNAMN                              
010116     MOVE 'W25216D2'       TO POSTSUM-DDNAMN2                             
