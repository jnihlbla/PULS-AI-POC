...
007900 77  IDPGM                       PIC X(8)    VALUE 'W3303D00'.            
...
008500                                                                          
008600                                                                          
008700 77  W3303DI-EOF-SW              PIC X       VALUE 'N'.                   
008800     88  END-OF-W3303DI                      VALUE 'J'.                   
008900     EJECT                                                                
009000 77  W3304D-EOF-SW              PIC X       VALUE 'N'.                    
009100     88  END-OF-W3304D                      VALUE 'J'.                    
009200     EJECT                                                                
...
023100*       *                                                                 
023200     PERFORM S14-SKRIV-W3303DV                                            
023300        .                                                                 
023400        EJECT                                                             
...
029300     PERFORM S11-SKRIV-W3303DU                                            
029400     .                                                                    
029500     EJECT                                                                
...
030600     .                                                                    
030700     EJECT                                                                
030800 S02-LAES-W3303DI SECTION.                                                
030900                                                                          
031000     READ W3303DI INTO IN-AREA                                            
031100     AT END                                                               
031200        SET END-OF-W3303DI TO TRUE                                        
031300                                                                          
031400     NOT AT END                                                           
031500        MOVE 'IN'       TO POSTSUM-TRANSTYP                               
031600        MOVE 'W33040'   TO POSTSUM-FDNAMN                                 
031700        MOVE 'W3303DD2' TO POSTSUM-DDNAMN2                                
031800        CALL POSTSUM USING POSTSUM-PARM                                   
031900     END-READ                                                             
032000     .                                                                    
032100     EJECT                                                                
032200 S03-LAES-W3304D  SECTION.                                                
032300*FIL MED EN POST SOM VISAR ANTALET POSTER I W3303D-FILEN FÖR VCOM.        
032400     READ W3304D  INTO ANTAL-AREA                                         
032500     AT END                                                               
032600        SET END-OF-W3304D  TO TRUE                                        
032700                                                                          
032800     NOT AT END                                                           
032900        MOVE 'ANT'      TO POSTSUM-TRANSTYP                               
033000        MOVE 'W3304D'   TO POSTSUM-FDNAMN                                 
033100        MOVE 'W3303DD5' TO POSTSUM-DDNAMN2                                
033200        CALL POSTSUM USING POSTSUM-PARM                                   
033300     END-READ                                                             
033400     .                                                                    
033500     EJECT                                                                
033600 S10-SKRIV-W3303DV-000 SECTION.                                           
033700                                                                          
