...
000900*    FUNKTION:                                                            
001000*                                                                         
001100*        IMPORTÖRSBEROENDE BEHANDLING (SYDAFRIKA)                         
...
002800     SELECT W4613C                       ASSIGN TO UT-S-W4613CD1.         
002900     SKIP2                                                                
003000*- - - - - - - - - - - - UTFIL:                                           
003100*                        - -  FIL TILL VIPS                               
003200     SELECT W461ZA                       ASSIGN TO UT-S-W4613CD2.         
003300     EJECT                                                                
...
005300*- - - - - - - - - - - - - -  PROGRAM-NAMN                                
005400 77  PROGRAM-NAMN                PIC X(8)    VALUE 'W4613C00'.            
005500     SKIP2                                                                
...
006200                                                                          
006300 77  W4613C-EOF                  PIC X(1)    VALUE 'N'.                   
006400     SKIP2                                                                
...
013200     SKIP2                                                                
013300     OPEN INPUT W4613C OUTPUT W461ZA                                      
013400     SKIP2                                                                
...
019494     MOVE     3160           TO START-IDDISTR                             
...
020800     .                                                                    
020900     SKIP2                                                                
021000 S01-LAS-W4613C SECTION.                                                  
021100     SKIP2                                                                
021200     READ   W4613C INTO W-ARBAREA                                         
021300     AT END MOVE JA TO W4613C-EOF                                         
021400     END-READ                                                             
021500                                                                          
021600     IF W4613C-EOF = NEJ                                                  
021700                                                                          
021800       MOVE 'W4613C'            TO POSTSUM-FDNAMN                         
021900       MOVE 'W4613CD1'          TO POSTSUM-DDNAMN2                        
