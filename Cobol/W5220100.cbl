...
000300*                                                                         
001200 ID DIVISION.                                                             
001300 PROGRAM-ID.     W5220100.                                                
001400 AUTHOR.         NILSSON LINDA.                                           
001500 DATE-WRITTEN.   02/05/06.                                                
001600 DATE-COMPILED.                                                           
001700                                                                          
001900*                                                                         
002000*    FUNCTION:                                                            
002100*        SELECTS DATA FROM DB2-TABLE T01IVW AND                           
002200*        CREATES A SEQUENCE-FILE FOR INTRASTAT                            
002400*                                                                         
002500*    INDATA.                                                              
002600*        TRANSACTION: W52201T                                             
002800*                                                                         
003100                                                                          
003200     SKIP3                                                                
...
003803     SELECT W52201                     ASSIGN TO W52201D1.                
003804     SKIP2                                                                
...
004405                                                                          
004406*01  POST    -COPY W522INT    -L.                                         
004407     SKIP3                                                                
004600 WORKING-STORAGE SECTION.                                                 
004700 77  IDPGM                       PIC X(08)   VALUE 'W5220100'.            
004800                                                                          
...
006480 01  WS-IDPTYP                   PIC X(3)    VALUE 'INT'.                 
...
006597*                                                                         
006598 01  WS-BEFORMS                  PIC X(15)   VALUE                        
006599                                            'INTRASTAT      '.            
...
007840*                                                                         
007850 01  PROGRAM-NAMN                PIC X(6)    VALUE 'W52201'.              
007860                                                                          
...
008503     EJECT                                                                
008602 01  INT-AREA                    PIC X(24)   VALUE 'INT-AREA'.            
008605                                                                          
008606*01  -COPY W522INT -PRE INT-                                              
008607     EJECT                                                                
008608                                                                          
...
013770          DAT-KDSVAR                                                      
013781     MOVE DAT-TIMM        TO WS-TIRP                                      
...
018115       MOVE T01IVW-IV-DATA  TO INT-W522INT-001                            
018116       MOVE T01IVW-IV-DATA2 TO INT-W522INT-002                            
018119       PERFORM S11-WRITE-W52201                                           
018120       PERFORM DB2-UPDATE-T01IVW                                          
018121       PERFORM DB2-FETCH-CRS                                              
018122     END-PERFORM                                                          
018123     PERFORM DB2-CLOSE-CRS                                                
018124     .                                                                    
018125     EJECT                                                                
...
019400     .                                                                    
019500     EJECT                                                                
023002 S11-WRITE-W52201 SECTION.                                                
023003     SKIP2                                                                
023045     WRITE POST FROM INT-W522INT                                          
023046     .                                                                    
023050     EJECT                                                                
...
023608     .                                                                    
023609     EJECT                                                                
023610 DB2-FETCH-CRS SECTION.                                                   
023611                                                                          
023612     MOVE 000100  TO GOOD-SQLCODECODES                                    
023613     EXEC SQL                                                             
023614         FETCH T01IVW-CRS                                                 
023615         INTO   :T01IVW-DAREGDAT                                          
023616              , :T01IVW-TIREGTID                                          
023617              , :T01IVW-IDLOPNR                                           
023618              , :T01IVW-IDPTYP                                            
023619              , :T01IVW-TIRP                                              
023620              , :T01IVW-FLKLAR                                            
023621              , :T01IVW-IV-DATA                                           
023622              , :T01IVW-IV-DATA2                                          
023623     END-EXEC                                                             
023624                                                                          
...
023628     .                                                                    
023629     EJECT                                                                
023630 DB2-UPDATE-T01IVW SECTION.                                               
023631                                                                          
023632     MOVE 000     TO GOOD-SQLCODECODES                                    
023633     EXEC SQL                                                             
023634         UPDATE T01IVW                                                    
023635         SET FLKLAR = 'J'                                                 
...
023657     .                                                                    
023658     EJECT                                                                
023659 DB2-CLOSE-CRS SECTION.                                                   
023660                                                                          
023661     EXEC SQL                                                             
023662         CLOSE T01IVW-CRS                                                 
023663     END-EXEC                                                             
023664     .                                                                    
023665     EJECT                                                                
023781 DB2-STATUS-CHECK SECTION.                                                
023782                                                                          
023783     SET SQLCODE-IX TO 1                                                  
023784     SEARCH GOOD-SQLCODE                                                  
023785       AT END                                                             
023786          STRING 'INVALID DB2 SQL STATUS CODE: ' SQLCODE-WS               
023787          DELIMITED BY SIZE INTO ERROR-TEXT                               
