000100 ID DIVISION.                                                             
000200 PROGRAM-ID.     W3716600.                                                
000300 AUTHOR.         BO HAMMARIN.                                             
000400 DATE-WRITTEN.   DEC-1999.                                                
000500 DATE-COMPILED.                                                           
000600                                                                          
000700*    FUNKTION:   PGM UPPDATERAR SEGMENT PÅ WDA701                         
000800*                                                                         
001100*    INDATA:     W37136 UPPDATERINGSPOSTER FAKT/KRED/JUST                 
001300*                                                                         
001500*    RETURKODER: 999 (DUMPKOD VID FELLOG ).                               
001600     EJECT                                                                
001610                                                                          
...
001900 FILE-CONTROL.                                                            
002000*- - - - - - - - - - - - - - - - - - - - - - INFILER.                     
002010     SELECT W37136     ASSIGN  TO  UT-S-W37166D1.                         
002050     EJECT                                                                
002051                                                                          
002060 DATA DIVISION.                                                           
002070 FILE SECTION.                                                            
002080                                                                          
002090*  UPPDATERINGSTRANSAKTIONER WDA701                                       
002100*                                                                         
002200 FD  W37136                                                               
002300     RECORDING F                                                          
002400     BLOCK 0 RECORDS.                                                     
002500                                                                          
002600*01  W37136-IN      -COPY W37109  -L.                                     
002700     EJECT                                                                
002710                                                                          
002800 WORKING-STORAGE SECTION.                                                 
002900                                                                          
003100*    -- CHECKED BY WY2000                                                 
003200 77  IDPGM                       PIC X(8)   VALUE 'W3716600'.             
...
004700                                                                          
004800 01  DIVERSE.                                                             
004900     03  W37136-EOF              PIC X      VALUE 'N'.                    
005000     03  RETURKOD                PIC S9(4)  COMP SYNC VALUE +0.           
005300     EJECT                                                                
007700                                                                          
007800 01  FILLER PIC X(16) VALUE '*****NYCKLAR****'.                           
007900                                                                          
008000 01  W-WDA701KY-X.                                                        
008010     03  W-IDPTYP                PIC X(3)   VALUE SPACE.                  
008100     03  W-IDDISTR               PIC S9(5)  COMP-3  VALUE ZERO.           
008110     03  W-IDARTNR               PIC S9(9)  COMP-3  VALUE ZERO.           
008120     03  W-IDKUNDNR              PIC S9(7)  COMP-3  VALUE ZERO.           
008130     03  W-IDBYTRAD              PIC S9(5)  COMP-3  VALUE ZERO.           
008900     EJECT                                                                
008910                                                                          
...
010400     EJECT                                                                
010410                                                                          
010500 01  FILLER                      PIC X(16)  VALUE '*****W37136'.          
010600*01  -COPY W37109  -PRE BYT-.                                             
010700     EJECT                                                                
010710                                                                          
...
013000     03  FILLER                  PIC X(8)  VALUE '*IMS-WS*'.              
...
017600                                                                          
018400     MOVE 'W37136' TO POSTSUM-PROGNAMN                                    
018500                                                                          
018600     OPEN INPUT W37136                                                    
018700     .                                                                    
018800     EJECT                                                                
019000                                                                          
019010 B-BEARBETNING SECTION.                                                   
019100     PERFORM BA-READ-W37136                                               
019200                                                                          
019300     PERFORM UNTIL W37136-EOF = JA                                        
019400       MOVE BYT-IDPTYP        TO W-IDPTYP                                 
019500       MOVE BYT-IDDISTR       TO W-IDDISTR                                
019600       MOVE BYT-IDARTNR       TO W-IDARTNR                                
019700       MOVE BYT-IDKUNDNR      TO W-IDKUNDNR                               
019710       MOVE BYT-IDBYTRAD      TO W-IDBYTRAD                               
019800       PERFORM IMS-GHU-WDA701                                             
019810                                                                          
019820       IF SEGMENT-FINNS                                                   
019900         ADD +1               TO CHKP-ANT                                 
020400         PERFORM IMS-DLET-WDA701                                          
020500                                                                          
...
021901       END-IF                                                             
021910                                                                          
022000       PERFORM BA-READ-W37136                                             
022100     END-PERFORM                                                          
022300     .                                                                    
022400     EJECT                                                                
022410                                                                          
022500 BA-READ-W37136 SECTION.                                                  
022900                                                                          
023000     READ W37136 INTO BYT-W37109                                          
023100     AT END                                                               
023200        MOVE JA         TO W37136-EOF                                     
023300     NOT AT END                                                           
023400        MOVE 'W37136'   TO POSTSUM-FDNAMN                                 
023500        MOVE 'W37166D1' TO POSTSUM-DDNAMN2                                
023600        CALL POSTSUM USING POSTSUM-PARM                                   
023700     END-READ                                                             
023800     .                                                                    
023900     EJECT                                                                
024100                                                                          
024110 C-AVSLUTNING SECTION.                                                    
024200     CLOSE W37136                                                         
024300                                                                          
...
024700     EJECT                                                                
024900                                                                          
024910 X-TAG-CHECKPOINT   SECTION.                                              
...
028100     EJECT                                                                
028110                                                                          
028500 IMS-GHU-WDA701 SECTION.                                                  
028700     STRING 'WDA701  (WDA701KY =' W-WDA701KY-X ')'                        
028800             DELIMITED BY SIZE INTO SSA1                                  
029000     MOVE   '  GE'         TO GODK-STATUSKODER                            
029100     CALL CBLTDLI USING GHU WDA7-PCB DLI-IO-WDA701 SSA1                   
029200     MOVE WDA7-STATUS-CODE TO STATUS-WS                                   
029300     PERFORM IMS-STATUSKONTROLL                                           
029400     .                                                                    
034000                                                                          
034001 IMS-DLET-WDA701 SECTION.                                                 
034002     MOVE '  '             TO GODK-STATUSKODER                            
034003     CALL CBLTDLI USING DLET WDA7-PCB DLI-IO-WDA701                       
034004     MOVE WDA7-STATUS-CODE TO STATUS-WS                                   
034005     PERFORM IMS-STATUSKONTROLL                                           
034006     .                                                                    
034800     EJECT                                                                
034810                                                                          
