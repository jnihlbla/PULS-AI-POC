...
000700*                                                                         
000800*    FUNKTION:                                                            
000900*        LÄGGER TILL TIDEN FÖR NORMALRABATTER FÖR ALLA                    
...
002403     SELECT W33510                     ASSIGN TO W33508D1.                
002404     SKIP2                                                                
002405*          --- FIL MED NYA PRISER SAMT TID NÄR MAN SKICKAT PRISET         
002410     SELECT W33508                     ASSIGN TO W33508D2.                
002600     EJECT                                                                
...
003010*01  -COPY W335101A      -L.                                              
003012     SKIP3                                                                
003013 FD  W33508                                                               
003016     RECORDING       V                                                    
003017     BLOCK CONTAINS  0.                                                   
003018                                                                          
003020*01  POST -COPY W335101B -PRE  UT-  -L.                                   
003100     EJECT                                                                
003200 WORKING-STORAGE SECTION.                                                 
003300                                                                          
003301                                                                          
003310*    -- CHECKED BY WY2000                                                 
003400 77  IDPGM                       PIC X(8)    VALUE 'W3350800'.            
003500 77  JA                          PIC X       VALUE 'J'.                   
003600 77  NEJ                         PIC X       VALUE 'N'.                   
003801                                                                          
003802 77  W33510-EOF-SW               PIC X       VALUE 'N'.                   
003810     88  END-OF-W33510                       VALUE 'J'.                   
003900     EJECT                                                                
003901                                                                          
003910 77  WS-TTMMSSTH                 PIC 9(8)    VALUE ZERO.                  
003911 77  IX                          PIC 9(2)    COMP SYNC.                   
003920                                                                          
...
006204     SKIP2                                                                
006205                                                                          
006206*01  AREA -COPY W335101A     -PRE IN-                                     
006207     EJECT                                                                
006208 01  UT-AREA-START               PIC X(24)   VALUE                        
006209                                 'UT-AREA-START  '.                       
006210     SKIP2                                                                
006211                                                                          
006220*01  AREA -COPY W335101B     -PRE UT-                                     
006300     EJECT                                                                
...
007010     PERFORM S01-LAES-W33510                                              
007100     PERFORM UNTIL END-OF-W33510                                          
007210       PERFORM C-BEARBETA                                                 
007810       PERFORM S01-LAES-W33510                                            
007900     END-PERFORM                                                          
008000                                                                          
008100                                                                          
...
008901                                                                          
008910     OPEN INPUT  W33510                                                   
009001                                                                          
009010     OPEN OUTPUT W33508                                                   
009100     SKIP2                                                                
...
009543     MOVE +1 TO IX                                                        
009544     PERFORM UNTIL IX = +100                                              
009547       MOVE IN-KDRABATT(IX)      TO UT-KDRABATT(IX)                       
009548       MOVE IN-REARTRAB-DO(IX)   TO UT-REARTRAB-DO(IX)                    
009549       MOVE IN-REARTRAB-BULK(IX) TO UT-REARTRAB-BULK(IX)                  
009550       IF IX = IN-KDRABATT(IX)                                            
009551         ADD +1 TO IX                                                     
009552       ELSE                                                               
009553         DISPLAY 'FEL I FILEN DEN INNEHÅLLER EJ 99 KODER'                 
009554         DISPLAY 'ELLER SÅ ÄR ORDNINGEN FEL             '                 
009555         PERFORM S99-ABEND                                                
009556       END-IF                                                             
009557     END-PERFORM                                                          
009572     MOVE WS-TTMMSSTH                 TO UT-TIKLOCK                       
009573     PERFORM S11-SKRIV-W33508                                             
009574     .                                                                    
009580     EJECT                                                                
...
009900     .                                                                    
010001     EJECT                                                                
010002 S01-LAES-W33510  SECTION.                                                
010003     READ W33510 INTO IN-AREA                                             
010004     AT END                                                               
010005        MOVE HIGH-VALUE TO IN-AREA                                        
010006        SET END-OF-W33510 TO TRUE                                         
010007                                                                          
010008     NOT AT END                                                           
010009        MOVE 'W33510' TO POSTSUM-FDNAMN                                   
010010        MOVE 'W33508D1' TO POSTSUM-DDNAMN2                                
010013        MOVE IN-IDVTYP TO POSTSUM-TRANSTYP                                
010014        CALL POSTSUM USING POSTSUM-PARM                                   
010015     END-READ                                                             
010020     .                                                                    
010101     EJECT                                                                
010102 S11-SKRIV-W33508 SECTION.                                                
010103                                                                          
010104     WRITE UT-POST FROM UT-AREA                                           
010105                                                                          
010106     MOVE UT-IDVTYP TO POSTSUM-TRANSTYP                                   
010107     MOVE 'W33508' TO POSTSUM-FDNAMN                                      
010108     MOVE 'W33508D2' TO POSTSUM-DDNAMN2                                   
