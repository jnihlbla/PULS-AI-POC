...
001500*    FUNKTION:                                                            
001600*                                                                         
001700*        IMPORTÖRSBEROENDE BEHANDLING (TAIWAN2)                           
...
003600     SELECT W4612A                       ASSIGN TO UT-S-W4612AD1.         
003700     SKIP2                                                                
003800*- - - - - - - - - - - - UTFIL:                                           
003900*                        - -  FIL TILL VIPS                               
004000     SELECT W46141                       ASSIGN TO UT-S-W4612AD2.         
004200     EJECT                                                                
...
006900*- - - - - - - - - - - - - -  PROGRAM-NAMN                                
007000 77  PROGRAM-NAMN                PIC X(8)    VALUE 'W4612A00'.            
007200     SKIP2                                                                
...
007900                                                                          
008000 77  W4612A-EOF                  PIC X(1)    VALUE 'N'.                   
008100     SKIP2                                                                
...
015400     SKIP2                                                                
015500     OPEN INPUT W4612A OUTPUT W46141                                      
015600     SKIP2                                                                
...
020300     MOVE     6200           TO START-IDDISTR                             
...
022200     .                                                                    
022300     SKIP2                                                                
022400 S01-LAS-W4612A SECTION.                                                  
022500     SKIP2                                                                
022600     READ   W4612A INTO W-ARBAREA                                         
022700     AT END MOVE JA TO W4612A-EOF                                         
022800     END-READ                                                             
022900                                                                          
023000     IF W4612A-EOF = NEJ                                                  
023100                                                                          
023200       MOVE 'W4612A'            TO POSTSUM-FDNAMN                         
023300       MOVE 'W4612AD1'          TO POSTSUM-DDNAMN2                        
