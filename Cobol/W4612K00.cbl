000100 ID  DIVISION.                                                            
000200     SKIP2                                                                
000300 PROGRAM-ID.    W4612K00.                                                 
000400*AUTHOR.        GERRY CARMICHAEL                                          
000500*DATE-WRITTEN.  JUNE 199                                                  
000600                                                                          
000700*REMARKS.                                                                 
000800*        IMPORTÖRSBEROENDE BEHANDLING (IRLAND, NEW CONCEPT)               
...
002600     SELECT W4612K                       ASSIGN TO UT-S-W4612KD1.         
002700     SKIP2                                                                
002800*- - - - - - - - - - - - UTFIL:                                           
002900*                        - -  FIL TILL VIPS                               
003000     SELECT W4612V                       ASSIGN TO UT-S-W4612KD2.         
003100     EJECT                                                                
...
005310     SKIP2                                                                
005320 01  RKB-POST      -COPY W461RKBN     -L.                                 
005330     SKIP2                                                                
005340 01  RKC-POST      -COPY W461RKCN     -L.                                 
005350     SKIP2                                                                
005360 01  RKD-POST      -COPY W461RKDN     -L.                                 
005400     EJECT                                                                
005500 WORKING-STORAGE SECTION.                                                 
005600                                                                          
005700*    -- CHECKED BY WY2000                                                 
005800*- - - - - - - - - - - - - -  PROGRAM-NAMN                                
005900 77  PROGRAM-NAMN                PIC X(8)    VALUE 'W4612K00'.            
006000     SKIP2                                                                
...
006700                                                                          
006800 77  W4612K-EOF                  PIC X(1)    VALUE 'N'.                   
006900     SKIP2                                                                
...
014000     SKIP2                                                                
014100     OPEN INPUT W4612K OUTPUT W4612V                                      
014200     SKIP2                                                                
...
020600     MOVE     1778           TO START-IDDISTR                             
...
022300     .                                                                    
022400     SKIP2                                                                
022500 S01-LAS-W4612K SECTION.                                                  
022600     SKIP2                                                                
022700     READ   W4612K INTO W-ARBAREA                                         
022800     AT END MOVE JA TO W4612K-EOF                                         
022900     END-READ                                                             
023000                                                                          
023100     IF W4612K-EOF = NEJ                                                  
023200                                                                          
023300       MOVE 'W4612K'            TO POSTSUM-FDNAMN                         
023400       MOVE 'W4612KD1'          TO POSTSUM-DDNAMN2                        
