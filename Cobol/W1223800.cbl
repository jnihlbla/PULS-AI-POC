001200 ID DIVISION.                                                             
001300 PROGRAM-ID.     W1223800.                                                
001400 AUTHOR.         ARCHANA BHAT.                                            
001500 DATE-WRITTEN.   14/11/14.                                                
...
002200*        FROM WDT4.                                                       
002300*                                                                         
002410*        THE PROGRAM UPDATES   WDT4                                       
002500*                                                                         
002600                                                                          
002700     SKIP3                                                                
...
003200 FILE-CONTROL.                                                            
003301     SKIP2                                                                
003302*          --- PARTS TO BE DELETED FROM WDT4                              
003310     SELECT W12207                     ASSIGN TO W12238D1.                
003500     EJECT                                                                
...
004200                                                                          
004300 77  IDPGM                       PIC X(8)    VALUE 'W1223800'.            
004400 01  CHKP-VAR.                                                            
...
005200 77  W-DLET-WDT401               PIC 9(7)    VALUE ZERO.                  
005300     SKIP2                                                                
...
010300                                                                          
010401 01  FILLER         PIC X(16) VALUE 'DLI-IO-WDT401'.                      
010402 01  DLI-IO-WDT401.                                                       
010410*    03  -COPY WDT401                                                     
010500                                                                          
010900     EJECT                                                                
...
011301                                                                          
011302*01  -COPY W0008  -PRE WDT4-                                              
011310     05  FILLER                  PIC X.                                   
011600     EJECT                                                                
011701 PROCEDURE DIVISION  USING MSG-PCB WDT4-PCB.                              
011702 MAIN SECTION.                                                            
011710     ENTRY 'DLITCBL' USING MSG-PCB WDT4-PCB.                              
011800                                                                          
012000     SKIP2                                                                
012100     PERFORM A-INIT                                                       
012200     PERFORM S01-READ-W12207                                              
012300     PERFORM UNTIL END-OF-W12207                                          
012400       IF IN-UTFIL-TYP = 'S' OR 'B'                                       
012500         MOVE IN-IDARTNR TO W-IDARTNR                                     
012600         PERFORM IMS-GHU-WDT401                                           
012700         IF SEGMENT-FOUND                                                 
012800            PERFORM IMS-DLET-WDT401                                       
                  ADD 1 TO W-DLET-WDT401                                        
012900            ADD +1       TO CHKP-ANT                                      
013000         END-IF                                                           
013100         IF CHKP-ANT > CHKP-MAX                                           
013200           PERFORM X-TAKE-CHECKPOINT                                      
013300         END-IF                                                           
013400       END-IF                                                             
013500       PERFORM S01-READ-W12207                                            
013600     END-PERFORM                                                          
013700                                                                          
013710     PERFORM Z-FINIT                                                      
013720                                                                          
013730     MOVE ZERO TO RETURN-CODE                                             
013740     GOBACK                                                               
014100     .                                                                    
014200     EJECT                                                                
...
016200                                                                          
           DISPLAY 'ANTAL BORTTAGNA WDT401: ' W-DLET-WDT401                     
016610     CLOSE W12207                                                         
016801     SKIP2                                                                
...
017111        MOVE 'W12238D1'   TO POSTSUM-DDNAMN2                              
...
018800                                                                          
018901     EJECT                                                                
018902 IMS-GHU-WDT401 SECTION.                                                  
018903                                                                          
018904     STRING 'WDT401  (IDARTNR  =' W-IDARTNR-X ')'                         
018905          DELIMITED BY SIZE INTO SSA1                                     
018906     MOVE '  GE'              TO GOOD-STATUSCODES                         
018907     CALL CBLTDLI          USING GHU WDT4-PCB DLI-IO-WDT401 SSA1          
018908     MOVE WDT4-STATUS-CODE    TO STATUS-WS                                
018909     PERFORM IMS-STATUSCHECK                                              
018910     .                                                                    
018911     SKIP3                                                                
018912 IMS-DLET-WDT401 SECTION.                                                 
018913                                                                          
018914     MOVE '  '                TO GOOD-STATUSCODES                         
018915     CALL CBLTDLI          USING DLET WDT4-PCB DLI-IO-WDT401              
018916     MOVE WDT4-STATUS-CODE    TO STATUS-WS                                
