...
000900*    FUNKTION:                                                            
001000*                                                                         
001100*        IMPORTÖRSBEROENDE BEHANDLING (RYSSLAND)                          
001110*        FILER INNEHÅLLER TRANSAR FÖR BÅDE DISTRIKT                       
001120*        2640   (TEST 2600 ??)                                            
...
002800     SELECT W4613A                       ASSIGN TO UT-S-W4613AD1.         
002900     SKIP2                                                                
003000*- - - - - - - - - - - - UTFIL:                                           
003100*                        - -  FIL TILL VIPS                               
003200     SELECT W461RU                       ASSIGN TO UT-S-W4613AD2.         
003300     EJECT                                                                
...
005300*- - - - - - - - - - - - - -  PROGRAM-NAMN                                
005400 77  PROGRAM-NAMN                PIC X(8)    VALUE 'W4613A00'.            
005500     SKIP2                                                                
...
006200                                                                          
006300 77  W4613A-EOF                  PIC X(1)    VALUE 'N'.                   
006400     SKIP2                                                                
...
013200     SKIP2                                                                
013300     OPEN INPUT W4613A OUTPUT W461RU                                      
013400     SKIP2                                                                
...
019494     MOVE     2602           TO START-IDDISTR                             
...
020800     .                                                                    
020900     SKIP2                                                                
021000 S01-LAS-W4613A SECTION.                                                  
021100     SKIP2                                                                
021200     READ   W4613A INTO W-ARBAREA                                         
021300     AT END MOVE JA TO W4613A-EOF                                         
021400     END-READ                                                             
021500                                                                          
021600     IF W4613A-EOF = NEJ                                                  
021700                                                                          
021800       MOVE 'W4613A'            TO POSTSUM-FDNAMN                         
021900       MOVE 'W4613AD1'          TO POSTSUM-DDNAMN2                        
