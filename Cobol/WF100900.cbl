...
000400*                                                                         
001150 ID DIVISION.                                                             
001200 PROGRAM-ID.     WF100900.                                                
001300 AUTHOR.         BO HAMMARIN.                                             
001400 DATE-WRITTEN.   DEC 2001.                                                
001500 DATE-COMPILED.                                                           
001700                                                                          
001800*   PGM                                                                   
001900*   -SELECTS ROWS FROM PERMANENT COST CENTER-TABLE                        
...
003000                                                                          
003010 INPUT-OUTPUT SECTION.                                                    
003011 FILE-CONTROL.                                                            
003020*          --- DISTRIBUTION-DATA                                          
003030     SELECT WF1015                     ASSIGN TO WF1009D1.                
003400                                                                          
...
004200 77  IDPGM                       PIC X(8)    VALUE 'WF100900'.            
004430                                                                          
...
006505     EJECT                                                                
006506                                                                          
006507*    --- PARAMETRAR TILL DATKORT                                          
006508*                                                                         
006509 01  DATUMKORT-ID                PIC X(6)    VALUE 'WDATUM'.              
006510                                                                          
006511*01  -COPY WDATKORT                                                       
006512     EJECT                                                                
006513                                                                          
006514*    --- PARAMETRAR TILL ABEND                                            
006515*                                                                         
006516 01  RKOD-ABEND-DB2              PIC S9(4)   VALUE +998 COMP SYNC.        
006542     EJECT                                                                
006543                                                                          
006544 01  WF1015-AREA-START           PIC X(24)   VALUE                        
006545                                             'WF10-AREA-START'.           
006546*01  -COPY WF10M11        -PRE UT-                                        
006547     EJECT                                                                
006550*                                                                         
...
010610     EJECT                                                                
010611                                                                          
010612 01  FILLER                       PIC X(16)   VALUE 'CCTR-AREA'.          
...
014989     PERFORM DB2-OPEN-CRS-CCTR                                            
014994     PERFORM DB2-FETCH-CRS-CCTR                                           
014995     PERFORM UNTIL ROW-MISSING                                            
014996       PERFORM BA-BUILD-OUTPUT-CCTR                                       
015004       PERFORM S11-WRITE-WF1015                                           
015006       PERFORM DB2-FETCH-CRS-CCTR                                         
015007     END-PERFORM                                                          
015009     PERFORM DB2-CLOSE-CRS-CCTR                                           
015103     .                                                                    
015104     EJECT                                                                
015105                                                                          
015106 BA-BUILD-OUTPUT-CCTR SECTION.                                            
015109     MOVE CCTR-IDLEGSEL           TO UT-IDLEGSEL                          
015111     MOVE CCTR-IDKST              TO UT-IDKST                             
015112     MOVE CCTR-IDGL               TO UT-IDGL                              
015115     MOVE CCTR-DAREGDAT           TO UT-DAREGDAT                          
015117     MOVE CCTR-DADELDAT           TO UT-DADELDAT                          
015144     .                                                                    
015195     EJECT                                                                
015196                                                                          
...
015203     EJECT                                                                
015204                                                                          
015205 S11-WRITE-WF1015 SECTION.                                                
015206     WRITE UT-POST   FROM UT-WF10M11                                      
015212     .                                                                    
015213     EJECT                                                                
015214                                                                          
015215* --- DB2 SECTIONS  ---                                                   
015216*                                                                         
015217 DB2-OPEN-CRS-CCTR SECTION.                                               
015219     EXEC SQL DECLARE CCTR-CRS CURSOR FOR                                 
015220     SELECT   T01CCTR.IDLEGSEL,                                           
015221              T01CCTR.IDKST,                                              
015222              T01CCTR.IDGL,                                               
015225              T01CCTR.DAREGDAT,                                           
015227              T01CCTR.DADELDAT                                            
015230                                                                          
015300     FROM     T01CCTR                                                     
015400                                                                          
015600     WHERE    T01CCTR.DAREGDAT = :WS-DAGENS-DATUM OR                      
015710              T01CCTR.DADELDAT = :WS-DAGENS-DATUM                         
015800                                                                          
016300     ORDER BY T01CCTR.IDLEGSEL,                                           
016410              T01CCTR.IDKST,                                              
016411              T01CCTR.IDGL                                                
016412                                                                          
...
017452     EJECT                                                                
017453                                                                          
017454 DB2-FETCH-CRS-CCTR SECTION.                                              
017500     EXEC SQL FETCH CCTR-CRS INTO                                         
017600            :CCTR-IDLEGSEL,                                               
017701            :CCTR-IDKST,                                                  
017702            :CCTR-IDGL,                                                   
017800            :CCTR-DAREGDAT,                                               
017820            :CCTR-DADELDAT                                                
017900     END-EXEC                                                             
017910                                                                          
...
019088     EJECT                                                                
019089                                                                          
019090 DB2-CLOSE-CRS-CCTR SECTION.                                              
019092     EXEC SQL CLOSE CCTR-CRS                                              
019093     END-EXEC                                                             
019094     .                                                                    
019116     EJECT                                                                
019117                                                                          
