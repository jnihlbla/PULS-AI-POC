...
001400*                                                                         
001430*    E-TRACKER 10143271 - CHINA WAREHOUSE PROJECT-1                       
001440*                                                                         
001500     EJECT                                                                
...
002400     SELECT  W57012        ASSIGN  W57011D1.                              
002500*                                                                         
002600*    ---- UTFIL1                                                          
002700*                            - UPPDATERINGSPOSTER TILL BILLIT             
002800     SELECT  W57013        ASSIGN  W57011D2.                              
002900*    ---- UTFIL2                                                          
003000*                            - TOFS-POSTER TILL                           
003100     SELECT W57011         ASSIGN  W57011D3.                              
003200*                                                                         
...
006400 77  PROGRAM-NAMN            PIC X(8) VALUE 'W5701100'.                   
006500                                                                          
...
009000     03  FILLER                 PIC X(6) VALUE 'W57011'.                  
009100     03  FILLER                 PIC X(8) VALUE 'W57011D1'.                
009200     03  IN-TRANSTYP            PIC X(4) VALUE '    '.                    
009300                                                                          
009400 01  UT-TRANSID.                                                          
009500     03  FILLER                 PIC X(6) VALUE 'W57014'.                  
009600     03  FILLER                 PIC X(8) VALUE 'W57011D2'.                
...
020900                                                                          
021000     OPEN INPUT  W57012                                                   
021100          OUTPUT W57013                                                   
021200          OUTPUT W57011                                                   
021300                                                                          
...
029200     READ W57012 INTO IN-AREA                                             
029300     AT END                                                               
029400         MOVE JA TO INPOST-EOF-SW                                         
029500     NOT AT END                                                           
029600         MOVE 'IN-POST'    TO POSTSUM-TRANSTYP                            
029700         MOVE 'W57011'     TO POSTSUM-FDNAMN                              
029800         MOVE 'W57011D1'   TO POSTSUM-DDNAMN2                             
...
030800     MOVE 'W57013'     TO POSTSUM-FDNAMN                                  
030900     MOVE 'W57011D2'   TO POSTSUM-DDNAMN2                                 
...
031800     MOVE 'W57011'     TO POSTSUM-FDNAMN                                  
031900     MOVE 'W57011D3'   TO POSTSUM-DDNAMN2                                 
