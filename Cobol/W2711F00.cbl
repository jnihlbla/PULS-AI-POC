000100 ID DIVISION.                                                             
000200     SKIP2                                                                
000300 PROGRAM-ID.     W2711F00.                                                
000400*AUTHOR.         JOHAN NIHLBLAD.                                          
000500*DATE-WRITTEN.   210517.                                                  
000600                                                                          
000700*    REMARKS                                                              
000800*                                                                         
000900*    FUNKTION:                                                            
001000*        UPDATES CHANGED PRE PLANNED FACTOR ON WDK7.                      
001400*                                                                         
...
003000     SELECT W2711E                     ASSIGN TO W2711FD1.                
003100     EJECT                                                                
...
003900                                                                          
004000*01  -COPY W2711E      -L.                                                
004100     EJECT                                                                
004200 WORKING-STORAGE SECTION.                                                 
004300     SKIP2                                                                
004400                                                                          
004500*    -- CHECKED BY WY2000                                                 
004600 77  IDPGM                       PIC X(8)    VALUE 'W2711F00'.            
...
006400                                                                          
006500 77  W2711E-EOF-SW               PIC X       VALUE 'N'.                   
006600     88  END-OF-W2711E                       VALUE 'J'.                   
006700                                                                          
...
008900     SKIP2                                                                
009000                                                                          
009100*01  AREA -COPY W2711E     -PRE IN-                                       
009200*                                                                         
009300     EJECT                                                                
...
013700     EJECT                                                                
013800 PROCEDURE DIVISION  USING MSG-PCB WDK7-PCB.                              
013900     ENTRY 'DLITCBL' USING MSG-PCB WDK7-PCB.                              
014000                                                                          
014100     PERFORM A-INIT                                                       
014200     PERFORM S01-LAES-W2711E                                              
014300     PERFORM UNTIL END-OF-W2711E                                          
014400                                                                          
014500       PERFORM B-BEHANDLA-POSTER                                          
014600                                                                          
014700       PERFORM S01-LAES-W2711E                                            
014800                                                                          
014900     END-PERFORM                                                          
...
018300                                                                          
018500     IF SLAG-REPPFAKT = IN-REPPFAKT                                       
018700       CONTINUE                                                           
018800     ELSE                                                                 
018900       MOVE IN-REPPFAKT    TO SLAG-REPPFAKT                               
...
021100     .                                                                    
021200     EJECT                                                                
021300 S01-LAES-W2711E  SECTION.                                                
021400     SKIP2                                                                
021500     READ W2711E INTO IN-AREA                                             
021600     AT END                                                               
021700        SET END-OF-W2711E TO TRUE                                         
021800                                                                          
021900     NOT AT END                                                           
022000        MOVE 'W2711E' TO POSTSUM-FDNAMN                                   
022100        MOVE 'W2711FD1' TO POSTSUM-DDNAMN2                                
