...
002403     SELECT W33530                     ASSIGN TO W33507D1.                
002404     SKIP2                                                                
002405*          --- FIL MED NYA PRISER SAMT TID NÄR MAN SKICKAT PRISET         
002410     SELECT W33507                     ASSIGN TO W33507D2.                
002600     EJECT                                                                
...
003010*01  -COPY W335301A      -L.                                              
003012     SKIP3                                                                
003013 FD  W33507                                                               
003016     RECORDING       V                                                    
003017     BLOCK CONTAINS  0.                                                   
003018                                                                          
003020*01  POST -COPY W335301B -PRE  UT-  -L.                                   
003100     EJECT                                                                
003200 WORKING-STORAGE SECTION.                                                 
003300                                                                          
003301                                                                          
003310*    -- CHECKED BY WY2000                                                 
003400 77  IDPGM                       PIC X(8)    VALUE 'W3350700'.            
003500 77  JA                          PIC X       VALUE 'J'.                   
003600 77  NEJ                         PIC X       VALUE 'N'.                   
003801                                                                          
003802 77  W33530-EOF-SW               PIC X       VALUE 'N'.                   
003810     88  END-OF-W33530                       VALUE 'J'.                   
003900     EJECT                                                                
003901                                                                          
...
006204     SKIP2                                                                
006205                                                                          
006206*01  AREA -COPY W335301A     -PRE IN-                                     
006207     EJECT                                                                
006208 01  UT-AREA-START               PIC X(24)   VALUE                        
006209                                 'UT-AREA-START  '.                       
006210     SKIP2                                                                
006211                                                                          
006220*01  AREA -COPY W335301B     -PRE UT-                                     
006300     EJECT                                                                
...
007010     PERFORM S01-LAES-W33530                                              
007100     PERFORM UNTIL END-OF-W33530                                          
007210       PERFORM C-BEARBETA                                                 
007810       PERFORM S01-LAES-W33530                                            
007900     END-PERFORM                                                          
008000                                                                          
008100                                                                          
...
008901                                                                          
008910     OPEN INPUT  W33530                                                   
009001                                                                          
009010     OPEN OUTPUT W33507                                                   
009100     SKIP2                                                                
...
009543     MOVE IN-IDARTNR                  TO UT-IDARTNR                       
009546     MOVE IN-REARTRAB-DO              TO UT-REARTRAB-DO                   
009547     MOVE IN-REARTRAB-BULK            TO UT-REARTRAB-BULK                 
009572     MOVE WS-TTMMSSTH                 TO UT-TIKLOCK                       
009573     PERFORM S11-SKRIV-W33507                                             
009574     .                                                                    
009580     EJECT                                                                
...
009900     .                                                                    
010001     EJECT                                                                
010002 S01-LAES-W33530  SECTION.                                                
010003     READ W33530 INTO IN-AREA                                             
010004     AT END                                                               
010005        MOVE HIGH-VALUE TO IN-AREA                                        
010006        SET END-OF-W33530 TO TRUE                                         
010007                                                                          
010008     NOT AT END                                                           
010009        MOVE 'W33530' TO POSTSUM-FDNAMN                                   
010010        MOVE 'W33507D1' TO POSTSUM-DDNAMN2                                
010013        MOVE IN-IDVTYP TO POSTSUM-TRANSTYP                                
010014        CALL POSTSUM USING POSTSUM-PARM                                   
010015     END-READ                                                             
010020     .                                                                    
010101     EJECT                                                                
010102 S11-SKRIV-W33507 SECTION.                                                
010103                                                                          
010104     WRITE UT-POST FROM UT-AREA                                           
010105                                                                          
010106     MOVE UT-IDVTYP TO POSTSUM-TRANSTYP                                   
010107     MOVE 'W33507' TO POSTSUM-FDNAMN                                      
010108     MOVE 'W33507D2' TO POSTSUM-DDNAMN2                                   
