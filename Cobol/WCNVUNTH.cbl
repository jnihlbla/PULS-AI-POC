...
000800*                                                                         
000900*    FUNCTION:                                                            
001000*        CONVERSION FROM UNICODE (UCS2 OR UTF8) TO THAI                   
001100*        EBCDIC CODEPAGES (CP838/CS1279 = CCSID 9030                      
001110*        AND CP839/CS929 = CCSID 839)                                     
001120*     NOTE: NO CONVERSION TABLE FOR CP839 EXISTS.                         
001130*        ACCORDING TO IBM CP839 "IS USED FOR PRESENTATION                 
001140*        PURPOSE ONLY" AND IS NOT SUPPORTED BY ANY IBM                    
001150*        PRODUCT AT THE MOMENT. THE CODE TO HANDLE CP839                  
001160*        IS THEREFOR COMMENTED IN THE PROGRAM.                            
001300                                                                          
001400     SKIP3                                                                
...
001900 77  IDPGM                       PIC X(8)    VALUE 'WCNVUNTH'.            
...
003190                                                                          
003191*    -- HELP-FIELD TO HANDLE DIFFERENT BYTE ORDER SCHEMES                 
...
006100*01  -COPY WCNVU838                                                       
006200     EJECT                                                                
006210* FIX -------------                                                       
006300*01  -KOPY WCNVU839                                                       
006310* END-FIX ---------                                                       
...
007700                                                                          
007800*      -- TRY CONVERTING TO SINGLEBYTE CODE (CP838)                       
007900       MOVE TECONV-TEMP (IXF + BO:1)     TO WBYTE                         
008000       ADD  WNUM  1                  GIVING IX0                           
008100       MOVE TAB2-IND-U838 (IX0)          TO IX1                           
008200       MOVE TECONV-TEMP (IXF + 1 - BO:1) TO WBYTE                         
008300       ADD  WNUM  1                  GIVING IX2                           
008400       MOVE UCS-TO-CP838 (IX1, IX2)      TO TEMP-1BYTE                    
008500       IF TEMP-1BYTE = X'3F'                                              
008510* FIX -------------------------                                           
008520* CONVERSION TABLE MISSING                                                
008530         MOVE X'FEFE' TO TEMP-2BYTE                                       
008600*        -- TRY CONVERTING TO DOUBLEBYTE CODE (CP839)                     
008700*        MOVE TECONV-TEMP (IXF + BO:1)     TO WBYTE                       
008800*        ADD  WNUM  1                  GIVING IX0                         
008900*        MOVE TAB2-IND-U839 (IX0)          TO IX1                         
009000*        MOVE TECONV-TEMP (IXF + 1 - BO:1) TO WBYTE                       
009100*        ADD  WNUM  1                  GIVING IX2                         
009200*        MOVE UCS-TO-CP839-X (IX1, IX2)    TO TEMP-2BYTE                  
009210* END-FIX ---------------------                                           
...
012610                                                                          
012620     IF FLUTF8 = JA OR YES                                                
012630*      -- UTF8 - COMPUTE LENGTH OF TEXT IN FROM FIELD                     
012640*      -- (IGNORE TRAILING NULL VALUES)                                   
012650       MOVE ZERO TO UTF8-LENG                                             
012660       INSPECT FUNCTION REVERSE (TECONV-FROM)                             
012670         TALLYING UTF8-LENG FOR LEADING LOW-VALUE                         
012671       IF UTF8-LENG = ZERO                                                
012672*      -- TRY TRAILING SPACE INSTEAD                                      
012673         INSPECT FUNCTION REVERSE (TECONV-FROM)                           
012674           TALLYING UTF8-LENG FOR LEADING SPACE                           
012675       END-IF                                                             
012680       COMPUTE UTF8-LENG = TECONV-LENG - UTF8-LENG                        
012690*      -- CONVERT UTF8 INPUT TO UCS2 BEFORE CONVERTING TO EBCDIC          
012692       MOVE LENGTH OF TECONV-TEMP TO UCS2-LENG                            
012693       CALL WCNVUTFU USING TECONV-FROM UTF8-LENG                          
012694                           TECONV-TEMP UCS2-LENG                          
012695       MOVE UCS2-LENG TO FLENG                                            
012696     ELSE                                                                 
012697*      -- UCS2 - COMPUTE LENGTH OF TEXT IN FROM FIELD                     
012698*      -- (IGNORE TRAILING DOUBLE-BYTE SPACES)                            
012699       MOVE ZERO TO FLENG                                                 
012700       INSPECT FUNCTION REVERSE (TECONV-FROM)                             
012701         TALLYING FLENG FOR LEADING SPACE                                 
012702       COMPUTE FLENG = TECONV-LENG - FLENG                                
012703       MOVE TECONV-FROM          TO TECONV-TEMP                           
012704     END-IF                                                               
012710     .                                                                    
012800     EJECT                                                                
