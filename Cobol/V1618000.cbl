...
000900*REMARKS:                                                                 
001000*                                                                         
001100*  * MAIN MASTER AUTHORITY PANEL                                          
001200*                                                                         
001300*  * DB2-TABLES:                                                          
001400*                                                                         
001500*        EXTRACT_MASTER                                                   
001600*                                                                         
001610*  * SUBPROGRAMS:                                                         
001620*                                                                         
001630*        V16182 V16183 V16185 V16197                                      
001640*                                                                         
001700*                                                                         
001800*  * RETURNCODES:                                                         
001900*                                                                         
...
004400*--------------------------------------------------------------           
004500 01  PROGRAM-NAME                 PIC X(8)  VALUE 'V1618000'.             
...
008100     SKIP2                                                                
008200 01  N-PANEL-V161800M.                                                    
008600     03 N-USERID-1                PIC X(8)  VALUE 'V161800A'.             
008700     03 N-USERID                  PIC X(8)  VALUE 'V161800B'.             
008800     03 N-AUTH                    PIC X(8)  VALUE 'V161800C'.             
008810     03 N-PREFIX                  PIC X(8)  VALUE 'V161800D'.             
008900     03 N-NAME                    PIC X(8)  VALUE 'V161800E'.             
009000     SKIP2                                                                
...
010410     03 LTH-PREFIX                PIC S9(6) VALUE 8  COMP.                
...
011910     03 ISPF-PREFIX               PIC X(8)  VALUE SPACE.                  
012000     03 ISPF-NAME                 PIC X(20) VALUE SPACE.                  
012100 01  DYNAMIC-SUBPROGRAMS.                                                 
012200     03 V161802P                  PIC X(8)  VALUE 'V1618020'.             
012300     03 V161803P                  PIC X(8)  VALUE 'V1618030'.             
012400     03 V161805P                  PIC X(8)  VALUE 'V1618050'.             
012403     03 V16197                    PIC X(8)  VALUE 'V16197  '.             
012404     SKIP2                                                                
012410 01  V16197-PARMS.                                                        
012411     03 V16197-USERID             PIC X(7)  VALUE SPACE.                  
012412     03 V16197-NAME               PIC X(20) VALUE ZERO.                   
012500     SKIP2                                                                
012600*--------------------------------------------------------------           
...
014900*ISPF-FIELDS                                                              
015000*--------------------------------------------------------------           
015200 01  V161800M                     PIC X(8)   VALUE 'V1618000'.            
015300 01  V1618001                     PIC X(8)   VALUE 'V1618001'.            
...
015800     EJECT                                                                
015900 01  EXTMASTTAB.                                                          
016000     03 EXTMASTTAB-NAME           PIC X(8)  VALUE 'V1618000'.             
016100     03 EXTMASTTAB-KEY            PIC X(10)  VALUE                        
016200     '(V161800B)'.                                                        
016300     03 EXTMASTTAB-VAR            PIC X(28) VALUE                         
016400     '(V161800C V161800D V161800E)'.                                      
016500 01  MESSAGES.                                                            
...
018600     END-EXEC.                                                            
019200     EXEC SQL                                                             
019300          INCLUDE EXTMAST                                                 
019400     END-EXEC.                                                            
019500*    -COPY EXTMAST -PRE EXTMAST-                                          
020100     EJECT                                                                
020800*************************************************************             
...
022700              CALL 'ISPLINK' USING TBDISPL EXTMASTTAB-NAME                
022800           ELSE                                                           
...
025200     PERFORM AC-VDEF-PANEL-V161800M                                       
...
028900     EJECT                                                                
029000*--------------------------------------------------------------           
029100 AC-VDEF-PANEL-V161800M SECTION.                                          
029200*--------------------------------------------------------------           
029300     MOVE 'AC-VDEF-PANEL-V161800M    ' TO ABEND-SECTION                   
...
030810     CALL 'ISPLINK' USING VDEFINE N-PREFIX ISPF-PREFIX                    
030820                          CHAR LTH-PREFIX                                 
...
033900       PERFORM CL-LOAD-EXTMAST                                            
034000     END-IF                                                               
...
035100     END-IF                                                               
035110D    DISPLAY 'USERID-1 ' ISPF-USERID-1                                    
035200     CONTINUE.                                                            
035300     EJECT                                                                
035400*--------------------------------------------------------------           
...
036700       WHEN 'C' PERFORM CC-CREATE-EXTMAST                                 
036800       WHEN 'U' PERFORM CU-UPDATE-EXTMAST                                 
036900       WHEN 'D' PERFORM CD-DELETE-EXTMAST                                 
037000       WHEN OTHER                                                         
...
037700     EJECT                                                                
037800*--------------------------------------------------------------           
037900 CL-LOAD-EXTMAST SECTION.                                                 
038000*--------------------------------------------------------------           
038100     MOVE 'CL-LOAD-EXTMAST       ' TO ABEND-SECTION                       
038200D    DISPLAY ABEND-SECTION                                                
038300     SKIP2                                                                
038400     PERFORM S01-TBCREATE-ISPFTAB                                         
038500     IF SW-ERROR = NOO                                                    
038600        PERFORM SQL-DECLARE-OPEN-EXTMAST                                  
038700        IF SQLCODE = +000                                                 
038800           PERFORM SQL-FETCH-EXTMAST                                      
038900           IF SQLCODE = +100                                              
039000              MOVE MSG-VIOS101O  TO ISPF-MSG-ID                           
039100           END-IF                                                         
039200           PERFORM UNTIL SQLCODE NOT = +000                               
039300             MOVE EXTMAST-USERID TO V16197-USERID, ISPF-USERID            
039410             MOVE EXTMAST-AUTH TO ISPF-AUTH                               
039500             MOVE EXTMAST-PREFIX        TO ISPF-PREFIX                    
039502             CALL V16197 USING V16197-USERID                              
039503                               V16197-NAME                                
039504             IF RETURN-CODE = 0 THEN                                      
039505               MOVE V16197-NAME      TO ISPF-NAME                         
039506             ELSE                                                         
039507               MOVE 'NAME NOT FOUND' TO ISPF-NAME                         
039508             END-IF                                                       
040100             PERFORM S01-TBADD-ISPFTAB                                    
040200             PERFORM SQL-FETCH-EXTMAST                                    
040300           END-PERFORM                                                    
040400        END-IF                                                            
040500        PERFORM SQL-CLOSE-EXTMAST                                         
...
041000     EJECT                                                                
041100*--------------------------------------------------------------           
041200 CC-CREATE-EXTMAST SECTION.                                               
041300*--------------------------------------------------------------           
041400     MOVE 'CC-CREATE-EXTMAST     ' TO ABEND-SECTION                       
041500D    DISPLAY ABEND-SECTION                                                
041600     SKIP2                                                                
041700D    DISPLAY 'W-USERID ' W-USERID                                         
041900     CALL V161802P USING W-USERID                                         
...
043700     SKIP2                                                                
043800     PERFORM SQL-SELECT-EXTMAST                                           
043900     IF SQLCODE = +000                                                    
043910       MOVE W-USERID              TO V16197-USERID, ISPF-USERID           
043912       MOVE EXTMAST-AUTH TO ISPF-AUTH                                     
043913       MOVE EXTMAST-PREFIX        TO ISPF-PREFIX                          
043917       CALL V16197 USING V16197-USERID                                    
043918                         V16197-NAME                                      
043919       IF RETURN-CODE = 0 THEN                                            
043920         MOVE V16197-NAME      TO ISPF-NAME                               
043921       ELSE                                                               
043922         MOVE 'NAME NOT FOUND' TO ISPF-NAME                               
043923       END-IF                                                             
...
044700     EJECT                                                                
044800*--------------------------------------------------------------           
044900 CU-UPDATE-EXTMAST SECTION.                                               
045000*--------------------------------------------------------------           
045100     MOVE 'CU-UPDATE-EXTMAST     ' TO ABEND-SECTION                       
045200D    DISPLAY ABEND-SECTION                                                
045300     SKIP2                                                                
045400     CALL V161803P USING W-USERID                                         
...
047200     SKIP2                                                                
047300     PERFORM SQL-SELECT-EXTMAST                                           
047400     IF SQLCODE = +000                                                    
047500       MOVE W-USERID              TO ISPF-USERID                          
047600       PERFORM S01-TBGET-ISPFTAB                                          
047700       IF RCODE = 0                                                       
047800         MOVE EXTMAST-AUTH TO ISPF-AUTH                                   
047810         MOVE EXTMAST-PREFIX        TO ISPF-PREFIX                        
...
048500     EJECT                                                                
048600*--------------------------------------------------------------           
048700 CD-DELETE-EXTMAST SECTION.                                               
048800*--------------------------------------------------------------           
048900     MOVE 'CD-DELETE-EXTMAST     ' TO ABEND-SECTION                       
049000D    DISPLAY ABEND-SECTION                                                
049100     SKIP2                                                                
049200     CALL V161805P USING W-USERID                                         
...
054200     SKIP2                                                                
054300     MOVE V1618001 TO ISPF-PANEL                                          
...
056200     PERFORM ZB-VDEL-PANEL-V161800M                                       
...
057700     EJECT                                                                
057800*--------------------------------------------------------------           
057900 ZB-VDEL-PANEL-V161800M SECTION.                                          
058000*--------------------------------------------------------------           
058100     MOVE 'ZB-VDEL-PANEL-V161800M  ' TO ABEND-SECTION                     
058200D    DISPLAY ABEND-SECTION                                                
058300     SKIP2                                                                
058500     CALL 'ISPLINK' USING VDELETE N-PREFIX                                
...
061500                          EXTMASTTAB-NAME                                 
061600                          EXTMASTTAB-KEY                                  
061700                          EXTMASTTAB-VAR                                  
061800                          TABNOW                                          
061900                          TABREP                                          
...
063500     SKIP2                                                                
063600     CALL 'ISPLINK' USING TBDISPL EXTMASTTAB-NAME V161800M                
063700                          ISPF-MSG-ID                                     
...
078300     EJECT                                                                
079900*--------------------------------------------------------------           
080000 SQL-SELECT-EXTMAST SECTION.                                              
080100*--------------------------------------------------------------           
080200     MOVE 'SQL-SELECT-EXTMAST          ' TO ABEND-SECTION                 
080300D    DISPLAY ABEND-SECTION                                                
080400     SKIP2                                                                
080500     EXEC SQL                                                             
080600        SELECT AUTH,PREFIX                                                
080700        INTO :EXTMAST-AUTH, :EXTMAST-PREFIX                               
080800        FROM EXTRACT_MASTER                                               
080900        WHERE USERID    = :W-USERID                                       
081100     END-EXEC                                                             
081200     PERFORM S95-CONTROL-SQLCODE                                          
081300     CONTINUE.                                                            
081400     EJECT                                                                
081500*--------------------------------------------------------------           
081600 SQL-DECLARE-OPEN-EXTMAST SECTION.                                        
081700*--------------------------------------------------------------           
081800     MOVE 'SQL-DECLARE-OPEN-EXTMAST    ' TO ABEND-SECTION                 
081900D    DISPLAY ABEND-SECTION                                                
082000     SKIP2                                                                
082100     EXEC SQL                                                             
082200         DECLARE CRS-EXTMAST-1 CURSOR FOR                                 
082300         SELECT USERID, AUTH, PREFIX                                      
082400         FROM EXTRACT_MASTER                                              
082600     END-EXEC                                                             
082700     EXEC SQL                                                             
082800         OPEN CRS-EXTMAST-1                                               
082900     END-EXEC                                                             
083000     PERFORM S95-CONTROL-SQLCODE                                          
083100     CONTINUE.                                                            
083200     EJECT                                                                
083300*--------------------------------------------------------------           
083400 SQL-FETCH-EXTMAST SECTION.                                               
083500*--------------------------------------------------------------           
083600     MOVE 'SQL-FETCH-EXTMAST           ' TO ABEND-SECTION                 
083700D    DISPLAY ABEND-SECTION                                                
083800     SKIP2                                                                
083900     EXEC SQL                                                             
084000         FETCH CRS-EXTMAST-1 INTO :EXTMAST-USERID,                        
084010                                  :EXTMAST-AUTH,                          
084100                                  :EXTMAST-PREFIX                         
084200     END-EXEC                                                             
084300     PERFORM S95-CONTROL-SQLCODE                                          
084400     CONTINUE.                                                            
084500     EJECT                                                                
084600*--------------------------------------------------------------           
084700 SQL-CLOSE-EXTMAST SECTION.                                               
084800*--------------------------------------------------------------           
084900     MOVE 'SQL-CLOSE-EXTMAST           ' TO ABEND-SECTION                 
085000D    DISPLAY ABEND-SECTION                                                
085100     SKIP2                                                                
085200     EXEC SQL                                                             
085300         CLOSE CRS-EXTMAST-1                                              
085400     END-EXEC                                                             
...
086800     CONTINUE.                                                            
086900     EJECT                                                                
087000*-------------------------------- DB2 ERRORHANTERING SEKTION              
087100*    -COPY V161PS                                                         
