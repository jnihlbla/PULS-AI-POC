000100 ID DIVISION.                                                             
000300 PROGRAM-ID.     W0153600.                                                
000400 AUTHOR.         KJELL ANDRE.                                             
000500 DATE-WRITTEN.   96/12/10.                                                
...
001600*                                                                         
002000*        PROGRAMMET UPPDATERAR WLFILA (WDR6)                              
002100*                                                                         
002500                                                                          
...
003400     SELECT W01536                     ASSIGN TO W01536D1.                
003500                                                                          
003800     EJECT                                                                
...
005720                                                                          
005800 77  IDPGM                       PIC X(8)    VALUE 'W0153600'.            
005900 01  CHKP-VAR.                                                            
...
007200                                                                          
007300 77  W01536-EOF-SW               PIC X       VALUE 'N'.                   
007400     88  END-OF-W01536                       VALUE 'J'.                   
007410                                                                          
007500                                                                          
...
009300                                                                          
009400*01  AREA -COPY WDR601  -L   -PRE RENS-                                   
009500*                                                                         
009900                                                                          
010300     EJECT                                                                
...
010700     03  W-WDR601KY-X.                                                    
010800         05  W-WDR601KY          PIC X(27)    VALUE SPACE.                
010900                                                                          
010910                                                                          
...
012800                                                                          
012900 01  FILLER         PIC X(24) VALUE 'DLI-IO-WLFILA01'.                    
013000 01  DLI-IO-WLFILA01.                                                     
013100*    03  -COPY WDR601    -PRE FILA-                                       
013300                                                                          
013400     EJECT                                                                
013500 LINKAGE SECTION.                                                         
013700*01  -COPY W0009  -PRE MSG-                                               
013800                                                                          
013900*01  -COPY W0008  -PRE FILA-                                              
014000     05  FILLER                  PIC X.                                   
014100     EJECT                                                                
014200 PROCEDURE DIVISION  USING MSG-PCB FILA-PCB.                              
014300 MAIN SECTION.                                                            
014400     ENTRY 'DLITCBL' USING MSG-PCB FILA-PCB.                              
014500                                                                          
014700     PERFORM A-INIT                                                       
014800     PERFORM S01-LAES-W01536                                              
014900     PERFORM UNTIL END-OF-W01536                                          
015000       IF CHKP-ANT > CHKP-MAX                                             
015100         PERFORM X-TAG-CHECKPOINT                                         
015200       END-IF                                                             
015300       PERFORM B-LAES-RENSA-TRANS                                         
015400                                                                          
015500       PERFORM S01-LAES-W01536                                            
015600     END-PERFORM                                                          
015700                                                                          
015800                                                                          
...
018800                                                                          
018900     MOVE RENS-AREA TO W-WDR601KY                                         
019000     PERFORM IMS-GET-FILA-FIL                                             
019100     IF SEGMENT-FINNS                                                     
019200       PERFORM IMS-DLET-FILA-FIL                                          
...
020800     .                                                                    
020900     EJECT                                                                
021000 S01-LAES-W01536  SECTION.                                                
021100                                                                          
021200     READ W01536 INTO RENS-AREA                                           
021300     AT END                                                               
021400        MOVE HIGH-VALUE TO RENS-AREA                                      
021500        MOVE JA TO W01536-EOF-SW                                          
021700     NOT AT END                                                           
...
023400                                                                          
023500 IMS-GET-FILA-FIL SECTION.                                                
023600                                                                          
023700     STRING 'WDR601  (WDR601KY =' W-WDR601KY-X ')'                        
023800          DELIMITED BY SIZE INTO SSA1                                     
023900     MOVE '  GE' TO GODK-STATUSKODER                                      
024000     CALL CBLTDLI USING GHU FILA-PCB DLI-IO-WLFILA01 SSA1                 
024100     MOVE FILA-STATUS-CODE TO STATUS-WS                                   
024200     PERFORM IMS-STATUSKONTROLL                                           
024300     .                                                                    
024310                                                                          
024400                                                                          
024500 IMS-DLET-FILA-FIL SECTION.                                               
024600                                                                          
024700     MOVE '  ' TO GODK-STATUSKODER                                        
024800     CALL CBLTDLI USING DLET FILA-PCB DLI-IO-WLFILA01                     
024900     MOVE FILA-STATUS-CODE TO STATUS-WS                                   
