001100 ID DIVISION.                                                             
001200 PROGRAM-ID.     W1168500.                                                
001300 AUTHOR.         LINDAHL BODIL.                                           
001400 DATE-WRITTEN.   05/08/18.                                                
001500 DATE-COMPILED.                                                           
001600                                                                          
001700*    FUNKTION:                                                            
001800*        SB NEDLÄSNING WDF5                                               
001900*                                                                         
002010*        PROGRAMMET LÄSER      WDF5                                       
002100*                                                                         
002200*    ABENDKODER:                                                          
002300*        U0016 -  . . . .                                                 
002400*        U1000 -  . . . .                                                 
...
003301     SKIP2                                                                
003302*          --- NEDLÄST WDF5                                               
003310     SELECT W11685                     ASSIGN TO W11685D1.                
003500     EJECT                                                                
...
003905                                                                          
003910001  POST -COPY W11685 -PRE  UT-  -L.                                     
004000     EJECT                                                                
004100 WORKING-STORAGE SECTION.                                                 
004200                                                                          
004300 77  IDPGM                       PIC X(8)    VALUE 'W1168500'.            
...
007304     SKIP2                                                                
007310*01  AREA -COPY W11685    -PRE UT-                                        
007400     EJECT                                                                
...
009901 01  FILLER         PIC X(16) VALUE 'DLI-IO-WDF5'.                        
009902 01  DLI-IO-AREA     PIC X(200).                                          
009903     SKIP3                                                                
009904*01  WDF501      -COPY WDF501  -RED DLI-IO-AREA.                          
009905     EJECT                                                                
009906*01  WDF502      -COPY WDF502  -RED DLI-IO-AREA.                          
009907     EJECT                                                                
010300 LINKAGE SECTION.                                                         
010502*01  -COPY W0008  -PRE WDF5-                                              
010510     05  FILLER                  PIC X.                                   
010600     EJECT                                                                
010701 PROCEDURE DIVISION  USING WDF5-PCB.                                      
010702 MAIN SECTION.                                                            
010710     ENTRY 'DLITCBL' USING WDF5-PCB.                                      
010800                                                                          
011100     PERFORM A-INIT                                                       
011200                                                                          
011301     PERFORM IMS-GET-WDF5                                                 
011302     PERFORM UNTIL SEGMENT-SAKNAS                                         
011303       EVALUATE WDF5-SEG-NAME-FB                                          
011304         WHEN 'WDF501'                                                    
011305           PERFORM B-FLYTTA-WDF501                                        
011306         WHEN 'WDF502'                                                    
011307           PERFORM C-FLYTTA-WDF502                                        
011308       END-EVALUATE                                                       
011309       PERFORM IMS-GET-WDF5                                               
011310     END-PERFORM                                                          
...
012201                                                                          
012210     OPEN OUTPUT W11685                                                   
012400     ACCEPT DAGENS-DATUM  FROM DATE                                       
012510     MOVE IDPGM TO POSTSUM-PROGNAMN                                       
012700     .                                                                    
012800     SKIP3                                                                
012810 B-FLYTTA-WDF501 SECTION.                                                 
012811                                                                          
012812     MOVE XART-IDARTNR TO UT-IDARTNR                                      
012820     .                                                                    
012830     SKIP3                                                                
012840 C-FLYTTA-WDF502 SECTION.                                                 
012850                                                                          
012851     MOVE XLEV-IDLEVNR  TO UT-IDLEVNR                                     
012852     MOVE XLEV-IDBENR   TO UT-IDBENR                                      
012853     MOVE XLEV-BELEVART TO UT-BELEVART                                    
012854     PERFORM S11-SKRIV-W11685                                             
012855     .                                                                    
012860     EJECT                                                                
...
013200     .                                                                    
013401     SKIP3                                                                
013402 S11-SKRIV-W11685 SECTION.                                                
013403                                                                          
013404     WRITE UT-POST FROM UT-AREA                                           
013405                                                                          
013406     MOVE SPACE      TO POSTSUM-TRANSTYP                                  
013407     MOVE 'W11685'   TO POSTSUM-FDNAMN                                    
013408     MOVE 'W11685D1' TO POSTSUM-DDNAMN2                                   
013409     CALL POSTSUM USING POSTSUM-PARM                                      
013410     .                                                                    
014200     EJECT                                                                
014300* --- IMS SEKTIONER ---                                                   
014501*                                                                         
014502 IMS-GET-WDF5   SECTION.                                                  
014504     CALL CBLTDLI USING GN WDF5-PCB DLI-IO-AREA                           
014505     MOVE WDF5-STATUS-CODE TO STATUS-WS                                   
