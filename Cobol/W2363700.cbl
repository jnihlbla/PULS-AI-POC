...
002400     SKIP2                                                                
002500*          --- LISTUNDERLAG                                               
002600     SELECT W23636                     ASSIGN TO W23637D1.                
002700     SKIP2                                                                
002800*          --- LISTA LEVERANSPRECISION/STYCK                              
002900     SELECT W23637-001                 ASSIGN TO W23637D2.                
003000     EJECT                                                                
...
004000     SKIP3                                                                
004100 FD  W23637-001                                                           
004200     RECORDING       F                                                    
004300     BLOCK CONTAINS  0.                                                   
004400     SKIP2                                                                
004500 01  W23637-001-RAD              PIC X(121).                              
004600     EJECT                                                                
004700 WORKING-STORAGE SECTION.                                                 
004800                                                                          
004900 77  IDPGM                       PIC X(8)    VALUE 'W2363700'.            
...
007320     03  TOT-ANTAL               PIC 9(5)     VALUE ZERO.                 
007330     03  TOT-ANTAL-X             PIC 9(5)     VALUE ZERO.                 
007340     03  TOT-TOTSUM              PIC 9(8)V99  VALUE ZERO.                 
007350     03  FILLER OCCURS 13.                                                
007360         05  TOT-SUM             PIC 9(8)V99  VALUE ZERO.                 
007370     03  FILLER OCCURS 13.                                                
007380         05  TOT-PROC            PIC 9(8)V99  VALUE ZERO.                 
007390     03  TOT-RATT                PIC 999V99   VALUE ZERO.                 
007391     03  TOT-TIDIGA              PIC 999V99   VALUE ZERO.                 
007392     03  TOT-SENA                PIC 999V99   VALUE ZERO.                 
...
009800*                                                                         
009900 01  PROGRAM-NAMN                PIC X(6)    VALUE 'W23637'.              
010000     SKIP2                                                                
...
012300     03  W001-LISTNR             PIC X(11)   VALUE 'W23637-001'.          
...
013700                                 VALUE 'W23637-001'.                      
013800     03  FILLER                  PIC X(54)                                
013900         VALUE 'DELIVERY PRECISION IN % OF QUANTITY'.                     
...
015000                           VALUE ' AVVIKELSE I DAGAR '.                   
015100     SKIP2                                                                
...
021401     03  FILLER                  PIC X(1)   VALUE SPACE.                  
021410     03  W001-TOTSUM             PIC Z(7)   VALUE ZERO.                   
...
022640     03  W001-IDLEVNR-TOT        PIC X(5)   VALUE SPACE.                  
022660     03  W001-TOTSUM-TOT         PIC Z(8)   VALUE ZERO.                   
...
024400                                                                          
024500       PERFORM S01-LAES-W23636                                            
024600     END-PERFORM                                                          
...
025700                                                                          
025800     OPEN INPUT  W23636                                                   
025900                                                                          
026000     OPEN OUTPUT W23637-001                                               
026100     SKIP2                                                                
...
038700     PERFORM S21-SKRIV-W23637-001                                         
039100     .                                                                    
039200     EJECT                                                                
...
039302     END-PERFORM                                                          
039307                                                                          
039308     PERFORM DA-SKRIV-SNITTAVVIKELSE                                      
039309                                                                          
039323     .                                                                    
039324     EJECT                                                                
039325 DA-SKRIV-SNITTAVVIKELSE SECTION.                                         
039326                                                                          
039327     MOVE 'TOTAL'         TO W001-IDLEVNR-TOT                             
039328                                                                          
039329     IF TOT-TOTSUM > ZERO                                                 
039330        COMPUTE TOT-SNITT ROUNDED =                                       
039331                               TOT-SUMVIKT / TOT-TOTSUM                   
039332     ELSE                                                                 
039333        MOVE ZERO            TO TOT-SNITT                                 
039334     END-IF                                                               
039335     MOVE TOT-SNITT          TO W001-SNITTAVV-TOT                         
039336     MOVE TOT-TOTSUM         TO W001-TOTSUM-TOT                           
039337     MOVE TOT-PROC (7)       TO W001-RATT-TOT                             
039338     MOVE ZERO               TO TOT-SENA TOT-TIDIGA                       
039339                                                                          
039340     MOVE +8                 TO IX-DEL                                    
039341     PERFORM UNTIL IX-DEL > 13                                            
039342        ADD TOT-PROC(IX-DEL) TO TOT-SENA                                  
039343        ADD +1               TO IX-DEL                                    
039344     END-PERFORM                                                          
039345     MOVE TOT-SENA            TO W001-SENA-TOT                            
039346                                                                          
039347     MOVE +1                 TO IX-DEL                                    
039348     PERFORM UNTIL IX-DEL > 6                                             
039349        ADD TOT-PROC(IX-DEL) TO TOT-TIDIGA                                
039350        ADD +1               TO IX-DEL                                    
039351     END-PERFORM                                                          
039352     MOVE TOT-TIDIGA         TO W001-TIDIGA-TOT                           
039353     MOVE W001-SNITT-TOT     TO W001-RAD                                  
039354     MOVE 50                 TO W001-RADRAKNARE                           
039355                                                                          
039356     PERFORM S21-SKRIV-W23637-001                                         
039357                                                                          
039359     .                                                                    
039360     EJECT                                                                
039370 Z-FINIT SECTION.                                                         
039400                                                                          
039500     CLOSE W23636                                                         
039600           W23637-001                                                     
039700     SKIP2                                                                
...
040000     .                                                                    
040100     EJECT                                                                
040200 S01-LAES-W23636  SECTION.                                                
040300     READ W23636 INTO IN-AREA                                             
040400     AT END                                                               
040500        SET END-OF-W23636 TO TRUE                                         
040600                                                                          
040700     NOT AT END                                                           
040800        MOVE 'W23636'   TO POSTSUM-FDNAMN                                 
040900        MOVE 'W23637D1' TO POSTSUM-DDNAMN2                                
041000        MOVE 'IN'       TO POSTSUM-TRANSTYP                               
041100        CALL POSTSUM USING POSTSUM-PARM                                   
041200     END-READ                                                             
041300     .                                                                    
041400     EJECT                                                                
041500 S21-SKRIV-W23637-001  SECTION.                                           
041600                                                                          
...
042000     END-IF                                                               
042100     SKIP2                                                                
042200     WRITE W23637-001-RAD FROM W001-RAD AFTER W001-SKIP                   
042300     SKIP2                                                                
042400     MOVE SPACE TO W001-RAD                                               
042500     ADD  +2 TO W001-RADRAKNARE                                           
042600     .                                                                    
042700     EJECT                                                                
042800 S21S-SKRIV-W23637-001  SECTION.                                          
042900                                                                          
...
043300     END-IF                                                               
043400     SKIP2                                                                
043500     WRITE W23637-001-RAD FROM W001-RAD AFTER W001-SKIP                   
043600     SKIP2                                                                
...
044500     WRITE W23637-001-RAD FROM W001-RUBRIK1 AFTER PAGE                    
044600     WRITE W23637-001-RAD FROM W001-RUBRIKA AFTER 2                       
044700     WRITE W23637-001-RAD FROM W001-RUBRIKB AFTER 1                       
