001000 ID DIVISION.                                                             
001100                                                                          
001200 PROGRAM-ID.     W4269800.                                                
001300 AUTHOR.         KENT JEBSEN.                                             
001400 DATE-WRITTEN.   00/09/18.                                                
001500 DATE-COMPILED.                                                           
001600                                                                          
001700*    FUNKTION:                                                            
001800*        LÄSER KRL-TRANSAR FRÅN WDR3 (W602KRUP) OCH SKRIVER UT DEM        
001900*        PÅ FIL FÖR UTSKRIFT AV FELLISTA: "ARTIKLAR UTAN                  
001901*        INKÖPSPRIS" I SENARE PROGRAM.                                    
...
002120*        PROGRAMMET ÄR EN MODIFIERAD KOPIA AV W42693.                     
002200*                                                                         
002300                                                                          
002800     SKIP3                                                                
...
003401     SKIP2                                                                
003402*          --- KRL-TRANSAR                                                
003403     SELECT W42698                     ASSIGN TO W42698D1.                
003404     SKIP2                                                                
003408*          --- LOGG PÅ TRANSAR SOM SKA TAS BORT                           
003410     SELECT W42699                     ASSIGN TO W42698D2.                
003600     EJECT                                                                
...
004005                                                                          
004006*01  POST -COPY W426PKR  -PRE KRL-   -L.                                  
004007     SKIP3                                                                
004014 FD  W42699                                                               
004015     RECORDING       F                                                    
...
004320                                                                          
004400 77  IDPGM                       PIC X(8)    VALUE 'W4269800'.            
004410 01  FELTEXT.                                                             
...
007301     EJECT                                                                
007307 01  KRL-AREA-START               PIC X(24)   VALUE                       
007308                                 'KRL-AREA-START   '.                     
007309     SKIP2                                                                
007311*01  AREA -COPY W426PKR     -PRE KRL-                                     
007312     EJECT                                                                
...
008101     03  W-IDCPYTXT-EK-X         PIC X(8)    VALUE 'W426PKR '.            
008200     SKIP2                                                                
...
010900                                                                          
011110*    -- LÄS ALLA KRL-TRANSAR OCH SKRIV UT DEM                             
...
011502       WHEN 'W426PKR '                                                    
011510         MOVE FILC-FIL-WDR301-DATA TO KRL-AREA                            
011600         PERFORM S11-SKRIV-W42698-KRL                                     
011601                                                                          
011602         MOVE FILC-FIL-WDR301 TO LOGG-AREA                                
011603         PERFORM S12-SKRIV-W42699-LOGG                                    
011604                                                                          
011605       END-EVALUATE                                                       
011606                                                                          
...
014300     .                                                                    
014501     EJECT                                                                
014502 S11-SKRIV-W42698-KRL   SECTION.                                          
014503                                                                          
014504     WRITE KRL-POST  FROM KRL-AREA                                        
014505                                                                          
014506     MOVE 'KRL'      TO POSTSUM-TRANSTYP                                  
014507     MOVE 'W42698'   TO POSTSUM-FDNAMN                                    
014508     MOVE 'W42698D1' TO POSTSUM-DDNAMN2                                   
014509     CALL POSTSUM USING POSTSUM-PARM                                      
014510     .                                                                    
014511     EJECT                                                                
014522 S12-SKRIV-W42699-LOGG SECTION.                                           
014523                                                                          
014524     WRITE LOGG-POST FROM LOGG-AREA                                       
014525                                                                          
014526     MOVE SPACE      TO POSTSUM-TRANSTYP                                  
014527     MOVE 'W42699'   TO POSTSUM-FDNAMN                                    
014528     MOVE 'W42698D2' TO POSTSUM-DDNAMN2                                   
