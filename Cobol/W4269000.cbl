001000 ID DIVISION.                                                             
001100                                                                          
001200 PROGRAM-ID.     W4269000.                                                
001300 AUTHOR.         KJELL ANDRE.                                             
001400 DATE-WRITTEN.   96/12/10.                                                
001500 DATE-COMPILED.                                                           
001600                                                                          
001700*    FUNKTION:                                                            
001800*        LÄSER KRF-TRANSAR (FAKTUROR)                                     
...
003401     SKIP2                                                                
003402*          --- KRF-TRANSAR                                                
003403     SELECT W42690                     ASSIGN TO W42690D1.                
003404     SKIP2                                                                
003408*          --- LOGG PÅ TRANSAR SOM SKA TAS BORT                           
003410     SELECT W42692                     ASSIGN TO W42690D2.                
003600     EJECT                                                                
...
004005                                                                          
004006*01  POST -COPY W426PKRF  -PRE KRF-   -L.                                 
004007     SKIP3                                                                
004014 FD  W42692                                                               
004015     RECORDING       F                                                    
...
004320                                                                          
004400 77  IDPGM                       PIC X(8)    VALUE 'W4269000'.            
004420 01  FELTEXT.                                                             
...
007301     EJECT                                                                
007307 01  KRF-AREA-START              PIC X(24)   VALUE                        
007308                                 'KRF-AREA-START  '.                      
007309     SKIP2                                                                
007311*01  AREA -COPY W426PKRF   -PRE KRF-                                      
007312     EJECT                                                                
...
008101     03  W-IDCPYTXT-KRF-X        PIC X(8)    VALUE 'W426PKRF'.            
008102     03  W-IDKR-X.                                                        
...
011410       MOVE FILC-FIL-WDR301-DATA TO KRF-AREA                              
011502       MOVE KRF-KRF-IDKR TO W-IDKR                                        
011503       PERFORM IMS-GU-W6H701                                              
011504       IF SEGMENT-FINNS                                                   
011505         PERFORM S11-SKRIV-W42690-KRF                                     
011506         MOVE FILC-FIL-WDR301 TO LOGG-AREA                                
011507         PERFORM S13-SKRIV-W42692-LOGG                                    
011521       ELSE                                                               
011522         STRING ' KR SAKNAS PÅ W6H7: ' KRF-KRF-IDKR                       
...
013302     OPEN OUTPUT W42690 W42692                                            
013400                                                                          
013610     MOVE IDPGM TO POSTSUM-PROGNAMN                                       
013800     .                                                                    
013900     EJECT                                                                
014000 Z-FINIT SECTION.                                                         
014101     CLOSE W42690 W42692                                                  
014201     SKIP2                                                                
014202     MOVE 'S' TO POSTSUM-OPKOD                                            
014210     CALL POSTSUM USING POSTSUM-PARM                                      
014300     .                                                                    
014501     EJECT                                                                
014502 S11-SKRIV-W42690-KRF   SECTION.                                          
014503                                                                          
014504     WRITE KRF-POST FROM KRF-AREA                                         
014505                                                                          
014506     MOVE KRF-KRF-IDPTYP TO POSTSUM-TRANSTYP                              
014507     MOVE 'W42690'       TO POSTSUM-FDNAMN                                
014508     MOVE 'W42690D1'     TO POSTSUM-DDNAMN2                               
014509     CALL POSTSUM     USING POSTSUM-PARM                                  
014510     .                                                                    
014511     EJECT                                                                
014522 S13-SKRIV-W42692-LOGG SECTION.                                           
014523                                                                          
014524     WRITE LOGG-POST FROM LOGG-AREA                                       
014525                                                                          
014526     MOVE SPACE      TO POSTSUM-TRANSTYP                                  
014527     MOVE 'W42692'   TO POSTSUM-FDNAMN                                    
014528     MOVE 'W42690D2' TO POSTSUM-DDNAMN2                                   
