...
008000     SELECT W55302                     ASSIGN TO W55313D1.                
008100     SKIP2                                                                
008200*          --- FELLISTA VCC REPORT1 TO BE SENT OUT BY EMAIL (D&P)         
008300     SELECT W55313A                    ASSIGN TO W55313D2.                
008400     SKIP2                                                                
008500*          --- VARNINGSLISTA VCC REPORT2 TO BE SENT BY (D&P)              
008600     SELECT W55313B                    ASSIGN TO W55313D3.                
008700     SKIP2                                                                
008800*          --- KONTROLLERADE POSTER (PV-INKÖP)                            
008900     SELECT W55313                     ASSIGN TO W55313D4.                
009000     EJECT                                                                
...
009800                                                                          
009900*01  -COPY W55302     -PRE INFIL-  -L.                                    
010000     SKIP2                                                                
010100 FD  W55313A                                                              
010200     RECORDING       V                                                    
010300     BLOCK CONTAINS  0.                                                   
010400                                                                          
010500 01  W55313A-RAD                 PIC X(191).                              
010600     SKIP2                                                                
010700 FD  W55313B                                                              
010800     RECORDING       V                                                    
010900     BLOCK CONTAINS  0.                                                   
011000                                                                          
011100 01  W55313B-RAD                 PIC X(224).                              
011200     SKIP2                                                                
011300 FD  W55313                                                               
011400     RECORDING       F                                                    
...
012200     SKIP3                                                                
012300 77  IDPGM                       PIC X(8)    VALUE 'W5531300'.            
...
012800                                                                          
012900 77  W55302-EOF-SW               PIC X       VALUE 'N'.                   
013000     88  END-OF-W55302                       VALUE 'J'.                   
...
019900*                                                                         
020000 01  PROGRAM-NAMN                PIC X(6)    VALUE 'W55313'.              
020100                                                                          
...
034300                                                                          
034400*01  AREA -COPY W55302        -PRE WIN-                                   
034500     EJECT                                                                
...
043300                                                                          
043400     PERFORM S01-LAS-W55302                                               
043500     PERFORM UNTIL END-OF-W55302                                          
...
047500                                                                          
047600     OPEN INPUT  W55302                                                   
047700                                                                          
047800     OPEN OUTPUT W55313                                                   
047900                 W55313A                                                  
048000                 W55313B                                                  
048100                                                                          
...
054701*** THERE SHOULD AREADY BE A COMMA IN THE PRICE                           
054710     COMPUTE WS-PRARTBEL = WIN-PRARTBEL / 1                               
054800                                                                          
...
105800     END-IF                                                               
105900     PERFORM S02-SKRIV-W55313                                             
106000     .                                                                    
106100     EJECT                                                                
...
114100     .                                                                    
114200     SKIP3                                                                
114300 S01-LAS-W55302   SECTION.                                                
114400                                                                          
114500     READ W55302 INTO WIN-AREA                                            
114600     AT END                                                               
114700         SET END-OF-W55302 TO TRUE                                        
114800     NOT AT END                                                           
114900         MOVE WIN-IDPTYP  TO POSTSUM-TRANSTYP                             
115000         MOVE 'W55302'    TO POSTSUM-FDNAMN                               
115100         MOVE 'W55313D1'  TO POSTSUM-DDNAMN2                              
115200         CALL POSTSUM USING POSTSUM-PARM                                  
115300     END-READ                                                             
115400     .                                                                    
115500     SKIP3                                                                
115600 S02-SKRIV-W55313 SECTION.                                                
115700                                                                          
115800     WRITE W553-POST FROM WUT-AREA                                        
115900                                                                          
116000     MOVE ' UT '      TO POSTSUM-TRANSTYP                                 
116100     MOVE 'W55313'    TO POSTSUM-FDNAMN                                   
116200     MOVE 'W55313D4'  TO POSTSUM-DDNAMN2                                  
...
117800           WRITE W55313A-RAD FROM W001-DAP                                
117900           MOVE  ' ¤DAPW553' TO W001-DAP                                  
118000           WRITE W55313A-RAD FROM W001-DAP                                
118100           WRITE W55313A-RAD FROM W001-RUBRIK2                            
118200        END-IF                                                            
118300        PERFORM J-READ-WDP311                                             
118400        PERFORM S06-SKRIV-W55313A                                         
118500     END-IF                                                               
118600     .                                                                    
118700     EJECT                                                                
118800 S06-SKRIV-W55313A     SECTION.                                           
118900         ADD +1 TO WS-COUNTER1                                            
119000         WRITE W55313A-RAD FROM FELLISTA-DETALJ1                          
119100     .                                                                    
119200     SKIP3                                                                
...
119800          WRITE W55313B-RAD FROM W001-DAP                                 
119900          MOVE ' ¤DAPW553'  TO W001-DAP                                   
120000          WRITE W55313B-RAD FROM W001-DAP                                 
120100          WRITE W55313B-RAD FROM W002-RUBRIK2-4                           
120200       END-IF                                                             
120300       ADD +1 TO WS-COUNTER2                                              
120400       WRITE W55313B-RAD FROM VARNLISTA-DETALJ                            
120500     END-IF                                                               
120600     .                                                                    
120700     EJECT                                                                
