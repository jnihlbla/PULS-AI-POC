000100 ID DIVISION.                                                             
000200                                                                          
000300 PROGRAM-ID.     W2045700.                                                
000400 AUTHOR.         MARIE ODSELL.                                            
000500 DATE-WRITTEN.   12/03/12.                                                
000600 DATE-COMPILED.                                                           
000700                                                                          
000800*    FUNKTION:                                                            
000900*        VISAR/UPPDATERAR REFILLINGKVANT/KVEOQ I ANSK.                    
000901*        COPY OF W2034700                                                 
000902*        REFILL: BERÄKNAD REFILLING KVANTITET                             
000903*        ANSKAFFNING: BERÄKNAD OPTIMAL HEMTAGNINGSKVANTITET               
001000*                                                                         
001100*        PROGRAMMET UPPDATERAR WDGX25 (WDR2)                              
001200*                                                                         
001300*    INDATA.                                                              
001400*        TRANSAKTION: W2T457                                              
001500*        MID:         W2I45701                                            
001600*                                                                         
001700*    UTDATA.                                                              
001800*        MOD:         W2O45701                                            
...
002700 77  IDPGM                       PIC X(08)   VALUE 'W2045700'.            
002800                                                                          
002900*    --- WORKFIELDS FOR ERROR MESSAGES WHEN CALL ABEND/FELLOG             
003000 77  ERROR-TEXT                  PIC X(80) VALUE SPACE.                   
003100                                                                          
003200 77  JA                          PIC X       VALUE 'J'.                   
003300 77  YES                         PIC X       VALUE 'Y'.                   
003310 77  NOO                         PIC X       VALUE 'N'.                   
003400 77  MAX-MOD-LAENGD              PIC S9(4) VALUE ZERO COMP SYNC.          
003500                                                                          
003600*    --- WORKINGFIELDS FOR KEY VALUES FROM SCREEN                         
003700                                                                          
003800 77  INDATA-SW                   PIC X       VALUE 'Y'.                   
003900     88  INDATA-OK                           VALUE 'Y'.                   
004000     88  INDATA-WRONG                        VALUE 'N'.                   
004100                                                                          
004200 77  KEYS-SW                     PIC X       VALUE 'Y'.                   
004300     88  KEYS-OK                             VALUE 'Y'.                   
004400     88  KEYS-WRONG                          VALUE 'N'.                   
004500                                                                          
004600 77  W-IDTRANS                   PIC X(4)    VALUE SPACE.                 
004700     88  OWN-MID                             VALUE '2457'.                
004800     88  GOOD-MID                            VALUE '2456' '2457'.         
...
006000     03  WS-FL-LAST-TABLE        PIC X(1)    VALUE 'N'.                   
006100                                                                          
006200     03  WS-INRAD.                                                        
...
006600                                                                          
006700     03  WS-NUM-TABLES           PIC 9(9)    VALUE ZERO.                  
006800                                                                          
...
009300     03  ERR-USER-NOT-AUTH       PIC X(3)    VALUE '405'.                 
009900                                                                          
010000 01  FEL-MEDDELANDEN.                                                     
010100     03  FEL-14                  PIC X(40)                                
010200         VALUE 'TABLE DO NOT EXIST                     '.                 
010300                                                                          
...
011100                 VALUE ' PROCUREMENT TABLES TO THIS DC '.                 
011200     03 TE-PF8-EN-TABELL      PIC X(33)                                   
011300                 VALUE ' PROCUREMENT TABLES TO THIS DC '.                 
011400     03 TE-PF8-MORE              PIC X(26)                                
011500                 VALUE ' PRESS PF8 FOR NEXT PAGE. '.                      
011600     03 TE-LAST-PAGE             PIC X(22)                                
011700                 VALUE ' LAST TABLE.          ' .                         
011800                                                                          
011900                                                                          
012000     EJECT                                                                
012002 01  FILLER                      PIC X(7)    VALUE 'WWIDFTG'.             
012003*01 -COPY WWIDFTG                                                         
012010     EJECT                                                                
...
013200     SKIP3                                                                
013300*    --- AREA FOR MFS AND HANDLE SCREEN                                   
013400*                                                                         
013500 01  FILLER                      PIC X(16)   VALUE 'MID-AREA'.            
013600     SKIP3                                                                
013700*01  MID -COPY W2I45701                                                   
013800     EJECT                                                                
...
017410     88  SEGMENT-END                         VALUE 'GB'.                  
017500     SKIP2                                                                
...
020610*01  -COPY W0008   -PRE WDP7-                                             
020620     05  FILLER                  PIC X.                                   
020630     EJECT                                                                
...
021200     EJECT                                                                
021300 PROCEDURE DIVISION  USING MSG-PCB WDP7-PCB WDR2-PCB WDB6-PCB.            
021400     ENTRY 'DLITCBL' USING MSG-PCB WDP7-PCB WDR2-PCB WDB6-PCB.            
021500                                                                          
...
022110              PERFORM S10-AUTH-USER-CHECK                                 
022120              IF INDATA-OK                                                
...
022600           ELSE                                                           
022700              IF MFS-FIRST                                                
022800                 PERFORM C-FIRST-LATEST-TABLE                             
022900              ELSE                                                        
023000                 IF MFS-NEXT                                              
023100                    PERFORM D-NEXT-TABLE                                  
023200                 ELSE                                                     
023300                    PERFORM E-SAME-TABLE                                  
023400                 END-IF                                                   
023500              END-IF                                                      
023600           END-IF                                                         
023610           IF INDATA-OK                                                   
...
025100       MOVE MSG-INDATA-MINUS-2-TRANSKODER TO MID-W2I45701                 
025200       MOVE MSG-IDTRANS-2  TO MFS-IDTRANS                                 
025300       MOVE MSG-KDMFSFOR-2 TO MFS-KDMFSFOR                                
025400     ELSE                                                                 
025500       MOVE MSG-INDATA-MINUS-1-TRANSKOD  TO MID-W2I45701                  
...
026510     MOVE 'W2O457N1' TO MFS-IDMOD                                         
026600     MOVE '2457' TO MOD-IDTRANS                                           
026700     MOVE MFS-ERASE-FIELD TO MOD-TEMFSFEL MOD-TEMFSINF                    
026800                                                                          
026900     COMPUTE MSG-KVLL = LENGTH OF MOD-W2O45701 + 4                        
027000                                                                          
...
028700     MOVE '2457'            TO MSGI-IDTRANS                               
028800     IF OWN-MID                                                           
029000       MOVE MID-IDDC-IN     TO MSGI-IDDC-KEY                              
029100     END-IF                                                               
029110     CALL W005INIT USING MSGI-WMSGINIT WDP7-PCB                           
029120                                                                          
029200     MOVE YES TO KEYS-SW                                                  
029400                                                                          
029500*    -- CHECK IDDC                                                        
029600     MOVE MFS-ERASE-FIELD TO MOD-IDDC-IN                                  
029700                                                                          
...
031000     IF SEGMENT-MISSING                                                   
031100       MOVE NOO              TO KEYS-SW                                   
031300     ELSE                                                                 
031301       IF DCS-NDC-CN OR (DCS-NDC-NA AND DCS-USA)                          
031302         CONTINUE                                                         
031303       ELSE                                                               
031400         MOVE NOO              TO KEYS-SW                                 
031410       END-IF                                                             
031500     END-IF                                                               
032300                                                                          
032400*    -- CHECK IDREFTAB                                                    
032500     MOVE MFS-ERASE-FIELD TO MOD-IDREFTAB-IN                              
032600                                                                          
...
033600     END-IF                                                               
033700                                                                          
033800     IF WS-IDREFTAB ALPHABETIC                                            
033810        CONTINUE                                                          
033820     ELSE                                                                 
033830        MOVE NOO            TO KEYS-SW                                    
033840     END-IF                                                               
033850                                                                          
033900     IF GOOD-MID OR KEYS-OK                                               
034000       MOVE WS-IDDC            TO MOD-IDDC-UT                             
034100       MOVE WS-IDREFTAB        TO MOD-IDREFTAB-UT                         
034400     ELSE                                                                 
034500       MOVE MFS-ERASE-FIELD    TO MOD-IDDC-UT                             
034600       MOVE MFS-ERASE-FIELD    TO MOD-IDREFTAB-UT                         
034800     END-IF                                                               
034900                                                                          
035000                                                                          
035100     IF KEYS-WRONG                                                        
...
035900     EJECT                                                                
038800                                                                          
038900 C-FIRST-LATEST-TABLE SECTION.                                            
039000                                                                          
039100                                                                          
...
041200        END-IF                                                            
041300     END-IF                                                               
041400     PERFORM MFS-ERASE-FIELD-IN                                           
041500     .                                                                    
041600     EJECT                                                                
041700                                                                          
041800                                                                          
041900 D-NEXT-TABLE SECTION.                                                    
042000                                                                          
042100     MOVE WS-IDDC              TO W-IDDC                                  
042200     MOVE MID-IDREFTAB-LAST    TO W-IDREFTAB                              
...
046710       IF 2502-IDREFTAB ALPHABETIC                                        
046800         MOVE MID-IDREFTAB-LAST TO MOD-IDREFTAB-FIRST                     
046900         MOVE 2502-IDREFTAB     TO MOD-IDREFTAB-LAST                      
047000                                   MOD-IDREFTAB-UT                        
047100                                   W-IDREFTAB                             
047200         PERFORM FX-SHOW-INFO                                             
047300         PERFORM IMS-GNP-2502-NEXT                                        
047400         IF SEGMENT-FOUND AND 2502-IDREFTAB ALPHABETIC                    
047500           CONTINUE                                                       
047600         ELSE                                                             
047700           MOVE YES            TO WS-FL-LAST-TABLE                        
047800         END-IF                                                           
047900         PERFORM FY-NUMBER-OF-TABLES                                      
047910       END-IF                                                             
048000     ELSE                                                                 
048100       PERFORM IMS-GU-2501                                                
048200       PERFORM IMS-GNP-2502-OKVAL                                         
048300       PERFORM UNTIL SEGMENT-MISSING OR SEGMENT-END                       
048400       IF SEGMENT-FOUND AND 2502-IDREFTAB ALPHABETIC                      
048500         MOVE 2502-IDREFTAB     TO MOD-IDREFTAB-FIRST                     
048600                                   MOD-IDREFTAB-LAST                      
048700                                   MOD-IDREFTAB-UT                        
048800         PERFORM FX-SHOW-INFO                                             
048900         PERFORM FY-NUMBER-OF-TABLES                                      
049000       END-IF                                                             
049100       PERFORM IMS-GNP-2502-OKVAL                                         
049101       END-PERFORM                                                        
049102     END-IF                                                               
049103     .                                                                    
049104     EJECT                                                                
...
049800       IF SEGMENT-FOUND                                                   
049900         MOVE 2502-IDREFTAB      TO MOD-IDREFTAB-FIRST                    
050000                                    MOD-IDREFTAB-LAST                     
050100                                    MOD-IDREFTAB-UT                       
050200         PERFORM FX-SHOW-INFO                                             
050300         PERFORM FY-NUMBER-OF-TABLES                                      
050400       ELSE                                                               
050500         PERFORM FZ-SHOW-SEGMENT-MISSING                                  
050600       END-IF                                                             
050700     ELSE                                                                 
...
051200        ELSE                                                              
051300           PERFORM FZ-SHOW-SEGMENT-MISSING                                
051400        END-IF                                                            
...
054700              PERFORM FX-SHOW-INFO                                        
054800              PERFORM FY-NUMBER-OF-TABLES                                 
054900           ELSE                                                           
055000              PERFORM FZ-SHOW-SEGMENT-MISSING                             
055100           END-IF                                                         
055200        ELSE                                                              
...
055800              PERFORM UNTIL SEGMENT-MISSING OR SEGMENT-END                
055810                IF SEGMENT-FOUND AND 2502-IDREFTAB ALPHABETIC             
055900                  MOVE 2502-IDREFTAB TO MOD-IDREFTAB-FIRST                
056000                                        MOD-IDREFTAB-LAST                 
056100                                        MOD-IDREFTAB-UT                   
056200                  PERFORM FX-SHOW-INFO                                    
056300                  PERFORM FY-NUMBER-OF-TABLES                             
056400                  ADD +1  TO IX-1                                         
056401                END-IF                                                    
056402                PERFORM IMS-GNP-2502-OKVAL                                
056403              END-PERFORM                                                 
056404              IF IX-1 = 0                                                 
056405                PERFORM FZ-SHOW-SEGMENT-MISSING                           
056406              END-IF                                                      
056600           END-IF                                                         
056700        END-IF                                                            
056900     END-IF                                                               
...
057200                                                                          
057300                                                                          
057400 FX-SHOW-INFO SECTION.                                                    
058600                                                                          
058601     MOVE 2502-TEREFLIM            TO MOD-TEREFLIM                        
058602                                                                          
058603     MOVE +1                       TO KOL-IX                              
...
060900                                                                          
061000                                                                          
061100 FY-NUMBER-OF-TABLES SECTION.                                             
061200                                                                          
061300     PERFORM IMS-GU-2501                                                  
061400     MOVE +0                      TO WS-NUM-TABLES                        
061500     PERFORM IMS-GNP-2502                                                 
061600     PERFORM UNTIL SEGMENT-MISSING                                        
061700       IF 2502-IDREFTAB ALPHABETIC                                        
061800          ADD +1                    TO WS-NUM-TABLES                      
061801       END-IF                                                             
061802       PERFORM IMS-GNP-2502                                               
061900     END-PERFORM                                                          
062000                                                                          
062100     MOVE WS-NUM-TABLES           TO UT-ANTAL-TABELLER                    
062200     IF WS-NUM-TABLES     = 1                                             
...
063600                                                                          
063700                                                                          
063800 FZ-SHOW-SEGMENT-MISSING SECTION.                                         
063900                                                                          
...
064300                                                                          
064400                                                                          
064500 G-CHECK-INPUT SECTION.                                                   
064600                                                                          
064700     MOVE WS-IDDC                 TO W-IDDC                               
064800     MOVE WS-IDREFTAB             TO W-IDREFTAB                           
064900                                                                          
065000     PERFORM GA-CHECK-INPUT-CHANGES                                       
065100     .                                                                    
065200     EJECT                                                                
065300                                                                          
065400                                                                          
065500 GA-CHECK-INPUT-CHANGES SECTION.                                          
065600                                                                          
...
066100        PERFORM MFS-ERASE-FIELD-IN                                        
066200        PERFORM MFS-ERASE-FIELD-OUT                                       
...
066900           PERFORM S31-INDATA-CHECK                                       
067000           IF INDATA-WRONG                                                
...
069100                                                                          
069200                                                                          
069300 H-UPDATE SECTION.                                                        
069400                                                                          
069500     PERFORM HA-CHANGE-TABLE                                              
069600     .                                                                    
069700     EJECT                                                                
069800                                                                          
069900                                                                          
070000 HA-CHANGE-TABLE SECTION.                                                 
070100                                                                          
...
073800                                                                          
073900                                                                          
073910 S10-AUTH-USER-CHECK SECTION.                                             
073920                                                                          
073930     MOVE YES TO INDATA-SW                                                
073940                                                                          
073950     MOVE MSGI-IDFTG    TO WS-IDFTG                                       
073960                                                                          
073970     IF MSGI-IDFTG = WC-IDFTG-PV                                          
073980       CONTINUE                                                           
073990     ELSE                                                                 
073991       IF DCS-NDC-NA                                                      
073992         IF IDFTG-US                                                      
073993           CONTINUE                                                       
073994         ELSE                                                             
073995           MOVE NOO   TO INDATA-SW                                        
073999         END-IF                                                           
074000       END-IF                                                             
074001       IF DCS-NDC-CN                                                      
074002         IF IDFTG-CN                                                      
074003           CONTINUE                                                       
074004         ELSE                                                             
...
074009         END-IF                                                           
074010       END-IF                                                             
074011       IF INDATA-WRONG                                                    
074013           MOVE ERR-USER-NOT-AUTH    TO MED-IDMFSFEL                      
074014           CALL WMEDKONV USING MED-WMEDAREA                               
074015           MOVE MED-MFSFEL           TO MOD-TEMFSFEL                      
074016           MOVE MID-IDREFTAB-FIRST   TO MOD-IDREFTAB-FIRST                
074017           MOVE MID-IDREFTAB-LAST    TO MOD-IDREFTAB-LAST                 
074018           PERFORM MFS-ROER-EJ-FAELT-UT                                   
074019           PERFORM MFS-ROER-EJ-FAELT-IN                                   
074024       END-IF                                                             
074025     END-IF                                                               
074026     .                                                                    
074027     EJECT                                                                
074028                                                                          
074029                                                                          
074030 S31-INDATA-CHECK SECTION.                                                
074100                                                                          
074200*CHECK TEXTLINE                                                           
074300                                                                          
074400     IF MID-TEREFLIM = ALL '+' OR SPACE                                   
074500        MOVE MFS-ALPHA-FIELD-OK         TO MOD-TEREFLIM-ATTR              
074600     ELSE                                                                 
074700        MOVE MFS-ALPHA-FIELD-OK         TO MOD-TEREFLIM-ATTR              
074800     END-IF                                                               
074900                                                                          
075000                                                                          
075100*ROW                                                                      
...
075700             MOVE MFS-NUM-FIELD-OK      TO MOD-RAD-IN-ATTR                
075900           ELSE                                                           
076000             MOVE NOO                   TO INDATA-SW                      
076100             MOVE MFS-NUM-FIELD-WRONG   TO MOD-RAD-IN-ATTR                
076200           END-IF                                                         
076300        ELSE                                                              
076400          MOVE NOO                      TO  INDATA-SW                     
076500          MOVE MFS-NUM-FIELD-WRONG      TO MOD-RAD-IN-ATTR                
076600        END-IF                                                            
076700     ELSE                                                                 
076800       MOVE MFS-NUM-FIELD-OK            TO MOD-RAD-IN-ATTR                
076900     END-IF                                                               
077000                                                                          
077100                                                                          
077200*CHECK PRICE ROW                                                          
077300                                                                          
...
078300              MOVE MFS-NUM-FIELD-OK     TO                                
078400                           MOD-KVREFKVA-IN-ATTR(KOL-IX)                   
078500           ELSE                                                           
078600              MOVE NOO                  TO INDATA-SW                      
078700              MOVE MFS-NUM-FIELD-WRONG  TO                                
...
079900              MOVE MFS-ALPHA-FIELD-OK       TO                            
080000                           MOD-KDREFPKT-KVA-IN-ATTR(KOL-IX)               
080100           ELSE                                                           
080200              MOVE NOO                  TO INDATA-SW                      
080300              MOVE MFS-ALPHA-FIELD-OK   TO                                
080400                           MOD-KDREFPKT-KVA-IN-ATTR(KOL-IX)               
080500           END-IF                                                         
080600        ELSE                                                              
080700           MOVE MFS-ALPHA-FIELD-OK      TO                                
...
082300              MOVE NOO TO INDATA-SW                                       
082400              MOVE MFS-NUM-FIELD-WRONG TO MOD-RAD-IN-ATTR                 
082500           END-IF                                                         
...
084900           MOVE NOO TO INDATA-SW                                          
085000           MOVE MFS-NUM-FIELD-WRONG TO MOD-RAD-IN                         
085100        END-IF                                                            
085200                                                                          
085300     END-IF                                                               
085400     .                                                                    
...
085700                                                                          
085800                                                                          
085900 S34-MID-INDATA-TO-MOD SECTION.                                           
086000                                                                          
086100                                                                          
086200* TEREFLIM                                                                
086300                                                                          
086400     IF MID-TEREFLIM = ALL '+'                                            
086500        MOVE MFS-ERASE-FIELD         TO MOD-TEREFLIM                      
086600     ELSE                                                                 
...
087400        MOVE MFS-ERASE-FIELD        TO MOD-RAD-IN                         
087500     ELSE                                                                 
087600        MOVE MFS-DO-NOT-TOUCH-FIELD TO MOD-RAD-IN                         
087700     END-IF                                                               
087800                                                                          
087900     MOVE +1    TO KOL-IX                                                 
088000     PERFORM UNTIL KOL-IX > 8                                             
088100        IF MID-KVREFKVA(KOL-IX) = ALL '+'                                 
088200           MOVE MFS-ERASE-FIELD        TO MOD-KVREFKVA-IN(KOL-IX)         
088300        ELSE                                                              
088400           MOVE MFS-DO-NOT-TOUCH-FIELD TO MOD-KVREFKVA-IN(KOL-IX)         
088500        END-IF                                                            
088600        IF MID-KDREFPKT-KVA(KOL-IX) = ALL '+'                             
088700           MOVE MFS-ERASE-FIELD   TO MOD-KDREFPKT-KVA-IN(KOL-IX)          
088800        ELSE                                                              
088810           MOVE MFS-DO-NOT-TOUCH-FIELD TO                                 
088900                                     MOD-KDREFPKT-KVA-IN(KOL-IX)          
089000        END-IF                                                            
...
089500                                                                          
089600                                                                          
089700 MFS-ERASE-FIELD-OUT SECTION.                                             
089800                                                                          
089900     MOVE MFS-ERASE-FIELD TO MOD-TEREFLIM                                 
090000     MOVE +1 TO KOL-IX                                                    
090100     PERFORM UNTIL KOL-IX > 8                                             
090200        MOVE MFS-ERASE-FIELD    TO MOD-KVPB-REF(KOL-IX)                   
090300        ADD +1 TO KOL-IX                                                  
090400     END-PERFORM                                                          
090500                                                                          
090600     MOVE +1 TO RAD-IX                                                    
090700     PERFORM UNTIL RAD-IX > 10                                            
090800        MOVE MFS-ERASE-FIELD    TO MOD-PRARTBES(RAD-IX)                   
090900        MOVE +1 TO KOL-IX                                                 
091000        PERFORM UNTIL KOL-IX > 8                                          
091100           MOVE MFS-ERASE-FIELD TO                                        
...
092000                                                                          
092100                                                                          
092200 MFS-ERASE-FIELD-IN SECTION.                                              
092300                                                                          
092600     MOVE +1 TO KOL-IX                                                    
092700     MOVE MFS-ERASE-FIELD TO MOD-RAD-IN                                   
092800                                                                          
092900     MOVE +1 TO KOL-IX                                                    
093000     PERFORM UNTIL KOL-IX > 8                                             
093100        MOVE MFS-ERASE-FIELD TO MOD-KVREFKVA-IN(KOL-IX)                   
...
094000                                                                          
094100     MOVE MFS-DO-NOT-TOUCH-FIELD    TO MOD-TEREFLIM                       
094200                                                                          
094300     MOVE +1 TO KOL-IX                                                    
094400     PERFORM UNTIL KOL-IX > 8                                             
094500        MOVE MFS-DO-NOT-TOUCH-FIELD TO MOD-KVPB-REF(KOL-IX)               
094600        ADD +1 1 TO KOL-IX                                                
094700     END-PERFORM                                                          
094800                                                                          
094900     MOVE +1 TO RAD-IX                                                    
095000     PERFORM UNTIL RAD-IX > 10                                            
095100        MOVE MFS-DO-NOT-TOUCH-FIELD TO MOD-PRARTBES(RAD-IX)               
095200        MOVE +1 TO KOL-IX                                                 
095300        PERFORM UNTIL KOL-IX > 8                                          
095400          MOVE MFS-DO-NOT-TOUCH-FIELD TO                                  
...
096600                                                                          
096700     MOVE MFS-DO-NOT-TOUCH-FIELD TO MOD-TEREFLIM                          
096800                                                                          
096900     MOVE MFS-DO-NOT-TOUCH-FIELD TO MOD-RAD-IN                            
097000                                                                          
097100     MOVE +1 TO KOL-IX                                                    
097200     PERFORM UNTIL KOL-IX > 8                                             
097300       MOVE MFS-DO-NOT-TOUCH-FIELD TO MOD-KVREFKVA-IN(KOL-IX)             
...
099600                                                                          
099700                                                                          
099800 MFS-READ-IN-AGAIN SECTION.                                               
099900                                                                          
100000     MOVE MFS-ADD-READ-FIELD       TO MOD-TEREFLIM-ATTR                   
100100                                                                          
100200     MOVE MFS-ADD-READ-FIELD       TO MOD-RAD-IN-ATTR                     
100300     MOVE +1 TO KOL-IX                                                    
100400     PERFORM UNTIL KOL-IX > 8                                             
100500       MOVE MFS-ADD-READ-FIELD   TO                                       
...
101700                                                                          
101800     MOVE '  QC' TO GOOD-STATUSCODES                                      
...
104300     MOVE '  GE' TO GOOD-STATUSCODES                                      
...
105400     MOVE '  GEGB' TO GOOD-STATUSCODES                                    
...
108900     PERFORM IMS-STATUSCHECK                                              
109000     .                                                                    
109100     EJECT                                                                
109200                                                                          
109300                                                                          
...
113200     PERFORM IMS-STATUSCHECK                                              
113300     .                                                                    
113400     EJECT                                                                
113500                                                                          
113600                                                                          
113700 IMS-STATUSCHECK SECTION.                                                 
113800                                                                          
113900     SET STATUS-IX TO 1                                                   
114000     SEARCH GOOD-STATUS                                                   
114100       AT END                                                             
114200         STRING ' INVALID STATUS CODE FROM IMS: ' STATUS-WS               
114300         DELIMITED BY SIZE INTO ERROR-TEXT                                
114400         CALL FELLOG                                                      
114500       WHEN GOOD-STATUS (STATUS-IX) = STATUS-WS                           
114600         CONTINUE                                                         
114700     END-SEARCH                                                           
114800     .                                                                    
114900     EJECT                                                                
