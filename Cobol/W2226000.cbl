...
000810*                                                                         
000900*    FUNKTION:                                                            
001100*        PROGRAM FÖR ATT TA FRAM EN LISTA MED                             
001110*        MANUELLT SATTA SÄSONGER                                          
001600*                                                                         
...
004400     SKIP2                                                                
005200                                                                          
005300     SELECT W22260                     ASSIGN TO W22260D1.                
005400*          --- UT-FIL                                                     
005800     EJECT                                                                
...
008300                                                                          
008400*01  POST -COPY W22260  -PRE UT-    -L.                                   
008410                                                                          
009200     EJECT                                                                
...
010000     SKIP3                                                                
010100 77  IDPGM                       PIC X(8)    VALUE 'W2226000'.            
...
019660                                                                          
019670     03  WS-CURRENT-DATE.                                                 
019680         05  WS-DAGENS-TIAAAA    PIC 9(4)   VALUE ZERO.                   
019690         05  FILLER              PIC 9(4)   VALUE ZERO.                   
019700         05  FILLER              PIC 9(6)   VALUE ZERO.                   
019800                                                                          
019900     03  FILLER REDEFINES WS-CURRENT-DATE.                                
020000*-----   INKLUSIVE SEKEL                                                  
020100         05  WS-DAGENS-DATUM     PIC 9(8).                                
020200         05  WS-DAGENS-TID.                                               
020300             07 WS-DAGENS-TIMME  PIC 9(2).                                
020400             07 WS-DAGENS-MINUT  PIC 9(2).                                
020500             07 WS-DAGENS-SEKUND PIC 9(2).                                
020600                                                                          
024800     EJECT                                                                
...
028600*                                                                         
028700 01  PROGRAM-NAMN                PIC X(6)    VALUE 'W22260'.              
028800     SKIP2                                                                
...
031100     SKIP2                                                                
031200                                                                          
031300*01  AREA -COPY W22260     -PRE UT-                                       
031400     EJECT                                                                
...
040924           AND JUST-DASPSEA > WS-CURRENT-DATE                             
...
049500                                                                          
049800     OPEN OUTPUT W22260                                                   
049900                                                                          
049910     MOVE FUNCTION CURRENT-DATE TO WS-CURRENT-DATE                        
050000                                                                          
...
052480       MOVE 5                TO W009VADDW-ANTAL                           
...
075500     END-IF                                                               
075510                                                                          
075600     PERFORM S01-SKRIV-W22260                                             
075700     .                                                                    
075800     EJECT                                                                
098646                                                                          
...
099600     EJECT                                                                
130800                                                                          
130900 S01-SKRIV-W22260 SECTION.                                                
131000                                                                          
131100     WRITE UT-POST FROM UT-AREA                                           
131200                                                                          
131300     MOVE 'W22260'   TO POSTSUM-FDNAMN                                    
131400     MOVE 'W22260D1' TO POSTSUM-DDNAMN2                                   
