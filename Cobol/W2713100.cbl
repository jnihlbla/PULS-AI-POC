...
000800*                                                                         
000900*    FUNKTION:                                                            
001000*        UPPDATERAR FÖRÄNDRAD PROGNOS PÅ WDK7                             
001100*        INGET ÅTERSTARSREGISTER BEHÖVS, VID                              
001200*        ABEND KOLLAS OM PROGNOSEN PÅ WDK7                                
...
003000     SELECT W27130                     ASSIGN TO W27131D1.                
003100     EJECT                                                                
...
003900                                                                          
004000*01  -COPY W27130      -L.                                                
004100     EJECT                                                                
004200 WORKING-STORAGE SECTION.                                                 
004300     SKIP2                                                                
004400                                                                          
004500*    -- CHECKED BY WY2000                                                 
004600 77  IDPGM                       PIC X(8)    VALUE 'W2713100'.            
...
006400                                                                          
006500 77  W27130-EOF-SW               PIC X       VALUE 'N'.                   
006600     88  END-OF-W27130                       VALUE 'J'.                   
006700                                                                          
...
008900     SKIP2                                                                
009000                                                                          
009100*01  AREA -COPY W27130     -PRE IN-                                       
009200*                                                                         
009300     EJECT                                                                
...
010010     03  W-KDSEGKEY-X.                                                    
010020         05  W-KDSEGKEY          PIC X       VALUE '1'.                   
010030                                                                          
010100     SKIP2                                                                
...
012100     SKIP3                                                                
013010 01  FILLER         PIC X(24) VALUE 'DLI-IO-WDK701'.                      
013020 01  DLI-IO-WDK701.                                                       
013030*    03  -COPY WDK701                                                     
013040     EJECT                                                                
013050                                                                          
013051 01  FILLER         PIC X(24) VALUE 'DLI-IO-WDK711'.                      
013052 01  DLI-IO-WDK711.                                                       
013053*    03  -COPY WDK711                                                     
013054     EJECT                                                                
013055                                                                          
013060 01  FILLER         PIC X(24) VALUE 'DLI-IO-WDK722'.                      
013070 01  DLI-IO-WDK722.                                                       
013080*    03  -COPY WDK722                                                     
013090     EJECT                                                                
013091                                                                          
...
013400     EJECT                                                                
013500*01  -COPY W0008  -PRE WDK7-                                              
013600     05  FILLER                  PIC X.                                   
013700     EJECT                                                                
013710*01  -COPY W0008  -PRE WDK72-                                             
013720     05  FILLER                  PIC X.                                   
013730     EJECT                                                                
013800 PROCEDURE DIVISION  USING MSG-PCB WDK7-PCB WDK72-PCB.                    
013900     ENTRY 'DLITCBL' USING MSG-PCB WDK7-PCB WDK72-PCB.                    
014000                                                                          
014100     PERFORM A-INIT                                                       
014200     PERFORM S01-LAES-W27130                                              
014300     PERFORM UNTIL END-OF-W27130                                          
014400                                                                          
014500       PERFORM B-BEHANDLA-POSTER                                          
014600                                                                          
014700       PERFORM S01-LAES-W27130                                            
014800                                                                          
014900     END-PERFORM                                                          
...
017800       END-IF                                                             
017900       PERFORM IMS-GU-WDK701                                              
018000       MOVE W-IDARTNR TO WS-IDARTNR                                       
018100     END-IF                                                               
018200     PERFORM IMS-GHNP-WDK711                                              
018300                                                                          
018500     IF SLAG-KVPB-REF = IN-KVPB-REF                                       
018700       CONTINUE                                                           
018800     ELSE                                                                 
018900       MOVE IN-KVPB-REF    TO SLAG-KVPB-REF                               
019000       MOVE IN-RETREND     TO SLAG-RETREND                                
019010       IF IN-TIREFMPB = ZERO                                              
019020         CONTINUE                                                         
019030       ELSE                                                               
019031         IF SLAG-TIREFMPB < IN-TIREFMPB                                   
019040           MOVE IN-TIREFMPB TO SLAG-TIREFMPB                              
019050         END-IF                                                           
019300       END-IF                                                             
019400       PERFORM IMS-REPL-WDK711                                            
019500       ADD +1 TO CHKP-ANT                                                 
020100     END-IF                                                               
020110     IF IN-NOLLA-JUST1 = 'J'                                              
020111       PERFORM IMS-GHU-WDK722                                             
020112       IF SEGMENT-FINNS                                                   
020113         MOVE ZERO     TO XLAG-KVPB-JUST1                                 
020114                          XLAG-TIPBJUST-1                                 
020115         PERFORM IMS-REPL-WDK722                                          
020116       END-IF                                                             
020117     END-IF                                                               
020118     IF IN-NOLLA-JUST2 = 'J'                                              
020119       PERFORM IMS-GHU-WDK722                                             
020120       IF SEGMENT-FINNS                                                   
020121         MOVE ZERO     TO XLAG-KVPB-JUST2                                 
020122                          XLAG-TIPBJUST-2                                 
020123         PERFORM IMS-REPL-WDK722                                          
020124       END-IF                                                             
020125     END-IF                                                               
020130                                                                          
020200     .                                                                    
...
021100     .                                                                    
021200     EJECT                                                                
021300 S01-LAES-W27130  SECTION.                                                
021400     SKIP2                                                                
021500     READ W27130 INTO IN-AREA                                             
021600     AT END                                                               
021700        SET END-OF-W27130 TO TRUE                                         
021800                                                                          
021900     NOT AT END                                                           
022000        MOVE 'W27130' TO POSTSUM-FDNAMN                                   
022100        MOVE 'W27131D1' TO POSTSUM-DDNAMN2                                
...
026400     .                                                                    
026500     EJECT                                                                
026600 IMS-GU-WDK701 SECTION.                                                   
026700                                                                          
026800     STRING 'WDK701  (IDARTNR  =' W-IDARTNR-X ')'                         
026900          DELIMITED BY SIZE INTO SSA1                                     
027000     MOVE '  ' TO GODK-STATUSKODER                                        
027100     CALL CBLTDLI USING GU WDK7-PCB DLI-IO-WDK701 SSA1                    
027200     MOVE WDK7-STATUS-CODE TO STATUS-WS                                   
027300     PERFORM IMS-STATUSKONTROLL                                           
027400     .                                                                    
027500     EJECT                                                                
027600 IMS-GHNP-WDK711 SECTION.                                                 
027700                                                                          
027800     STRING 'WDK711  (IDDC     =' W-IDDC-X ')'                            
027900          DELIMITED BY SIZE INTO SSA1                                     
028000     MOVE '  ' TO GODK-STATUSKODER                                        
028100     CALL CBLTDLI USING GHNP WDK7-PCB DLI-IO-WDK711 SSA1                  
028200     MOVE WDK7-STATUS-CODE TO STATUS-WS                                   
028300     PERFORM IMS-STATUSKONTROLL                                           
028400     .                                                                    
028500     SKIP3                                                                
028510 IMS-GHU-WDK722 SECTION.                                                  
028520                                                                          
028530     STRING 'WDK701  (IDARTNR  =' W-IDARTNR-X ')'                         
028540          DELIMITED BY SIZE INTO SSA1                                     
028541     STRING 'WDK711  (IDDC     =' W-IDDC-X ')'                            
028542          DELIMITED BY SIZE INTO SSA2                                     
028543     STRING 'WDK722  (KDSEGKEY =' W-KDSEGKEY-X ')'                        
028544          DELIMITED BY SIZE INTO SSA3                                     
028550     MOVE '  GE' TO GODK-STATUSKODER                                      
028560     CALL CBLTDLI USING GHU WDK72-PCB DLI-IO-WDK722 SSA1 SSA2 SSA3        
028570     MOVE WDK72-STATUS-CODE TO STATUS-WS                                  
028580     PERFORM IMS-STATUSKONTROLL                                           
028590     .                                                                    
028591     EJECT                                                                
028600 IMS-REPL-WDK711 SECTION.                                                 
028700                                                                          
028800     MOVE '  ' TO GODK-STATUSKODER                                        
028900     CALL CBLTDLI USING REPL WDK7-PCB DLI-IO-WDK711                       
029000     MOVE WDK7-STATUS-CODE TO STATUS-WS                                   
029100     PERFORM IMS-STATUSKONTROLL                                           
029200     .                                                                    
029300     EJECT                                                                
029310 IMS-REPL-WDK722 SECTION.                                                 
029320                                                                          
029330     MOVE '  ' TO GODK-STATUSKODER                                        
029340     CALL CBLTDLI USING REPL WDK72-PCB DLI-IO-WDK722                      
029350     MOVE WDK72-STATUS-CODE TO STATUS-WS                                  
029360     PERFORM IMS-STATUSKONTROLL                                           
029370     .                                                                    
029380     EJECT                                                                
