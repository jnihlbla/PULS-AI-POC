...
000090*REMARKS:                                                                 
000100*                                                                         
000110*  * ACTION CODE C (CREATE) ON MASTER AUTHORITY PANEL                     
000130*                                                                         
000140*  * DB2-TABLES:                                                          
000150*                                                                         
...
000660*--------------------------------------------------------------           
000670 01  PROGRAM-NAME                 PIC X(8)  VALUE 'V1618020'.             
...
000829     SKIP2                                                                
000835 01  N-PANEL-V161802M.                                                    
000837     03 N-USERID                  PIC X(8)  VALUE 'V161802A'.             
000839     03 N-AUTH                    PIC X(8)  VALUE 'V161802B'.             
000840     03 N-PREFIX                  PIC X(8)  VALUE 'V161802C'.             
000843     SKIP2                                                                
000848 01  LTH-PANEL-V161802M.                                                  
...
000867     SKIP2                                                                
000870*--------------------------------------------------------------           
000871*DEKLARATION AV ISPF-KONSTANTER                                           
000872*--------------------------------------------------------------           
...
000878*--------------------------------------------------------------           
000879*DEKLARATION AV ISPF-FÄLT                                                 
000880*--------------------------------------------------------------           
000881 01  V161802M                     PIC X(8)  VALUE 'V1618020'.             
...
001523     PERFORM AB-VDEF-PANEL-V161802M                                       
001540     CONTINUE.                                                            
001550     EJECT                                                                
001560*--------------------------------------------------------------           
...
001668     EJECT                                                                
001694*--------------------------------------------------------------           
001695 AB-VDEF-PANEL-V161802M SECTION.                                          
001696*--------------------------------------------------------------           
001697     MOVE 'AB-VDEF-PANEL-V161802M    ' TO ABEND-SECTION                   
001698D    DISPLAY ABEND-SECTION                                                
001699     SKIP2                                                                
001700     CALL 'ISPLINK' USING VDEFINE N-PREFIX ISPF-PREFIX                    
001701                          CHAR LTH-PREFIX                                 
...
001750     EJECT                                                                
001751*--------------------------------------------------------------           
001752 B-CHECK-EXTMAST SECTION.                                                 
001753*--------------------------------------------------------------           
001754     MOVE 'B-CHECK-EXTMAST' TO ABEND-SECTION                              
...
001960     EJECT                                                                
001961*--------------------------------------------------------------           
001962 D-INSERT-EXTMAST SECTION.                                                
001963*--------------------------------------------------------------           
001964     MOVE 'D-INSERT-EXTMAST      ' TO ABEND-SECTION                       
001965D    DISPLAY ABEND-SECTION                                                
001966     SKIP2                                                                
001967     MOVE ISPF-PREFIX        TO EXTMAST-PREFIX                            
001968     MOVE ISPF-USERID        TO EXTMAST-USERID                            
001973     MOVE ISPF-AUTH TO EXTMAST-AUTH                                       
001979     PERFORM SQL-INSERT-EXTMAST                                           
...
002032     SKIP2                                                                
002033     PERFORM ZA-VDEL-PANEL-V161802M                                       
002034     MOVE RCODE TO RETURN-CODE                                            
002040     CONTINUE.                                                            
002050     EJECT                                                                
003010*--------------------------------------------------------------           
003020 ZA-VDEL-PANEL-V161802M SECTION.                                          
003030*--------------------------------------------------------------           
003031     MOVE 'ZB-VDEL-PANEL-V161802M    ' TO ABEND-SECTION                   
...
003053     SKIP2                                                                
003054     CALL 'ISPLINK' USING DISPLAYE V161802M                               
...
003108     SKIP2                                                                
003109     EXEC SQL                                                             
003110        SELECT  USERID                                                    
003111        INTO :EXTMAST-PREFIX                                              
...
003119     EJECT                                                                
003120*--------------------------------------------------------------           
003121 SQL-INSERT-EXTMAST SECTION.                                              
003122*--------------------------------------------------------------           
003123     MOVE 'SQL-INSERT-EXTMAST        ' TO ABEND-SECTION                   
003124D    DISPLAY ABEND-SECTION                                                
003125     SKIP2                                                                
003126     EXEC SQL                                                             
003127        INSERT  INTO EXTRACT_MASTER (PREFIX,                              
003128                                   USERID,                                
003130                                   AUTH)                                  
003134        VALUES                   (:EXTMAST-PREFIX,                        
003135                                  :EXTMAST-USERID,                        
003137                                  :EXTMAST-AUTH)                          
003142     END-EXEC                                                             
