000100 ID DIVISION.                                                             
000200 PROGRAM-ID.    W5128500.                                                 
000300                                                                          
000400*    AUTHOR.        BARSHARANI BISHOYE.                                   
000500*    DATE-WRITTEN   NOVEMBER 2019.                                        
000600*                                                                         
000700*    FUNKTION:                                                            
000800*               SKAPAR W51285-0XX FÖR KURANSGRUPPER PER DC                
...
001500 FILE-CONTROL.                                                            
001600                                                                          
001700     SELECT W51284  ASSIGN       TO W51285D1.                             
001800                                                                          
001900     SELECT W51285S ASSIGN       TO W51285D2.                             
002000     SELECT W51285K ASSIGN       TO W51285D3.                             
002100     EJECT                                                                
002200                                                                          
...
003600                                                                          
003700 01  W51285-S-REC            PIC X(121).                                  
003800     SKIP2                                                                
003900                                                                          
004000 FD  W51285K                                                              
004100     RECORDING V                                                          
...
004300                                                                          
004400 01  W51285-K-REC            PIC X(121).                                  
004500     EJECT                                                                
004600                                                                          
004700 WORKING-STORAGE SECTION.                                                 
004800     SKIP3                                                                
004900 77  IDPGM                   PIC X(8)      VALUE 'W5128500'.              
...
006600     03  FILLER              PIC X(8) VALUE 'W51285D1'.                   
...
008100                                                                          
008200 01  FILLER                  PIC X(16)   VALUE 'W51284-AREA'.             
008300 01  INAREA.                                                              
008400*    03  -COPY W51284     -PRE IN-                                        
008500     EJECT                                                                
008600                                                                          
008700 01  W001-DAP.                                                            
...
031300                                                                          
031400     PERFORM S01-READ-W51284-POST                                         
031500     IF EOF-W51284 = JA                                                   
031600        CONTINUE                                                          
031700     ELSE                                                                 
031800        PERFORM UNTIL EOF-W51284 = JA                                     
...
033100     OPEN INPUT  W51284                                                   
033200          OUTPUT W51285S W51285K                                          
033300                                                                          
...
036200                                                                          
036300             WRITE W51285-S-REC FROM ROW-SUPERTOTAL                       
036400             WRITE W51285-S-REC FROM FILLER-LINE                          
...
039400       END-IF                                                             
039500       PERFORM S01-READ-W51284-POST                                       
039600     END-PERFORM                                                          
039700                                                                          
...
040200                                                                          
040300     WRITE W51285-S-REC FROM ROW-SUPERTOTAL                               
040400     WRITE W51285-S-REC FROM FILLER-LINE                                  
040500                                                                          
...
043300     END-IF                                                               
043400                                                                          
043500     WRITE W51285-S-REC  FROM MAIN-LINE1                                  
043600     WRITE W51285-S-REC  FROM FILLER-LINE                                 
043700     WRITE W51285-S-REC  FROM ROW-LINE1                                   
043800     WRITE W51285-S-REC  FROM FILLER-LINE                                 
043900     .                                                                    
044000                                                                          
044100                                                                          
...
047500     WRITE W51285-S-REC FROM ROW                                          
...
048900     WRITE W51285-S-REC FROM ROW                                          
...
050300     WRITE W51285-S-REC FROM ROW                                          
...
051700     WRITE W51285-S-REC FROM ROW                                          
...
053100     WRITE W51285-S-REC FROM ROW                                          
...
054500     WRITE W51285-S-REC FROM ROW                                          
...
055500     WRITE W51285-S-REC FROM ROW-TOTAL                                    
055600     WRITE W51285-S-REC FROM FILLER-LINE                                  
...
058800     END-IF                                                               
058900                                                                          
059000     WRITE W51285-K-REC FROM MAIN-LINE1                                   
059100     WRITE W51285-K-REC FROM FILLER-LINE                                  
059200     WRITE W51285-K-REC FROM ROW-LINE2                                    
059300     WRITE W51285-K-REC FROM FILLER-LINE                                  
059400     .                                                                    
059500                                                                          
059600                                                                          
...
062300                      + W-KUR6                                            
062400     WRITE W51285-K-REC FROM ROW2                                         
...
065000     WRITE W51285-K-REC FROM ROW2-TOTAL                                   
065100     WRITE W51285-K-REC FROM FILLER-LINE                                  
065200     .                                                                    
065300     SKIP3                                                                
065400                                                                          
...
068300                                                                          
068400     WRITE W51285-K-REC FROM ROW-OBSOL                                    
068500     WRITE W51285-K-REC FROM FILLER-LINE                                  
068600     WRITE W51285-K-REC FROM ROWT-OBSOL                                   
068700     WRITE W51285-K-REC FROM FILLER-LINE                                  
068800     MOVE W-KURSUM2 TO ROWS-LVALUE                                        
068900     WRITE W51285-K-REC FROM ROW-SUPERTOTAL                               
069000     .                                                                    
069100     EJECT                                                                
069200                                                                          
069300 Z-END    SECTION.                                                        
069400     CLOSE W51284                                                         
069500           W51285S W51285K                                                
069600                                                                          
...
070000     EJECT                                                                
070100                                                                          
070200 S01-READ-W51284-POST SECTION.                                            
070300     READ W51284 INTO INAREA                                              
070400     AT END                                                               
070500       MOVE JA TO EOF-W51284                                              
070600     NOT AT END                                                           
070700       MOVE W51284-TRANSID TO POSTSUM-TRANSID                             
...
071300                                                                          
071400     MOVE ' ¤DAPW51285-001' TO W001-DAP                                   
071500     WRITE W51285-S-REC  FROM W001-DAP                                    
071600                                                                          
...
072400     WRITE W51285-S-REC  FROM W001-DAP                                    
072500                                                                          
072600     MOVE SPACE TO W001-DAP                                               
072700     .                                                                    
072800 S04-SKRIV-DAP1-K SECTION.                                                
072900                                                                          
073000     MOVE ' ¤DAPW51285-002' TO W001-DAP                                   
073100     WRITE W51285-K-REC  FROM W001-DAP                                    
073200                                                                          
...
073900     WRITE W51285-K-REC  FROM W001-DAP                                    
074000                                                                          
