...
002500     SELECT W23636                     ASSIGN TO W23638D1.                
002600     SKIP2                                                                
002700*          --- LISTA TRANSPORTTIDER                                       
002800     SELECT W23638-001                 ASSIGN TO W23638D2.                
002900     EJECT                                                                
...
003900     SKIP3                                                                
004000 FD  W23638-001                                                           
004100     RECORDING       F                                                    
004200     BLOCK CONTAINS  0.                                                   
004300     SKIP2                                                                
004400 01  W23638-001-RAD              PIC X(121).                              
004500     EJECT                                                                
004600 WORKING-STORAGE SECTION.                                                 
004700                                                                          
004800 77  IDPGM                       PIC X(8)    VALUE 'W2363800'.            
004900 77  JA                          PIC X       VALUE 'J'.                   
005000 77  NEJ                         PIC X       VALUE 'N'.                   
005100                                                                          
005200 77  W23636-EOF-SW               PIC X       VALUE 'N'.                   
005300     88  END-OF-W23636                       VALUE 'J'.                   
005400                                                                          
...
008710     03  TOT-TTILLF              PIC S9(3)    VALUE ZERO.                 
008720     03  TOT-ANTAL               PIC 9(6)     VALUE ZERO.                 
008730     03  TOT-TOTSUM              PIC 9(8)V99  VALUE ZERO.                 
008731     03  WS-TOTSUM-TOT           PIC 9(8)V99  VALUE ZERO.                 
008740     03  FILLER OCCURS 30.                                                
008750         05  TOT-SUM             PIC 9(8)V99  VALUE ZERO.                 
008760     03  FILLER OCCURS 30.                                                
008770         05  TOT-PROC            PIC 9(8)V99  VALUE ZERO.                 
008780     03  TOT-W001-PROC           PIC 9(8)V99  VALUE ZERO.                 
008790     03  TOT-PROC-RATT           PIC 999V99   VALUE ZERO.                 
008791     03  TOT-PROC-TIDIGA         PIC 999V99   VALUE ZERO.                 
008792     03  TOT-PROC-SENA           PIC 999V99   VALUE ZERO.                 
008793     03  TOT-SNITT               PIC 9(8)V99  VALUE ZERO.                 
008794     03  TOT-VIKT                PIC 9(8)V99  VALUE ZERO.                 
008795     03  TOT-SUMVIKT             PIC 9(8)V99  VALUE ZERO.                 
008796     03  WS-SUM-RATT             PIC 9(8)V99  VALUE ZERO.                 
008797     03  WS-SUM-TIDIGA           PIC 9(8)V99  VALUE ZERO.                 
008798     03  WS-SUM-SENA             PIC 9(8)V99  VALUE ZERO.                 
008800     EJECT                                                                
...
013700     03  W001-LISTNR             PIC X(11)   VALUE 'W23638-001'.          
...
015100                                 VALUE 'W23638-001'.                      
015200     03  FILLER                  PIC X(54)                                
015300         VALUE 'DELIVERY PRECISION IN % OF TRANSPORT DAYS'.               
...
017610     03  FILLER                  PIC X(02)  VALUE SPACE.                  
017620     03  W001-ANT                PIC Z(03)  VALUE ZERO.                   
...
019040     03  W001-IDLEVNR-TOT        PIC X(5)   VALUE SPACE.                  
019060     03  W001-ANT-TOT            PIC Z(05)  VALUE ZERO.                   
...
020700                                                                          
020800       PERFORM S01-LAES-W23636                                            
020900     END-PERFORM                                                          
...
021900                                                                          
022000     OPEN INPUT  W23636                                                   
022100                                                                          
022200     OPEN OUTPUT W23638-001                                               
022300     SKIP2                                                                
...
039400     PERFORM S21-SKRIV-W23638-001                                         
039500     .                                                                    
039600     EJECT                                                                
...
039726                                                                          
039727     MOVE 'TOTAL'         TO W001-IDLEVNR-TOT                             
039729                                                                          
...
039741                                                                          
039742     COMPUTE TOT-PROC-RATT     ROUNDED =                                  
039743                   100 * WS-SUM-RATT   / WS-TOTSUM-TOT                    
039744     COMPUTE TOT-PROC-SENA     ROUNDED =                                  
039745                   100 * WS-SUM-SENA   / WS-TOTSUM-TOT                    
039746     COMPUTE TOT-PROC-TIDIGA   ROUNDED =                                  
039747                   100 * WS-SUM-TIDIGA / WS-TOTSUM-TOT                    
039748                                                                          
039751     MOVE TOT-PROC-RATT        TO W001-RATT-TOT                           
039760     MOVE TOT-PROC-SENA        TO W001-SENA-TOT                           
039767     MOVE TOT-PROC-TIDIGA      TO W001-TIDIGA-TOT                         
039768                                                                          
039769     MOVE W001-SNITT-TOT       TO W001-RAD                                
039770     MOVE 50                   TO W001-RADRAKNARE                         
039771                                                                          
039772     PERFORM S21-SKRIV-W23638-001                                         
039773     .                                                                    
039774     EJECT                                                                
...
040300     .                                                                    
040400     EJECT                                                                
040500 S01-LAES-W23636  SECTION.                                                
040600     READ W23636 INTO IN-AREA                                             
040700     AT END                                                               
040800        SET END-OF-W23636 TO TRUE                                         
040900                                                                          
041000     NOT AT END                                                           
041100        MOVE 'W23636'   TO POSTSUM-FDNAMN                                 
041200        MOVE 'W23638D1' TO POSTSUM-DDNAMN2                                
041300        MOVE 'IN'       TO POSTSUM-TRANSTYP                               
041400        CALL POSTSUM USING POSTSUM-PARM                                   
041500     END-READ                                                             
041600     .                                                                    
041700     EJECT                                                                
041800 S21-SKRIV-W23638-001  SECTION.                                           
041900                                                                          
...
042300     END-IF                                                               
042400     SKIP2                                                                
042500     WRITE W23638-001-RAD FROM W001-RAD AFTER W001-SKIP                   
042600     SKIP2                                                                
...
043500     WRITE W23638-001-RAD FROM W001-RUBRIK1 AFTER PAGE                    
043600     WRITE W23638-001-RAD FROM W001-RUBRIKA AFTER 2                       
043700     WRITE W23638-001-RAD FROM W001-RUBRIKB AFTER 1                       
