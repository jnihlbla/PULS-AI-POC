000100 ID DIVISION.                                                             
000200                                                                          
000300 PROGRAM-ID.     WCNVUNKO.                                                
000400 AUTHOR.         KJELL ANDRE.                                             
000500 DATE-WRITTEN.   97/04/24.                                                
000600 DATE-COMPILED.                                                           
000700                                                                          
000810*                                                                         
000820*                                                                         
000900*    FUNCTION:                                                            
001000*        CONVERSION FROM UNICODE (UCS2 OR UTF8) TO KOREAN                 
001100*        EBCDIC CODEPAGES (CP833/CS1278 AND CP834/CS1050                  
001200*        = CCSID 9125)                                                    
001300                                                                          
001400     SKIP3                                                                
...
001900 77  IDPGM                       PIC X(8)    VALUE 'WCNVUNKO'.            
...
006100*01  -COPY WCNVU833                                                       
006200     EJECT                                                                
006300*01  -COPY WCNVU834                                                       
...
009520           PERFORM S01-HEX-TO-CHAR                                        
009530           STRING 'POS ' IXF-DISP ' ' TEMP-HEX-ENT '. '                   
009540                DELIMITED BY SIZE                                         
009550           INTO BEFEL WITH POINTER EPTR                                   
009600         END-IF                                                           
009700       END-IF                                                             
...
012675       END-IF                                                             
012676*      -- CONVERT UTF8 INPUT TO UCS2 BEFORE CONVERTING TO EBCDIC          
