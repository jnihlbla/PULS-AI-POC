...
001100*        TRANSAKTIONER SOM SKALL RENSAS PÅ WDH8-BASEN.                    
001200*                                                                         
...
001600*                                                                         
001700*        PROGRAMMET UPPATERAR WLART  (WDH8)                               
001800*                                                                         
001900*    ABENDKODER:                                                          
002000*        U0016 -  . . . .                                                 
002100*        U1000 -  . . . .                                                 
...
002900 FILE-CONTROL.                                                            
003000     SKIP2                                                                
003100*          --- WDH8 TRANSAR SOM SKALL RENSAS                              
003200     SELECT W55326                     ASSIGN TO W55326D1.                
003300     EJECT                                                                
...
004800 77  IDPGM                       PIC X(8)    VALUE 'W5532600'.            
...
005700                                                                          
005800 77  W55326-EOF-SW               PIC X       VALUE 'N'.                   
005900     88  END-OF-W55326                       VALUE 'J'.                   
006000     EJECT                                                                
...
007500     EJECT                                                                
007600 01  W55326-AREA-START           PIC X(24)   VALUE                        
007700                                             'W55326-AREA-START'.         
007800     SKIP2                                                                
007900                                                                          
008000*01  AREA -COPY W55326     -PRE IN-                                       
008100*                                                                         
008200 01  FILLER                      PIC X(16)   VALUE 'IMS-WS'.              
008300     SKIP3                                                                
008400 01  NYCKLAR-TILL-DLI.                                                    
008500     03  W-WDH801KY-X.                                                    
008600         05  W-IDARTNR           PIC S9(9) COMP-3 VALUE ZERO.             
008800         05  W-DAREGDAT          PIC 9(8)         VALUE ZERO.             
008900         05  W-TIREGTID          PIC S9(7) COMP-3 VALUE ZERO.             
009300     SKIP2                                                                
...
010400     SKIP3                                                                
010500 01  SSA1                        PIC X(75).                               
010600 01  SSA2                        PIC X(75).                               
010700     EJECT                                                                
...
011600     SKIP3                                                                
011700     03  WLPRIG01 REDEFINES IO-AREA.                                      
011800*        05  -COPY WDH801     -PRE PRIG-                                  
011801     EJECT                                                                
012000 LINKAGE SECTION.                                                         
012100                                                                          
012200*01  -COPY W0009      -PRE MSG-                                           
012300     EJECT                                                                
012400*01  -COPY W0008      -PRE PRIG-                                          
012500     05  FILLER                  PIC X.                                   
012600     EJECT                                                                
012700 PROCEDURE DIVISION  USING MSG-PCB PRIG-PCB.                              
012800     ENTRY 'DLITCBL' USING MSG-PCB PRIG-PCB.                              
012900                                                                          
013000     PERFORM A-INIT                                                       
013100     PERFORM S01-LAES-W55326                                              
013200                                                                          
013300     PERFORM UNTIL END-OF-W55326                                          
013400                                                                          
...
014000                                                                          
014100       PERFORM S01-LAES-W55326                                            
014200     END-PERFORM                                                          
014300                                                                          
...
016300                                                                          
016400     MOVE IN-IDARTNR             TO W-IDARTNR                             
016500     MOVE IN-DAREGDAT            TO W-DAREGDAT                            
016600     MOVE IN-TIREGTID            TO W-TIREGTID                            
016700                                                                          
016800     PERFORM IMS-GHU-WDH801                                               
016900                                                                          
017000     IF SEGMENT-FINNS                                                     
017030       ADD +1     TO CHKP-ANT                                             
017040       PERFORM IMS-DLET-WDH801                                            
017060     END-IF                                                               
017100                                                                          
017700     .                                                                    
017800     EJECT                                                                
...
018500     .                                                                    
018600     EJECT                                                                
018700 S01-LAES-W55326  SECTION.                                                
018800                                                                          
018900     READ W55326 INTO IN-AREA                                             
019000     AT END                                                               
019100        SET END-OF-W55326      TO TRUE                                    
019200                                                                          
019300     NOT AT END                                                           
019400        MOVE 'W55326'          TO POSTSUM-FDNAMN                          
019500        MOVE 'W55326D1'        TO POSTSUM-DDNAMN2                         
019600        MOVE 'WDH801'          TO POSTSUM-TRANSTYP                        
...
020900     SKIP3                                                                
021810 IMS-GHU-WDH801    SECTION.                                               
021820*                                                                         
021830     STRING 'WLPRIG01(WDH801KY =' W-WDH801KY-X ')'                        
021840          DELIMITED BY SIZE INTO SSA1                                     
021850     MOVE '  GE'               TO GODK-STATUSKODER                        
021860     CALL CBLTDLI USING GHU PRIG-PCB DLI-IO-AREA SSA1                     
021870     MOVE PRIG-STATUS-CODE     TO STATUS-WS                               
021880     PERFORM IMS-STATUS-KONTROLL                                          
021890     .                                                                    
021891     SKIP3                                                                
021900 IMS-DLET-WDH801  SECTION.                                                
022000                                                                          
022100     MOVE '  '                 TO GODK-STATUSKODER                        
022200     CALL CBLTDLI USING DLET PRIG-PCB DLI-IO-AREA                         
022300     MOVE PRIG-STATUS-CODE     TO STATUS-WS                               
022400     PERFORM IMS-STATUS-KONTROLL                                          
022500     .                                                                    
022600     EJECT                                                                
022710 IMS-RESTART SECTION.                                                     
022800     SKIP2                                                                
