...
002600     SELECT W01538                     ASSIGN TO W01538D1.                
002700                                                                          
002800     EJECT                                                                
...
004300                                                                          
004400 77  IDPGM                       PIC X(8)    VALUE 'W0153800'.            
004500 01  CHKP-VAR.                                                            
...
006100                                                                          
006200 77  W01538-EOF-SW               PIC X       VALUE 'N'.                   
006300     88  END-OF-W01538                       VALUE 'J'.                   
006400                                                                          
006500                                                                          
...
007300                                                                          
007400*01  AREA -COPY WDR801  -L   -PRE RENS-                                   
007500*                                                                         
007600                                                                          
007700     EJECT                                                                
...
008100     03  W-WDR801KY-X.                                                    
008200         05  W-WDR801KY          PIC X(27)    VALUE SPACE.                
008300                                                                          
008400                                                                          
...
010100                                                                          
010200 01  FILLER         PIC X(24) VALUE 'DLI-IO-WLFILB01'.                    
010300 01  DLI-IO-WLFILB01.                                                     
010400*    03  -COPY WDR801    -PRE FILB-                                       
010500                                                                          
010600     EJECT                                                                
010700 LINKAGE SECTION.                                                         
010800*01  -COPY W0009  -PRE MSG-                                               
010900                                                                          
011000*01  -COPY W0008  -PRE FILB-                                              
011100     05  FILLER                  PIC X.                                   
011200     EJECT                                                                
011300 PROCEDURE DIVISION  USING MSG-PCB FILB-PCB.                              
011400 MAIN SECTION.                                                            
011500     ENTRY 'DLITCBL' USING MSG-PCB FILB-PCB.                              
011600                                                                          
011700     PERFORM A-INIT                                                       
011800     PERFORM S01-LAES-W01538                                              
011900     PERFORM UNTIL END-OF-W01538                                          
012000       IF CHKP-ANT > CHKP-MAX                                             
012100         PERFORM X-TAG-CHECKPOINT                                         
012200       END-IF                                                             
012300       PERFORM B-LAES-RENSA-TRANS                                         
012400                                                                          
012500       PERFORM S01-LAES-W01538                                            
012600     END-PERFORM                                                          
012700                                                                          
012800                                                                          
...
014500                                                                          
014600     MOVE RENS-AREA TO W-WDR801KY                                         
014700     PERFORM IMS-GET-FILB-FIL                                             
014800     IF SEGMENT-FINNS                                                     
014900       PERFORM IMS-DLET-FILB-FIL                                          
...
016200     .                                                                    
016300     EJECT                                                                
016400 S01-LAES-W01538  SECTION.                                                
016500                                                                          
016600     READ W01538 INTO RENS-AREA                                           
016700     AT END                                                               
016800        MOVE HIGH-VALUE TO RENS-AREA                                      
016900        MOVE JA TO W01538-EOF-SW                                          
017000     NOT AT END                                                           
...
018400                                                                          
018500 IMS-GET-FILB-FIL SECTION.                                                
018600                                                                          
018700     STRING 'WDR801  (WDR801KY =' W-WDR801KY-X ')'                        
018800          DELIMITED BY SIZE INTO SSA1                                     
018900     MOVE '  GE' TO GODK-STATUSKODER                                      
019000     CALL CBLTDLI USING GHU FILB-PCB DLI-IO-WLFILB01 SSA1                 
019100     MOVE FILB-STATUS-CODE TO STATUS-WS                                   
019200     PERFORM IMS-STATUSKONTROLL                                           
019300     .                                                                    
019400                                                                          
019500                                                                          
019600 IMS-DLET-FILB-FIL SECTION.                                               
019700                                                                          
019800     MOVE '  ' TO GODK-STATUSKODER                                        
019900     CALL CBLTDLI USING DLET FILB-PCB DLI-IO-WLFILB01                     
020000     MOVE FILB-STATUS-CODE TO STATUS-WS                                   
