000100 ID  DIVISION.                                                            
000200     SKIP2                                                                
000300 PROGRAM-ID.    W4612N00.                                                 
000400*AUTHOR.        TINA LINDQVIST                                            
000500*DATE-WRITTEN.  DEC 2000                                                  
000600                                                                          
000700*REMARKS.                                                                 
000800*        IMPORTÖRSBEROENDE BEHANDLING (TURKIET)                           
...
002600     SELECT W4612N                       ASSIGN TO UT-S-W4612ND1.         
002700     SKIP2                                                                
002800*- - - - - - - - - - - - UTFIL:                                           
002900*                        - -  FIL TILL VIPS                               
003000     SELECT W4612Y                       ASSIGN TO UT-S-W4612ND2.         
003100     EJECT                                                                
...
005800*- - - - - - - - - - - - - -  PROGRAM-NAMN                                
005900 77  PROGRAM-NAMN                PIC X(8)    VALUE 'W4612N00'.            
006000     SKIP2                                                                
...
006700                                                                          
006800 77  W4612N-EOF                  PIC X(1)    VALUE 'N'.                   
006900     SKIP2                                                                
...
014000     SKIP2                                                                
014100     OPEN INPUT W4612N OUTPUT W4612Y                                      
014200     SKIP2                                                                
...
020600     MOVE     5811           TO START-IDDISTR                             
...
022300     .                                                                    
022400     SKIP2                                                                
022500 S01-LAS-W4612N SECTION.                                                  
022600     SKIP2                                                                
022700     READ   W4612N INTO W-ARBAREA                                         
022800     AT END MOVE JA TO W4612N-EOF                                         
022900     END-READ                                                             
023000                                                                          
023100     IF W4612N-EOF = NEJ                                                  
023200                                                                          
023300       MOVE 'W4612N'            TO POSTSUM-FDNAMN                         
023400       MOVE 'W4612ND1'          TO POSTSUM-DDNAMN2                        
