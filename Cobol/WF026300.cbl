...
001100*        THE PROGRAM READS   TABLE T01DOTY                                
001200*                                                                         
001300*    INDATA.                                                              
001400*        TRANSACTION: WF0263T                                             
...
002800 77  IDPGM                       PIC X(08)  VALUE 'WF026300'.             
002900                                                                          
...
004210                    VALUE 'CARPARTS.BILLIT.APPRDOCLOCATE'.                
004410                                                                          
...
005500 01  WS-COUNTER-T01DOTY          PIC S9(7)  VALUE ZERO    COMP-3.         
005510 01  WS-BELEGRAD-1               PIC X(35)  VALUE SPACE.                  
005520 01  WS-IDLEGSEL                 PIC X(4)   VALUE SPACE.                  
005551                                                                          
007710*    --- MAPPING FIELDS                                                   
007711 01  MAP-KDFINDOC-LINE           PIC X(4)   VALUE SPACE.                  
007712 01  MAP-BEFINDOC-LINE           PIC X(35)  VALUE SPACE.                  
...
008802         05  IS-INVALID              PIC X(3)   VALUE '023'.              
008803         05  MUST-BE-NUMERIC         PIC X(3)   VALUE '024'.              
008804         05  NOT-FOUND               PIC X(3)   VALUE '025'.              
008805         05  MUST-BE-ENTERED         PIC X(3)   VALUE '026'.              
008806         05  ERR-LINES-NOT-FOUND     PIC X(3)   VALUE '027'.              
008810         05  ERR-TOO-MANY-LINES      PIC X(3)   VALUE '028'.              
008820         05  SYSTEM-ERROR            PIC X(3)   VALUE '099'.              
009310     EJECT                                                                
009400                                                                          
...
012500     EJECT                                                                
012501                                                                          
012510 01  FILLER                      PIC X(16)   VALUE 'T01DOTY-AREA'.        
012600*01  -COPY T01DOTY -PRE T01DOTY-                                          
012700     EJECT                                                                
012800                                                                          
012900     EXEC SQL INCLUDE T01LSEL END-EXEC.                                   
013000     EJECT                                                                
013200     EXEC SQL INCLUDE T01DOTY END-EXEC.                                   
013300     EJECT                                                                
013310                                                                          
...
016005     MOVE ZERO                  TO WS-COUNTER-T01DOTY                     
016006                                   RESP-KVRADER                           
016500     .                                                                    
016600     EJECT                                                                
016700                                                                          
...
018400     END-IF                                                               
018500                                                                          
018510     IF REQU-IDUSER = SPACE OR = ALL '+'                                  
018511       MOVE NOO TO KEYS-SW                                                
018522     ELSE                                                                 
018523       CONTINUE                                                           
018524     END-IF                                                               
018530                                                                          
...
018900                                                                          
018901     IF KEYS-OK                                                           
018902       PERFORM DB2-SELECT-T01LSEL-TAB                                     
018903       IF LINES-FOUND                                                     
018904         CONTINUE                                                         
018905       ELSE                                                               
018906         MOVE NOT-FOUND    TO RESP-IDMSG-ERROR                            
018907         MOVE 'IDLEGSEL'   TO RESP-IDELMT-ERROR                           
018908         MOVE NOO TO KEYS-SW                                              
018909       END-IF                                                             
018910     END-IF                                                               
018911     .                                                                    
018920     EJECT                                                                
...
019600     MOVE REQU-KDFINDOC-KEY TO RESP-KDFINDOC-KEY                          
...
020610     MOVE ZERO TO WS-COUNTER-T01DOTY                                      
020700     IF REQU-KDFINDOC-KEY = SPACE OR = ALL '+'                            
020801       PERFORM FAB-HANDLE-KDFINDOC-KEY                                    
020802     ELSE                                                                 
020810       PERFORM FAA-HANDLE-KDFINDOC-KEY                                    
020910     END-IF                                                               
020920                                                                          
...
023900     EJECT                                                                
024000                                                                          
024010*** - HANDLE KEY KDFINDOC                                                 
024030 FAA-HANDLE-KDFINDOC-KEY SECTION.                                         
024041     PERFORM DB2-COUNT-CRS-1                                              
024046     IF WS-COUNTER-T01DOTY = ZERO                                         
024051       MOVE ERR-LINES-NOT-FOUND TO RESP-IDMSG-ERROR                       
024052     ELSE                                                                 
024053       IF WS-COUNTER-T01DOTY > WS-MAX-LINES                               
024054         MOVE ERR-TOO-MANY-LINES TO RESP-IDMSG-ERROR                      
024055       ELSE                                                               
024056         MOVE WS-COUNTER-T01DOTY TO RESP-KVRADER                          
024057       END-IF                                                             
024058     END-IF                                                               
024059                                                                          
024060     IF RESP-IDMSG-ERROR = SPACE                                          
024061       PERFORM DB2-DCL-OPN-T01DOTY-CRS-1                                  
024062       PERFORM DB2-FETCH-T01DOTY-CRS-1                                    
024063       MOVE ZERO TO WS-IX                                                 
024064                                                                          
024065       PERFORM UNTIL LINES-MISSING                                        
024066         PERFORM S03-MOVE-TO-RESPOND                                      
024067         PERFORM DB2-FETCH-T01DOTY-CRS-1                                  
024068       END-PERFORM                                                        
024069                                                                          
024070       PERFORM DB2-CLOSE-T01DOTY-CRS-1                                    
024071     END-IF                                                               
024072     .                                                                    
024073     EJECT                                                                
024074                                                                          
024075*** - HANDLE KEY KDFINDOC WHEN SPACE                                      
024076 FAB-HANDLE-KDFINDOC-KEY SECTION.                                         
024077     PERFORM DB2-COUNT-CRS-2                                              
024121     IF WS-COUNTER-T01DOTY = ZERO                                         
024123       MOVE ERR-LINES-NOT-FOUND TO RESP-IDMSG-ERROR                       
024127     ELSE                                                                 
024128       IF WS-COUNTER-T01DOTY > WS-MAX-LINES                               
024129         MOVE ERR-TOO-MANY-LINES TO RESP-IDMSG-ERROR                      
024130       ELSE                                                               
024131         MOVE WS-COUNTER-T01DOTY TO RESP-KVRADER                          
024132       END-IF                                                             
024133     END-IF                                                               
024134                                                                          
024135     IF RESP-IDMSG-ERROR = SPACE                                          
024136       PERFORM DB2-DCL-OPN-T01DOTY-CRS-2                                  
024137       PERFORM DB2-FETCH-T01DOTY-CRS-2                                    
024138       MOVE ZERO TO WS-IX                                                 
024139                                                                          
024140       PERFORM UNTIL LINES-MISSING                                        
024141         PERFORM S03-MOVE-TO-RESPOND                                      
024142         PERFORM DB2-FETCH-T01DOTY-CRS-2                                  
024143       END-PERFORM                                                        
024144                                                                          
024145       PERFORM DB2-CLOSE-T01DOTY-CRS-2                                    
024146     END-IF                                                               
024147     .                                                                    
024148     EJECT                                                                
024149                                                                          
...
031170       MOVE MAP-KDFINDOC-LINE     TO RESP-KDFINDOC-LINE(WS-IX)            
031171       MOVE MAP-BEFINDOC-LINE     TO RESP-BEFINDOC-LINE(WS-IX)            
...
031198       AND MAP-KDFINDOC-LINE =  RESP-KDFINDOC-LINE(WS-IX)                 
...
034260           SELECT COUNT(*)                                                
034270                                                                          
034280           INTO  :WS-COUNTER-T01DOTY                                      
034290                                                                          
034291           FROM   T01DOTY                                                 
034292                                                                          
034296           WHERE    IDLEGSEL = :REQU-IDLEGSEL-KEY                         
034297                AND KDFINDOC = :REQU-KDFINDOC-KEY                         
...
034308     EJECT                                                                
034309                                                                          
034310 DB2-DCL-OPN-T01DOTY-CRS-1 SECTION.                                       
034600     MOVE 000100 TO GOOD-SQLCODECODES                                     
034700                                                                          
034800     EXEC SQL                                                             
034900         DECLARE T01DOTY-CRS-1 CURSOR WITH HOLD FOR                       
035000                                                                          
035200           SELECT  BEFINDOC                                               
035300                 , KDFINDOC                                               
035310                 , KDSTATUS                                               
035400                 , DAREGDAT                                               
035500                 , DAUPPDAT                                               
...
036400                AND KDFINDOC = :REQU-KDFINDOC-KEY                         
...
038501     EJECT                                                                
038510                                                                          
038530 DB2-FETCH-T01DOTY-CRS-1 SECTION.                                         
038550     MOVE 000100  TO GOOD-SQLCODECODES                                    
038560                                                                          
038570     EXEC SQL                                                             
038580                                                                          
038590         FETCH T01DOTY-CRS-1                                              
038591                                                                          
038592         INTO :MAP-BEFINDOC-LINE                                          
038593            , :MAP-KDFINDOC-LINE                                          
...
038615     EJECT                                                                
038616                                                                          
038617 DB2-CLOSE-T01DOTY-CRS-1 SECTION.                                         
038619     EXEC SQL                                                             
038620        CLOSE T01DOTY-CRS-1                                               
038621     END-EXEC                                                             
038622     .                                                                    
038623     EJECT                                                                
038624                                                                          
...
042010     EJECT                                                                
042100                                                                          
042560 DB2-DCL-OPN-T01DOTY-CRS-2 SECTION.                                       
042700     MOVE 000100 TO GOOD-SQLCODECODES                                     
042800                                                                          
042900     EXEC SQL                                                             
043000         DECLARE T01DOTY-CRS-2 CURSOR WITH HOLD FOR                       
043100                                                                          
043300          SELECT   KDFINDOC                                               
043310                 , BEFINDOC                                               
043400                 , KDSTATUS                                               
043500                 , DAREGDAT                                               
043600                 , DAUPPDAT                                               
...
046600     EJECT                                                                
046610                                                                          
046620 DB2-FETCH-T01DOTY-CRS-2 SECTION.                                         
046640     MOVE 000100  TO GOOD-SQLCODECODES                                    
046650                                                                          
046660     EXEC SQL                                                             
046670                                                                          
046680         FETCH T01DOTY-CRS-2                                              
046690                                                                          
046691         INTO :MAP-KDFINDOC-LINE                                          
046692            , :MAP-BEFINDOC-LINE                                          
...
046714     EJECT                                                                
046715                                                                          
046716 DB2-CLOSE-T01DOTY-CRS-2 SECTION.                                         
046718     EXEC SQL                                                             
046719        CLOSE T01DOTY-CRS-2                                               
046720     END-EXEC                                                             
046721     .                                                                    
046722     EJECT                                                                
058900                                                                          
