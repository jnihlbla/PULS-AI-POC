...
000700                                                                          
000800*    FUNCTION:                                                            
000900*        CLEAR STOP DATE FOR ALARM 223 ON WDK611                          
001000*                                                                         
001100*        THE PROGRAM UPDATE    WDK611                                     
001200*                                                                         
001300                                                                          
001400     SKIP3                                                                
...
001900 FILE-CONTROL.                                                            
002000     SKIP2                                                                
002100*          --- UTDRAG UR WDK6                                             
002200     SELECT W01160                     ASSIGN TO W22167D1.                
002300     EJECT                                                                
...
003100                                                                          
003200*01  -COPY W01160      -L.                                                
003300     EJECT                                                                
003400 WORKING-STORAGE SECTION.                                                 
003500                                                                          
003600 77  IDPGM                       PIC X(8)    VALUE 'W2216700'.            
...
005000                                                                          
005100 77  W01160-EOF-SW               PIC X       VALUE 'N'.                   
005200     88  END-OF-W01160                       VALUE 'Y'.                   
005300     EJECT                                                                
...
007200     SKIP2                                                                
007300                                                                          
007400*01  AREA -COPY W01160     -PRE IN-                                       
007500*                                                                         
007600     EJECT                                                                
...
008200                                                                          
008300     03  W-KDSEGKEY-X.                                                    
008400         05  W-KDSEGKEY          PIC X(1)    VALUE '1'.                   
008500     SKIP2                                                                
...
010400                                                                          
010500 01  FILLER         PIC X(16) VALUE 'DLI-IO-WDK611'.                      
010600 01  DLI-IO-WDK611.                                                       
...
011800 MAIN SECTION.                                                            
011900     ENTRY 'DLITCBL' USING MSG-PCB WDK6-PCB.                              
012000                                                                          
012100     PERFORM A-INIT                                                       
012200     PERFORM S01-READ-W01160                                              
012300     PERFORM UNTIL END-OF-W01160                                          
012400                                                                          
012500       IF CHKP-ANT > CHKP-MAX                                             
012600         PERFORM X-TAKE-CHECKPOINT                                        
012700       END-IF                                                             
012710                                                                          
012800       IF IN-CLAG-TISTODAT-LARM > +0                                      
012810      AND IN-CLAG-TISTODAT-LARM < TODAYS-DATE                             
012900          MOVE IN-CLAG-IDARTNR TO W-IDARTNR                               
013000          PERFORM IMS-GHU-WDK611                                          
013100          IF SEGMENT-FOUND                                                
013200             MOVE +0           TO CLAG-TISTODAT-LARM                      
...
016600     .                                                                    
016700     EJECT                                                                
016800 S01-READ-W01160  SECTION.                                                
016900     SKIP2                                                                
017000     READ W01160        INTO IN-AREA                                      
017100     AT END                                                               
017300        SET END-OF-W01160 TO TRUE                                         
017400                                                                          
017500     NOT AT END                                                           
017600        MOVE 'W01160'     TO POSTSUM-FDNAMN                               
017700        MOVE 'W22167D1'   TO POSTSUM-DDNAMN2                              
...
018510     MOVE 'IMS-GHU-WDK611  ' TO DBS-SECTION                               
018600                                                                          
018700     STRING 'WDK601  (IDARTNR  =' W-IDARTNR-X ')'                         
018800          DELIMITED BY SIZE INTO SSA1                                     
018900     STRING 'WDK611  (KDSEGKEY =' W-KDSEGKEY-X ')'                        
019000          DELIMITED BY SIZE INTO SSA2                                     
019100     MOVE '  GE'              TO GOOD-STATUSCODES                         
019200     CALL CBLTDLI USING GHU WDK6-PCB DLI-IO-WDK611 SSA1 SSA2              
019300     MOVE WDK6-STATUS-CODE    TO STATUS-WS                                
019400     PERFORM IMS-STATUSCHECK                                              
019500     .                                                                    
019600                                                                          
019700 IMS-REPL-WDK611 SECTION.                                                 
019710     MOVE 'IMS-REPL-WDK611 ' TO DBS-SECTION                               
019800                                                                          
019900     MOVE '  '             TO GOOD-STATUSCODES                            
020000     CALL CBLTDLI  USING REPL WDK6-PCB DLI-IO-WDK611                      
020100     MOVE WDK6-STATUS-CODE TO STATUS-WS                                   
