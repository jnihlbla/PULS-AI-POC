...
010000 ID DIVISION.                                                             
020000 PROGRAM-ID.     WF102500.                                                
030000 AUTHOR.         BARSHARANI BISHOYE.                                      
040000 DATE-WRITTEN.   20/05/06.                                                
...
230000     SELECT W51293                     ASSIGN TO WF1025D1.                
240000     EJECT                                                                
250000*          --- ONE YEAR OF NON-VCCS RECORDS AS PER DC                     
260000     SELECT W51294                     ASSIGN TO WF1025D2.                
270000     EJECT                                                                
280000*          --- ONE YEAR OF VCCS RECORDS AS PER COMPANY                    
290000     SELECT W51295                     ASSIGN TO WF1025D3.                
300000     EJECT                                                                
310000*          --- ONE YEAR OF NON-VCCS RECORDS AS PER COMPANY                
320000     SELECT W51296                     ASSIGN TO WF1025D4.                
330000     EJECT                                                                
...
410000                                                                          
420000*01 POST-W51293 -COPY W51293   -L.                                        
430000     EJECT                                                                
440000     SKIP3                                                                
450000 FD  W51294                                                               
460000     RECORDING       F                                                    
...
480000                                                                          
490000*01 POST-W51294 -COPY W51293   -L.                                        
500000     EJECT                                                                
510000     SKIP3                                                                
520000 FD  W51295                                                               
530000     RECORDING       F                                                    
...
550000                                                                          
560000*01 POST-W51295 -COPY W51293   -L.                                        
570000     EJECT                                                                
580000     SKIP3                                                                
590000 FD  W51296                                                               
600000     RECORDING       F                                                    
...
620000                                                                          
630000*01 POST-W51296 -COPY W51293   -L.                                        
640000     EJECT                                                                
650000 WORKING-STORAGE SECTION.                                                 
660000                                                                          
670000 77  IDPGM                       PIC X(8)    VALUE 'WF102500'.            
680000     SKIP2                                                                
...
810000     EJECT                                                                
820000 01  PROGRAM-NAMN                PIC X(6)    VALUE 'WF1025'.              
830000                                                                          
...
730000           MOVE '100' TO  WS-IDEXCUST-MIN                                 
740000           MOVE '9000' TO  WS-IDEXCUST-MAX                                
750000         ELSE                                                             
760000           MOVE '1000' TO  WS-IDEXCUST-MIN                                
770000           MOVE '9999' TO  WS-IDEXCUST-MAX                                
780000         END-IF                                                           
...
830000             PERFORM S11-WRITE-W51293-W51294                              
...
930000             PERFORM S11-WRITE-W51295-W51296                              
...
070000     .                                                                    
080000     EJECT                                                                
090000 S11-WRITE-W51293-W51294 SECTION.                                         
100000     IF DLIN-IDLEGSEL  = 'VCCS'                                           
110000       WRITE POST-W51293 FROM UT-W51293                                   
120000     ELSE                                                                 
130000       WRITE POST-W51294 FROM UT-W51293                                   
140000     END-IF                                                               
150000     .                                                                    
160000     EJECT                                                                
170000 S11-WRITE-W51295-W51296 SECTION.                                         
180000     SKIP2                                                                
190000     IF DLIN-IDLEGSEL  = 'VCCS'                                           
200000       WRITE POST-W51295 FROM UT-W51293                                   
210000     ELSE                                                                 
220000       WRITE POST-W51296 FROM UT-W51293                                   
230000     END-IF                                                               
240000     .                                                                    
250000     EJECT                                                                
