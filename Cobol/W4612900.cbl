000400 ID  DIVISION.                                                            
000500     SKIP2                                                                
000600 PROGRAM-ID.    W4612900.                                                 
000700*              PROGRAM CONVERTED BY                                       
000800*              COBOL CONVERSION AID PO 5785-ABJ                           
000900*              CONVERSION DATE 05/25/91 18:33:18.                         
001000*AUTHOR.        N. N.                                                     
...
001500*    FUNKTION:                                                            
001600*                                                                         
001700*        IMPORTÖRSBEROENDE BEHANDLING (FINLAND)                           
...
003600     SELECT W46129                       ASSIGN TO UT-S-W46129D1.         
003700     SKIP2                                                                
003800*- - - - - - - - - - - - UTFIL:                                           
003900*                        - -  FIL TILL VIPS                               
004000     SELECT W46149                       ASSIGN TO UT-S-W46129D2.         
004100     SELECT W4614I                       ASSIGN TO UT-S-W46129D3.         
004200     EJECT                                                                
...
005780     SKIP2                                                                
005790 01  RKB-POST  -COPY W461RKBN     -L.                                     
005791     SKIP2                                                                
005792 01  RKC-POST  -COPY W461RKCN     -L.                                     
005793     SKIP2                                                                
005794 01  RKD-POST  -COPY W461RKDN     -L.                                     
005800 FD  W4614I                                                               
005900     RECORDING      V                                                     
...
006181     SKIP2                                                                
006190 01  RKB-POST2 -COPY W461RKBN     -L.                                     
006191     SKIP2                                                                
006192 01  RKC-POST2 -COPY W461RKCN     -L.                                     
006193     SKIP2                                                                
006194 01  RKD-POST2 -COPY W461RKDN     -L.                                     
006200     EJECT                                                                
006300 WORKING-STORAGE SECTION.                                                 
006310                                                                          
006400*    -- CHECKED BY WY2000                                                 
006900*- - - - - - - - - - - - - -  PROGRAM-NAMN                                
007000 77  PROGRAM-NAMN                PIC X(8)    VALUE 'W4612900'.            
007200     SKIP2                                                                
...
007900                                                                          
008000 77  W46129-EOF                  PIC X(1)    VALUE 'N'.                   
008100     SKIP2                                                                
...
015400     SKIP2                                                                
015500     OPEN INPUT W46129 OUTPUT W46149 W4614I                               
015600     SKIP2                                                                
...
017400     PERFORM S01-LAS-W46129                                               
017500     PERFORM UNTIL                                                        
017600      NOT ( W46129-EOF = NEJ )                                            
017700       IF W-RIF-IDPTYP  = 'RIF'                                           
017800         MOVE W-ARBAREA TO JFR-RIF-W461RIFN-CTX                           
017900         PERFORM S01-LAS-W46129                                           
018000       ELSE                                                               
018100         IF JFR-RIF-IDPTYP   = 'RIF'                                      
018200           ADD     +1           TO W-ANT-POSTER                           
018210           WRITE   UTPOST   FROM JFR-RIF-W461RIFN-CTX                     
018220           WRITE   UTPOST2  FROM JFR-RIF-W461RIFN-CTX                     
018500           MOVE SPACE TO JFR-RIF-W461RIFN-CTX                             
018600         END-IF                                                           
018700         IF W-RIF-IDPTYP = 'RIC' OR 'RIT'                                 
018800           PERFORM S01-LAS-W46129                                         
018900         ELSE                                                             
018910           EVALUATE    W-RIF-IDPTYP                                       
018920                                                                          
018930             WHEN  'RID'                                                  
018940                  WRITE RID-POST  FROM INPOST                             
018941                  WRITE RID-POST2 FROM INPOST                             
018950                                                                          
018960             WHEN  'RIE'                                                  
018970                  WRITE RIE-POST  FROM INPOST                             
018971                  WRITE RIE-POST2 FROM INPOST                             
018980                                                                          
018990             WHEN  'RIH'                                                  
019000                  WRITE RIH-POST  FROM INPOST                             
019001                  WRITE RIH-POST2 FROM INPOST                             
019010                                                                          
019020             WHEN  'RIO'                                                  
019030                  WRITE RIO-POST  FROM INPOST                             
019031                  WRITE RIO-POST2 FROM INPOST                             
019040                                                                          
019041             WHEN  'RKB'                                                  
019042                  WRITE RKB-POST  FROM INPOST                             
019043                  WRITE RKB-POST2 FROM INPOST                             
019044                                                                          
019045             WHEN  'RKC'                                                  
019046                  WRITE RKC-POST  FROM INPOST                             
019047                  WRITE RKC-POST2 FROM INPOST                             
019048                                                                          
019049             WHEN  'RKD'                                                  
019050                  WRITE RKD-POST  FROM INPOST                             
019051                  WRITE RKD-POST2 FROM INPOST                             
019052                                                                          
019053             WHEN  OTHER                                                  
019060                  WRITE UTPOST  FROM INPOST                               
019070                  WRITE UTPOST2 FROM INPOST                               
019085                                                                          
019086           END-EVALUATE                                                   
019087           ADD     +1           TO W-ANT-POSTER                           
019090           PERFORM S01-LAS-W46129                                         
019091         END-IF                                                           
019092       END-IF                                                             
019093     END-PERFORM                                                          
...
020300     MOVE     1090           TO START-IDDISTR                             
...
022200     .                                                                    
022300     SKIP2                                                                
022400 S01-LAS-W46129 SECTION.                                                  
022500     SKIP2                                                                
022600     READ   W46129 INTO W-ARBAREA                                         
022700     AT END MOVE JA TO W46129-EOF                                         
022800     END-READ                                                             
022900                                                                          
023000     IF W46129-EOF = NEJ                                                  
023100                                                                          
023200       MOVE 'W46129'            TO POSTSUM-FDNAMN                         
023300       MOVE 'W46129D1'          TO POSTSUM-DDNAMN2                        
...
024200     SKIP2                                                                
024300                                                                          
024400     CLOSE W46129 W46149 W4614I                                           
024500     SKIP2                                                                
