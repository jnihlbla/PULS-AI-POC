000100 ID  DIVISION.                                                            
000200     SKIP2                                                                
000300 PROGRAM-ID.    W4612H00.                                                 
000400*AUTHOR.        GERRY CARMICHAEL.                                         
000500*DATE-WRITTEN.  OKTOBER 1998.                                             
000600                                                                          
000700*    REMARKS.                                                             
000800*                                                                         
000900*    FUNKTION:                                                            
001000*                                                                         
001100*        IMPORTÖRSBEROENDE BEHANDLING (JAPAN)                             
001200*        FILER INNEHÅLLER TRANSAR DISTRIKT 5222.                          
001300*                                                                         
...
003000     SELECT W4612H                       ASSIGN TO UT-S-W4612HD1.         
003100     SKIP2                                                                
003200*- - - - - - - - - - - - UTFIL:                                           
003300*                        - -  FIL TILL VIPS                               
003400     SELECT W4612S                       ASSIGN TO UT-S-W4612HD2.         
003500     EJECT                                                                
...
006100*- - - - - - - - - - - - - -  PROGRAM-NAMN                                
006200 77  PROGRAM-NAMN                PIC X(8)    VALUE 'W4612H00'.            
006300     SKIP2                                                                
...
007000                                                                          
007100 77  W4612H-EOF                  PIC X(1)    VALUE 'N'.                   
007200     SKIP2                                                                
...
028400     SKIP2                                                                
028500     OPEN INPUT W4612H OUTPUT W4612S                                      
028600     SKIP2                                                                
...
031600         END-IF                                                           
031700         IF W-RIF-IDPTYP = 'RIC' OR 'RIQ' OR 'RIS' OR 'RKA'               
031800           PERFORM S01-LAS-W4612H                                         
031900         ELSE                                                             
...
033030                                                                          
033040             WHEN  'RKB'                                                  
033050                  WRITE RKB-POST FROM INPOST                              
033060                                                                          
033070             WHEN  'RKC'                                                  
033080                  WRITE RKC-POST FROM INPOST                              
033090                                                                          
033091             WHEN  'RKD'                                                  
033092                  WRITE RKD-POST FROM INPOST                              
033093                                                                          
033100             WHEN  OTHER                                                  
...
091000     MOVE     5222           TO START-IDDISTR                             
...
092700     .                                                                    
092800     SKIP2                                                                
092900 S01-LAS-W4612H SECTION.                                                  
093000     SKIP2                                                                
093100     READ   W4612H INTO W-ARBAREA                                         
093200     AT END MOVE JA TO W4612H-EOF                                         
093300     END-READ                                                             
093400                                                                          
093500     IF W4612H-EOF = NEJ                                                  
093600                                                                          
093700       MOVE 'W4612H'            TO POSTSUM-FDNAMN                         
093800       MOVE 'W4612HD1'          TO POSTSUM-DDNAMN2                        
