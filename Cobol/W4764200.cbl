000100 ID DIVISION.                                                             
000200     SKIP2                                                                
000300 PROGRAM-ID.     W4764200.                                                
000400*AUTHOR.         STINA MOGREN.                                            
000500*DATE-WRITTEN.   05/01/05.                                                
000600                                                                          
000700*    REMARKS.                                                             
000800*                                                                         
000900*    FUNKTION:                                                            
001000*        LÄSER NER LOGGTRANSAR FRÅN W476NAPR TILL SEKV.FIL.               
001010*                                                                         
001020*        SKAPAR DESSUTOM FIL FÖR ATT RENSA WDR7                           
001021*                                                                         
001030*        DETTA PROGRAM HÄMTAR ENDAST TYP 'NAP'                            
001100*                                                                         
...
002800 FILE-CONTROL.                                                            
002900     SKIP2                                                                
003000*          --- TRANSAR-LISTA                                              
003100     SELECT W47642-001                 ASSIGN TO W47642D1.                
003200     SKIP2                                                                
003600*          --- WDR7 TRANSAR SOM SKALL RENSAS                              
003700     SELECT W47643                     ASSIGN TO W47642D2.                
003710     SKIP2                                                                
003900 DATA DIVISION.                                                           
004000     SKIP3                                                                
004100 FILE SECTION.                                                            
004200     SKIP3                                                                
004300 FD  W47642-001                                                           
004310     LABEL RECORD    STANDARD                                             
004400     RECORDING       F                                                    
004500     BLOCK CONTAINS  0.                                                   
004600     SKIP2                                                                
004700 01  UT-POST.                                                             
004710     03  UT-RAD           PIC X(115).                                     
004800     SKIP3                                                                
005700 FD  W47643                                                               
005800     RECORDING       F                                                    
...
006500 77  IDPGM                       PIC X(8)    VALUE 'W4764200'.            
...
008800     EJECT                                                                
008810*                                                                         
008811*01  FILLER   -COPY W006PRAR                                              
008812     EJECT                                                                
008820                                                                          
008900 01  W47642-AREA-START           PIC X(16)   VALUE                        
009000                                 'W47642-AREA-STAR'.                      
009100     SKIP2                                                                
009200 01  UT-AREA-SPEC                PIC X(120).                              
009210 01  FILLER                      REDEFINES UT-AREA-SPEC.                  
009220     03  UT-STYR                 PIC S9(3) COMP-3.                        
009230     03  UT-AREA                 PIC X(118).                              
009300     SKIP2                                                                
009301 01  W-AREA                      PIC X(118).                              
009302 01  FILLER                      REDEFINES W-AREA.                        
009303     03  FILLER                  PIC X(66).                               
009304     03  W-INV-NR                PIC X(19).                               
009305     03  FILLER                  REDEFINES W-INV-NR.                      
009306      05  W-INVOICE              PIC X(7).                                
009307      05  FILLER                 PIC X(12).                               
009308     03  FILLER                  PIC X(33).                               
009309                                                                          
009310 01  UT-IDPTYP                   PIC X(3)   VALUE 'NAP'.                  
009320                                                                          
009810                                                                          
010400 01  WDR701-AREA-START           PIC X(16)   VALUE                        
010500                                 'WDR701-AREA-STAR'.                      
010600     SKIP2                                                                
...
016210         AND FIL-IDPGM = 'W476NAPR'                                       
016300         EVALUATE FIL-CT-IDPTYP                                           
017240           WHEN 'NAP'                                                     
017250             PERFORM B-SKAPA-POST                                         
017252             PERFORM S11-SKRIV-W47642                                     
017253             PERFORM C-SKAPA-EXTRA-RAD                                    
...
022900     MOVE FIL-WDR701-DATA        TO UT-AREA-SPEC                          
023100     .                                                                    
023200     EJECT                                                                
023300 C-SKAPA-EXTRA-RAD  SECTION.                                              
023310     MOVE UT-AREA                TO W-AREA                                
023320     IF W-INVOICE = 'Invoice'                                             
023330       MOVE SPACE                TO UT-AREA                               
023340       MOVE W-INV-NR             TO UT-AREA(45:19)                        
023341       WRITE UT-POST FROM UT-AREA AFTER ADVANCING 1 LINES                 
023350     END-IF                                                               
023400     .                                                                    
023500     EJECT                                                                
...
035900     PERFORM S14-SKRIV-W47643                                             
036000     .                                                                    
036100     EJECT                                                                
036336 Z-FINIT SECTION.                                                         
036340     CLOSE W47642-001                                                     
036500           W47643                                                         
036600     SKIP2                                                                
...
036900     .                                                                    
037000     EJECT                                                                
037100 S10-SKRIV  SECTION.                                                      
037110     IF PRT-RADSKIP = PRT-NYSIDA-RAD7                                     
037111       WRITE UT-POST FROM UT-AREA AFTER ADVANCING PAGE                    
037112     ELSE                                                                 
037113     IF PRT-RADSKIP = PRT-NYSIDA-RAD5                                     
037114       WRITE UT-POST FROM UT-AREA AFTER ADVANCING PAGE                    
037115     ELSE                                                                 
037116     IF PRT-RADSKIP = PRT-AFTER-1                                         
037117       WRITE UT-POST FROM UT-AREA AFTER ADVANCING 1 LINES                 
037118     ELSE                                                                 
037119     IF PRT-RADSKIP = PRT-AFTER-2                                         
037120       WRITE UT-POST FROM UT-AREA AFTER ADVANCING 2 LINES                 
037121     ELSE                                                                 
037122     IF PRT-RADSKIP = PRT-AFTER-3                                         
037123       WRITE UT-POST FROM UT-AREA AFTER ADVANCING 3 LINES                 
037124     ELSE                                                                 
037125     IF PRT-RADSKIP = PRT-AFTER-4                                         
037126       WRITE UT-POST FROM UT-AREA AFTER ADVANCING 4 LINES                 
037127     ELSE                                                                 
037128     IF PRT-RADSKIP = PRT-AFTER-8                                         
037129       WRITE UT-POST FROM UT-AREA AFTER ADVANCING 8 LINES                 
037130     ELSE                                                                 
037131     IF PRT-RADSKIP = PRT-AFTER-9                                         
037132       WRITE UT-POST FROM UT-AREA AFTER ADVANCING 9 LINES                 
037133     ELSE                                                                 
037134     IF PRT-RADSKIP = PRT-EQUAL-40                                        
037135       WRITE UT-POST FROM UT-AREA AFTER ADVANCING 3 LINES                 
037136     END-IF                                                               
037137     END-IF                                                               
037138     END-IF                                                               
037139     END-IF                                                               
...
037145     .                                                                    
037146     EJECT                                                                
037150 S11-SKRIV-W47642  SECTION.                                               
037200                                                                          
037310     MOVE UT-STYR         TO PRT-RADSKIP                                  
037320     PERFORM S10-SKRIV                                                    
037400                                                                          
037500     MOVE UT-IDPTYP       TO POSTSUM-TRANSTYP                             
037600     MOVE 'W47642'        TO POSTSUM-FDNAMN                               
037700     MOVE 'W47642D1'      TO POSTSUM-DDNAMN2                              
037800     CALL POSTSUM USING POSTSUM-PARM                                      
037900     .                                                                    
038000     EJECT                                                                
040100 S14-SKRIV-W47643  SECTION.                                               
040200     SKIP2                                                                
040300     WRITE RENS-POST      FROM RENS-AREA                                  
040400                                                                          
040500     MOVE SPACE           TO POSTSUM-TRANSTYP                             
040600     MOVE 'W47643'        TO POSTSUM-FDNAMN                               
040700     MOVE 'W47642D2'      TO POSTSUM-DDNAMN2                              
