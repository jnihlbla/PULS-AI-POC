000100 ID DIVISION.                                                             
000200 PROGRAM-ID.              W2218110.                                       
000300 AUTHOR.                  PA HELGEGREN.                                   
000400 DATE-WRITTEN.            OKTOBER 1993.                                   
000500     REMARKS.                                                             
000600*                                                                         
000900*        KOPIA PÅ W2218010 (NY ROT PÅ XXBL = 2217J)                       
001200*                                                                         
001300*        PROGRAMMET ÄR ETT SUBPROGRAM TILL W2218100                       
...
002300 77   PROGRAM-NAMN           VALUE 'W2218110'                             
002400                                 PIC X(8).                                
...
003900     05  FILLER                  PIC  X(5)  VALUE '2217J'.                
004000     05  FILLER                  PIC  X(25) VALUE LOW-VALUE.              
004100     SKIP3                                                                
...
019411        MOVE XXBK-2216-FLLEVPLP       TO LINK1-FLLEVPLP                   
019412        MOVE XXBK-2216-FLLEVVB        TO LINK1-FLLEVVB                    
019413        MOVE XXBK-2216-FLODETTE       TO LINK1-FLODETTE                   
019414***     FIX                                                               
019415        IF   LINK1-FLLEVPLP NOT = JA  AND                                 
019416             LINK1-FLLEVPLP NOT = NEJ                                     
019417             MOVE NEJ TO LINK1-FLLEVPLP                                   
019418        END-IF                                                            
019419        IF   LINK1-FLLEVVB  NOT = JA  AND                                 
019420             LINK1-FLLEVVB  NOT = NEJ                                     
019421             MOVE NEJ TO LINK1-FLLEVVB                                    
019422        END-IF                                                            
019423        IF   XXBK-2216-TISEND-PER    NOT NUMERIC                          
019424             MOVE ZERO                TO XXBK-2216-TISEND-PER             
019425        END-IF                                                            
019426***     FIX                                                               
019430        MOVE XXBK-2216-TISEND-PER     TO LINK1-TISEND-PER                 
019500                                                                          
019600        MOVE LINK0-KDSVAR-OK          TO LINK0-KDSVAR                     
019700     ELSE                                                                 
...
020400*    SKIP3                                                                
020500*    MOVE LINK1-W221L801          TO XXBK-2216-WDGX2216                   
020600*                                                                         
