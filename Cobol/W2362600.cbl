...
002400     SKIP2                                                                
002500*          --- LISTUNDERLAG                                               
002600     SELECT W23626                     ASSIGN TO W23626D1.                
002700     SKIP2                                                                
002800*          --- LISTA LEVERANSPRECISION                                    
002900     SELECT W23626-001                 ASSIGN TO W23626D2.                
003000     EJECT                                                                
...
004000     SKIP3                                                                
004100 FD  W23626-001                                                           
004200     RECORDING       F                                                    
004300     BLOCK CONTAINS  0.                                                   
004400     SKIP2                                                                
004500 01  W23626-001-RAD              PIC X(121).                              
004600     EJECT                                                                
004700 WORKING-STORAGE SECTION.                                                 
004800                                                                          
004900 77  IDPGM                       PIC X(8)    VALUE 'W2362600'.            
...
007310     03  TOT-ANTAL               PIC 9(6)    VALUE ZERO.                  
...
009800*                                                                         
009900 01  PROGRAM-NAMN                PIC X(6)    VALUE 'W23626'.              
010000     SKIP2                                                                
...
012300     03  W001-LISTNR             PIC X(11)   VALUE 'W23626-001'.          
...
013700                                 VALUE 'W23626-001'.                      
013800     03  FILLER                  PIC X(54)                                
013900     VALUE 'PERIOD: DELIVERY PRECISION IN % OF PRE ADVICES'.              
...
019810     03  W001-ANTAL              PIC Z(4)   VALUE ZERO.                   
...
021040     03  W001-IDLEVNR-TOT        PIC X(3)   VALUE SPACE.                  
021060     03  W001-ANTAL-TOT          PIC Z(6)   VALUE ZERO.                   
...
022700                                                                          
022800       PERFORM S01-LAES-W23626                                            
022900     END-PERFORM                                                          
...
024000                                                                          
024100     OPEN INPUT  W23626                                                   
024200                                                                          
024300     OPEN OUTPUT W23626-001                                               
024400     SKIP2                                                                
...
036200     PERFORM S21-SKRIV-W23626-001                                         
036300                                                                          
036400     .                                                                    
036500     EJECT                                                                
036510 D-SUMMERA-TOT-LEV   SECTION.                                             
036520                                                                          
036530     MOVE ZERO              TO TOT-TOTSUM                                 
036540                                                                          
036550     MOVE +1                TO IX-DEL                                     
036560     PERFORM UNTIL IX-DEL > 13                                            
036570        ADD TOT-SUM (IX-DEL) TO TOT-TOTSUM                                
036580        ADD +1              TO IX-DEL                                     
036590     END-PERFORM                                                          
036591                                                                          
036592     MOVE +1                TO IX-DEL                                     
036593     PERFORM UNTIL IX-DEL > 13                                            
036594        IF TOT-TOTSUM > ZERO                                              
036595           COMPUTE TOT-PROC (IX-DEL) ROUNDED =                            
036596                   100 * TOT-SUM (IX-DEL) / TOT-TOTSUM                    
036597        ELSE                                                              
036598           MOVE ZERO        TO TOT-PROC (IX-DEL)                          
036599        END-IF                                                            
036600        MOVE TOT-PROC (IX-DEL) TO W001-PROC-TOT (IX-DEL)                  
036601        ADD +1              TO IX-DEL                                     
036602     END-PERFORM                                                          
036603                                                                          
036604     PERFORM DA-SKRIV-SNITTAVVIKELSE                                      
036605                                                                          
036617     .                                                                    
036618     EJECT                                                                
036619 DA-SKRIV-SNITTAVVIKELSE SECTION.                                         
036620                                                                          
036621     MOVE 'TOT'           TO W001-IDLEVNR-TOT                             
036622                                                                          
036623     IF TOT-ANTAL > ZERO                                                  
036624        COMPUTE TOT-SNITT ROUNDED =                                       
036625                                TOT-SUMVIKT / TOT-ANTAL                   
036626     ELSE                                                                 
036627        MOVE ZERO            TO TOT-SNITT                                 
036628     END-IF                                                               
036629     MOVE TOT-SNITT          TO W001-SNITTAVV-TOT                         
036630     MOVE TOT-ANTAL          TO W001-ANTAL-TOT                            
036631     MOVE TOT-PROC (7)       TO W001-RATT-TOT                             
036632     MOVE ZERO               TO TOT-SENA TOT-TIDIGA                       
036633                                                                          
036634     MOVE +8                 TO IX-DEL                                    
036635     PERFORM UNTIL IX-DEL > 13                                            
036636        ADD TOT-PROC(IX-DEL) TO TOT-SENA                                  
036637        ADD +1               TO IX-DEL                                    
036638     END-PERFORM                                                          
036639     MOVE TOT-SENA           TO W001-SENA-TOT                             
036640                                                                          
036641     MOVE +1                 TO IX-DEL                                    
036642     PERFORM UNTIL IX-DEL > 6                                             
036643        ADD TOT-PROC(IX-DEL) TO TOT-TIDIGA                                
036644        ADD +1               TO IX-DEL                                    
036645     END-PERFORM                                                          
036646     MOVE TOT-TIDIGA         TO W001-TIDIGA-TOT                           
036647     MOVE W001-SNITT-TOT     TO W001-RAD                                  
036648     MOVE 50                 TO W001-RADRAKNARE                           
036649                                                                          
036650     PERFORM S21-SKRIV-W23626-001                                         
036651                                                                          
036652     .                                                                    
036653     EJECT                                                                
036660 Z-FINIT SECTION.                                                         
036700                                                                          
036800     CLOSE W23626                                                         
036900           W23626-001                                                     
037000     SKIP2                                                                
...
037300     .                                                                    
037400     EJECT                                                                
037500 S01-LAES-W23626  SECTION.                                                
037600     READ W23626 INTO IN-AREA                                             
037700     AT END                                                               
037800        SET END-OF-W23626 TO TRUE                                         
037900                                                                          
038000     NOT AT END                                                           
038100        MOVE 'W23626'   TO POSTSUM-FDNAMN                                 
038200        MOVE 'W23626D1' TO POSTSUM-DDNAMN2                                
038300        MOVE 'IN'       TO POSTSUM-TRANSTYP                               
038400        CALL POSTSUM USING POSTSUM-PARM                                   
038500     END-READ                                                             
038600     .                                                                    
038700     EJECT                                                                
038800 S21-SKRIV-W23626-001  SECTION.                                           
038900                                                                          
...
039300     END-IF                                                               
039400     SKIP2                                                                
039500     WRITE W23626-001-RAD FROM W001-RAD AFTER W001-SKIP                   
039600     SKIP2                                                                
039700     MOVE SPACE TO W001-RAD                                               
039800     ADD  +2 TO W001-RADRAKNARE                                           
039900     .                                                                    
040000     EJECT                                                                
040100 S21S-SKRIV-W23626-001  SECTION.                                          
040200                                                                          
...
040600     END-IF                                                               
040700     SKIP2                                                                
040800     WRITE W23626-001-RAD FROM W001-RAD AFTER W001-SKIP                   
040900     SKIP2                                                                
...
041800     WRITE W23626-001-RAD FROM W001-RUBRIK1 AFTER PAGE                    
041900     WRITE W23626-001-RAD FROM W001-RUBRIKA AFTER 2                       
042000     WRITE W23626-001-RAD FROM W001-RUBRIKB AFTER 1                       
