000100 ID DIVISION.                                                             
000200 PROGRAM-ID.     W4285200.                                                
000300 AUTHOR.         SHILPA MADHURI G.                                        
000400 DATE-WRITTEN.   11/11/15.                                                
000500 DATE-COMPILED.                                                           
000600                                                                          
000700******************************************************************        
000800*                                                                *        
000900* THE PROGRAM GENERATES A FILE TAKING THE COMBINED SORTED INPUT  *        
001000* PERIODIC FILE AND GENERATES A FILE FOR ALL THE IDDC'S SEPERATE *        
001100* LY WHICH INTURN WILL BE USED TO GENERATE REPORT ON THE WEB     *        
001200*                                                                *        
...
001800 FILE-CONTROL.                                                            
001900*          --- W4285A FILE                                                
002000       SELECT W4285A                     ASSIGN TO W42852D1.              
002100*          --- W42852 FILE                                                
002200       SELECT W428521                    ASSIGN TO W42852D2.              
002300       EJECT                                                              
...
002900                                                                          
003000*01   -COPY W42850      -PRE W4285A-                                      
003100                                                                          
003200 FD   W428521                                                             
003300      RECORDING       V                                                   
...
003700*01   -COPY W428521       -PRE U1-                                        
003800      EJECT                                                               
003900*01   -COPY W428522       -PRE U2-                                        
004000      EJECT                                                               
004100*01   -COPY W428523       -PRE U3-                                        
004200      EJECT                                                               
004300                                                                          
004400                                                                          
004500 01   W42852-001-LINE             PIC X(121).                             
004600      EJECT                                                               
004700 WORKING-STORAGE SECTION.                                                 
004800                                                                          
004900 77   IDPGM                       PIC X(8)    VALUE 'W4285200'.           
...
006400      88  END-OF-W4285A                       VALUE 'Y'.                  
006500      88  NO-EOF-W4285A                       VALUE 'N'.                  
006600                                                                          
006700 77   W001-HEADER-SW              PIC X       VALUE 'N'.                  
006800      88  HDR-WRITTEN                         VALUE 'Y'.                  
006900      88  HDR-NOTWRITTEN                      VALUE 'N'.                  
007000                                                                          
007100 77   W001-W4285A-SW              PIC X       VALUE 'N'.                  
007200      88  W4285A-EMPTY                        VALUE 'Y'.                  
007300      88  W4285A-NOTEMPTY                     VALUE 'N'.                  
007400                                                                          
007500      EJECT                                                               
...
011100      EJECT                                                               
011200                                                                          
011300 01   PROGRAM-NAME                PIC X(6)    VALUE 'W42852'.             
...
011900       EJECT                                                              
012000                                                                          
012400 01   W428F1-AREA-START           PIC X(24)   VALUE                       
012500                                   'W428F1-AREA-START  '.                 
012600                                                                          
...
013700     PERFORM S01-READ-W4285A                                              
013800     IF END-OF-W4285A                                                     
013900       SET W4285A-EMPTY TO TRUE                                           
014000     END-IF                                                               
014100                                                                          
014200     IF NOT END-OF-W4285A                                                 
014300       PERFORM UNTIL END-OF-W4285A                                        
014400        IF NOT END-OF-W4285A                                              
014600         PERFORM B-PROCESS-W4285A                                         
014700         PERFORM S01-READ-W4285A                                          
014800        END-IF                                                            
014900       END-PERFORM                                                        
015000       IF END-OF-W4285A                                                   
...
016700                                                                          
016800     OPEN INPUT  W4285A                                                   
016900                                                                          
017000     OPEN OUTPUT W428521                                                  
...
018300     .                                                                    
018400     EJECT                                                                
018500 S01-READ-W4285A  SECTION.                                                
018600     READ W4285A          INTO W428F1-AREA                                
018700     AT END                                                               
018800       MOVE HIGH-VALUE    TO W428F1-AREA                                  
018900       DISPLAY 'EOF1 REACHED'                                             
019000       SET END-OF-W4285A  TO TRUE                                         
019100                                                                          
019200     NOT AT END                                                           
019400       MOVE 'W4285A'      TO POSTSUM-FDNAMN                               
019500       MOVE 'W42852D1'    TO POSTSUM-DDNAMN2                              
019600       MOVE SPACES        TO POSTSUM-TRANSTYP                             
019700       CALL POSTSUM    USING POSTSUM-PARM                                 
019800       SET  W4285A-NOTEMPTY TO TRUE                                       
019900     END-READ                                                             
020000     .                                                                    
020100     EJECT                                                                
020200 B-PROCESS-W4285A    SECTION.                                             
020300     IF NOT END-OF-W4285A                                                 
...
025100     IF W4285A-KVRETINL > 0                                               
025200       ADD W4285A-KVRETINL      TO WS-TEMP-BIN                            
025300       ADD W4285A-KVRETINL      TO WS-TOT-BIN                             
025400       ADD W4285A-KVRETINL      TO W001-TOT-BIN                           
025500     END-IF                                                               
025600     IF W4285A-KVAVV-KVANT > 0                                            
025700       ADD W4285A-KVAVV-KVANT   TO WS-TEMP-DEV                            
025800       ADD W4285A-KVAVV-KVANT   TO WS-TOT-DEV                             
025900     END-IF                                                               
026000     IF W4285A-KVRETINL-SKR > 0                                           
026100       ADD W4285A-KVRETINL-SKR  TO WS-TEMP-SCRAP                          
026200       ADD W4285A-KVRETINL-SKR  TO WS-TOT-SCRAP                           
026300       ADD W4285A-KVRETINL-SKR  TO W001-TOT-SCRAP                         
026400     END-IF                                                               
026500     IF W4285A-KVAVV-KVAL   > 0                                           
026600       ADD W4285A-KVAVV-KVAL    TO WS-TEMP-QUAL                           
026700       ADD W4285A-KVAVV-KVAL    TO WS-TOT-QUAL                            
026800     END-IF                                                               
026900     ADD W4285A-KVDAGAR-INL     TO WS-TEMP-AVTIM                          
027000     .                                                                    
027100     EJECT                                                                
...
028700     MOVE U2-DOC-W428522      TO W001-LINE                                
028800     PERFORM S21-WRITE-W42852-001                                         
...
030600     MOVE U3-DOC-W428523     TO W001-LINE                                 
030700     PERFORM S21-WRITE-W42852-001                                         
...
031100     .                                                                    
031200     EJECT                                                                
031300 S21-WRITE-W42852-001  SECTION.                                           
031400                                                                          
031500     WRITE W42852-001-LINE FROM W001-LINE                                 
...
032300     MOVE W4285A-TISAAPP-INLINL-TIAAPP TO U1-DOC-TIAAPP                   
032400     MOVE DAP-IDDC         TO U1-DOC-IDDC                                 
032600     INITIALIZE               W001-LINE                                   
032700     MOVE U1-DOC-W428521   TO W001-LINE                                   
032900     WRITE W42852-001-LINE FROM W001-LINE                                 
033000     SET HDR-WRITTEN       TO TRUE                                        
033100     INITIALIZE               U1-DOC-W428521                              
033200     .                                                                    
033300     EJECT                                                                
...
034000     MOVE 'W4285A'                    TO POSTSUM-FDNAMN                   
034100     MOVE 'W42852D2'                  TO POSTSUM-DDNAMN2                  
...
035000     MOVE 'W428521'                   TO POSTSUM-FDNAMN                   
035100     MOVE 'W42852D2'                  TO POSTSUM-DDNAMN2                  
