...
002200 FILE-CONTROL.                                                            
002300     SKIP2                                                                
002400*          --- GÅGNA PERIODS INLEV                                        
002500     SELECT W23623                     ASSIGN TO W23629D1.                
002600     SKIP2                                                                
002700*          --- LISTA INLEVERANSTIDER                                      
002800     SELECT W23629-001                 ASSIGN TO W23629D2.                
002900     SKIP2                                                                
003000*          --- SORTERINGSFIL                                              
003100     SELECT SORTFIL                    ASSIGN TO W23629DS.                
003200     EJECT                                                                
...
004200     SKIP3                                                                
004300 FD  W23629-001                                                           
004400     RECORDING       F                                                    
004500     BLOCK CONTAINS  0.                                                   
004600     SKIP2                                                                
004700 01  W23629-001-RAD              PIC X(121).                              
004800     SKIP2                                                                
004900 SD  SORTFIL.                                                             
005000                                                                          
...
005400                                                                          
005500 77  IDPGM                       PIC X(8)    VALUE 'W2362900'.            
005600 77  JA                          PIC X       VALUE 'J'.                   
005700 77  NEJ                         PIC X       VALUE 'N'.                   
005800                                                                          
005900 77  W23623-EOF-SW               PIC X       VALUE 'N'.                   
006000     88  END-OF-W23623                       VALUE 'J'.                   
006100                                                                          
...
016400     03  W001-LISTNR             PIC X(11)   VALUE 'W23629-001'.          
...
017800                                 VALUE 'W23629-001'.                      
017900     03  FILLER                  PIC X(54)                                
018000     VALUE 'PERIOD: DELIVERY PRECISION IN % OF RECIVING DAYS'.            
...
022600     03  W001-BEFT-TOT           PIC X(3)   VALUE SPACE.                  
022700     03  W001-ANT-TOT            PIC Z(6)   VALUE ZERO.                   
...
028200                                                                          
028300     OPEN INPUT  W23623                                                   
028400         OUTPUT  W23629-001                                               
028500                                                                          
...
030700                                                                          
030800     PERFORM S01-LAES-W23623                                              
030900     PERFORM UNTIL END-OF-W23623                                          
031000       MOVE IN-AREA TO SORTWS-AREA                                        
031100       PERFORM S31-SORT-RELEASE                                           
031200       PERFORM S01-LAES-W23623                                            
031300     END-PERFORM                                                          
031400     .                                                                    
031500     EJECT                                                                
...
049800     PERFORM S21-SKRIV-W23629-001                                         
049900     .                                                                    
050000     EJECT                                                                
050100 CBAA-FIXA-JFR-VARDE      SECTION.                                        
050200                                                                          
050300     SKIP1                                                                
050400     MOVE ZERO           TO W001-JFRV                                     
050410                            IX-JFR                                        
050500*                 NEDAN:  LÅNGSAM MÅLNING                                 
050600     IF  OLD-BEFT  = +44                                                  
050700       MOVE +30          TO W001-JFRV                                     
050701                            IX-JFR                                        
050710*      *-- IX-JFR IS SET TO +13  AT END OF THIS SECTION                   
050800     END-IF                                                               
050900                                                                          
051000     IF  OLD-BEFT  = +57                                                  
051100       MOVE +15          TO W001-JFRV IX-JFR                              
051110*      *-- IX-JFR IS SET TO +13  AT END OF THIS SECTION                   
051200     END-IF                                                               
051300                                                                          
051310     IF  OLD-BEFT  = +46                                                  
051311     OR  OLD-BEFT  = +49                                                  
051320       MOVE +7           TO W001-JFRV IX-JFR                              
051330     END-IF                                                               
051340                                                                          
051350     IF (OLD-BEFT >= +21 AND <= +28)                                      
051360     OR  OLD-BEFT  = +84                                                  
051361     OR  OLD-BEFT  = +85                                                  
051370       MOVE +4           TO W001-JFRV IX-JFR                              
051380     END-IF                                                               
051390                                                                          
051400*                 NEDAN:  MÅLNING = FÖRP.KOD 41-49                        
051500     IF  OLD-BEFT  =  +6                                                  
051600     OR  OLD-BEFT  =  +9                                                  
051700     OR  OLD-BEFT  = +20                                                  
052000     OR  OLD-BEFT  = +38                                                  
052100     OR  OLD-BEFT  = +41                                                  
052200     OR  OLD-BEFT  = +42                                                  
052210     OR  OLD-BEFT  = +43                                                  
052300     OR  OLD-BEFT  = +45                                                  
052310     OR  OLD-BEFT  = +47                                                  
052500     OR  OLD-BEFT  = +66                                                  
052700     OR  OLD-BEFT  = +79                                                  
052900       MOVE +5           TO W001-JFRV IX-JFR                              
053000     END-IF                                                               
053100                                                                          
053200     IF  OLD-BEFT  = +10                                                  
053210     OR (OLD-BEFT >= +12 AND <= +16 )                                     
053220     OR  OLD-BEFT  = +18                                                  
053230     OR  OLD-BEFT  = +19                                                  
053240     OR  OLD-BEFT  = +32                                                  
053250     OR  OLD-BEFT  = +33                                                  
053260     OR  OLD-BEFT  = +34                                                  
053300     OR  OLD-BEFT  = +35                                                  
053400     OR  OLD-BEFT  = +36                                                  
053500     OR  OLD-BEFT  = +37                                                  
053600     OR  OLD-BEFT  = +39                                                  
053700     OR (OLD-BEFT >= +50 AND <= +54 )                                     
053800     OR  OLD-BEFT  = +56                                                  
053900     OR (OLD-BEFT >= +58 AND <= +62 )                                     
053910     OR  OLD-BEFT  = +63                                                  
054000     OR  OLD-BEFT  = +64                                                  
054100     OR  OLD-BEFT  = +65                                                  
054110     OR  OLD-BEFT  = +67                                                  
054200     OR  OLD-BEFT  = +68                                                  
054300     OR  OLD-BEFT  = +69                                                  
054400     OR  OLD-BEFT  = +81                                                  
054500     OR  OLD-BEFT  = +82                                                  
054600     OR  OLD-BEFT  = +83                                                  
054700     OR (OLD-BEFT >= +86 AND <= +89 )                                     
054800       MOVE +4           TO W001-JFRV IX-JFR                              
054900     END-IF                                                               
055000                                                                          
055100     IF  OLD-BEFT  =  +7                                                  
055101     OR  OLD-BEFT  =  +8                                                  
055110     OR  OLD-BEFT  = +48                                                  
055200     OR  OLD-BEFT  = +55                                                  
055300     OR  OLD-BEFT  = +74                                                  
055400     OR  OLD-BEFT  = +77                                                  
055410     OR  OLD-BEFT  = +78                                                  
055600     OR  OLD-BEFT  = +97                                                  
055700     OR  OLD-BEFT  = +98                                                  
055800       MOVE +3           TO W001-JFRV IX-JFR                              
055900     END-IF                                                               
056000                                                                          
056200     IF  OLD-BEFT  = +29                                                  
056300     OR  OLD-BEFT  = +30                                                  
056310     OR  OLD-BEFT  = +31                                                  
056320     OR  OLD-BEFT  = +73                                                  
056330     OR  OLD-BEFT  = +90                                                  
056400     OR  OLD-BEFT  = +91                                                  
056500       MOVE +2           TO W001-JFRV IX-JFR                              
056600     END-IF                                                               
056700                                                                          
056800     IF  OLD-BEFT <=  +5                                                  
057010     OR  OLD-BEFT  = +11                                                  
057020     OR  OLD-BEFT  = +17                                                  
057200     OR (OLD-BEFT >= +70 AND <= +72 )                                     
057500     OR  OLD-BEFT  = +80                                                  
057700     OR  OLD-BEFT  = +92                                                  
057800     OR  OLD-BEFT  = +94                                                  
057900     OR  OLD-BEFT  = +96                                                  
058000     OR  OLD-BEFT  = +99                                                  
058100       MOVE +1           TO W001-JFRV IX-JFR                              
058200     END-IF                                                               
058300                                                                          
058301     IF  OLD-BEFT  = +75                                                  
058302     OR  OLD-BEFT  = +76                                                  
058303     OR  OLD-BEFT  = +93                                                  
058304     OR  OLD-BEFT  = +95                                                  
058305        CONTINUE                                                          
058306*       -- FÅR INITIERINGSVÄRDET = ZERO                                   
058307     END-IF                                                               
058310                                                                          
058400     ADD +1 TO IX-JFR                                                     
058500     IF IX-JFR > + 13                                                     
058600       MOVE +13            TO IX-JFR                                      
058700     END-IF                                                               
058800     .                                                                    
058900     EJECT                                                                
...
061800                                                                          
061900     MOVE 'TOT'           TO W001-BEFT-TOT                                
062000                                                                          
...
064600                                                                          
064700     PERFORM S21-SKRIV-W23629-001                                         
064800     .                                                                    
064900     EJECT                                                                
...
065700     .                                                                    
065800     EJECT                                                                
065900 S01-LAES-W23623  SECTION.                                                
066000     READ W23623 INTO IN-AREA                                             
066100     AT END                                                               
066200        SET END-OF-W23623 TO TRUE                                         
066300                                                                          
066400     NOT AT END                                                           
066500        MOVE 'W23623'   TO POSTSUM-FDNAMN                                 
066600        MOVE 'W23629D1' TO POSTSUM-DDNAMN2                                
066700        MOVE 'IN'       TO POSTSUM-TRANSTYP                               
066800        CALL POSTSUM USING POSTSUM-PARM                                   
066900     END-READ                                                             
067000     .                                                                    
067100     EJECT                                                                
067200 S21-SKRIV-W23629-001  SECTION.                                           
067300                                                                          
...
067700     END-IF                                                               
067800     SKIP2                                                                
067900     WRITE W23629-001-RAD FROM W001-RAD AFTER W001-SKIP                   
068000     SKIP2                                                                
...
068900     WRITE W23629-001-RAD FROM W001-RUBRIK1 AFTER PAGE                    
069000     WRITE W23629-001-RAD FROM W001-RUBRIKA AFTER 2                       
069100     WRITE W23629-001-RAD FROM W001-RUBRIKB AFTER 1                       
