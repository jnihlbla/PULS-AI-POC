001000 ID DIVISION.                                                             
001100                                                                          
001200 PROGRAM-ID.     W9101300.                                                
001300 AUTHOR.         KJELL ANDRE.                                             
001400 DATE-WRITTEN.   96/12/16.                                                
001500 DATE-COMPILED.                                                           
001600                                                                          
001700*    FUNKTION:                                                            
001800*        LÄSER RPP-TRANSAR FRÅN WDR3 (W10113) OCH SKRIVER UT DEM          
...
003300 FILE-CONTROL.                                                            
003401     SKIP2                                                                
003402*          --- RPP (PPMS) -TRANSAR                                        
003403     SELECT W91013                     ASSIGN TO W91013D1.                
003404     SKIP2                                                                
003408*          --- LOGG PÅ TRANSAR SOM SKA TAS BORT                           
003410     SELECT W91014                     ASSIGN TO W91013D2.                
003600     EJECT                                                                
...
004005                                                                          
004006*01  POST -COPY W111PPMS -PRE RPP-  -L.                                   
004007     SKIP3                                                                
004014 FD  W91014                                                               
004015     RECORDING       F                                                    
...
004320                                                                          
004400 77  IDPGM                       PIC X(8)    VALUE 'W9101300'.            
...
007301     EJECT                                                                
007307 01  RPP-AREA-START               PIC X(24)   VALUE                       
007308                                 'RPP-AREA-START   '.                     
007309     SKIP2                                                                
007311*01  AREA -COPY W111PPMS    -PRE RPP-                                     
007312     EJECT                                                                
...
008101     03  W-IDCPYTXT-RPP-X        PIC X(8)    VALUE 'W111RPP '.            
008200     SKIP2                                                                
...
010900                                                                          
011110*    -- LÄS ALLA RPP-TRANSAR OCH SKRIV UT DEM                             
...
011502       WHEN 'W111RPP '                                                    
011510         MOVE FILC-FIL-WDR301-DATA TO RPP-AREA                            
011600         PERFORM S11-SKRIV-W91013-RPP                                     
011601                                                                          
011602         MOVE FILC-FIL-WDR301 TO LOGG-AREA                                
011603         PERFORM S13-SKRIV-W91014-LOGG                                    
011604                                                                          
011605       END-EVALUATE                                                       
011606                                                                          
...
014300     .                                                                    
014501     EJECT                                                                
014502 S11-SKRIV-W91013-RPP   SECTION.                                          
014503                                                                          
014504     WRITE RPP-POST  FROM RPP-AREA                                        
014505                                                                          
014506     MOVE 'RPP'      TO POSTSUM-TRANSTYP                                  
014507     MOVE 'W91013'   TO POSTSUM-FDNAMN                                    
014508     MOVE 'W91013D1' TO POSTSUM-DDNAMN2                                   
014509     CALL POSTSUM USING POSTSUM-PARM                                      
014510     .                                                                    
014511     EJECT                                                                
014522 S13-SKRIV-W91014-LOGG SECTION.                                           
014523                                                                          
014524     WRITE LOGG-POST FROM LOGG-AREA                                       
014525                                                                          
014526     MOVE SPACE      TO POSTSUM-TRANSTYP                                  
014527     MOVE 'W91014'   TO POSTSUM-FDNAMN                                    
014528     MOVE 'W91013D2' TO POSTSUM-DDNAMN2                                   
...
015603                                                                          
015604     STRING 'WLFILC01(IDCPYTXT =' W-IDCPYTXT-RPP-X  ')'                   
