000100 ID  DIVISION.                                                            
000200     SKIP2                                                                
000300 PROGRAM-ID.    W4613B00.                                                 
000400*AUTHOR.        STINA MOGREN.                                             
000500*DATE-WRITTEN.  SEPT 2006.                                                
000600                                                                          
000700*    REMARKS.                                                             
000800*                                                                         
000900*    FUNKTION:                                                            
001000*                                                                         
001100*        IMPORTÖRSBEROENDE BEHANDLING (KINA)                              
001110*        FILER INNEHÅLLER TRANSAR FÖR BÅDE DISTRIKT                       
001120*        6214   (TEST/PROD)                                               
...
002800     SELECT W4613B                       ASSIGN TO UT-S-W4613BD1.         
002900     SKIP2                                                                
003000*- - - - - - - - - - - - UTFIL:                                           
003100*                        - -  FIL TILL VIPS                               
003200     SELECT W461CN                       ASSIGN TO UT-S-W4613BD2.         
003300     EJECT                                                                
...
005300*- - - - - - - - - - - - - -  PROGRAM-NAMN                                
005400 77  PROGRAM-NAMN                PIC X(8)    VALUE 'W4613B00'.            
005500     SKIP2                                                                
...
006200                                                                          
006300 77  W4613B-EOF                  PIC X(1)    VALUE 'N'.                   
006400     SKIP2                                                                
...
013200     SKIP2                                                                
013300     OPEN INPUT W4613B OUTPUT W461CN                                      
013400     SKIP2                                                                
...
016400         END-IF                                                           
016500         IF W-RIF-IDPTYP = 'RIC' OR 'RIQ' OR 'RKF' OR 'RKO'               
016600           PERFORM S01-LAS-W4613B                                         
016700         ELSE                                                             
...
019494     MOVE     6214           TO START-IDDISTR                             
...
020800     .                                                                    
020900     SKIP2                                                                
021000 S01-LAS-W4613B SECTION.                                                  
021100     SKIP2                                                                
021200     READ   W4613B INTO W-ARBAREA                                         
021300     AT END MOVE JA TO W4613B-EOF                                         
021400     END-READ                                                             
021500                                                                          
021600     IF W4613B-EOF = NEJ                                                  
021700                                                                          
021800       MOVE 'W4613B'            TO POSTSUM-FDNAMN                         
021900       MOVE 'W4613BD1'          TO POSTSUM-DDNAMN2                        
