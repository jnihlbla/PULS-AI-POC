000100 ID DIVISION.                                                             
000200 PROGRAM-ID.     W1165000.                                                
000300 AUTHOR.         SATHISH T.                                               
000400 DATE-WRITTEN.   JUNE 2024.                                               
000500 DATE-COMPILED.                                                           
000600                                                                          
000700*                                                                         
000800*FUNCTION:                                                                
000900*Clone OF W11680.W11680 is used for VCOM ,W11650 is used for MQ.          
001000*Receive request from vips/customer and trigger routines for              
001100*supersession/partinfo for different countries to send back the           
001101*information.                                                             
001102*                                                                         
001300*    ABENDKODER:                                                          
001400*        U0016 -  . . . .                                                 
...
002300 FILE-CONTROL.                                                            
002400     SKIP2                                                                
002500*          --- COUNTRY INFO FROM VIPS                                     
002600     SELECT SYSIN                      ASSIGN TO W11650D1.                
002700     SKIP2                                                                
002800*          --- INFIL FRÅN BESTÄLLARE                                      
002900     SELECT INFIL                      ASSIGN TO W11650D2.                
003000     EJECT                                                                
...
005100 77  IDPGM                       PIC X(8)    VALUE 'W1165000'.            
...
008000 01  PARM-AREA.                                                           
008100     03  PARM-IDLANDX2           PIC X(2).                                
008300                                                                          
...
010100     MOVE PARM-IDLANDX2 TO SOP-IDLANDX2                                   
...
011700                                                                          
011800************* TOTAL FILE SPARE PART INFO                                  
011900                                                                          
012000     IF IN-BESTALLNING = 'PART '                                          
012010        MOVE SOP-SYMB-AREA TO SOP-SYMBOLIC-VARIABLES                      
012020        IF PARM-IDLANDX2 = 'US' OR 'CA' OR 'JP' OR 'AU' OR                
012110                       'IN' OR 'KR' OR 'CN' OR 'TR' OR 'MY' OR            
...
013900     END-IF                                                               
014000                                                                          
014100************* TOTAL FILE SUPERSESSION INFO                                
014200                                                                          
014300     IF IN-BESTALLNING = 'SUPER'                                          
014400        IF PARM-IDLANDX2 = 'JP' OR 'AU' OR 'IN' OR 'KR' OR 'TR'           
014401                    OR 'CN' OR 'MY' OR 'TH' OR 'TW' OR 'MX'               
014402                    OR 'ZA' OR 'BR'                                       
014405           MOVE 'W116SF'        TO SOP-PROC-NAME                          
014406           MOVE SOP-SYMB-AREA   TO                                        
014407                           SOP-SYMBOLIC-VARIABLES                         
014408        ELSE                                                              
014409           IF PARM-IDLANDX2 = 'US'                                        
014500              MOVE 'W116S7'       TO SOP-PROC-NAME                        
014600           ELSE                                                           
014700              IF PARM-IDLANDX2 = 'CA'                                     
...
021600         OR 'W116S7' OR 'W116S8' OR 'W116SF'                              
021900                                                                          
