...
001300 FILE-CONTROL.                                                            
001400                                                                          
001501     SELECT W51571B ASSIGN       TO W51571D1.                             
001600                                                                          
001701     SELECT W51571  ASSIGN       TO W51571D2.                             
001800                                                                          
001900     EJECT                                                                
...
003700     SKIP3                                                                
003801 77  IDPGM                   PIC X(8)      VALUE 'W5157100'.              
003900 77  JA                      PIC X         VALUE 'J'.                     
004000 77  NEJ                     PIC X         VALUE 'N'.                     
004101 77  EOF-W51571B             PIC X         VALUE 'N'.                     
004200 77  LINE-COUNT              PIC S9(3)     VALUE +1 COMP SYNC.            
004300                                                                          
004400 01  SUBPROGRAM.                                                          
004500     03  POSTSUM             PIC X(8)    VALUE 'POSTSUM'.                 
004600                                                                          
004701 01  W51571B-TRANSID.                                                     
004801     03  FILLER              PIC X(6) VALUE 'W51571'.                     
004901     03  FILLER              PIC X(8) VALUE 'W51571D1'.                   
005000     03  FILLER              PIC X(4) VALUE ' IN1'.                       
005100                                                                          
005201 01  W51571-TRANSID.                                                      
005301     03  FILLER              PIC X(6) VALUE 'W51571'.                     
005401     03  FILLER              PIC X(8) VALUE 'W51571D4'.                   
...
009500                                                                          
009601     PERFORM S01-READ-W51571B-POST                                        
009701     PERFORM UNTIL  EOF-W51571B = JA                                      
...
010500           CONTINUE                                                       
010600         ELSE                                                             
010701           PERFORM S06-CREATE-FILE-W51571-HEAD                            
...
011801           PERFORM S06-CREATE-FILE-W51571-HEAD                            
011900         END-IF                                                           
012000         MOVE INAREA2 TO UTAREA2                                          
012101         PERFORM S06-CREATE-FILE-W51571-LINE                              
012200       END-IF                                                             
012301       PERFORM S01-READ-W51571B-POST                                      
012400     END-PERFORM                                                          
012500                                                                          
...
013401     OPEN INPUT  W51571B                                                  
013501     OPEN OUTPUT W51571                                                   
013600                                                                          
...
014800     EJECT                                                                
014900                                                                          
015001 S01-READ-W51571B-POST SECTION.                                           
015101     READ W51571B INTO INAREA2                                            
015200     AT END                                                               
015301       MOVE JA TO EOF-W51571B                                             
015400     NOT AT END                                                           
015501       MOVE W51571B-TRANSID TO POSTSUM-TRANSID                            
015600       CALL POSTSUM USING POSTSUM-PARM                                    
015700     END-READ                                                             
015800     .                                                                    
015900     SKIP2                                                                
016000                                                                          
016101 S06-CREATE-FILE-W51571-HEAD SECTION.                                     
016200     WRITE R3-71HEAD-POST  FROM UTAREA1                                   
016301     MOVE W51571-TRANSID TO POSTSUM-TRANSID                               
016400     CALL POSTSUM USING POSTSUM-PARM                                      
016500     .                                                                    
016600     EJECT                                                                
016700                                                                          
016801 S06-CREATE-FILE-W51571-LINE SECTION.                                     
016900     WRITE R3-71LINE-POST  FROM UTAREA2                                   
017001     MOVE W51571-TRANSID TO POSTSUM-TRANSID                               
