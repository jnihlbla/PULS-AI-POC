...
000090*REMARKS:                                                                 
000100*                                                                         
000110*  * ACTION CODE U (UPDATE) ON EXTRACT-AUTHORITY PANEL                    
000130*                                                                         
000140*  * DB2-TABLES:                                                          
000150*                                                                         
000160*        EXTRACT_USER                                                     
...
000660*--------------------------------------------------------------           
000670 01  PROGRAM-NAME                 PIC X(8)  VALUE 'V1617030'.             
...
000829     SKIP2                                                                
000835 01  N-PANEL-V161703M.                                                    
000837     03 N-EXTRACTID               PIC X(8)  VALUE 'V161703A'.             
000838     03 N-USERID                  PIC X(8)  VALUE 'V161703B'.             
000839     03 N-AUTH                    PIC X(8)  VALUE 'V161703C'.             
000844     SKIP2                                                                
000848 01  LTH-PANEL-V161703M.                                                  
000849     03 LTH-USERID                PIC S9(6) VALUE 7  COMP.                
000850     03 LTH-EXTRACTID             PIC S9(6) VALUE 8  COMP.                
000852     03 LTH-AUTH                  PIC S9(6) VALUE 1  COMP.                
000857     SKIP2                                                                
000860 01  ISPF-PANEL-V161703M.                                                 
000861     03 ISPF-USERID               PIC X(7)  VALUE SPACE.                  
000862     03 ISPF-EXTRACTID            PIC X(8)  VALUE SPACE.                  
000864     03 ISPF-AUTH                 PIC X(1)  VALUE SPACE.                  
000869     SKIP2                                                                
000872*--------------------------------------------------------------           
000873*ISPF-CONSTANTS                                                           
000874*--------------------------------------------------------------           
...
000880*ISPF-FIELDS                                                              
000881*--------------------------------------------------------------           
000882 01  V161703M                     PIC X(8)  VALUE 'V1617030'.             
...
001273*--------------------------------------------------------------           
001276 01  PARM-EXTRACTID         PIC X(8).                                     
001277 01  PARM-USERID            PIC X(7).                                     
001280*************************************************************             
001290 PROCEDURE DIVISION USING PARM-EXTRACTID                                  
001291                          PARM-USERID.                                    
001300*************************************************************             
...
001318           PERFORM D-UPDATE-EXTRACTID                                     
001319         END-IF                                                           
001320       END-IF                                                             
001330     END-IF                                                               
...
001523     PERFORM AB-VDEF-PANEL-V161703M                                       
001540     CONTINUE.                                                            
001550     EJECT                                                                
001560*--------------------------------------------------------------           
...
001650     EJECT                                                                
001694*--------------------------------------------------------------           
001695 AB-VDEF-PANEL-V161703M SECTION.                                          
001696*--------------------------------------------------------------           
001697     MOVE 'AB-VDEF-PANEL-V161703M    ' TO ABEND-SECTION                   
001698D    DISPLAY ABEND-SECTION                                                
001699     SKIP2                                                                
001700     CALL 'ISPLINK' USING VDEFINE N-USERID     ISPF-USERID                
001701                          CHAR LTH-USERID                                 
001702     CALL 'ISPLINK' USING VDEFINE N-EXTRACTID ISPF-EXTRACTID              
001703                          CHAR LTH-EXTRACTID                              
...
001903     MOVE PARM-EXTRACTID        TO ISPF-EXTRACTID                         
001904     MOVE EXTUSER-AUTH TO ISPF-AUTH                                       
...
001960     EJECT                                                                
001961*--------------------------------------------------------------           
001962 D-UPDATE-EXTRACTID SECTION.                                              
001963*--------------------------------------------------------------           
001964     MOVE 'D-UPDATE-EXTRACTID      ' TO ABEND-SECTION                     
001965D    DISPLAY ABEND-SECTION                                                
001966     SKIP2                                                                
001967     MOVE ISPF-EXTRACTID     TO EXTUSER-EXTRACTID                         
001968     MOVE ISPF-USERID        TO EXTUSER-USERID                            
001969     MOVE ISPF-AUTH TO EXTUSER-AUTH                                       
001979     PERFORM SQL-UPDATE-EXTUSER                                           
...
002031     SKIP2                                                                
002033     PERFORM ZA-VDEL-PANEL-V161703M                                       
002034     MOVE RCODE TO RETURN-CODE                                            
002040     CONTINUE.                                                            
002050     EJECT                                                                
003010*--------------------------------------------------------------           
003020 ZA-VDEL-PANEL-V161703M SECTION.                                          
003030*--------------------------------------------------------------           
003031     MOVE 'ZA-VDEL-PANEL-V161703M    ' TO ABEND-SECTION                   
...
003053     SKIP2                                                                
003054     CALL 'ISPLINK' USING DISPLAYE V161703M                               
...
003109     EXEC SQL                                                             
003110        SELECT  AUTH                                                      
003113        INTO :EXTUSER-AUTH                                                
003119        FROM EXTRACT_USER                                                 
003120        WHERE EXTRACTID = :EXTUSER-EXTRACTID                              
003121        AND   USERID    = :EXTUSER-USERID                                 
003123     END-EXEC                                                             
003124     PERFORM S95-CONTROL-SQLCODE                                          
003125     CONTINUE.                                                            
003126     EJECT                                                                
003127*--------------------------------------------------------------           
003128 SQL-UPDATE-EXTUSER SECTION.                                              
003129*--------------------------------------------------------------           
003130     MOVE 'SQL-UPDATE-EXTUSER        ' TO ABEND-SECTION                   
003131D    DISPLAY ABEND-SECTION                                                
003132     SKIP2                                                                
003133     EXEC SQL                                                             
003134        UPDATE EXTRACT_USER                                               
003135        SET USERID        = :EXTUSER-USERID,                              
003136            AUTH = :EXTUSER-AUTH                                          
003140        WHERE EXTRACTID  = :EXTUSER-EXTRACTID                             
003141        AND   USERID     = :EXTUSER-USERID                                
003143     END-EXEC                                                             
