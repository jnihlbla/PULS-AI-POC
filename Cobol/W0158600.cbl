...
003700 77  IDPGM                       PIC X(8)    VALUE 'W0158600'.            
...
007710 01  UTAREA.                                                              
007720*    03  SEGNAMN.                                                         
007730*      05 FILLER                 PIC X(4).                                
007740*      05 SEG-TYP                PIC X(4).                                
007750*    03  SEGKEY                  PIC X(38).                               
...
013000       MOVE SEG-KFB(1:LENGTH-FB-KEY) TO SEGKEY(1:LENGTH-FB-KEY)           
