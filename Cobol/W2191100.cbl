...
000700*    FUNKTION:                                                            
000800*                                                                         
000900*                PROGRAMMET SUMMERAR DATA PER KAMPANJ OCH ARTIKEL         
001000*                FRÅN QW90                                                
001500*                                                                         
001600*                                                                         
001700*    ABENDKODER:                                                          
...
002700 FILE-CONTROL.                                                            
002800     SKIP2                                                                
002810     SELECT W21911IN                   ASSIGN TO W21911D1.                
002900*                                                                         
003000     SELECT W21911UT                   ASSIGN TO W21911D2.                
004000     SKIP2                                                                
004100     EJECT                                                                
...
004480                                                                          
004481                                                                          
004483*01  POST -COPY W21910QW  -PRE  IN-  -L.                                  
004491                                                                          
004492     SKIP3                                                                
004493                                                                          
004494 FD  W21911UT                                                             
...
004500                                                                          
004501*01  POST -COPY W21911   -PRE  UT-  -L.                                   
004600                                                                          
009100*                                                                         
009200     EJECT                                                                
009300 WORKING-STORAGE SECTION.                                                 
009400*    -- CHECKED BY WY2000                                                 
009500 77  IDPGM                       PIC X(8)    VALUE 'W2191100'.            
...
010844     03  WS-SPARA-IDARTNR        PIC 9(9)    VALUE ZERO.                  
010846     03  WS-KVREPANT             PIC 9(9)V9(2)                            
010847                                             VALUE ZERO.                  
010848     03  WS-ANTAL-MARKN          PIC 9(9)    VALUE ZERO.                  
010849     03  WS-ANTAL-UTFIL          PIC 9(9)    VALUE ZERO.                  
012700     EJECT                                                                
...
018400                                                                          
018500 77  W21911-EOF-SW               PIC X       VALUE 'N'.                   
018600     88  END-OF-W21911                       VALUE 'J'.                   
018900     EJECT                                                                
...
021300     SKIP2                                                                
021400*01  AREA -COPY W21911QW   -PRE IN-                                       
022800                                                                          
022900     EJECT                                                                
023000 01  UT-AREA-START              PIC X(24)   VALUE                         
023100                                 'UT-AREA-START  '.                       
023110*01  AREA -COPY W21911     -PRE UT-                                       
023200     SKIP2                                                                
023210                                                                          
023310                                                                          
023400     EJECT                                                                
...
023800                                                                          
023910     PERFORM S01-LAES-W21911IN                                            
024100                                                                          
024200     PERFORM UNTIL END-OF-W21911                                          
024410                                                                          
024411       PERFORM B-NOLLSTALL                                                
024412       MOVE IN-IDKAMP        TO WS-SPARA-IDKAMP                           
024413       MOVE IN-IDARTNR       TO WS-SPARA-IDARTNR                          
024415       PERFORM UNTIL END-OF-W21911                                        
024416       OR NOT (IN-IDKAMP  = WS-SPARA-IDKAMP                               
024417       AND     IN-IDARTNR = WS-SPARA-IDARTNR)                             
024418                                                                          
024419         ADD 1               TO WS-ANTAL-MARKN                            
024430         PERFORM C-BEHANDLA                                               
024540                                                                          
024900         PERFORM S01-LAES-W21911IN                                        
026092                                                                          
026100       END-PERFORM                                                        
026102                                                                          
026129                                                                          
026130                                                                          
026131       MOVE 'Q9A'            TO UT-IDPTYP                                 
026132       MOVE WS-SPARA-IDKAMP  TO UT-IDKAMP                                 
026133       MOVE WS-SPARA-IDARTNR TO UT-IDARTNR                                
026134       COMPUTE WS-KVREPANT ROUNDED =                                      
026135               WS-KVREPANT / WS-ANTAL-MARKN                               
026136       COMPUTE UT-KVREPANT ROUNDED = WS-KVREPANT * 1                      
026150       PERFORM S02-SKRIV-UTFIL                                            
027000                                                                          
027199     END-PERFORM                                                          
027200                                                                          
027300     IF WS-ANTAL-UTFIL = ZERO                                             
027310         STRING ' OMKÖRNING ?   KTRL VECKA !  SE A-INIT   '               
027320         DELIMITED BY SIZE INTO FELTEXT-STR                               
027600         CALL FELLOG                                                      
027700     END-IF                                                               
030000                                                                          
...
030800     SKIP2                                                                
030900                                                                          
031000     OPEN INPUT  W21911IN                                                 
031200     OPEN OUTPUT W21911UT                                                 
...
031598         CALL FELLOG                                                      
031599     END-IF                                                               
031600* VID OMKÖRNING VECKAN EFTER      START                                   
031601*                                                                         
031602*    SUBTRACT 1              FROM WS-AKTUELL-AAVV                         
031603*                                                                         
031604* OBS LÄGG I FIXA OCH KÖR DÄRIFRÅN !                                      
031605*                                                                         
031607* VID OMKÖRNING VECKAN EFTER      SLUT                                    
031608     .                                                                    
031609     EJECT                                                                
031610 B-NOLLSTALL SECTION.                                                     
031611     SKIP2                                                                
031612                                                                          
031613     MOVE ZERO               TO WS-KVREPANT                               
031620                                WS-ANTAL-MARKN                            
031628     .                                                                    
031629     EJECT                                                                
031630 C-BEHANDLA SECTION.                                                      
031631                                                                          
031632     ADD IN-KVREPANT         TO WS-KVREPANT                               
031670     .                                                                    
031700     EJECT                                                                
031800                                                                          
...
032000                                                                          
032100                                                                          
032300     CLOSE W21911IN                                                       
032400           W21911UT                                                       
032600     .                                                                    
032700     EJECT                                                                
032800 S01-LAES-W21911IN SECTION.                                               
032900     SKIP2                                                                
032901     READ W21911IN           INTO IN-AREA                                 
032902     AT END                                                               
032903        MOVE JA TO W21911-EOF-SW                                          
032904                                                                          
032905     END-READ                                                             
032906                                                                          
...
032950       MOVE DAT-TIAAVV-GRP   TO WS-KTRL-AAVV                              
032960     ELSE                                                                 
032970       MOVE ZERO             TO WS-KTRL-AAVV                              
032980     END-IF                                                               
032990                                                                          
033000     PERFORM UNTIL END-OF-W21911                                          
033100     OR WS-AKTUELL-AAVV = WS-KTRL-AAVV                                    
033200                                                                          
033300       READ W21911IN         INTO IN-AREA                                 
033400       AT END                                                             
033410          MOVE JA TO W21911-EOF-SW                                        
033420                                                                          
033430       END-READ                                                           
033440                                                                          
033450       MOVE 'AAMMDD'         TO DAT-KDDATFORM                             
033460       MOVE IN-TICREATE      TO DAT-I-TIDATUM                             
033470                                                                          
033480       CALL WDATKONV USING DAT-KDDATFORM DAT-I-TIDATUM                    
033490                       DAT-O-TIDATUM DAT-KDSVAR                           
033491                                                                          
033492       IF DAT-KDSVAR-OK                                                   
033493         MOVE DAT-TIAAVV-GRP TO WS-KTRL-AAVV                              
033494       ELSE                                                               
033495         MOVE ZERO           TO WS-KTRL-AAVV                              
033496       END-IF                                                             
033497     END-PERFORM                                                          
033500     .                                                                    
033600     EJECT                                                                
