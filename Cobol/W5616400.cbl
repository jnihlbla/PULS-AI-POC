000100 ID DIVISION.                                                             
000200 PROGRAM-ID.     W5616400.                                                
000300 AUTHOR.         ARCHANA BHAT.                                            
000400 DATE-WRITTEN.   20171103.                                                
000500 DATE-COMPILED.                                                           
000600                                                                          
000700                                                                          
000800*    FUNKTION:                                                            
000900*        PROGRAMMET LÄSER IN UPPDATERINGS-POSTER FRÅN FIL W5616F          
...
001900 FILE-CONTROL.                                                            
002000     SKIP2                                                                
002100*          --- INFIL FRÅN PGM W5616300                                    
002200     SELECT W5616F                     ASSIGN TO W56164D1.                
002300     SKIP2                                                                
002310*          --- INFIL FRÅN PGM W5616300                                    
002320     SELECT W5616B                     ASSIGN TO W56164D2.                
002330     SKIP2                                                                
002400*          --- UTFIL FRÅN PGM W5616400                                    
002500     SELECT W5616M                     ASSIGN TO W56164D3.                
002600     SKIP2                                                                
...
003900 01  W5616M-001              PIC X(999).                                  
004000     SKIP3                                                                
004100 WORKING-STORAGE SECTION.                                                 
004200                                                                          
004300 77  IDPGM                       PIC X(8)    VALUE 'W5616400'.            
004400 01  CHKP-VAR.                                                            
...
005700                                                                          
005800 77  W5616F-EOF-SW               PIC X       VALUE 'N'.                   
005900     88  END-OF-W5616F                       VALUE 'J'.                   
006000                                                                          
006001 77  W5616B-EOF-SW               PIC X       VALUE 'N'.                   
006002     88  END-OF-W5616B                       VALUE 'J'.                   
006003                                                                          
...
029900                                                                          
030000     PERFORM S01-LAES-W5616F                                              
030100     PERFORM UNTIL END-OF-W5616F                                          
...
030900       PERFORM S01-LAES-W5616F                                            
031000     END-PERFORM                                                          
031100                                                                          
031110     PERFORM S01-LAES-W5616B                                              
031120     PERFORM UNTIL END-OF-W5616B                                          
...
031191       PERFORM S01-LAES-W5616B                                            
031192     END-PERFORM                                                          
031193                                                                          
...
032100                                                                          
032200     OPEN INPUT  W5616F                                                   
032201     OPEN INPUT  W5616B                                                   
032210     OPEN OUTPUT W5616M                                                   
032300                                                                          
...
033512       CONTINUE                                                           
033513     ELSE                                                                 
033515       WRITE W5616M-001 FROM HEAD-LINE                                    
...
033663     WRITE W5616M-001 FROM ROW-LINE                                       
033664     .                                                                    
033665     EJECT                                                                
033666                                                                          
...
034200     .                                                                    
034300     EJECT                                                                
034400 S01-LAES-W5616F  SECTION.                                                
034500     SKIP2                                                                
034600     READ W5616F INTO IN1-AREA                                            
034700     AT END                                                               
034800        SET END-OF-W5616F TO TRUE                                         
034900     NOT AT END                                                           
035000        MOVE 'W5616F'   TO POSTSUM-FDNAMN                                 
035100        MOVE 'W56164D1' TO POSTSUM-DDNAMN2                                
035200        MOVE 'UPPD'     TO POSTSUM-TRANSTYP                               
035300        CALL POSTSUM USING POSTSUM-PARM                                   
035400     END-READ                                                             
035500     .                                                                    
035600     EJECT                                                                
035610 S01-LAES-W5616B  SECTION.                                                
035620     SKIP2                                                                
035630     READ W5616B INTO IN2-AREA                                            
035640     AT END                                                               
035650        SET END-OF-W5616B TO TRUE                                         
035660     NOT AT END                                                           
035670        MOVE 'W5616B'   TO POSTSUM-FDNAMN                                 
035680        MOVE 'W56164D2' TO POSTSUM-DDNAMN2                                
