001300 ID DIVISION.                                                             
001400 PROGRAM-ID.     W3016700.                                                
001500 AUTHOR.         BO HAMMARIN.                                             
001600 DATE-WRITTEN.   00/05/04.                                                
001700 DATE-COMPILED.                                                           
001800                                                                          
001900*    FUNKTION:                                                            
002000*        PGM VISAR SKROT-/MOTTAGNINGSINFORMATION                          
...
002400*                                                                         
002500*    INDATA.                                                              
002600*        TRANSAKTION: W3T167                                              
002700*        MID:         W3I16701                                            
002800*                                                                         
002900*    UTDATA.                                                              
003000*        MOD:         W3O16701                                            
003010*                                                                         
003020*    REMARKS:  040820 RÄTTELSE GJORTS MED ETRACKER NR 1311105/EÖ          
003030*                                                                         
003100                                                                          
...
003710     SKIP3                                                                
003800 77  IDPGM                       PIC X(08)   VALUE 'W3016700'.            
003900                                                                          
...
006410                                                                          
006411*    --- DIVERSE                                                          
006412 01  WS-IDARTNR-9                PIC  9(9).                               
006413 01  WS-IDARTNR-8                PIC  X(8).                               
006420 01  WS-DAAAPP-FOM               PIC  9(6)   VALUE 200000.                
006421 01  WS-TIAAPP-FOM               PIC  9(4).                               
006422 01  WS-TIAAPP-FOM-ALFA.                                                  
006423     03  FILLER                  PIC  X(2).                               
006424     03  WS-TIAAPP-FOM-2-4       PIC  X(2).                               
006425 01  WS-DAAAPP-TOM               PIC  9(6)   VALUE 200000.                
006426 01  WS-TIAAPP-TOM               PIC  9(4).                               
006427 01  WS-TIAAPP-TOM-ALFA.                                                  
006428     03  FILLER                  PIC  X(2).                               
006429     03  WS-TIAAPP-TOM-2-4       PIC  X(2).                               
006430 01  WS-SUSKROT-DC               PIC S9(9)   VALUE ZERO COMP-3.           
006431 01  WS-SUMOTT-CP                PIC S9(9)   VALUE ZERO COMP-3.           
006432 01  WS-SUSKROT-REM              PIC S9(9)   VALUE ZERO COMP-3.           
006433 01  WS-SUMOTT-REM               PIC S9(9)   VALUE ZERO COMP-3.           
006434 01  WS-REPROCDC                 PIC S9(3)V9(3) VALUE ZERO COMP-3.        
006435 01  WS-REPROCENT-DC             PIC S9(3)   VALUE ZERO COMP-3.           
006436 01  WS-REPROCREM                PIC S9(3)V9(3) VALUE ZERO COMP-3.        
006437 01  WS-REPROCENT-REM            PIC S9(3)   VALUE ZERO COMP-3.           
006438                                                                          
006439 01  WS-IDFKNGRP-JFR             PIC S9(5)   VALUE ZERO COMP-3.           
006440 01  WS-IDARTNR-JFR              PIC S9(9)   VALUE ZERO COMP-3.           
006441     EJECT                                                                
006442                                                                          
...
014106     EJECT                                                                
014107                                                                          
014108 PROCEDURE DIVISION  USING MSG-PCB  USEA-PCB                              
014109                           WDA9-PCB WDA9B-PCB                             
014110                           WDD3B-PCB.                                     
014111 MAIN SECTION.                                                            
014112     ENTRY 'DLITCBL' USING MSG-PCB  USEA-PCB                              
014120                           WDA9-PCB WDA9B-PCB                             
014130                           WDD3B-PCB.                                     
014200                                                                          
...
015400       END-IF                                                             
015700       COMPUTE MSG-KVLL = LENGTH OF MOD-W3O16701 + 4                      
...
016900       MOVE MSG-INDATA-MINUS-2-TRANSKODER TO MID-W3I16701                 
017000       MOVE MSG-IDTRANS-2  TO MFS-IDTRANS                                 
017100       MOVE MSG-KDMFSFOR-2 TO MFS-KDMFSFOR                                
017200     ELSE                                                                 
017300       MOVE MSG-INDATA-MINUS-1-TRANSKOD  TO MID-W3I16701                  
...
018300     MOVE 'W3O167N1'       TO MFS-IDMOD                                   
018400     MOVE '3167'           TO MOD-IDTRANS                                 
...
020300     MOVE '3167'              TO MSGI-IDTRANS                             
020400     IF GODK-MID                                                          
...
021153                                 W-IDARTNR-D3                             
021154                                 WS-IDARTNR-JFR                           
021155         IF WS-IDARTNR-JFR > ZERO                                         
021156           MOVE NEJ           TO SOK-FKNGRP-SW                            
021157         END-IF                                                           
021158       ELSE                                                               
021159         MOVE NEJ             TO NYCKLAR-SW                               
021160       END-IF                                                             
021161     ELSE                                                                 
021162       MOVE NEJ               TO NYCKLAR-SW                               
021163     END-IF                                                               
021164                                                                          
021165*    -- KONTROLL AV PERIOD-FOM                                            
021166     MOVE MFS-RENSA-FAELT     TO MOD-TIAAPP-FOM-IN                        
021167                                                                          
021168     IF MID-TIAAPP-FOM-IN NOT = ALL '+'                                   
021169       MOVE '7'               TO MFS-IDPFK                                
021170       MOVE SPACE             TO MFS-KDTRTYP                              
021171     END-IF                                                               
021172     INSPECT MSGI-TIAAVV-FOM REPLACING LEADING SPACE BY ZERO              
021173     IF MSGI-TIAAVV-FOM NUMERIC                                           
021174       MOVE MSGI-TIAAVV-FOM   TO WS-TIAAPP-FOM                            
021175                                 WS-TIAAPP-FOM-ALFA                       
021176       MOVE 200000            TO WS-DAAAPP-FOM                            
021177       ADD WS-TIAAPP-FOM      TO WS-DAAAPP-FOM                            
021178       MOVE WS-DAAAPP-FOM     TO W-DAAAPP-A9-MIN                          
021179     ELSE                                                                 
021180       MOVE NEJ               TO NYCKLAR-SW                               
021190     END-IF                                                               
021201                                                                          
...
021810       PERFORM MFS-RENSA-FAELT-IN                                         
...
024000     COMPUTE WS-SUSKROT-DC = WS-SUSKROT-DC +                              
024100                             UPA-SUSKROT-DC                               
024200     END-COMPUTE                                                          
024300     COMPUTE WS-SUMOTT-CP  = WS-SUMOTT-CP +                               
024400                             UPA-SUMOTT-CP                                
024410     END-COMPUTE                                                          
024500     .                                                                    
024800     EJECT                                                                
024810                                                                          
024820 FB-BYGG-WDA921 SECTION.                                                  
024821     COMPUTE WS-SUSKROT-REM = WS-SUSKROT-REM   +                          
024822                              UPP-SUSKROT1-REM +                          
024823                              UPP-SUSKROT2-REM                            
024824     END-COMPUTE                                                          
024825     COMPUTE WS-SUMOTT-REM  = WS-SUMOTT-REM +                             
024826                              UPP-SUMOTT-REM                              
024827     END-COMPUTE                                                          
024840     .                                                                    
024850     EJECT                                                                
024860                                                                          
024870 FC-BYGG-MOD SECTION.                                                     
024880     MOVE WS-SUSKROT-DC      TO MOD-SUSKROT-DC                            
024881     MOVE WS-SUSKROT-REM     TO MOD-SUSKROT-REM                           
024882     MOVE WS-SUMOTT-CP       TO MOD-SUMOTT-CP                             
024883     MOVE WS-SUMOTT-REM      TO MOD-SUMOTT-REM                            
024884                                                                          
024885     IF WS-SUMOTT-CP > ZERO                                               
024886*      COMPUTE WS-REPROCENT-DC ROUNDED = (WS-SUSKROT-DC /                 
024887*                                         WS-SUMOTT-CP) *                 
024888*                                         100                             
024889*      END-COMPUTE                                                        
024890       COMPUTE WS-REPROCDC = (WS-SUSKROT-DC /                             
024891                              WS-SUMOTT-CP) *                             
024892                              100                                         
024893       COMPUTE WS-REPROCENT-DC ROUNDED = WS-REPROCDC                      
024894       END-COMPUTE                                                        
024897       MOVE WS-REPROCENT-DC  TO MOD-REPROCENT-DC                          
024898     ELSE                                                                 
024899       MOVE ZERO             TO MOD-REPROCENT-DC                          
024900     END-IF                                                               
024901                                                                          
024902     IF WS-SUMOTT-REM > ZERO                                              
024903*      COMPUTE WS-REPROCENT-REM ROUNDED = (WS-SUSKROT-REM /               
024904*                                          WS-SUMOTT-REM) *               
024905*                                          100                            
024906*      END-COMPUTE                                                        
024907       COMPUTE WS-REPROCREM = (WS-SUSKROT-REM /                           
024908                               WS-SUMOTT-REM) *                           
024909                               100                                        
024910       COMPUTE WS-REPROCENT-REM ROUNDED = WS-REPROCREM                    
024911       END-COMPUTE                                                        
024912       MOVE WS-REPROCENT-REM TO MOD-REPROCENT-REM                         
024913     ELSE                                                                 
024914       MOVE ZERO             TO MOD-REPROCENT-REM                         
024915     END-IF                                                               
024916     .                                                                    
024917     EJECT                                                                
024920                                                                          
...
025210                             MOD-SUSKROT-DC                               
025220                             MOD-SUSKROT-REM                              
025230                             MOD-SUMOTT-CP                                
025240                             MOD-SUMOTT-REM                               
025250                             MOD-REPROCENT-DC                             
025251                             MOD-REPROCENT-REM                            
025500     .                                                                    
025600     EJECT                                                                
025700                                                                          
