...
000700*    FUNKTION:                                                            
000800*                                                                         
000900*                LADDAR/UPPDATERAR KAMPANJTABELL (TP1ARTK)                
...
002700 FILE-CONTROL.                                                            
002800     SKIP2                                                                
002810     SELECT W21915IN                   ASSIGN TO W21915D1.                
004000     SKIP2                                                                
004100     EJECT                                                                
...
004480                                                                          
004481                                                                          
004482*01  POST -COPY W21913    -PRE  IN-  -L.                                  
004491                                                                          
004493                                                                          
009100*                                                                         
009200     EJECT                                                                
...
009500 77  IDPGM                       PIC X(8)    VALUE 'W2191500'.            
...
010700     SKIP2                                                                
010710 01  FILLER                      PIC X(08)   VALUE                        
010720                                             'WS'.                        
010800 01  WS.                                                                  
...
010853     03 WS-DB2-SEKTION           PIC X(24)   VALUE SPACE.                 
010854 01  FILLER                      PIC X(16)   VALUE                        
010855                                             'NYCKLAR-TILL-DB2'.          
010856 01  NYCKLAR-TILL-DB2.                                                    
010860     03  W-IDARTNR               PIC S9(9)    VALUE ZERO COMP-3.          
012700     EJECT                                                                
...
018400                                                                          
018500 77  W21915-EOF-SW               PIC X       VALUE 'N'.                   
018600     88  END-OF-W21915                       VALUE 'J'.                   
018900     EJECT                                                                
...
021300     SKIP2                                                                
021400*01  AREA -COPY W21913     -PRE IN-                                       
022800                                                                          
022900     EJECT                                                                
023201*                                                                         
...
023220     EJECT                                                                
023221 01  FILLER                      PIC X(16)   VALUE 'TP1ARTK-AREA'.        
023222*01  AREA -COPY TP1ARTK  -PRE TP1ARTK-                                    
023226     EJECT                                                                
023227 01  FILLER                      PIC X(16)   VALUE 'TP1ARTK-DCL '.        
023228       EXEC SQL INCLUDE TP1ARTK  END-EXEC.                                
023232                                                                          
023239     EJECT                                                                
...
023800                                                                          
023910     PERFORM S01-LAES-W21915IN                                            
024100                                                                          
024200     PERFORM UNTIL END-OF-W21915                                          
024410                                                                          
024411       ADD 1                 TO WS-ANTAL-INDATA                           
024412       IF IN-KDSTATUS-KAMP = 'N'                                          
024413         MOVE IN-IDKAMP      TO TP1ARTK-IDKAMP                            
024414         MOVE IN-IDARTNR     TO TP1ARTK-IDARTNR                           
024415         MOVE IN-KVREPANT    TO TP1ARTK-KVREPANT                          
024416         MOVE ZERO           TO TP1ARTK-KVKAMP-TOTAL                      
024417                                TP1ARTK-KVKAMP-LAUNCH                     
024418                                TP1ARTK-KVKAMP-FIRST                      
024420         MOVE 1.00           TO TP1ARTK-RERESPRT                          
024421         MOVE 'N'            TO TP1ARTK-FLKVKAMP-TOTAL                    
024422         PERFORM DB2-INSERT-TP1ARTK                                       
024424         IF CURSOR-OK                                                     
024425           ADD 1             TO WS-ANTAL-INSERT                           
024426         ELSE                                                             
024427           MOVE IN-IDARTNR   TO W-IDARTNR                                 
024428           MOVE IN-KVREPANT  TO TP1ARTK-KVREPANT                          
024429           PERFORM DB2-UPDATE-TP1ARTK                                     
024430           ADD 1             TO WS-ANTAL-UPDATE                           
024431         END-IF                                                           
024432       ELSE                                                               
024433         IF IN-KDSTATUS-KAMP = 'C'                                        
024434           MOVE IN-IDARTNR   TO W-IDARTNR                                 
024435           MOVE IN-KVREPANT  TO TP1ARTK-KVREPANT                          
024440           PERFORM DB2-UPDATE-TP1ARTK                                     
024441           ADD 1             TO WS-ANTAL-UPDATE                           
024442         ELSE                                                             
024443*          *DELETE*   IN-KDSTATUS-KAMP = 'D'                              
024443*                     GÖR INGEN DELETE                                    
024444           MOVE IN-IDARTNR   TO W-IDARTNR                                 
024443*    FIX   *DELETE*   IN-KDSTATUS-KAMP = 'B' FIX FÖR BORTTAG              
                 IF IN-KDSTATUS-KAMP = 'B' AND                                  
                    IN-KVREPANT = ZERO                                          
024445              PERFORM DB2-DELETE-TP1ARTK                                  
                 END-IF                                                         
024446           ADD 1             TO WS-ANTAL-DELETE                           
024450         END-IF                                                           
024460       END-IF                                                             
024540                                                                          
024900       PERFORM S01-LAES-W21915IN                                          
026092                                                                          
026100     END-PERFORM                                                          
026102                                                                          
...
032000                                                                          
032100     DISPLAY 'ANTAL INDATA : ' WS-ANTAL-INDATA                            
032200     DISPLAY 'ANTAL INSERT : ' WS-ANTAL-INSERT                            
032210     DISPLAY 'ANTAL UPDATE : ' WS-ANTAL-UPDATE                            
032220     DISPLAY 'ANTAL DELETE : ' WS-ANTAL-DELETE                            
032300     CLOSE W21915IN                                                       
032600     .                                                                    
032700     EJECT                                                                
032800 S01-LAES-W21915IN SECTION.                                               
032900     SKIP2                                                                
032901     READ W21915IN           INTO IN-AREA                                 
032902     AT END                                                               
032903        MOVE JA TO W21915-EOF-SW                                          
032904                                                                          
032905     END-READ                                                             
033500     .                                                                    
033600     EJECT                                                                
033700                                                                          
035100                                                                          
035800 DB2-INSERT-TP1ARTK SECTION.                                              
035810     MOVE 'DB2-INSERT-TP1ARTK   ' TO  WS-DB2-SEKTION                      
035820     SKIP2                                                                
035840     MOVE 000803   TO GOOD-SQLCODECODES                                   
035900                                                                          
036100     SKIP2                                                                
036200     EXEC SQL                                                             
036300       INSERT INTO TP1ARTK                                                
036400         (                                                                
036500          IDKAMP                                                          
036600         ,IDARTNR                                                         
036700         ,KVREPANT                                                        
036710         ,KVKAMP_TOTAL                                                    
036720         ,KVKAMP_LAUNCH                                                   
036730         ,KVKAMP_FIRST                                                    
036800         ,RERESPRT                                                        
039600         )                                                                
039700       VALUES                                                             
039800         (                                                                
039900          :TP1ARTK-IDKAMP                                                 
040000         ,:TP1ARTK-IDARTNR                                                
040100         ,:TP1ARTK-KVREPANT                                               
040110         ,:TP1ARTK-KVKAMP-TOTAL                                           
040120         ,:TP1ARTK-KVKAMP-LAUNCH                                          
040130         ,:TP1ARTK-KVKAMP-FIRST                                           
040200         ,:TP1ARTK-RERESPRT                                               
043000         )                                                                
043100     END-EXEC                                                             
043200                                                                          
...
044400                                                                          
044500                                                                          
044600 DB2-UPDATE-TP1ARTK SECTION.                                              
044700                                                                          
044810     MOVE 'DB2-UPDATE-TP1ARTK   ' TO  WS-DB2-SEKTION                      
044820     SKIP2                                                                
044830     MOVE 000   TO GOOD-SQLCODECODES                                      
044840                                                                          
044900     SKIP2                                                                
045000     EXEC SQL                                                             
045100       UPDATE TP1ARTK                                                     
045200       SET                                                                
045211          KVREPANT       = :TP1ARTK-KVREPANT                              
047100       WHERE                                                              
047200                IDKAMP         = :IN-IDKAMP                               
047300           AND  IDARTNR        = :W-IDARTNR                               
047800     END-EXEC                                                             
047900                                                                          
...
048910     EJECT                                                                
049000                                                                          
049002 DB2-DELETE-TP1ARTK SECTION.                                              
049003     MOVE 'DB2-DELETE-TP1ARTK   ' TO  WS-DB2-SEKTION                      
049004                                                                          
049005     MOVE 000100   TO GOOD-SQLCODECODES                                   
049006                                                                          
049007     EXEC SQL                                                             
049008         DELETE FROM TP1ARTK                                              
049009                                                                          
049010         WHERE  IDKAMP         = :IN-IDKAMP                               
049011           AND  IDARTNR        = :W-IDARTNR                               
049012     END-EXEC                                                             
049013                                                                          
...
049081       AT END CALL FELLOG                                                 
049094       WHEN GOOD-SQLCODE (SQLCODE-IX) = SQLCODE-WS CONTINUE               
049095     END-SEARCH                                                           
049096     .                                                                    
049100                                                                          
