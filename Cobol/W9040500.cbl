...
002600*                                                                         
002610*        MARS-04   PROGRAMET KOPIERAT FRÅN W1010700 FÖR ANPASSNING        
002620*                  TILL SPIE2. DELAR AV PGM ÄR BORTAGET FÖR ATT           
002630*                  EJ VISAS/SKICKAS TILL SPIE2. //J.NIHLBLAD              
002640*                                                                         
002650*                                                                         
002700     SKIP3                                                                
...
003500 77  IDPGM                       PIC X(8)    VALUE 'W9040500'.            
...
011200     SKIP3                                                                
011300                                                                          
011400*01  MID -COPY W90405I1 -PRE MID-.                                        
011500     EJECT                                                                
011600                                                                          
011700*01  -COPY WMSGAREA                                                       
011800     EJECT                                                                
011900                                                                          
012000*  03  MOD -COPY W90405O1 -PRE MOD- -RED MSG-AREA.                        
012100     EJECT                                                                
012200                                                                          
...
015700   03  IO-AREA-2                 PIC X(900)  VALUE SPACE.                 
015800     SKIP3                                                                
...
021800       MOVE MSG-INDATA-MINUS-2-TRANSKODER TO MID-W90405I1-CTX             
021900       MOVE MSG-IDTRANS-2 TO MFS-IDTRANS                                  
022000       MOVE MSG-KDMFSFOR-2 TO MFS-KDMFSFOR                                
022100       MOVE JA TO FL-BORJA-SIDA1                                          
022200     ELSE                                                                 
022300       MOVE MSG-INDATA-MINUS-1-TRANSKOD  TO MID-W90405I1-CTX              
...
023200                               MSGI-IDLTERM-USER                          
023300     MOVE '9405'            TO MSGI-IDTRANS                               
023400                                                                          
...
024800     MOVE 'W90405O1'      TO MFS-IDMOD                                    
024900     MOVE '9405'          TO MOD-TRANS-NUMMER                             
025000                                                                          
...
028700                                                                          
028800     IF MFS-IDTRANS  NOT = '9405'                                         
...
029310         CONTINUE                                                         
029320* EVENTUELLT BEHÖVS MID-BELEV-UT FÖR ATT DET SKALL FUNKA TILL 100%        
