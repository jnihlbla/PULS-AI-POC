000100 ID DIVISION.                                                             
000200                                                                          
000300 PROGRAM-ID.     W1116300.                                                
000400*AUTHOR.         GÖRAN KJELLSON.                                          
000500*DATE-WRITTEN.   JANUARI 2019.                                            
000600*                                                                         
000700*        REMARKS.                                                         
000800*                                                                         
000900*        FUNKTION:                                                        
001400*            -  SKAPAR FIL W11163.                                        
001500*                                                                         
...
002300 FILE-CONTROL.                                                            
002400                                                                          
002500     SELECT  W11173   ASSIGN TO W11163D1.                                 
002510     SELECT  W11162   ASSIGN TO W11163D2.                                 
002600     SELECT  W11163   ASSIGN TO W11163D3.                                 
002800                                                                          
002900                                                                          
...
003700                                                                          
003800*01  POST   -COPY W11123     -PRE CHG-    -L.                             
003900                                                                          
003910                                                                          
003920 FD  W11162                                                               
003930     RECORDING F                                                          
...
003950                                                                          
003960*01  POST   -COPY W11123     -PRE IN-     -L.                             
003970                                                                          
003980                                                                          
004000 FD  W11163                                                               
004100     RECORDING V                                                          
...
005700*                                                                         
005800 77  IDPGM                  PIC X(8)   VALUE 'W1116300'.                  
...
009400                                                                          
009500 77  W11173-EOF-SW              PIC X       VALUE 'N'.                    
009600     88  END-OF-W11173                      VALUE 'J'.                    
009610 77  W11162-EOF-SW              PIC X       VALUE 'N'.                    
009620     88  END-OF-W11162                      VALUE 'J'.                    
009700                                                                          
009710                                                                          
...
011000     03  PROG-ID             PIC X(8)  VALUE 'W1116300'.                  
...
011801                                                                          
011802 01  CHG-AREA-START          PIC X(24)   VALUE 'CHG-AREA START'.          
011803*01  AREA   -COPY W11123        -PRE CHG-                                 
011810                                                                          
011900                                                                          
...
019500                                                                          
019600                                                                          
019900 PROCEDURE DIVISION  USING  ERSA-PCB ARTC-PCB BENA-PCB.                   
020000     ENTRY 'DLITCBL' USING  ERSA-PCB ARTC-PCB BENA-PCB.                   
020100                                                                          
020200     PERFORM A-INIT                                                       
022800*                                                                         
022900*--- LÄSER IGENOM FILEN W11173 OCH SKAPAR 701-                            
023000*    OCH 702-POSTER                                                       
023100*                                                                         
023101     PERFORM S01-LAES-W11173                                              
023102     PERFORM UNTIL END-OF-W11173                                          
023103                                                                          
023104        MOVE CHG-IDARTNR   TO W-SP-IDARTNR                                
023105        MOVE CHG-KDERS-OLD TO W-SP-KDERS-OLD                              
023106        MOVE CHG-KDERS-NEW TO W-SP-KDERS-NEW                              
023108                                                                          
023109        PERFORM B-SKAPA-701-POST                                          
023110        IF (W-SP-KDERS-OLD) < (W-SP-KDERS-NEW) OR                         
023111          (W-SP-KDERS-OLD > 20 AND W-SP-KDERS-NEW > 20)                   
023112          IF ART-FINNS-ERSREG                                             
023113            PERFORM C-SKAPA-702-POST                                      
023114          END-IF                                                          
023115        END-IF                                                            
023116        PERFORM S01-LAES-W11173                                           
023117                                                                          
023118     END-PERFORM                                                          
023119*                                                                         
023120*--- LÄSER IGENOM FILEN W11162 OCH SKAPAR 701-                            
023130*    OCH 702-POSTER                                                       
023140*                                                                         
023200     PERFORM S02-LAES-W11162                                              
023300                                                                          
023400     PERFORM UNTIL END-OF-W11162                                          
023500                                                                          
...
024500          END-IF                                                          
024600        END-IF                                                            
024700        PERFORM S02-LAES-W11162                                           
024800                                                                          
024900     END-PERFORM                                                          
025000                                                                          
...
025700                                                                          
025800     OPEN INPUT  W11173                                                   
025810                 W11162                                                   
025900     OPEN OUTPUT W11163                                                   
026100                                                                          
...
034300                                                                          
034400       PERFORM S03-SKRIV-UTPOST                                           
034500     ELSE                                                                 
...
041300                                                                          
041400        PERFORM S03-SKRIV-UTPOST                                          
041500                                                                          
...
042900                                                                          
042910                                                                          
042920 S01-LAES-W11173  SECTION.                                                
042930     SKIP2                                                                
042940     READ W11173 INTO CHG-AREA                                            
042950     AT END                                                               
042960        SET END-OF-W11173 TO TRUE                                         
042970                                                                          
042980     NOT AT END                                                           
042990        MOVE IN-IDPTYP  TO POSTSUM-TRANSTYP                               
042991        MOVE 'W11173'   TO POSTSUM-FDNAMN                                 
042992        MOVE 'W11163D1' TO POSTSUM-DDNAMN2                                
042993        CALL POSTSUM USING POSTSUM-PARM                                   
042994     END-READ                                                             
042995     .                                                                    
042996                                                                          
042997                                                                          
042998 S02-LAES-W11162  SECTION.                                                
042999     SKIP2                                                                
043000     READ W11162 INTO IN-AREA                                             
043001     AT END                                                               
043002        SET END-OF-W11162 TO TRUE                                         
043003                                                                          
043004     NOT AT END                                                           
043005        MOVE IN-IDPTYP  TO POSTSUM-TRANSTYP                               
043006        MOVE 'W11162'   TO POSTSUM-FDNAMN                                 
043007        MOVE 'W11163D2' TO POSTSUM-DDNAMN2                                
043008        CALL POSTSUM USING POSTSUM-PARM                                   
043009     END-READ                                                             
043010     .                                                                    
043011                                                                          
043012                                                                          
043020 S03-SKRIV-UTPOST SECTION.                                                
043100                                                                          
...
044000                                                                          
044100     MOVE 'W11163'      TO POSTSUM-FDNAMN                                 
044200     MOVE 'W11163D3'    TO POSTSUM-DDNAMN2                                
