...
002200*        FRÅN WDD5                                                        
002300*                                                                         
002410*        PROGRAMMET UPPDATERAR WDD5.                                      
002500*                                                                         
003000                                                                          
003100     SKIP3                                                                
...
003710     SELECT W12207                     ASSIGN TO W12228D1.                
003900     EJECT                                                                
...
004700 77  IDPGM                       PIC X(8)    VALUE 'W1222800'.            
004800 01  CHKP-VAR.                                                            
...
005600 77  W-DLET-WDD501               PIC 9(7)    VALUE ZERO.                  
005700     SKIP2                                                                
005800 01  FELTEXT.                                                             
...
010610 01  FILLER         PIC X(16) VALUE 'DLI-IO-WDD5'.                        
010620 01  DLI-IO-WDD5.                                                         
010630*    03  -COPY WDD501                                                     
010640     EJECT                                                                
012200 LINKAGE SECTION.                                                         
012400*01  -COPY W0009  -PRE MSG-                                               
012500     EJECT                                                                
012502*01  -COPY W0008  -PRE WDD5-                                              
012510     05  FILLER                  PIC X.                                   
012800     EJECT                                                                
012901 PROCEDURE DIVISION  USING MSG-PCB WDD5-PCB.                              
012902 MAIN SECTION.                                                            
012910     ENTRY 'DLITCBL' USING MSG-PCB WDD5-PCB.                              
013000                                                                          
...
013900         PERFORM IMS-GET-WDD501                                           
014000         IF SEGMENT-FINNS                                                 
014010*****       DISPLAY 'DLET  ' W-IDARTNR                                    
014100            PERFORM IMS-DLET-WDD5                                         
                  ADD 1 TO W-DLET-WDD501                                        
...
017801                                                                          
           DISPLAY 'ANTAL BORTTAGNA WDD501: ' W-DLET-WDD501                     
017810     CLOSE W12207                                                         
...
018311        MOVE 'W12228D1'   TO POSTSUM-DDNAMN2                              
...
020000     SKIP3                                                                
020102 IMS-GET-WDD501 SECTION.                                                  
020104     STRING 'WDD501  (IDARTNR  =' W-IDARTNR-X ')'                         
020105          DELIMITED BY SIZE INTO SSA1                                     
020106     MOVE '  GE' TO GODK-STATUSKODER                                      
020107     CALL CBLTDLI USING GHU WDD5-PCB DLI-IO-WDD5 SSA1                     
020108     MOVE WDD5-STATUS-CODE TO STATUS-WS                                   
020109     PERFORM IMS-STATUSKONTROLL                                           
020110     .                                                                    
020120     SKIP3                                                                
020121 IMS-DLET-WDD5 SECTION.                                                   
020123     MOVE '  ' TO GODK-STATUSKODER                                        
020124     CALL CBLTDLI USING DLET WDD5-PCB DLI-IO-WDD5                         
020125     MOVE WDD5-STATUS-CODE TO STATUS-WS                                   
