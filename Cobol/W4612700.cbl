...
001500*    FUNKTION:                                                            
001600*                                                                         
001700*        IMPORTÖRSBEROENDE BEHANDLING (ITALIEN)                           
...
003600     SELECT W46127                       ASSIGN TO UT-S-W46127D1.         
003700     SKIP2                                                                
003800*- - - - - - - - - - - - UTFIL:                                           
003900*                        - -  FIL TILL VIPS                               
004000     SELECT W46147                       ASSIGN TO UT-S-W46127D2.         
004200     EJECT                                                                
...
006900*- - - - - - - - - - - - - -  PROGRAM-NAMN                                
007000 77  PROGRAM-NAMN                PIC X(8)    VALUE 'W4612700'.            
007200     SKIP2                                                                
...
007900                                                                          
008000 77  W46127-EOF                  PIC X(1)    VALUE 'N'.                   
008100     SKIP2                                                                
...
015400     SKIP2                                                                
015500     OPEN INPUT W46127 OUTPUT W46147                                      
015600     SKIP2                                                                
...
022200     .                                                                    
022300     SKIP2                                                                
022400 S01-LAS-W46127 SECTION.                                                  
022500     SKIP2                                                                
022600     READ   W46127 INTO W-ARBAREA                                         
022700     AT END MOVE JA TO W46127-EOF                                         
022800     END-READ                                                             
022900                                                                          
023000     IF W46127-EOF = NEJ                                                  
023100                                                                          
023200       MOVE 'W46127'            TO POSTSUM-FDNAMN                         
023300       MOVE 'W46127D1'          TO POSTSUM-DDNAMN2                        
