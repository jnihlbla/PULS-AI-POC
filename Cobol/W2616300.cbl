...
002600     SELECT W26162                     ASSIGN TO W26163D1.                
002700     SKIP2                                                                
002800*          --- FÖRSÄLJNINGSINFO                                           
002900     SELECT WXTR3B                     ASSIGN TO W26163D2.                
003000     SKIP2                                                                
003100*          --- BENÄMNINGAR                                                
003200     SELECT W01174                     ASSIGN TO W26163D3.                
003300     SKIP2                                                                
003400*          --- ARTIKLAR FÖR UTSKRIFT                                      
003500     SELECT W26168                     ASSIGN TO W26163D4.                
003600     EJECT                                                                
...
006200                                                                          
006300*01  POST -COPY W26165 -PRE  UT-  -L.                                     
006400     EJECT                                                                
006500 WORKING-STORAGE SECTION.                                                 
006600                                                                          
006700*    -- CHECKED BY WY2000                                                 
006800 77  IDPGM                       PIC X(8)    VALUE 'W2616300'.            
006900 77  JA                          PIC X       VALUE 'J'.                   
007000 77  NEJ                         PIC X       VALUE 'N'.                   
007100                                                                          
007200 77  W26162-EOF-SW               PIC X       VALUE 'N'.                   
007300     88  END-OF-W26162                       VALUE 'J'.                   
007400                                                                          
...
011400     SKIP2                                                                
011500                                                                          
011600*01  AREA -COPY W26163     -PRE IN-                                       
011700     EJECT                                                                
...
013200     SKIP2                                                                
013300                                                                          
013400*01  AREA -COPY W26165     -PRE UT-                                       
013500     EJECT                                                                
...
014300     PERFORM S01-LAES-W26162                                              
014400     PERFORM UNTIL END-OF-W26162                                          
014500                                                                          
...
017000       PERFORM S01-LAES-W26162                                            
017100     END-PERFORM                                                          
017200                                                                          
017300                                                                          
...
018100                                                                          
018200     OPEN INPUT  W26162                                                   
018300                 WXTR3B                                                   
018400                 W01174                                                   
018500                                                                          
018600     OPEN OUTPUT W26168                                                   
018700     SKIP2                                                                
...
020700           MOVE IN-TISLUTKP     TO UT-TISLUTKP                            
020800           MOVE IN-KVLS         TO UT-KVLS                                
020900           MOVE IN-PRARTSTD     TO UT-PRARTSTD                            
021000           MOVE IN-KVSLUTKP     TO UT-KVSLUTKP                            
021100           MOVE IN-ADLAGOMR     TO UT-ADLAGOMR                            
021200           MOVE IN-ADPLATS      TO UT-ADPLATS                             
...
021800           MOVE W-BEART         TO UT-BEART                               
021900                                                                          
022000           PERFORM S11-SKRIV-W26168                                       
022100        END-IF                                                            
022200                                                                          
022300     .                                                                    
022400     EJECT                                                                
...
023300     .                                                                    
023400     EJECT                                                                
023500 S01-LAES-W26162  SECTION.                                                
023600     READ W26162 INTO IN-AREA                                             
023700     AT END                                                               
023800        SET END-OF-W26162 TO TRUE                                         
023900                                                                          
024000     NOT AT END                                                           
024100        MOVE 'W26163'   TO POSTSUM-FDNAMN                                 
024200        MOVE 'W26163D1' TO POSTSUM-DDNAMN2                                
...
025600        MOVE 'W26163D2' TO POSTSUM-DDNAMN2                                
...
027000        MOVE 'W26163D3' TO POSTSUM-DDNAMN2                                
027100        MOVE 'BEN'      TO POSTSUM-TRANSTYP                               
027200        CALL POSTSUM USING POSTSUM-PARM                                   
027300     END-READ                                                             
027400     .                                                                    
027500     EJECT                                                                
027600 S11-SKRIV-W26168 SECTION.                                                
027700                                                                          
027800     WRITE UT-POST FROM UT-AREA                                           
027900                                                                          
028000     MOVE 'UT'       TO POSTSUM-TRANSTYP                                  
028100     MOVE 'W26168'   TO POSTSUM-FDNAMN                                    
028200     MOVE 'W26163D4' TO POSTSUM-DDNAMN2                                   
