001000 ID DIVISION.                                                             
001100                                                                          
001200 PROGRAM-ID.     W2364800.                                                
001300 AUTHOR.         KJELL ANDRE.                                             
001400 DATE-WRITTEN.   96/12/10.                                                
001500 DATE-COMPILED.                                                           
001600                                                                          
001700*    FUNKTION:                                                            
001800*        LÄSER RY7-TRANSAR FRÅN WDR3 OCH SKRIVER UT DEM                   
001900*        PÅ EN FIL. EN LOGG-FIL ÖVER UTLÄSTA TRANSAR                      
002000*        SKRIVS OCKSÅ FÖR BORTTAG I ETT EFTERFÖLJANDE                     
002100*        BMP-PROGRAM.                                                     
002101*                                                                         
...
003401     SKIP2                                                                
003402*          --- RY7-TRANSAR                                                
003403     SELECT W23648                     ASSIGN TO W23648D1.                
003404     SKIP2                                                                
003405*          --- LOGG PÅ TRANSAR SOM SKA TAS BORT                           
003410     SELECT W23649                     ASSIGN TO W23648D2.                
003600     EJECT                                                                
...
004005                                                                          
004006*01  POST -COPY W236RY7 -PRE  TRANS-  -L.                                 
004007     SKIP3                                                                
004008 FD  W23649                                                               
004009     RECORDING       F                                                    
...
004400 77  IDPGM                       PIC X(8)    VALUE 'W2364800'.            
...
007301     EJECT                                                                
007302 01  TRANS-AREA-START            PIC X(24)   VALUE                        
007303                                 'TRANS-AREA-START  '.                    
007304     SKIP2                                                                
007305                                                                          
007306*01  AREA -COPY W236RY7     -PRE TRANS-                                   
007307     EJECT                                                                
007308 01  LOGG-AREA-START             PIC X(24)   VALUE                        
007309                                 'LOGG-AREA-START  '.                     
007310     SKIP2                                                                
007311                                                                          
...
008101     03  W-IDCPYTXT-X            PIC X(8)    VALUE 'W236RY7 '.            
008200     SKIP2                                                                
...
010900                                                                          
011100                                                                          
011110*    -- LÄS ALLA RY7-TRANSAR OCH SKRIV UT DEM                             
011200     PERFORM A-INIT                                                       
011300     PERFORM IMS-GET-FILC-FIL                                             
011400     PERFORM UNTIL SEGMENT-SAKNAS                                         
011500                                                                          
011510       MOVE FILC-FIL-WDR301-DATA TO TRANS-AREA                            
011600       PERFORM S11-SKRIV-W23648-TRANS                                     
011601                                                                          
011602       MOVE FILC-FIL-WDR301 TO LOGG-AREA                                  
011610       PERFORM S12-SKRIV-W23649-LOGG                                      
012000                                                                          
...
014300     .                                                                    
014501     EJECT                                                                
014502 S11-SKRIV-W23648-TRANS SECTION.                                          
014503                                                                          
014504     WRITE TRANS-POST FROM TRANS-AREA                                     
014505                                                                          
014506     MOVE 'RY7'      TO POSTSUM-TRANSTYP                                  
014507     MOVE 'W23648'   TO POSTSUM-FDNAMN                                    
014508     MOVE 'W23648D1' TO POSTSUM-DDNAMN2                                   
014509     CALL POSTSUM USING POSTSUM-PARM                                      
014510     .                                                                    
014511     EJECT                                                                
014512 S12-SKRIV-W23649-LOGG SECTION.                                           
014513                                                                          
014514     WRITE LOGG-POST FROM LOGG-AREA                                       
014515                                                                          
014516     MOVE SPACE      TO POSTSUM-TRANSTYP                                  
014517     MOVE 'W23649'   TO POSTSUM-FDNAMN                                    
014518     MOVE 'W23648D2' TO POSTSUM-DDNAMN2                                   
...
015603                                                                          
015604     STRING 'WLFILC01(IDCPYTXT =' W-IDCPYTXT-X ')'                        
