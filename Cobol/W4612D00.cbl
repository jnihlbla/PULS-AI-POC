...
000900*    FUNKTION:                                                            
001000*                                                                         
001100*        IMPORTÖRSBEROENDE BEHANDLING (CANADA)                            
001110*        FILER INNEHÅLLER TRANSAR FÖR BÅDE DISTRIKT                       
001120*        7674 OCH 8751.                                                   
...
002800     SELECT W4612D                       ASSIGN TO UT-S-W4612DD1.         
002900     SKIP2                                                                
003000*- - - - - - - - - - - - UTFIL:                                           
003100*                        - -  FIL TILL VIPS                               
003200     SELECT W4612O                       ASSIGN TO UT-S-W4612DD2.         
003300     EJECT                                                                
...
005300*- - - - - - - - - - - - - -  PROGRAM-NAMN                                
005400 77  PROGRAM-NAMN                PIC X(8)    VALUE 'W4612D00'.            
005500     SKIP2                                                                
...
006200                                                                          
006300 77  W4612D-EOF                  PIC X(1)    VALUE 'N'.                   
006400     SKIP2                                                                
...
013200     SKIP2                                                                
013300     OPEN INPUT W4612D OUTPUT W4612O                                      
013400     SKIP2                                                                
...
019494     MOVE     7674           TO START-IDDISTR                             
...
020800     .                                                                    
020900     SKIP2                                                                
021000 S01-LAS-W4612D SECTION.                                                  
021100     SKIP2                                                                
021200     READ   W4612D INTO W-ARBAREA                                         
021300     AT END MOVE JA TO W4612D-EOF                                         
021400     END-READ                                                             
021500                                                                          
021600     IF W4612D-EOF = NEJ                                                  
021700                                                                          
021800       MOVE 'W4612D'            TO POSTSUM-FDNAMN                         
021900       MOVE 'W4612DD1'          TO POSTSUM-DDNAMN2                        
