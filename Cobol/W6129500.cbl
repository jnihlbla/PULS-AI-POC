...
001800                                                                          
001900*    FUNKTION:                                                            
002000*        PRINTAR FÖR PGM W6031600                                         
002100*                                                                         
...
004000                                                                          
004100 77  IDPGM                       PIC X(8)    VALUE 'W6129500'.            
...
007500*                                                                         
007600 01  PROGRAM-NAMN                PIC X(6)    VALUE 'W61295'.              
007700     SKIP2                                                                
...
016916      IF PARM-ADLEVEL-FOM <= WORK-ADLEVEL               AND               
016917         PARM-ADLEVEL-TOM >= WORK-ADLEVEL               AND               
016918         PARM-ADSEC-FOM <= WORK-ADSEC                   AND               
016919         PARM-ADSEC-TOM >= WORK-ADSEC                   AND               
...
017038     MOVE PARM-ADSEC-FOM       TO LIST-SF                                 
017039     MOVE PARM-ADSEC-TOM       TO LIST-ST                                 
017040     MOVE PARM-ADLEVEL-FOM     TO LIST-LF                                 
017041     MOVE PARM-ADLEVEL-TOM     TO LIST-LT                                 
