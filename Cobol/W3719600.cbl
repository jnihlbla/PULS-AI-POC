...
003310     SELECT W37152                     ASSIGN TO W37196D1.                
003500     EJECT                                                                
...
004300 77  IDPGM                       PIC X(8)    VALUE 'W3719600'.            
...
005100     03  DAGENS-DATUM-AAAA       PIC 9(4).                                
005200     03  DAGENS-DATUM-MAANAD     PIC 9(2).                                
005300     03  DAGENS-DATUM-DAG        PIC 9(2).                                
005340 01  WS-DAREGDAT                 PIC 9(8)    VALUE ZERO.                  
005350 77  WS-RAKNARE2                 PIC 9(7) VALUE ZERO COMP-3.              
005360 77  WS-RAKNARE3                 PIC 9(7) VALUE ZERO COMP-3.              
005370 77  WS-RAKNARE4                 PIC 9(7) VALUE ZERO COMP-3.              
005380 77  WS-RAKNARE9                 PIC 9(7) VALUE ZERO COMP-3.              
005400     EJECT                                                                
...
012300                                                                          
012400     MOVE FUNCTION CURRENT-DATE (1:8) TO DAGENS-DATUM                     
012510     MOVE IDPGM TO POSTSUM-PROGNAMN                                       
012511                                                                          
012545     COMPUTE DAGENS-DATUM-AAAA = DAGENS-DATUM-AAAA - 1                    
012547     DISPLAY 'DAGENS-DATUM ' DAGENS-DATUM                                 
012700     .                                                                    
012800     EJECT                                                                
...
012827                                                                          
012829     IF WS-DAREGDAT > 19980401                                            
012833        IF BYTF-RAPP-FLBYGODK = 'J'                                       
012834           IF BYTF-RAPP-KDBYTSTA-RAPP = '2'                               
012835              ADD +1 TO WS-RAKNARE2                                       
012836           END-IF                                                         
012837           IF BYTF-RAPP-KDBYTSTA-RAPP = '3'                               
012838              ADD +1 TO WS-RAKNARE3                                       
012839           END-IF                                                         
012840           IF BYTF-RAPP-KDBYTSTA-RAPP = '4'                               
012841              ADD +1 TO WS-RAKNARE4                                       
012842           END-IF                                                         
012843           IF BYTF-RAPP-KDBYTSTA-RAPP = '9'                               
012844              ADD +1 TO WS-RAKNARE9                                       
012845           END-IF                                                         
012846           MOVE BYTF-RAPP-IDDISTR    TO UT-IDDISTR                        
012847           MOVE BYTF-RAPP-IDBYTRAP   TO UT-IDBYTRAP                       
012848           PERFORM S11-SKRIV-W37152                                       
012849         END-IF                                                           
012850     END-IF                                                               
012851                                                                          
012852     .                                                                    
...
013101     SKIP2                                                                
013102     DISPLAY '*********************************************'              
013103     DISPLAY '*** STATISTIK *******************************'              
013104     DISPLAY '*********************************************'              
013105     DISPLAY 'STATUS 2 ' WS-RAKNARE2                                      
013106     DISPLAY 'STATUS 3 ' WS-RAKNARE3                                      
013107     DISPLAY 'STATUS 4 ' WS-RAKNARE4                                      
013108     DISPLAY 'STATUS 9 ' WS-RAKNARE9                                      
013109     DISPLAY '*********************************************'              
013110     MOVE 'S' TO POSTSUM-OPKOD                                            
013120     CALL POSTSUM USING POSTSUM-PARM                                      
013200     .                                                                    
013401     EJECT                                                                
...
013408     MOVE 'W37196D1' TO POSTSUM-DDNAMN2                                   
