000100 ID  DIVISION.                                                            
000200     SKIP2                                                                
000300 PROGRAM-ID.  W9702500.                                                   
000400     SKIP2                                                                
000500 AUTHOR.        KARIN OLSSON.                                             
000600     DATE-WRITTEN.  FEB 1993.                                             
000700*                                                                         
000800*                                                                         
000900*                                                                         
001000     EJECT                                                                
...
001500 FILE-CONTROL.                                                            
001600*                                                                         
001700     SELECT INFIL           ASSIGN TO W97025D1.                           
001800*                                                                         
...
003200 01  W-IN-AREA.                                                           
003300*                                                                         
003400     03  IN-LOGONID          PIC X(8).                                    
003500     03  IN-NAMN             PIC X(20).                                   
003600     03  IN-BOLAG            PIC X(3).                                    
003610     03  IN-LAND             PIC X(2).                                    
003710     03  IN-JOBFUNC          PIC X(2).                                    
003800     03  IN-DIVMISC          PIC X(3).                                    
003900     03  IN-ANSTNR           PIC X(5).                                    
003910     03  IN-AVD              PIC X(5).                                    
004000     03  IN-DATUM            PIC X(8).                                    
004020     03  FILLER              PIC X(4).                                    
004100*                                                                         
...
006700       VALUE ':rdef hrules=no vrules=no id=col'.                          
006800 77  DCF-RDEF2               PIC X(80)                                    
006900       VALUE 'cwidths=''20mm 50mm 12mm 6mm 12mm''.'.                      
007000 77  DCF-TABLE                   PIC X(80)                                
007100       VALUE ':table frame=no refid=col column.'.                         
...
011400*                                                                         
011510 01  W-BOLAG                 PIC X(3).                                    
011520 01  W-JOBFUNC               PIC X(2).                                    
011530 01  W-LAND                  PIC X(2).                                    
011800 01  OLD-BOLAG               PIC X(3).                                    
011801 01  OLD-JOBFUNC             PIC X(2).                                    
...
013100     EJECT                                                                
013101 LINKAGE SECTION.                                                         
013102     SKIP2                                                                
013110 01  PARM.                                                                
013111     03  PARM-LAENGD             PIC S9(4)   COMP SYNC.                   
013112     03  PARM-VAERDE             PIC X(44).                               
013120     EJECT                                                                
...
014041                                                                          
014100         PERFORM C-SKRIV-MEMPOST                                          
014200         PERFORM S10-LAS-INFIL                                            
014300       END-PERFORM                                                        
014301                                                                          
014320                                                                          
014400       PERFORM D-AVSLUTA-MEDLEM                                           
014500     END-PERFORM                                                          
014600                                                                          
...
015200     SKIP2                                                                
015210     IF PARM-LAENGD = 0 OR 2                                              
015220       DISPLAY 'SAKNAR NAMN PÅ TEXT-BIBLIOTEK.'                           
015230       PERFORM S99-ABEND                                                  
015240     END-IF                                                               
015250                                                                          
015260     IF PARM-LAENGD > 40                                                  
015270       DISPLAY 'NAMN PÅ TEXT-BIBLIOTEK LÄNGRE ÄN 40 TECKEN.'              
015280       PERFORM S99-ABEND                                                  
015290     END-IF                                                               
015291                                                                          
015292     MOVE PARM-VAERDE (1:PARM-LAENGD) TO WDSNAME                          
015293                                                                          
015300     ACCEPT DAGENS-DATUM  FROM DATE                                       
015310     ACCEPT AKTUELL-TID   FROM TIME                                       
015400                                                                          
...
022482            INTO ZLMTIME                                                  
022483                                                                          
022484     MOVE ZERO TO ZLCNORC ZLINORC                                         
022485                                                                          
...
023880                                                                          
023922     MOVE DCF-RDEF1 TO MEMPOST                                            
023923     PERFORM S20-SKRIV-MEMPOST                                            
023924                                                                          
023925     MOVE DCF-RDEF2 TO MEMPOST                                            
023926     PERFORM S20-SKRIV-MEMPOST                                            
023927                                                                          
023928     MOVE DCF-TABLE TO MEMPOST                                            
023930     PERFORM S20-SKRIV-MEMPOST                                            
023934     .                                                                    
023935     EJECT                                                                
023940 C-SKRIV-MEMPOST    SECTION.                                              
024000     SKIP2                                                                
...
024600                                                                          
024700     MOVE IN-LOGONID TO MEM-RAD                                           
024800     PERFORM S20-SKRIV-MEMPOST                                            
024900                                                                          
025000     MOVE IN-NAMN TO MEM-RAD                                              
025100     PERFORM S20-SKRIV-MEMPOST                                            
025200                                                                          
025300     MOVE IN-AVD   TO MEM-RAD                                             
025400     PERFORM S20-SKRIV-MEMPOST                                            
025410                                                                          
025411     IF IN-JOBFUNC = '**'                                                 
025412       MOVE SPACE       TO MEM-RAD                                        
025413     ELSE                                                                 
025414       MOVE IN-JOBFUNC  TO MEM-RAD                                        
025415     END-IF                                                               
025416     PERFORM S20-SKRIV-MEMPOST                                            
025417                                                                          
025420     MOVE IN-DATUM TO MEM-RAD                                             
025430     PERFORM S20-SKRIV-MEMPOST                                            
025500     .                                                                    
025600     EJECT                                                                
025610 D-AVSLUTA-MEDLEM   SECTION.                                              
025800     SKIP2                                                                
