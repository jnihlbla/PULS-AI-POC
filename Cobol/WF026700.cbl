...
000100 ID DIVISION.                                                             
000200 PROGRAM-ID.     WF026700.                                                
000300 AUTHOR.         LUNDH BERNT.                                             
000400 DATE-WRITTEN.   02/03/25.                                                
000500 DATE-COMPILED.                                                           
000600                                                                          
000610*    NAME:                                                                
000620*        CARPARTS.BILLIT.RECCOUNTRYLOCATE                                 
000700*    FUNCTION:                                                            
...
001100*        THE PROGRAM READS   TABLE T01RECO                                
001110*        THE PROGRAM READS   TABLE T01COCO                                
001200*                                                                         
001300*    INDATA.                                                              
001400*        TRANSACTION: WF0267T                                             
001410*                                                                         
...
002800 77  IDPGM                       PIC X(08)  VALUE 'WF026700'.             
002900                                                                          
...
004210                         VALUE 'CARPARTS.BILLIT.RECCOUNTRYLOCATE'.        
004410                                                                          
...
005500 01  WS-COUNTER-T01RECO          PIC S9(7)  VALUE ZERO    COMP-3.         
...
012500     EJECT                                                                
012501                                                                          
012510 01  FILLER                      PIC X(16)   VALUE 'T01RECO-AREA'.        
012600*01  -COPY T01RECO -PRE T01RECO-                                          
012700     EJECT                                                                
012800                                                                          
012810 01  FILLER                      PIC X(16)   VALUE 'T01COCO-AREA'.        
012820*01  -COPY T01COCO -PRE T01COCO-                                          
012830     EJECT                                                                
012840                                                                          
012900     EXEC SQL INCLUDE T01LSEL END-EXEC.                                   
013000     EJECT                                                                
013200     EXEC SQL INCLUDE T01RECO END-EXEC.                                   
013300     EJECT                                                                
...
018510       END-IF                                                             
018512       IF REQU-KDPGMACT = WS-SEARCH                                       
018513         CONTINUE                                                         
018514       ELSE                                                               
018515         MOVE SYSTEM-ERROR TO RESP-IDMSG-ERROR                            
018516         MOVE 'KDPGMACT'   TO RESP-IDELMT-ERROR                           
018517       END-IF                                                             
018518       IF REQU-IDUSER = SPACE OR = ALL '+'                                
018519         MOVE SYSTEM-ERROR TO RESP-IDMSG-ERROR                            
018520         MOVE 'IDUSER'     TO RESP-IDELMT-ERROR                           
018521       END-IF                                                             
018522     END-IF                                                               
018530     IF KEYS-OK                                                           
018540       IF REQU-IDLANDX3-KEY > SPACE                                       
018550       AND REQU-IDLANDX3-KEY NOT = ALL '+'                                
018560         MOVE REQU-IDLANDX3-KEY TO WS-IDLANDX3                            
018570         PERFORM DB2-SELECT-T01COCO-TAB                                   
018580         IF LINES-FOUND                                                   
018590           CONTINUE                                                       
018600         ELSE                                                             
018700           MOVE NOT-FOUND       TO RESP-IDMSG-ERROR                       
018800           MOVE 'IDLANDX3'      TO RESP-IDELMT-ERROR                      
018810           MOVE NOO TO KEYS-SW                                            
018820         END-IF                                                           
018830       END-IF                                                             
018840     END-IF                                                               
018841     IF KEYS-OK                                                           
018850       PERFORM DB2-SELECT-T01LSEL-TAB                                     
018860       IF LINES-FOUND                                                     
018870         CONTINUE                                                         
018880       ELSE                                                               
018881         MOVE NOT-FOUND       TO RESP-IDMSG-ERROR                         
018882         MOVE 'IDLEGSEL'      TO RESP-IDELMT-ERROR                        
018890         MOVE NOO TO KEYS-SW                                              
018891       END-IF                                                             
018892     END-IF                                                               
018900     .                                                                    
...
031198       AND MAP-IDLANDX3-LINE = RESP-IDLANDX3-LINE(WS-IX)                  
...
034192     END-EXEC                                                             
034193                                                                          
034194     MOVE SQLCODE TO SQLCODE-WS                                           
034195     PERFORM DB2-STATUS-CHECK                                             
034196     .                                                                    
034200* * * * * * * * * *   - CURSOR-1 -   * * * * * * * * * * * * * * *        
...
034260           SELECT COUNT(*)                                                
034270                                                                          
034280           INTO  :WS-COUNTER-T01RECO                                      
034290                                                                          
034291           FROM   T01RECO                                                 
034292                                                                          
...
034306     .                                                                    
034310 DB2-DCL-OPN-T01RECO-CRS-1 SECTION.                                       
034400                                                                          
034600     MOVE 000100 TO GOOD-SQLCODECODES                                     
034700                                                                          
034800     EXEC SQL                                                             
034900         DECLARE T01RECO-CRS-1 CURSOR WITH HOLD FOR                       
035000                                                                          
...
038614     .                                                                    
038617 DB2-CLOSE-T01RECO-CRS-1 SECTION.                                         
038618                                                                          
038619     EXEC SQL                                                             
038620        CLOSE T01RECO-CRS-1                                               
038621     END-EXEC                                                             
038622     .                                                                    
038625* * * * * * * * * *   - CURSOR-2 -   * * * * * * * * * * * * * * *        
...
039200          SELECT COUNT(*)                                                 
039300                                                                          
039400          INTO  :WS-COUNTER-T01RECO                                       
039500                                                                          
039600          FROM   T01RECO                                                  
039700                                                                          
...
042000     .                                                                    
042560 DB2-DCL-OPN-T01RECO-CRS-2 SECTION.                                       
042600                                                                          
042700     MOVE 000100 TO GOOD-SQLCODECODES                                     
042800                                                                          
042900     EXEC SQL                                                             
043000         DECLARE T01RECO-CRS-2 CURSOR WITH HOLD FOR                       
043100                                                                          
...
046713     .                                                                    
046715 DB2-CLOSE-T01RECO-CRS-2 SECTION.                                         
046716                                                                          
046717     EXEC SQL                                                             
046718        CLOSE T01RECO-CRS-2                                               
046719     END-EXEC                                                             
046720     .                                                                    
