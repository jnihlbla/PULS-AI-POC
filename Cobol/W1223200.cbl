...
002200*        FRÅN WDJ9                                                        
002300*                                                                         
002410*        PROGRAMMET UPPDATERAR WDJ9.                                      
002500*                                                                         
003000                                                                          
003100     SKIP3                                                                
...
003710     SELECT W12207                     ASSIGN TO W12232D1.                
003900     EJECT                                                                
...
004700 77  IDPGM                       PIC X(8)    VALUE 'W1223200'.            
004800 01  CHKP-VAR.                                                            
...
005400 03  CHKP-MAX                    PIC S9(3)   VALUE +500.                  
005500 77  JA                          PIC X       VALUE 'J'.                   
005600 77  NEJ                         PIC X       VALUE 'N'.                   
005600 77  W-DLET-WDJ901               PIC 9(7)    VALUE ZERO.                  
005700     SKIP2                                                                
005800 01  FELTEXT.                                                             
...
010610 01  FILLER         PIC X(16) VALUE 'DLI-IO-WDJ9'.                        
010620 01  DLI-IO-WDJ9.                                                         
010630*    03  -COPY WDJ901                                                     
010640     EJECT                                                                
012200 LINKAGE SECTION.                                                         
012400*01  -COPY W0009  -PRE MSG-                                               
012500     EJECT                                                                
012502*01  -COPY W0008  -PRE WDJ9-                                              
012510     05  FILLER                  PIC X.                                   
012800     EJECT                                                                
012901 PROCEDURE DIVISION  USING MSG-PCB WDJ9-PCB.                              
012902 MAIN SECTION.                                                            
012910     ENTRY 'DLITCBL' USING MSG-PCB WDJ9-PCB.                              
013000                                                                          
...
013900         PERFORM IMS-GET-WDJ901                                           
014000         IF SEGMENT-FINNS                                                 
014010****        DISPLAY 'DLET  ' W-IDARTNR                                    
014100            PERFORM IMS-DLET-WDJ9                                         
                  ADD 1 TO W-DLET-WDJ901                                        
...
017801                                                                          
           DISPLAY 'ANTAL BORTTAGNA WDJ901: ' W-DLET-WDJ901                     
017810     CLOSE W12207                                                         
...
018311        MOVE 'W12232D1'   TO POSTSUM-DDNAMN2                              
...
020000     SKIP3                                                                
020102 IMS-GET-WDJ901 SECTION.                                                  
020104     STRING 'WDJ901  (IDARTNR  =' W-IDARTNR-X ')'                         
020105          DELIMITED BY SIZE INTO SSA1                                     
020106     MOVE '  GE' TO GODK-STATUSKODER                                      
020107     CALL CBLTDLI USING GHU WDJ9-PCB DLI-IO-WDJ9 SSA1                     
020108     MOVE WDJ9-STATUS-CODE TO STATUS-WS                                   
020109     PERFORM IMS-STATUSKONTROLL                                           
020110     .                                                                    
020120     SKIP3                                                                
020121 IMS-DLET-WDJ9 SECTION.                                                   
020123     MOVE '  ' TO GODK-STATUSKODER                                        
020124     CALL CBLTDLI USING DLET WDJ9-PCB DLI-IO-WDJ9                         
020125     MOVE WDJ9-STATUS-CODE TO STATUS-WS                                   
