000100 ID  DIVISION.                                                            
000200     SKIP2                                                                
000300 PROGRAM-ID.    W4612F00.                                                 
000400*AUTHOR.        GERRY CARMICHAEL.                                         
000500*DATE-WRITTEN.  DECEMBER 1997.                                            
000600                                                                          
000700*    REMARKS.                                                             
000800*                                                                         
000900*    FUNKTION:                                                            
001000*                                                                         
001100*        IMPORTÖRSBEROENDE BEHANDLING (KOREA)                             
001200*        FILER INNEHÅLLER TRANSAR DISTRIKT ????.                          
001300*                                                                         
...
003000     SELECT W4612F                       ASSIGN TO UT-S-W4612FD1.         
003100     SKIP2                                                                
003200*- - - - - - - - - - - - UTFIL:                                           
003300*                        - -  FIL TILL VIPS                               
003400     SELECT W4612Q                       ASSIGN TO UT-S-W4612FD2.         
003500     EJECT                                                                
...
006100*- - - - - - - - - - - - - -  PROGRAM-NAMN                                
006200 77  PROGRAM-NAMN                PIC X(8)    VALUE 'W4612F00'.            
006300     SKIP2                                                                
...
007000                                                                          
007100 77  W4612F-EOF                  PIC X(1)    VALUE 'N'.                   
007200     SKIP2                                                                
...
028400     SKIP2                                                                
028500     OPEN INPUT W4612F OUTPUT W4612Q                                      
028600     SKIP2                                                                
...
031600         END-IF                                                           
031700         IF W-RIF-IDPTYP = 'RIC' OR 'RIQ' OR 'RKF'                        
031800           PERFORM S01-LAS-W4612F                                         
031900         ELSE                                                             
...
091000     MOVE     6124           TO START-IDDISTR                             
...
092700     .                                                                    
092800     SKIP2                                                                
092900 S01-LAS-W4612F SECTION.                                                  
093000     SKIP2                                                                
093100     READ   W4612F INTO W-ARBAREA                                         
093200     AT END MOVE JA TO W4612F-EOF                                         
093300     END-READ                                                             
093400                                                                          
093500     IF W4612F-EOF = NEJ                                                  
093600                                                                          
093700       MOVE 'W4612F'            TO POSTSUM-FDNAMN                         
093800       MOVE 'W4612FD1'          TO POSTSUM-DDNAMN2                        
