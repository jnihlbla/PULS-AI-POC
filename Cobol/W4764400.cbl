001100 ID DIVISION.                                                             
001200 PROGRAM-ID.     W4764400.                                                
001300 AUTHOR.         CAMELIA OLGRENER.                                        
001400 DATE-WRITTEN.   05/03/13.                                                
001500 DATE-COMPILED.                                                           
001600                                                                          
001800*    FUNKTION:                                                            
001900*        PROGRAMMET LÄSER IN FILER MED POSTER SOM SKALL RENSAS PÅ         
002000*        WDR4. RENSNINGSFILEN KOMMER FRÅN PGM W4764300.                   
002100*                                                                         
...
003000 FILE-CONTROL.                                                            
003101     SKIP2                                                                
003102*          --- RENSNINGSPOSTER FÖR WDGX4504                               
003110     SELECT W47643B                    ASSIGN TO W47644D1.                
003300     EJECT                                                                
...
003705                                                                          
003710*01  -COPY WDGX4504    -L.                                                
003800     EJECT                                                                
003900 WORKING-STORAGE SECTION.                                                 
004001                                                                          
004010*    -- CHECKED BY WY2000                                                 
004100 77  IDPGM                       PIC X(8)    VALUE 'W4764400'.            
004140 77  JA                          PIC X       VALUE 'J'.                   
004150 77  NEJ                         PIC X       VALUE 'N'.                   
004160 77  W-ANTAL-4504                PIC 9(4)    VALUE ZERO.                  
004200 01  CHKP-VAR.                                                            
...
005024                                                                          
005602 77  W47643B-EOF-SW              PIC X       VALUE 'N'.                   
005610     88  END-OF-W47643B                      VALUE 'J'.                   
005900     EJECT                                                                
...
007410*01  AREA -COPY WDGX4504   -PRE IN-                                       
007600     EJECT                                                                
...
008012       05 W-IDHTYP               PIC X(4)    VALUE '4503'.                
008013       05 FILLER                 PIC X(26)   VALUE LOW-VALUE.             
008019                                                                          
008080     03 W-KY4504-X.                                                       
...
014601                                                                          
014610     OPEN INPUT W47643B                                                   
014900                                                                          
015200     MOVE +0    TO CHKP-ANT                                               
015310     MOVE IDPGM TO POSTSUM-PROGNAMN                                       
015600     .                                                                    
015800     EJECT                                                                
015810 B-RENSA-4504 SECTION.                                                    
015811                                                                          
015812     PERFORM IMS-GU-WDR401                                                
015819                                                                          
015820     PERFORM S01-LAES-W47643B                                             
015830     PERFORM UNTIL END-OF-W47643B                                         
015838                                                                          
...
015860       END-IF                                                             
015870                                                                          
015895       MOVE IN-4504-IDPRODNR TO W-IDPRODNR                                
015896       MOVE IN-4504-IDKOLLI  TO W-IDKOLLI                                 
015897       PERFORM IMS-GHNP-WDGX4504                                          
015898       IF SEGMENT-FINNS                                                   
015899         PERFORM IMS-DLET-WDGX4504                                        
015900         ADD +1 TO CHKP-ANT                                               
015901                   W-ANTAL-4504                                           
015902       END-IF                                                             
015903                                                                          
015904       PERFORM S01-LAES-W47643B                                           
015905     END-PERFORM                                                          
015906     .                                                                    
015907     EJECT                                                                
015981                                                                          
...
016401                                                                          
016410     CLOSE W47643B                                                        
016431                                                                          
016440     DISPLAY 'ANTAL 4504-BORTTAG: ' W-ANTAL-4504                          
016601                                                                          
016602     MOVE 'S' TO POSTSUM-OPKOD                                            
016610     CALL POSTSUM USING POSTSUM-PARM                                      
016800     .                                                                    
016901     EJECT                                                                
016902 S01-LAES-W47643B SECTION.                                                
016903     SKIP2                                                                
016904     READ W47643B INTO IN-AREA                                            
016905     AT END                                                               
016907        SET END-OF-W47643B TO TRUE                                        
016908                                                                          
016909     NOT AT END                                                           
016910        MOVE 'W47643B'   TO POSTSUM-FDNAMN                                
016911        MOVE 'W47644D1'  TO POSTSUM-DDNAMN2                               
016912        MOVE '4504'      TO POSTSUM-TRANSTYP                              
...
018732     .                                                                    
018733     SKIP3                                                                
018744 IMS-GHNP-WDGX4504 SECTION.                                               
018745                                                                          
018748     STRING 'WDGX4504(KY4504   =' W-KY4504-X ')'                          
...
018754     .                                                                    
018755     SKIP3                                                                
018766 IMS-DLET-WDGX4504 SECTION.                                               
018767                                                                          
