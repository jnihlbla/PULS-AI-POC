000100 ID DIVISION.                                                             
000200 PROGRAM-ID.     W5709600.                                                
000300 AUTHOR.         ARINDAM METIA.                                           
000400 DATE-WRITTEN.   20250912.                                                
...
004700     SELECT W57066                     ASSIGN TO W57096D1.                
004800                                                                          
004900*          --- SAP/R3 - EJ FAKTUROR/KREDITNOTOR                           
005000     SELECT W57051Z                    ASSIGN TO W57096D2.                
005100                                                                          
005200*          --- SAP/R3 - FAKTURA-/KREDITNOTAPOSTER ACKUM.                  
005300     SELECT W57052Z                    ASSIGN TO W57096D3.                
005400                                                                          
005500*          --- SAP/R3 - FAKTURA-/KREDITNOTAPOSTER ÖVRIGA                  
005600     SELECT W57053Z                    ASSIGN TO W57096D4.                
005700                                                                          
005800*          --- LOGG TILL ON-DEMAND                                        
005900     SELECT W57055Z                    ASSIGN TO W57096D5.                
006000                                                                          
006100*          --- LOGG TILL ARTIKEL-DIFF-ANALYSEN                            
006200     SELECT W57058Z                    ASSIGN TO W57096D6.                
006300                                                                          
006400*      - - - SAP-POSTER TILL NÄSTA DAGKÖRNING                             
006500     SELECT W5705NZ                    ASSIGN TO W57096D7.                
006600                                                                          
006700*      - - - INV-POSTER TILL NÄSTA VECKOKÖRNING                           
006800     SELECT W51350Z                    ASSIGN TO W57096D8.                
006900     EJECT                                                                
007000                                                                          
...
012500 77  IDPGM                        PIC X(8)    VALUE 'W5709600'.           
...
020400 01  WS-KDVALISO-ZA               PIC X(3) VALUE 'ZAR'.                   
020500 01  WS-PRKURS                    PIC S9(6)V9(5) COMP-3.                  
020600 01  WS-PRKURS-ZA                 PIC S9(6)V9(5) COMP-3.                  
020700 01  WS-PRKURS-ZA2                PIC S9(6)V9(5) COMP-3.                  
020800 01  WS-PRKURS-ZA3                PIC S9(6)V9(5) COMP-3.                  
...
029200 01  PROGRAM-NAMN                 PIC X(6)    VALUE 'W57096'.             
029300                                                                          
...
050200         PERFORM S60-WRITE-W5705NZ                                        
050300       ELSE                                                               
...
057400                                                                          
057500     MOVE WS-KDVALISO-ZA        TO CURR-KDVALISO-ROW                      
057600     CALL W510CURR USING CURR-W510CURR WDG2-PCB                           
057700     IF CURR-KDSVAR = ' '                                                 
057800       MOVE CURR-PRKURS-NEW     TO WS-PRKURS-ZA                           
057900     ELSE                                                                 
058000       MOVE 1                   TO WS-PRKURS-ZA                           
058100     END-IF                                                               
058200     COMPUTE WS-PRKURS-ZA2 ROUNDED = 1 / WS-PRKURS-ZA                     
058300     MOVE WS-PRKURS-ZA          TO WS-PRKURS-ZA3                          
058400     .                                                                    
058500     EJECT                                                                
058600                                                                          
058700 C-EXECUTE SECTION.                                                       
058800     MOVE WC-IDFTG-ZA           TO W-IDFTG                                
...
060800* BOKFÖRINGEN I SAP SKER DOCK ALLTID I ZAR, DÄRFÖR BYTET HÄR:             
...
061200*      MOVE 'ZAR'               TO WS-KDVALISO                            
061300*    END-IF                                                               
061400                                                                          
...
072800     MOVE 'ZA04'                  TO R3-HEAD-COMPANY-CODE                 
...
078600       PERFORM S004-WRITE-W57053Z-HEAD                                    
078700     ELSE                                                                 
078800       PERFORM S002-WRITE-W57051Z-HEAD                                    
078900     END-IF                                                               
079000     .                                                                    
079100     EJECT                                                                
079200                                                                          
...
079600     MOVE 'ZA04'                  TO R3-HEAD-COMPANY-CODE                 
...
082000       MOVE WS-PRKURS-ZA2         TO R3-HEAD-EXCHANGE-RATE                
082100       MOVE 'ZAR'                 TO CURR-KDVALISO-ROW                    
...
084000           MOVE CURR-PRKURS-NEW TO WS-PRKURS-ZA                           
084100         ELSE                                                             
084200           IF WS-PRKURS = ZERO                                            
084300             MOVE 1             TO WS-PRKURS-ZA                           
084400           END-IF                                                         
084500         END-IF                                                           
084600       ELSE                                                               
084700         MOVE 1                 TO WS-PRKURS-ZA                           
084800       END-IF                                                             
084900       COMPUTE R3-HEAD-EXCHANGE-RATE = WS-PRKURS-ZA *                     
...
088000       MOVE 'ZAR'                 TO R3-HEAD-CURRENCY                     
...
088900                                                                          
089000* ENBART NEDANSTÅENDE HUVUDHÄNDELSETYP TILL W57053Z                       
089100       PERFORM S004-WRITE-W57053Z-HEAD                                    
089200     .                                                                    
089300     EJECT                                                                
089400                                                                          
...
089800     MOVE 'ZA04'                  TO R3-HEAD-COMPANY-CODE                 
...
091400       MOVE 'ZAR'                 TO R3-HEAD-CURRENCY                     
091500       MOVE WS-PRKURS             TO R3-HEAD-EXCHANGE-RATE                
091600     ELSE                                                                 
091700       MOVE 'SEK'                 TO R3-HEAD-CURRENCY                     
091800       MOVE WS-PRKURS-ZA2         TO R3-HEAD-EXCHANGE-RATE                
...
096600                                                                          
096700* ENBART NEDANSTÅENDE HUVUDHÄNDELSETYP TILL W57053Z                       
096800       PERFORM S004-WRITE-W57053Z-HEAD                                    
096900     .                                                                    
097000     EJECT                                                                
097100                                                                          
...
098500     MOVE 'ZA04'              TO R3-LINE-COMPANY-CODE                     
...
108300           PERFORM S02-WRITE-W57051Z                                      
108400         END-IF                                                           
108500       END-IF                                                             
108600                                                                          
...
110000           PERFORM S02-WRITE-W57051Z                                      
110100         END-IF                                                           
110200       END-IF                                                             
110300                                                                          
...
111400           PERFORM S02-WRITE-W57051Z                                      
111500         END-IF                                                           
111600       END-IF                                                             
111700                                                                          
...
112800           PERFORM S02-WRITE-W57051Z                                      
112900         END-IF                                                           
113000       END-IF                                                             
113100                                                                          
113200     END-EVALUATE                                                         
...
114300          IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA * -1            
...
115300               IN-EKH-SUBEL / WS-PRKURS-ZA  * -1                          
115400       MOVE R3-LINE-AMOUNT-LC TO R3-LINE-AMOUNT                           
115500       PERFORM S04-WRITE-W57053Z                                          
115600                                                                          
115700     WHEN 'EMB'                                                           
...
116100               IN-EKH-SUBEL / WS-PRKURS-ZA  * -1                          
116200       MOVE R3-LINE-AMOUNT-LC TO R3-LINE-AMOUNT                           
116300       PERFORM S04-WRITE-W57053Z                                          
116400                                                                          
116500     WHEN 'DDI'                                                           
...
117400           PERFORM S04-WRITE-W57053Z                                      
117500         END-IF                                                           
117600       ELSE                                                               
...
118400           PERFORM S04-WRITE-W57053Z                                      
118500         END-IF                                                           
118600       END-IF                                                             
118700     END-EVALUATE                                                         
118800     .                                                                    
...
119800             IN-EKH-KVANTAL *  IN-EKH-PRARTNTO / WS-PRKURS-ZA3            
...
120900            (IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA3) +          
121000            (IN-EKH-KVANTAL *                                             
121100            IN-EKH-PRARTNTO / WS-PRKURS-ZA3 * WS-MARKUP)                  
...
124100                 IN-EKH-SUBEL / WS-PRKURS-ZA3                             
124200         MOVE R3-LINE-AMOUNT-LC TO R3-LINE-AMOUNT                         
124300         PERFORM S04-WRITE-W57053Z                                        
124400       END-IF                                                             
124500                                                                          
...
125000                 IN-EKH-SUBEL / WS-PRKURS-ZA3                             
...
125600         PERFORM S04-WRITE-W57053Z                                        
125700       END-IF                                                             
125800                                                                          
125900     WHEN 'EMB'                                                           
...
126400                 IN-EKH-SUBEL / WS-PRKURS-ZA3                             
126500         MOVE R3-LINE-AMOUNT-LC TO R3-LINE-AMOUNT                         
126600         PERFORM S04-WRITE-W57053Z                                        
126700       END-IF                                                             
126800                                                                          
...
127300                 IN-EKH-SUBEL / WS-PRKURS-ZA3                             
...
127900         PERFORM S04-WRITE-W57053Z                                        
128000       END-IF                                                             
128100     END-EVALUATE                                                         
128200                                                                          
128300     .                                                                    
...
129500            (IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA3) +          
129600            (IN-EKH-KVANTAL *                                             
129700             IN-EKH-PRARTNTO / WS-PRKURS-ZA3 * WS-MARKUP)                 
...
130300           PERFORM S02-WRITE-W57051Z                                      
130400         END-IF                                                           
130500                                                                          
...
131100            (IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA3) +          
131200            (IN-EKH-KVANTAL *                                             
131300             IN-EKH-PRARTNTO / WS-PRKURS-ZA3 * WS-MARKUP)                 
...
132100           PERFORM S02-WRITE-W57051Z                                      
132200         END-IF                                                           
132300       END-IF                                                             
132400                                                                          
132500                                                                          
...
133200            (IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA3) +          
133300            (IN-EKH-KVANTAL *                                             
133400             IN-EKH-PRARTNTO / WS-PRKURS-ZA3 * WS-MARKUP)                 
...
134200           PERFORM S02-WRITE-W57051Z                                      
134300         END-IF                                                           
134400                                                                          
...
135000            (IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA3) +          
135100            (IN-EKH-KVANTAL *                                             
135200             IN-EKH-PRARTNTO / WS-PRKURS-ZA3 * WS-MARKUP)                 
...
135800           PERFORM S02-WRITE-W57051Z                                      
135900         END-IF                                                           
136000       END-IF                                                             
136100                                                                          
136200     END-EVALUATE                                                         
...
137900         PERFORM S02-WRITE-W57051Z                                        
138000       END-IF                                                             
138100                                                                          
...
138900         PERFORM S02-WRITE-W57051Z                                        
139000       END-IF                                                             
139100     END-EVALUATE                                                         
139200     .                                                                    
139300     EJECT                                                                
...
140300         IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA   * -1           
...
145100       PERFORM S04-WRITE-W57053Z                                          
145200                                                                          
145300     WHEN 'EMB'                                                           
...
145700               (IN-EKH-SUBEL / WS-PRKURS-ZA) * -1                         
...
146300       PERFORM S04-WRITE-W57053Z                                          
146400                                                                          
146500     WHEN 'DDI'                                                           
...
147800           PERFORM S04-WRITE-W57053Z                                      
147900         END-IF                                                           
148000       ELSE                                                               
...
149200           PERFORM S04-WRITE-W57053Z                                      
149300         END-IF                                                           
149400       END-IF                                                             
149500     END-EVALUATE                                                         
149600     .                                                                    
...
150700         (IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA) +              
150800         (IN-EKH-KVANTAL *                                                
150900          IN-EKH-PRARTNTO / WS-PRKURS-ZA * WS-MARKUP)                     
...
152100             IN-EKH-PRARTNTO / WS-PRKURS-ZA * WS-MARKUP)                  
...
155600           PERFORM S04-WRITE-W57053Z                                      
155700         END-IF                                                           
155800       END-IF                                                             
...
156700           PERFORM S04-WRITE-W57053Z                                      
156800         END-IF                                                           
156900       END-IF                                                             
157000                                                                          
157100     END-EVALUATE                                                         
...
158200            (IN-EKH-KVANTAL * (IN-EKH-PRARTNTO / WS-PRKURS-ZA3))          
158300            + (IN-EKH-KVANTAL *                                           
158400            (IN-EKH-PRARTNTO / WS-PRKURS-ZA3) * WS-MARKUP)                
...
159200           PERFORM S02-WRITE-W57051Z                                      
159300         END-IF                                                           
159400                                                                          
...
159900            (IN-EKH-KVANTAL * (IN-EKH-PRARTNTO / WS-PRKURS-ZA3))          
...
160800           PERFORM S02-WRITE-W57051Z                                      
160900         END-IF                                                           
161000                                                                          
...
162200           PERFORM S02-WRITE-W57051Z                                      
162300         END-IF                                                           
162400                                                                          
162500     END-EVALUATE                                                         
162600     .                                                                    
...
163600            (IN-EKH-KVANTAL * (IN-EKH-PRARTNTO / WS-PRKURS-ZA3))          
163700            + (IN-EKH-KVANTAL *                                           
163800            (IN-EKH-PRARTNTO / WS-PRKURS-ZA3) * WS-MARKUP)                
...
164600           PERFORM S02-WRITE-W57051Z                                      
164700         END-IF                                                           
164800                                                                          
...
165300            (IN-EKH-KVANTAL * (IN-EKH-PRARTNTO / WS-PRKURS-ZA3))          
...
166200           PERFORM S02-WRITE-W57051Z                                      
166300         END-IF                                                           
166400                                                                          
...
167600           PERFORM S02-WRITE-W57051Z                                      
167700         END-IF                                                           
167800                                                                          
167900     END-EVALUATE                                                         
168000     .                                                                    
...
169000            (IN-EKH-KVANTAL * (IN-EKH-PRARTNTO / WS-PRKURS-ZA3))          
169100            + (IN-EKH-KVANTAL *                                           
169200            (IN-EKH-PRARTNTO / WS-PRKURS-ZA3) * WS-MARKUP)                
...
170000           PERFORM S02-WRITE-W57051Z                                      
170100         END-IF                                                           
170200                                                                          
...
170700            (IN-EKH-KVANTAL * (IN-EKH-PRARTNTO / WS-PRKURS-ZA3))          
...
171600           PERFORM S02-WRITE-W57051Z                                      
171700         END-IF                                                           
171800                                                                          
...
173000           PERFORM S02-WRITE-W57051Z                                      
173100         END-IF                                                           
173200                                                                          
173300     END-EVALUATE                                                         
173400     .                                                                    
...
174400          IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA * -1            
...
175500               IN-EKH-SUBEL / WS-PRKURS-ZA  * -1                          
175600       MOVE R3-LINE-AMOUNT-LC TO R3-LINE-AMOUNT                           
175700       PERFORM S04-WRITE-W57053Z                                          
175800                                                                          
175900     WHEN 'DDI'                                                           
...
176800           PERFORM S04-WRITE-W57053Z                                      
176900         END-IF                                                           
177000       ELSE                                                               
...
177800           PERFORM S04-WRITE-W57053Z                                      
177900         END-IF                                                           
178000       END-IF                                                             
178100     END-EVALUATE                                                         
178200     .                                                                    
...
179200             IN-EKH-KVANTAL *  IN-EKH-PRARTNTO / WS-PRKURS-ZA3            
...
180300            (IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA3) +          
180400            (IN-EKH-KVANTAL *                                             
180500            IN-EKH-PRARTNTO / WS-PRKURS-ZA3 * WS-MARKUP)                  
...
183600                 IN-EKH-SUBEL / WS-PRKURS-ZA3                             
183700         MOVE R3-LINE-AMOUNT-LC TO R3-LINE-AMOUNT                         
183800         PERFORM S04-WRITE-W57053Z                                        
183900       END-IF                                                             
184000                                                                          
...
184500                 IN-EKH-SUBEL / WS-PRKURS-ZA3                             
...
185100         PERFORM S04-WRITE-W57053Z                                        
185200       END-IF                                                             
185300                                                                          
185400     END-EVALUATE                                                         
185500     .                                                                    
...
186700            (IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA3) +          
186800            (IN-EKH-KVANTAL *                                             
186900             IN-EKH-PRARTNTO / WS-PRKURS-ZA3 * WS-MARKUP)                 
...
187500           PERFORM S02-WRITE-W57051Z                                      
187600         END-IF                                                           
187700                                                                          
...
188300            (IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA3) +          
188400            (IN-EKH-KVANTAL *                                             
188500             IN-EKH-PRARTNTO / WS-PRKURS-ZA3 * WS-MARKUP)                 
...
189300           PERFORM S02-WRITE-W57051Z                                      
189400         END-IF                                                           
189500       END-IF                                                             
189600                                                                          
189700                                                                          
...
190400            (IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA3) +          
190500            (IN-EKH-KVANTAL *                                             
190600             IN-EKH-PRARTNTO / WS-PRKURS-ZA3 * WS-MARKUP)                 
...
191400           PERFORM S02-WRITE-W57051Z                                      
191500         END-IF                                                           
191600                                                                          
...
192200            (IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA3) +          
192300            (IN-EKH-KVANTAL *                                             
192400             IN-EKH-PRARTNTO / WS-PRKURS-ZA3 * WS-MARKUP)                 
...
193000           PERFORM S02-WRITE-W57051Z                                      
193100         END-IF                                                           
193200       END-IF                                                             
193300                                                                          
193400     END-EVALUATE                                                         
...
194500         IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA   * -1           
...
199300       PERFORM S04-WRITE-W57053Z                                          
199400                                                                          
199500     WHEN 'EMB'                                                           
...
199900               (IN-EKH-SUBEL / WS-PRKURS-ZA) * -1                         
...
200500       PERFORM S04-WRITE-W57053Z                                          
200600                                                                          
200700     WHEN 'DDI'                                                           
...
202000           PERFORM S04-WRITE-W57053Z                                      
202100         END-IF                                                           
202200       ELSE                                                               
...
203400           PERFORM S04-WRITE-W57053Z                                      
203500         END-IF                                                           
203600       END-IF                                                             
203700     END-EVALUATE                                                         
203800     .                                                                    
...
207100           PERFORM S04-WRITE-W57053Z                                      
207200         END-IF                                                           
207300       END-IF                                                             
207400                                                                          
...
209100           PERFORM S04-WRITE-W57053Z                                      
209200         END-IF                                                           
209300       END-IF                                                             
216600                                                                          
216700     WHEN 'DDI'                                                           
...
218000           PERFORM S04-WRITE-W57053Z                                      
218100         END-IF                                                           
218200       ELSE                                                               
...
219400           PERFORM S04-WRITE-W57053Z                                      
219500         END-IF                                                           
219600       END-IF                                                             
219700     END-EVALUATE                                                         
219800     .                                                                    
...
222000           PERFORM S04-WRITE-W57053Z                                      
222100         END-IF                                                           
222200       END-IF                                                             
222300                                                                          
231600     WHEN 'DDI'                                                           
...
232900           PERFORM S04-WRITE-W57053Z                                      
233000         END-IF                                                           
233100       ELSE                                                               
...
234300           PERFORM S04-WRITE-W57053Z                                      
234400         END-IF                                                           
234500       END-IF                                                             
234600                                                                          
234700     END-EVALUATE                                                         
...
237000           PERFORM S04-WRITE-W57053Z                                      
237100         END-IF                                                           
237200       END-IF                                                             
237300                                                                          
246600     WHEN 'DDI'                                                           
...
247900           PERFORM S04-WRITE-W57053Z                                      
248000         END-IF                                                           
248100       ELSE                                                               
...
249300           PERFORM S04-WRITE-W57053Z                                      
249400         END-IF                                                           
249500       END-IF                                                             
249600                                                                          
249700     END-EVALUATE                                                         
...
253800         MOVE 0000359318          TO R3-LINE-PA-CUSTOMER                  
...
258300         MOVE 0000359318        TO R3-LINE-PA-CUSTOMER                    
...
261100         IF IN-EKH-KDVALISO = 'ZAR'                                       
261200           MOVE R3-LINE-AMOUNT-LC TO R3-LINE-AMOUNT                       
261300         END-IF                                                           
261400         MOVE 0000359318          TO R3-LINE-PA-CUSTOMER                  
...
263600         MOVE 0000359318          TO R3-LINE-PA-CUSTOMER                  
...
271500       PERFORM S04-WRITE-W57053Z                                          
271600                                                                          
271700     END-EVALUATE                                                         
271800     .                                                                    
271900     EJECT                                                                
...
274600         PERFORM S02-WRITE-W57051Z                                        
274700       END-IF                                                             
274800                                                                          
...
276200         PERFORM S02-WRITE-W57051Z                                        
276300       END-IF                                                             
276400     END-EVALUATE                                                         
276500     .                                                                    
276600     EJECT                                                                
...
278200           IF IN-EKH-KDVALISO = 'ZAR'                                     
278300             MOVE R3-LINE-AMOUNT-LC TO R3-LINE-AMOUNT                     
278400           END-IF                                                         
278500           MOVE 0000359318          TO R3-LINE-PA-CUSTOMER                
278700           PERFORM S02-WRITE-W57051Z                                      
278800         END-IF                                                           
278900                                                                          
...
280500           MOVE 0000359318        TO R3-LINE-PA-CUSTOMER                  
280700           PERFORM S02-WRITE-W57051Z                                      
280800         END-IF                                                           
280900       ELSE                                                               
...
282000           IF IN-EKH-KDVALISO = 'ZAR'                                     
282100             MOVE R3-LINE-AMOUNT-LC TO R3-LINE-AMOUNT                     
282200           END-IF                                                         
282300           MOVE 0000359318          TO R3-LINE-PA-CUSTOMER                
282500           PERFORM S02-WRITE-W57051Z                                      
282600         END-IF                                                           
282700                                                                          
...
284300           MOVE 0000359318        TO R3-LINE-PA-CUSTOMER                  
284500           PERFORM S02-WRITE-W57051Z                                      
284600         END-IF                                                           
284700       END-IF                                                             
284800     END-EVALUATE                                                         
284900     .                                                                    
...
287900         IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA * -1             
...
288790         IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA * -1             
288791         * WS-MARKUP                                                      
...
288809         IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA * -1             
288810         * WS-MARKUP                                                      
...
289500               R3-LINE-AMOUNT-LC / WS-PRKURS-ZA3                          
...
290200         PERFORM S02-WRITE-W57051Z                                        
290300       END-IF                                                             
290400                                                                          
290500     WHEN 'DDI'                                                           
...
291700           PERFORM S02-WRITE-W57051Z                                      
291800         END-IF                                                           
291900       ELSE                                                               
...
293000           PERFORM S02-WRITE-W57051Z                                      
293100         END-IF                                                           
293200       END-IF                                                             
293300     END-EVALUATE                                                         
293400     .                                                                    
...
294400                 IN-EKH-SUBEL * -1  / WS-PRKURS-ZA3                       
...
296500           PERFORM S04-WRITE-W57053Z                                      
296600         END-IF                                                           
296700       ELSE                                                               
...
297800           PERFORM S04-WRITE-W57053Z                                      
297900         END-IF                                                           
298000       END-IF                                                             
298100     END-EVALUATE                                                         
298200     .                                                                    
...
299300         IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA3 * -1            
...
301000         IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA3 * -1            
301100         * WS-MARKUP                                                      
...
302800         IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA3 * -1            
302900         * WS-MARKUP                                                      
...
305400         IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA3 * -1            
...
307100         IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA3 * -1            
307200         * WS-MARKUP                                                      
...
308900         IN-EKH-KVANTAL * IN-EKH-PRARTNTO / WS-PRKURS-ZA3 * -1            
309000         * WS-MARKUP                                                      
...
312600         PERFORM S02-WRITE-W57051Z                                        
312700       END-IF                                                             
312800                                                                          
...
314600         PERFORM S02-WRITE-W57051Z                                        
314700       END-IF                                                             
314800     END-EVALUATE                                                         
314900     .                                                                    
315000     EJECT                                                                
...
317110          MOVE 0000359318          TO R3-LINE-PA-CUSTOMER                 
317200          PERFORM S02-WRITE-W57051Z                                       
317300        END-IF                                                            
317400                                                                          
...
319200          PERFORM S02-WRITE-W57051Z                                       
319300        END-IF                                                            
319400     END-EVALUATE                                                         
319500     .                                                                    
319600     EJECT                                                                
...
321500         MOVE 0000359318          TO R3-LINE-PA-CUSTOMER                  
...
324100         MOVE 0000359318          TO R3-LINE-PA-CUSTOMER                  
...
326400           IF IN-EKH-KDVALISO = 'ZAR'                                     
326500             MOVE R3-LINE-AMOUNT-LC TO R3-LINE-AMOUNT                     
326600           END-IF                                                         
326700           MOVE SPACE               TO R3-LINE-TRADING-PARTNER            
326710*          MOVE BET-KDTRADP         TO R3-LINE-TRADING-PARTNER            
326800           MOVE 0000359318          TO R3-LINE-PA-CUSTOMER                
327000           PERFORM S02-WRITE-W57051Z                                      
327100         END-IF                                                           
327200       END-IF                                                             
327300                                                                          
...
328800           MOVE 0000359318          TO R3-LINE-PA-CUSTOMER                
329000           PERFORM S02-WRITE-W57051Z                                      
329100         END-IF                                                           
329200       END-IF                                                             
329300                                                                          
...
330100           IF IN-EKH-KDVALISO = 'ZAR'                                     
330200             MOVE R3-LINE-AMOUNT-LC TO R3-LINE-AMOUNT                     
330300           END-IF                                                         
330400           MOVE SYST-IDKST          TO R3-LINE-COST-CENTER                
330500           MOVE 0000359318          TO R3-LINE-PA-CUSTOMER                
330700           PERFORM S02-WRITE-W57051Z                                      
330800         END-IF                                                           
330900       END-IF                                                             
331000                                                                          
...
332600           MOVE 0000359318          TO R3-LINE-PA-CUSTOMER                
332800           PERFORM S02-WRITE-W57051Z                                      
332900         END-IF                                                           
333000       END-IF                                                             
333100     END-EVALUATE                                                         
333200     .                                                                    
...
335100           PERFORM S02-WRITE-W57051Z                                      
335200         END-IF                                                           
335300       END-IF                                                             
335400                                                                          
...
336800           PERFORM S02-WRITE-W57051Z                                      
336900         END-IF                                                           
337000       END-IF                                                             
337100     END-EVALUATE                                                         
337200     .                                                                    
...
339900           IF IN-EKH-KDVALISO = 'ZAR'                                     
340000             MOVE R3-LINE-AMOUNT-LC TO R3-LINE-AMOUNT                     
340100           END-IF                                                         
340200           PERFORM S02-WRITE-W57051Z                                      
340300         END-IF                                                           
340400                                                                          
...
341800           PERFORM S02-WRITE-W57051Z                                      
341900         END-IF                                                           
342000       END-IF                                                             
342100                                                                          
...
343500           PERFORM S02-WRITE-W57051Z                                      
343600         END-IF                                                           
343700                                                                          
...
350400         PERFORM S02-WRITE-W57051Z                                        
350500       END-IF                                                             
350600                                                                          
...
352500     MOVE 'ZA04'             TO R3-LINE-COMPANY-CODE                      
...
359200                                                                          
359300           PERFORM S04-WRITE-W57053Z                                      
359400         END-IF                                                           
359500       END-IF                                                             
359600                                                                          
...
361200                                                                          
361300           PERFORM S04-WRITE-W57053Z                                      
361400         END-IF                                                           
361500       END-IF                                                             
361600     END-EVALUATE                                                         
361700     .                                                                    
...
362800                   R3-LINE-AMOUNT    / WS-PRKURS-ZA  * -1                 
362900           MOVE R3-LINE-AMOUNT-LC  TO R3-LINE-AMOUNT                      
363000           MOVE 'V0'     TO R3-LINE-TAX-CODE                              
...
365100                   R3-LINE-AMOUNT    / WS-PRKURS-ZA  * -1                 
365200           MOVE R3-LINE-AMOUNT-LC  TO R3-LINE-AMOUNT                      
365300           MOVE 'V0'     TO R3-LINE-TAX-CODE                              
...
366000                     R3-LINE-TAX-AMOUNT    / WS-PRKURS-ZA  * -1           
...
366500                                                                          
366600           PERFORM S04-WRITE-W57053Z                                      
366700         END-IF                                                           
366800       END-IF                                                             
366900     END-EVALUATE                                                         
367000     .                                                                    
...
368400                   R3-LINE-AMOUNT    / WS-PRKURS-ZA  * -1                 
368500           MOVE R3-LINE-AMOUNT-LC  TO R3-LINE-AMOUNT                      
368600           MOVE 'V0'     TO R3-LINE-TAX-CODE                              
...
369300               R3-LINE-TAX-AMOUNT / WS-PRKURS-ZA  * -1                    
...
369800                                                                          
369900           PERFORM S04-WRITE-W57053Z                                      
370000         END-IF                                                           
370100       END-IF                                                             
370200                                                                          
...
370900                   R3-LINE-AMOUNT    / WS-PRKURS-ZA  * -1                 
371000           MOVE R3-LINE-AMOUNT-LC  TO R3-LINE-AMOUNT                      
371100           MOVE 'V0'     TO R3-LINE-TAX-CODE                              
...
371800               R3-LINE-TAX-AMOUNT / WS-PRKURS-ZA * -1                     
...
372300                                                                          
372400           PERFORM S04-WRITE-W57053Z                                      
372500         END-IF                                                           
372600       END-IF                                                             
372700     END-EVALUATE                                                         
372800     .                                                                    
...
373900                   R3-LINE-AMOUNT    / WS-PRKURS-ZA  * -1                 
374000           MOVE R3-LINE-AMOUNT-LC  TO R3-LINE-AMOUNT                      
374100           MOVE 'V0'     TO R3-LINE-TAX-CODE                              
...
376300                   R3-LINE-AMOUNT    / WS-PRKURS-ZA                       
376400           MOVE R3-LINE-AMOUNT-LC  TO R3-LINE-AMOUNT                      
376500           MOVE 'V0'     TO R3-LINE-TAX-CODE                              
...
379300                   R3-LINE-AMOUNT    / WS-PRKURS-ZA  * -1                 
379400           MOVE R3-LINE-AMOUNT-LC TO R3-LINE-AMOUNT                       
379500           MOVE 'V0'     TO R3-LINE-TAX-CODE                              
...
382300           IF ADR-IDLANDX2 = 'ZA'                                         
382400             PERFORM S10-VATCODE                                          
382500           ELSE                                                           
382600             MOVE 'V0'             TO R3-LINE-TAX-CODE                    
...
385400                                                                          
385500           PERFORM S04-WRITE-W57053Z                                      
385600         END-IF                                                           
385700       END-IF                                                             
385800                                                                          
...
386200           IF ADR-IDLANDX2 = 'ZA'                                         
386300             MOVE 'V3'             TO R3-LINE-TAX-CODE                    
386400             COMPUTE IN-EKH-SUVAT ROUNDED = IN-EKH-SUBEL * 0.15           
386500           ELSE                                                           
386600             MOVE 'V0'             TO R3-LINE-TAX-CODE                    
...
389400                                                                          
389500           PERFORM S04-WRITE-W57053Z                                      
389600         END-IF                                                           
389700       END-IF                                                             
389800     END-EVALUATE                                                         
389900     .                                                                    
...
390800         (IN-EKH-SUBEL / WS-PRKURS-ZA)                                    
...
391300                 R3-LINE-TAX-AMOUNT-LC / WS-PRKURS-ZA                     
391400         MOVE WS-KDBETVIL          TO R3-LINE-PAYTERMS                    
391500                                                                          
391600         PERFORM S04-WRITE-W57053Z                                        
391700       END-IF                                                             
391800     END-EVALUATE                                                         
391900     .                                                                    
392000     EJECT                                                                
...
392170         (IN-EKH-SUBEL / WS-PRKURS-ZA3)                                   
...
392193                 R3-LINE-TAX-AMOUNT-LC / WS-PRKURS-ZA3                    
392194         MOVE WS-KDBETVIL          TO R3-LINE-PAYTERMS                    
392195                                                                          
392196         PERFORM S04-WRITE-W57053Z                                        
392197       END-IF                                                             
392198     END-EVALUATE                                                         
392199     .                                                                    
392200     EJECT                                                                
...
393000               R3-LINE-AMOUNT-LC / WS-PRKURS-ZA3                          
393100         MOVE R3-LINE-AMOUNT       TO R3-LINE-AMOUNT-LC                   
393200         MOVE 'V0'                 TO R3-LINE-TAX-CODE                    
...
393600                 R3-LINE-TAX-AMOUNT-LC / WS-PRKURS-ZA3                    
393700         MOVE WS-KDBETVIL          TO R3-LINE-PAYTERMS                    
393800                                                                          
393900         PERFORM S04-WRITE-W57053Z                                        
394000       END-IF                                                             
394100     END-EVALUATE                                                         
394200     .                                                                    
394300     EJECT                                                                
...
395700     MOVE 'ZA04'             TO R3-LINE-COMPANY-CODE                      
...
400000                                                                          
400100           PERFORM S04-WRITE-W57053Z                                      
400200         END-IF                                                           
400300       END-IF                                                             
400400                                                                          
400500     END-EVALUATE                                                         
...
402200     MOVE 'ZA04'           TO LOGG-KDTRADP                                
402300                                                                          
...
406600        MOVE 'W57096D1'   TO POSTSUM-DDNAMN2                              
...
407300     .                                                                    
407400                                                                          
407500 S02-WRITE-W57051Z SECTION.                                               
...
409800     END-IF                                                               
409900     MOVE 'W57051Z'             TO POSTSUM-FDNAMN                         
410000     MOVE 'W57096D2'            TO POSTSUM-DDNAMN2                        
410100     CALL POSTSUM USING POSTSUM-PARM                                      
410200     .                                                                    
410300                                                                          
410400 S002-WRITE-W57051Z-HEAD SECTION.                                         
...
411800     MOVE 'W57051Z'             TO POSTSUM-FDNAMN                         
411900     MOVE 'W57096D2'            TO POSTSUM-DDNAMN2                        
...
413700     MOVE 'W57052Z'           TO POSTSUM-FDNAMN                           
413800     MOVE 'W57096D3'          TO POSTSUM-DDNAMN2                          
413900     CALL POSTSUM USING POSTSUM-PARM                                      
414000                                                                          
414100     PERFORM S20-CREATE-WRITE-LOG                                         
414200     .                                                                    
414300                                                                          
414400 S04-WRITE-W57053Z SECTION.                                               
...
416200     END-IF                                                               
416300                                                                          
416400     MOVE 'W57053Z'             TO POSTSUM-FDNAMN                         
416500     MOVE 'W57096D4'            TO POSTSUM-DDNAMN2                        
...
417100     .                                                                    
417200                                                                          
417300 S004-WRITE-W57053Z-HEAD SECTION.                                         
...
418700     MOVE 'W57053Z'             TO POSTSUM-FDNAMN                         
418800     MOVE 'W57096D4'            TO POSTSUM-DDNAMN2                        
...
420500       MOVE 'V3'     TO R3-LINE-TAX-CODE                                  
420600**** HERE WE ADD VAT FOR 16% TO BOOKING                                   
420700       COMPUTE IN-EKH-SUVAT ROUNDED = IN-EKH-SUBEL * 0.15                 
420800     ELSE                                                                 
420900       MOVE 'V0'     TO R3-LINE-TAX-CODE                                  
421000     END-IF                                                               
421100     IF IN-EKH-BEVAT = 'XX'                                               
421200       MOVE 'V0'     TO R3-LINE-TAX-CODE                                  
421300     END-IF                                                               
421400     .                                                                    
421500     EJECT                                                                
421600                                                                          
...
421720     MOVE WC-NDC-ZA          TO W-IDDC-B6                                 
...
425400                                                                          
425500     PERFORM S21-WRITE-W57055Z                                            
425600     PERFORM S22-WRITE-W57058Z                                            
425700                                                                          
...
426200                                                                          
426300       PERFORM S21-WRITE-W57055Z                                          
426400     END-IF                                                               
426500     .                                                                    
426600     EJECT                                                                
426700                                                                          
426800 S21-WRITE-W57055Z SECTION.                                               
...
428600     MOVE 'W57055Z'   TO POSTSUM-FDNAMN                                   
428700     MOVE 'W57096D5'  TO POSTSUM-DDNAMN2                                  
428800     CALL POSTSUM USING POSTSUM-PARM                                      
428900     .                                                                    
429000                                                                          
429100 S22-WRITE-W57058Z SECTION.                                               
...
433200       MOVE 'W57058Z'           TO POSTSUM-FDNAMN                         
433300       MOVE 'W57096D6'          TO POSTSUM-DDNAMN2                        
...
434800         MOVE 'ZA99999'       TO W-WDB1-IDPARTNR                          
434900       ELSE                                                               
435000         MOVE GMT-IDPARTNR    TO W-WDB1-IDPARTNR                          
435100       END-IF                                                             
435200     END-IF                                                               
435300     MOVE WC-IDFTG-ZA         TO W-WDB1-IDFTG                             
...
436700     END-IF                                                               
436800     MOVE 'ZAR'           TO WS-KDVALISO-WDB1                             
436900                                                                          
...
444100       PERFORM S70-WRITE-W51350Z                                          
444200     END-IF                                                               
444300     .                                                                    
444400     EJECT                                                                
444500                                                                          
...
445900       PERFORM S70-WRITE-W51350Z                                          
446000     END-IF                                                               
446100     .                                                                    
446200     EJECT                                                                
446300                                                                          
...
448500       PERFORM S70-WRITE-W51350Z                                          
448600     END-IF                                                               
448700     .                                                                    
448800     EJECT                                                                
448900                                                                          
...
450800       PERFORM S70-WRITE-W51350Z                                          
450900     END-IF                                                               
451000     .                                                                    
451100     EJECT                                                                
451200                                                                          
451300 S60-WRITE-W5705NZ SECTION.                                               
451400     WRITE SAPUT-POST  FROM IN-AREA                                       
451500                                                                          
451600     MOVE 'SPAR'              TO POSTSUM-TRANSTYP                         
451700     MOVE 'W5705NZ'           TO POSTSUM-FDNAMN                           
451800     MOVE 'W57096D7'          TO POSTSUM-DDNAMN2                          
451900     CALL POSTSUM USING POSTSUM-PARM                                      
452000     .                                                                    
452100     EJECT                                                                
452200                                                                          
452300 S70-WRITE-W51350Z SECTION.                                               
...
455900     MOVE 'W51350Z'           TO POSTSUM-FDNAMN                           
456000     MOVE 'W57096D8'          TO POSTSUM-DDNAMN2                          
...
458817             MOVE WS-KDVALISO-ZA      TO CURR-KDVALISO-ROW                
458818             CALL W510CURR USING CURR-W510CURR WDG2-PCB                   
458819             IF CURR-KDSVAR = ' '                                         
458820               MOVE CURR-PRKURS-NEW   TO WS-PRKURS-ZA3                    
458821             ELSE                                                         
458822               MOVE +1                TO WS-PRKURS-ZA3                    
458823             END-IF                                                       
458824           ELSE                                                           
458825             MOVE INL-PRKURS        TO WS-PRKURS-ZA3                      
458830           END-IF                                                         
458900         ELSE                                                             
...
459600           MOVE WS-KDVALISO-ZA        TO CURR-KDVALISO-ROW                
459700           CALL W510CURR USING CURR-W510CURR WDG2-PCB                     
459800           IF CURR-KDSVAR = ' '                                           
459900             MOVE CURR-PRKURS-NEW     TO WS-PRKURS-ZA3                    
460000           ELSE                                                           
460100             MOVE +1                  TO WS-PRKURS-ZA3                    
460200           END-IF                                                         
460300         END-IF                                                           
460400       END-IF                                                             
460500     END-IF                                                               
...
461100     MOVE 'ZAR'               TO CURR-KDVALISO-ROW                        
...
463000         MOVE CURR-PRKURS-NEW TO WS-PRKURS-ZA3                            
463100       ELSE                                                               
463200         IF WS-PRKURS = ZERO                                              
463300           MOVE 1           TO WS-PRKURS-ZA3                              
463400         END-IF                                                           
463500       END-IF                                                             
463600     ELSE                                                                 
463700       MOVE 1               TO WS-PRKURS-ZA3                              
463800     END-IF                                                               
463900     .                                                                    
464000     EJECT                                                                
464100                                                                          
