...
001800 FILE-CONTROL.                                                            
001900     SKIP2                                                                
002000*          --- INPUT FILE FROM W272G1                                     
002100     SELECT W272G2                     ASSIGN TO W272G2D1.                
002200     EJECT                                                                
...
003000                                                                          
003100*01  -COPY W272G1      -L.                                                
003200     EJECT                                                                
003300 WORKING-STORAGE SECTION.                                                 
003400                                                                          
003500 77  IDPGM                       PIC X(8)    VALUE 'W272G200'.            
003600 01  CHKP-VAR.                                                            
...
004900                                                                          
005000 77  W272G2-EOF-SW               PIC X       VALUE 'N'.                   
005100     88  END-OF-W272G2                       VALUE 'Y'.                   
005200     EJECT                                                                
...
007100                                                                          
007200*01  AREA -COPY W272G1     -PRE IN-                                       
007300*                                                                         
007400     EJECT                                                                
...
013700                                                                          
013800*01  -COPY W0008  -PRE WDK6-                                              
013900     05  FILLER                  PIC X.                                   
014000     EJECT                                                                
014100 PROCEDURE DIVISION  USING MSG-PCB WDE3-PCB WDK6-PCB.                     
014200 MAIN SECTION.                                                            
014300     ENTRY 'DLITCBL' USING MSG-PCB WDE3-PCB WDK6-PCB.                     
014400                                                                          
014500     SKIP2                                                                
014600     PERFORM A-INIT                                                       
014700     PERFORM S01-READ-W272G2                                              
014800     PERFORM UNTIL END-OF-W272G2                                          
...
015400                                                                          
015500       PERFORM S01-READ-W272G2                                            
015600     END-PERFORM                                                          
015700                                                                          
015800                                                                          
...
017540       PERFORM IMS-GHU-WDK6-CLAG                                          
017541       IF SEGMENT-FOUND                                                   
017544         COMPUTE CLAG-KVBEART = CLAG-KVBEART - WS-KVBEART                 
017547                                                                          
017548         PERFORM IMS-REPL-WDK611                                          
...
024600     .                                                                    
024700     EJECT                                                                
024800 S01-READ-W272G2  SECTION.                                                
024810     MOVE 'S01-READ-W272G2       ' TO CURRENT-SECTION                     
024900     SKIP2                                                                
025000     READ W272G2 INTO IN-AREA                                             
025100     AT END                                                               
025200        SET END-OF-W272G2 TO TRUE                                         
025300                                                                          
025400     NOT AT END                                                           
025500        MOVE 'W272G2' TO POSTSUM-FDNAMN                                   
025600        MOVE 'W272G2D1' TO POSTSUM-DDNAMN2                                
...
041280     .                                                                    
041290     EJECT                                                                
041300 IMS-GHU-WDK6-CLAG SECTION.                                               
041310     MOVE 'IMS-GHU-WDK6-CLAG      ' TO DBS-SECTION                        
041400                                                                          
041500     STRING 'WDK601  (IDARTNR  =' W-IDARTNR-X ')'                         
041600          DELIMITED BY SIZE INTO SSA1                                     
041700     MOVE 'WDK611  '       TO SSA2                                        
041800     MOVE '  GE' TO GOOD-STATUSCODES                                      
041900     CALL CBLTDLI USING GHU WDK6-PCB DLI-IO-WDK611 SSA1 SSA2              
042000     MOVE WDK6-STATUS-CODE TO STATUS-WS                                   
042001     PERFORM IMS-STATUSCHECK                                              
042200     .                                                                    
042300     SKIP3                                                                
042400                                                                          
042410 IMS-REPL-WDK611 SECTION.                                                 
042420     MOVE 'IMS-REPL-WDK611 '  TO DBS-SECTION                              
042430                                                                          
042440     MOVE '  ' TO GOOD-STATUSCODES                                        
042450     CALL CBLTDLI USING REPL WDK6-PCB DLI-IO-WDK611                       
042460     MOVE WDK6-STATUS-CODE TO STATUS-WS                                   
