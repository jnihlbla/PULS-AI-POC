...
003200 77  IDPGM               PIC X(8)    VALUE 'W9040600'.                    
...
010200     SKIP2                                                                
010300*01      MID -COPY W90406I1 -PRE MID-.                                    
010400     EJECT                                                                
010500*01      -COPY WMSGAREA.                                                  
010600     EJECT                                                                
010700*  03    MOD -COPY W90406O1 -PRE MOD- -RED MSG-AREA.                      
010800     EJECT                                                                
...
019000       MOVE MSG-INDATA-MINUS-2-TRANSKODER TO MID-W90406I1-CTX             
019100       MOVE MSG-IDTRANS-2 TO MFS-IDTRANS                                  
019200       MOVE MSG-KDMFSFOR-2 TO MFS-KDMFSFOR                                
019300       MOVE JA TO ARTIKEL-SW                                              
019400     ELSE                                                                 
019500       MOVE MSG-INDATA-MINUS-1-TRANSKOD  TO MID-W90406I1-CTX              
...
020400                               MSGI-IDLTERM-USER                          
020500     MOVE '9406'            TO MSGI-IDTRANS                               
020600     IF MFS-IDTRANS = '9406'                                              
...
021900     END-IF                                                               
022000     SKIP2                                                                
022100     IF MFS-IDTRANS NOT = '9406'                                          
...
024400     MOVE 'W90406O1' TO MFS-IDMOD                                         
024500     MOVE '9406' TO MOD-IDTRANS                                           
024600                                                                          
024700*    MOVE IDARTNR-WS TO MOD-IDARTNR-UT                                    
024800*    INSPECT MOD-IDARTNR-UT REPLACING LEADING ZERO BY SPACE               
024900     MOVE MFS-RENSA-FAELT TO                                              
024910*                            MOD-IDARTNR-IN                               
...
032100*    SKIP2                                                                
032200*    MOVE MFS-ROER-EJ-FAELT TO                                            
...
033300       MOVE MFS-ROER-EJ-FAELT TO                                          
033310*                                MOD-IDLEVNR (IX)                         
