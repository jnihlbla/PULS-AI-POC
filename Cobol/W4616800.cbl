...
000900*    FUNKTION: *****************                                          
001000*                                                                         
001100*        IMPORTÖRSBEROENDE BEHANDLING (ÖSTERRIKE)                         
...
003000     SELECT W46168                       ASSIGN TO UT-S-W46168D1.         
003100     SKIP2                                                                
003200*- - - - - - - - - - - - UTFIL:                                           
003300*                        - -  FIL TILL VIPS                               
003400     SELECT W46188                       ASSIGN TO UT-S-W46168D2.         
003500     SELECT W4614X                       ASSIGN TO UT-S-W46168D3.         
003600     EJECT                                                                
...
012100 01  UTPOST2                      PIC X(80).                              
012200     SKIP2                                                                
012220 01  RID-POST2 -COPY W461RIDN     -L.                                     
012230     SKIP2                                                                
012240 01  RIE-POST2 -COPY W461RIEN     -L.                                     
012250     SKIP2                                                                
012260 01  RIH-POST2 -COPY W461RIHN     -L.                                     
012270     SKIP2                                                                
012280 01  RIO-POST2 -COPY W461RIO2     -L.                                     
012290     SKIP2                                                                
012291 01  RKB-POST2 -COPY W461RKBN     -L.                                     
012292     SKIP2                                                                
012293 01  RKC-POST2 -COPY W461RKCN     -L.                                     
012294     SKIP2                                                                
012295 01  RKD-POST2 -COPY W461RKDN     -L.                                     
012300     EJECT                                                                
012400 WORKING-STORAGE SECTION.                                                 
012500                                                                          
012600*    -- CHECKED BY WY2000                                                 
012700*- - - - - - - - - - - - - -  PROGRAM-NAMN                                
012800 77  PROGRAM-NAMN                PIC X(8)    VALUE 'W4616800'.            
012900     SKIP2                                                                
...
013600                                                                          
013700 77  W46168-EOF                  PIC X(1)    VALUE 'N'.                   
013800     SKIP2                                                                
...
015060*01  FILLER -COPY WWDIST34 -RED TEST-IDDISTR.                             
015061       EJECT                                                              
...
035400     SKIP2                                                                
035500     OPEN INPUT W46168 OUTPUT W46188 W4614X                               
035600     SKIP2                                                                
...
037400     PERFORM S01-LAS-W46168                                               
037500     PERFORM UNTIL                                                        
037600      NOT ( W46168-EOF = NEJ )                                            
...
051731                       WRITE RID-POST2 FROM INPOST                        
051740                                                                          
051750                  WHEN 'RIE'                                              
051760                       WRITE RIE-POST  FROM INPOST                        
051761                       WRITE RIE-POST2 FROM INPOST                        
051770                                                                          
051780                  WHEN 'RIH'                                              
051790                       WRITE RIH-POST  FROM INPOST                        
051791                       WRITE RIH-POST2 FROM INPOST                        
051792                                                                          
051795                  WHEN OTHER                                              
051796                       WRITE UTPOST  FROM INPOST                          
051797                       WRITE UTPOST2 FROM INPOST                          
051798                                                                          
051799                  END-EVALUATE                                            
052000                END-IF                                                    
052100             ELSE                                                         
...
052595                        WRITE RIO-POST2 FROM INPOST                       
052596                                                                          
052597                   WHEN OTHER                                             
052598                        WRITE UTPOST  FROM INPOST                         
052599                        WRITE UTPOST2 FROM INPOST                         
052600                                                                          
052601                   END-EVALUATE                                           
052800                 END-IF                                                   
052900               ELSE                                                       
...
101000     MOVE     2378           TO START-IDDISTR                             
...
101800     WRITE    UTPOST2        FROM  START-W461RI0N-CTX                     
101900     .                                                                    
102000     SKIP2                                                                
...
102700     WRITE    UTPOST2        FROM  SLUT-W461RI9                           
102800     DISPLAY  'SLUT-KORT   ' SLUT-W461RI9                                 
102900     .                                                                    
103000     SKIP2                                                                
103100 S01-LAS-W46168 SECTION.                                                  
103200     SKIP2                                                                
103300     READ   W46168 INTO W-ARBAREA                                         
103400     AT END MOVE JA TO W46168-EOF                                         
103500     END-READ                                                             
103600                                                                          
103700     IF W46168-EOF = NEJ                                                  
103800                                                                          
103900       MOVE 'W46168'            TO POSTSUM-FDNAMN                         
104000       MOVE 'W46168D1'          TO POSTSUM-DDNAMN2                        
...
104800     SKIP2                                                                
104900                                                                          
105000     CLOSE W46168 W46188 W4614X                                           
105100     SKIP2                                                                
