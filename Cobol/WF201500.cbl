...
000400*                                                                         
001150 ID DIVISION.                                                             
001200 PROGRAM-ID.     WF201500.                                                
001300 AUTHOR.         ANDERS HENRIKSSON.                                       
001400 DATE-WRITTEN.   02-04-19.                                                
001500 DATE-COMPILED.                                                           
001700                                                                          
001800*   PGM                                                                   
001900*   CREATES FILE (A/P DATA) FROM DOCUMENT-TYPE AND                        
...
002471*   - ROWS IN TABLE T01LSEL                                               
002480                                                                          
002490*** VI HAR KVAR ATT LÄGGA TILL REVALUTA HÄR                               
002500                                                                          
002700 ENVIRONMENT DIVISION.                                                    
002900 INPUT-OUTPUT SECTION.                                                    
003011 FILE-CONTROL.                                                            
003012*    ---- UTFIL: GENERAL LEDGER DATA                                      
003013     SELECT  WF2015        ASSIGN TO WF2015D1.                            
003014                                                                          
003015     SELECT  WF2025        ASSIGN TO WF2015D2.                            
003016     EJECT                                                                
003017                                                                          
...
003030                                                                          
003040*01  POST-WF2015   -COPY WF2015  -L.                                      
003041                                                                          
003042 FD  WF2025                                                               
003043     RECORDING  F                                                         
003044     BLOCK CONTAINS 0.                                                    
003045                                                                          
003046*01  POST-WF2025   -COPY WF2015  -L.                                      
003050     EJECT                                                                
004000 WORKING-STORAGE SECTION.                                                 
004110                                                                          
004200 77  IDPGM                        PIC X(8)   VALUE 'WF201500'.            
004430     EJECT                                                                
004440                                                                          
...
006501     EJECT                                                                
006502                                                                          
006503 01  OUTPUT-AREA-T               PIC X(24)   VALUE                        
006504                                 'OUTPUT-TAB   '.                         
006505*01  -COPY WF2015T                                                        
006506                                                                          
006507 01  UTFIL-AREA-START            PIC X(24)   VALUE                        
006508                                             'UTFIL-AREA-START'.          
006509     SKIP2                                                                
006510*01  -COPY WF2015 -PRE WS-                                                
006520     EJECT                                                                
006550                                                                          
006560 01  WS-AREA.                                                             
...
006598                                                                          
006780     03 DOTY-FLAP         OCCURS 100   PIC X(1).                          
006790     03 BURE-FLAP         OCCURS 100   PIC X(1).                          
006791                                                                          
...
013110     OPEN OUTPUT WF2015                                                   
013120                 WF2025                                                   
014100     .                                                                    
014210                                                                          
014985 B-EXECUTE SECTION.                                                       
014986     PERFORM DB2-OPEN-CRS-LSEL                                            
014987     PERFORM DB2-FETCH-CRS-LSEL                                           
014988     PERFORM UNTIL LINES-MISSING                                          
014991       PERFORM DB2-SELECT-T01PROC                                         
014996                                                                          
014998       PERFORM DB2-DCL-OPN-CRS1-ALL                                       
014999       PERFORM DB2-FETCH-CRS1-ALL                                         
015000       IF SQLERRD(3) > 0                                                  
015001         MOVE 000     TO SQLCODE-WS                                       
015002       END-IF                                                             
015003       PERFORM UNTIL LINES-MISSING                                        
015004         MOVE SQLERRD(3) TO WS-MULTIFETCH                                 
015005         MOVE ZERO       TO WS-MX                                         
015006         PERFORM UNTIL WS-MX = WS-MULTIFETCH                              
015007           ADD +1        TO WS-MX                                         
015008**** INT2 SHOULD NOT BE IN FILE                                           
015009           IF WS-KDFINDOC(WS-MX) = 'INT2'                                 
015010             CONTINUE                                                     
015011           ELSE                                                           
015012             PERFORM F-CREATE-SEQUENCEFILE                                
015013             PERFORM S11-WRITE-WF20X5                                     
015014           END-IF                                                         
015015         END-PERFORM                                                      
015016         IF WS-MULTIFETCH = 100                                           
015017           PERFORM DB2-FETCH-CRS1-ALL                                     
015018           IF SQLERRD(3) > 0                                              
015019             MOVE 000     TO SQLCODE-WS                                   
015020           END-IF                                                         
015021         ELSE                                                             
015022           MOVE 100     TO SQLCODE-WS                                     
015023         END-IF                                                           
015024       END-PERFORM                                                        
015025       PERFORM DB2-CLOSE-CRS1-ALL                                         
015026                                                                          
015030       PERFORM DB2-FETCH-CRS-LSEL                                         
015040     END-PERFORM                                                          
015050     PERFORM DB2-CLOSE-CRS-LSEL                                           
015103     .                                                                    
015105                                                                          
015106 F-CREATE-SEQUENCEFILE SECTION.                                           
015109     MOVE  WS-IDLEGSEL(WS-MX)         TO WS-AP-IDLEGSEL                   
015110     MOVE  WS-KDVALISO(WS-MX)         TO WS-AP-KDVALISO                   
015111     MOVE  WS-PRKURS(WS-MX)           TO WS-AP-PRKURS                     
015112     MOVE  WS-IDLANDX3-SEND(WS-MX)    TO WS-AP-IDLANDX3-SEND              
015113     MOVE  WS-IDPARTNR(WS-MX)         TO WS-AP-IDPARTNR                   
015114     MOVE  WS-KDFINDOC(WS-MX)         TO WS-AP-KDFINDOC                   
015116     MOVE  WS-DAFINDOC(WS-MX)         TO WS-AP-DAFINDOC                   
015117     MOVE  WS-IDFINDOC(WS-MX)         TO WS-AP-IDFINDOC                   
015118     MOVE  WS-IDLANDX3-BET(WS-MX)     TO WS-AP-IDLANDX3-BET               
015119     MOVE  WS-SUNTO-SERV(WS-MX)       TO WS-AP-SUNTO-SERV                 
015120     MOVE  WS-SUBTO-SERV(WS-MX)       TO WS-AP-SUBTO-SERV                 
015121     MOVE  WS-SUNTO-PART(WS-MX)       TO WS-AP-SUNTO-PART                 
015122     MOVE  WS-SUBTO-PART(WS-MX)       TO WS-AP-SUBTO-PART                 
015123     MOVE  WS-SUNTO-TOT(WS-MX)        TO WS-AP-SUNTO-TOT                  
015124     MOVE  WS-SUBTO-TOT(WS-MX)        TO WS-AP-SUBTO-TOT                  
015125     MOVE  WS-SUVAT-BILLIT-TOT(WS-MX) TO WS-AP-SUVAT-BILLIT-TOT           
015155     .                                                                    
015157                                                                          
015158 S11-WRITE-WF20X5 SECTION.                                                
015160     IF WS-AP-IDLEGSEL        = 'VCCS'                                    
015161       WRITE POST-WF2015 FROM WS-AP-WF2015                                
015162     ELSE                                                                 
015163       IF WS-AP-IDLEGSEL(1:2) = 'SC'                                      
015164         WRITE POST-WF2025 FROM WS-AP-WF2015                              
015165       END-IF                                                             
015166     END-IF                                                               
015167     .                                                                    
015170                                                                          
...
019398     .                                                                    
019400                                                                          
019401 DB2-STATUS-CHECK  SECTION.                                               
019402                                                                          
019403     SET SQLCODE-IX TO 1                                                  
019404     SEARCH GOOD-SQLCODE                                                  
019405       AT END                                                             
019406          STRING 'INVALID DB2 SQL STATUS CODE: ' SQLCODE-WS               
019407          DELIMITED BY SIZE INTO ERROR-TEXT                               
019408          CALL ABEND USING RKOD-ABEND-DB2                                 
019409       WHEN GOOD-SQLCODE (SQLCODE-IX) = SQLCODE-WS                        
019410          CONTINUE                                                        
019420     END-SEARCH                                                           
019500     .                                                                    
